...
{
	//Fixa o ponteiro.
	cli::pin_ptr<IDXGIResource*> p = &PonteiroTrabalho;

	//Chama o método de ADICIONAR PONTEIRO na classe base(Caren).
	return Caren::Shared_AdicionarPonteiro(Param_PonteiroNativo, reinterpret_cast<IUnknown**>(static_cast<IDXGIResource**>(p)));
}
...
CarenResult CarenDXGIResource::GetDevice(
...
CarenResult CarenDXGIResource::GetParent(
	String^ Param_RIIDInterface, 
...
CarenResult CarenDXGIResource::SetPrivateData(
...
CarenResult CarenDXGIResource::GetPrivateData(
	String^ Param_GuidIdentificao, 
...
CarenResult CarenDXGIResource::SetPrivateDataInterface(
