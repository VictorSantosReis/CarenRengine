...
METODODELC CLN_ID2D1CommandSink1::BeginDraw()
{
	//Entra na sessão critica de codígo.
	EnterCriticalSection(&SessaoCritica);
...
METODODELC CLN_ID2D1CommandSink1::EndDraw()
{
	//Entra na sessão critica de codígo.
	EnterCriticalSection(&SessaoCritica);
...
METODODELC CLN_ID2D1CommandSink1::SetAntialiasMode(D2D1_ANTIALIAS_MODE antialiasMode)
{
	//Entra na sessão critica de codígo.
	EnterCriticalSection(&SessaoCritica);
...
METODODELC CLN_ID2D1CommandSink1::SetTags(
	D2D1_TAG tag1,
	D2D1_TAG tag2)
{
	//Entra na sessão critica de codígo.
...
METODODELC CLN_ID2D1CommandSink1::SetTextAntialiasMode(D2D1_TEXT_ANTIALIAS_MODE textAntialiasMode)
{
	//Entra na sessão critica de codígo.
	EnterCriticalSection(&SessaoCritica);
...
METODODELC CLN_ID2D1CommandSink1::SetTextRenderingParams(_In_opt_ IDWriteRenderingParams* textRenderingParams)
{
	//Entra na sessão critica de codígo.
	EnterCriticalSection(&SessaoCritica);
...
METODODELC CLN_ID2D1CommandSink1::SetTransform(_In_ CONST D2D1_MATRIX_3X2_F* transform)
{
	//Entra na sessão critica de codígo.
	EnterCriticalSection(&SessaoCritica);
...
METODODELC CLN_ID2D1CommandSink1::SetPrimitiveBlend(D2D1_PRIMITIVE_BLEND primitiveBlend)
{
	//Entra na sessão critica de codígo.
	EnterCriticalSection(&SessaoCritica);
...
METODODELC CLN_ID2D1CommandSink1::SetUnitMode(D2D1_UNIT_MODE unitMode)
{
	//Entra na sessão critica de codígo.
	EnterCriticalSection(&SessaoCritica);
...
METODODELC CLN_ID2D1CommandSink1::Clear(_In_opt_ CONST D2D1_COLOR_F* color)
{
	//Entra na sessão critica de codígo.
	EnterCriticalSection(&SessaoCritica);
...
METODODELC CLN_ID2D1CommandSink1::DrawGlyphRun(
...
METODODELC CLN_ID2D1CommandSink1::DrawLine(
...
METODODELC CLN_ID2D1CommandSink1::DrawGeometry(
...
METODODELC CLN_ID2D1CommandSink1::DrawRectangle(
...
METODODELC CLN_ID2D1CommandSink1::DrawBitmap(
...
METODODELC CLN_ID2D1CommandSink1::DrawImage(
...
METODODELC CLN_ID2D1CommandSink1::DrawGdiMetafile(
...
METODODELC CLN_ID2D1CommandSink1::FillMesh(
	_In_ ID2D1Mesh* mesh,
	_In_ ID2D1Brush* brush)
{
	//Entra na sessão critica de codígo.
...
METODODELC CLN_ID2D1CommandSink1::FillOpacityMask(
...
METODODELC CLN_ID2D1CommandSink1::FillGeometry(
	_In_ ID2D1Geometry* geometry,
	_In_ ID2D1Brush* brush,
...
METODODELC CLN_ID2D1CommandSink1::FillRectangle(
	_In_ CONST D2D1_RECT_F* rect,
	_In_ ID2D1Brush* brush)
{
	//Entra na sessão critica de codígo.
...
METODODELC CLN_ID2D1CommandSink1::PushAxisAlignedClip(
...
METODODELC CLN_ID2D1CommandSink1::PushLayer(
...
METODODELC CLN_ID2D1CommandSink1::PopAxisAlignedClip()
{
	//Entra na sessão critica de codígo.
	EnterCriticalSection(&SessaoCritica);
...
METODODELC CLN_ID2D1CommandSink1::PopLayer()
{
	//Entra na sessão critica de codígo.
	EnterCriticalSection(&SessaoCritica);
