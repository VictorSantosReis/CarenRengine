...
public:
	static operator CarenMFLocalMFTRegistration^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFLocalMFTRegistration^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFLocalMFTRegistration();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFLocalMFTRegistration*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFLocalMFTRegistration::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
