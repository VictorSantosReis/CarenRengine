...
#include "../pch.h"
#include "CarenD2D1Factory7.h"

//Destruidor.
CarenD2D1Factory7::~CarenD2D1Factory7()
{
...
CarenResult CarenD2D1Factory7::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD2D1Factory7::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1Factory7*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1Factory7::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1Factory7*>(Param_PonteiroNativo);
...
CarenResult CarenD2D1Factory7::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1Factory7::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1Factory7::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenD2D1Factory7::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD2D1Factory7::ObterCodigoErro()
{
...
/// </summary>
void CarenD2D1Factory7::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD2D1Factory7::LiberarReferencia()
{
...
/// </summary>
void CarenD2D1Factory7::LimparDados()
{
...
/// </summary>
void CarenD2D1Factory7::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenD2D1Factory7();
}



// Métodos da interface proprietária(ICarenD2D1Factory7)
...
CarenResult CarenD2D1Factory7::CreateDevice(
	...
	[Out] ICarenD2D1Device6^% Param_Out_D2DDispositivo)
{
	...
	ID2D1Device6* pOutD2DDevice = NULL;
	...
	Param_Out_D2DDispositivo = gcnew CarenD2D1Device6();
...
// Métodos da interface (ICarenD2D1Factory6)
	...
	[Out] ICarenD2D1Device5^% Param_Out_D2DDispositivo)
{
	...
	//Variaveis a serem utilizadas.
	IDXGIDevice* pDxgiDevice = NULL;
	ID2D1Device5* pOutD2DDevice = NULL;
	...
	//Cria a interface que será retornada.
	Param_Out_D2DDispositivo = gcnew CarenD2D1Device5();
...
// Métodos da interface (ICarenD2D1Factory5)
	...
	[Out] ICarenD2D1Device4^% Param_Out_D2DDispositivo)
{
	...
	//Variaveis a serem utilizadas.
	IDXGIDevice* pDxgiDevice = NULL;
	ID2D1Device4* pOutD2DDevice = NULL;
	...
	//Cria a interface que será retornada.
	Param_Out_D2DDispositivo = gcnew CarenD2D1Device4();
...
// Métodos da interface (ICarenD2D1Factory4)
...
CarenResult CarenD2D1Factory7::CreateDrawingStateBlock(
...
CarenResult CarenD2D1Factory7::CreateGdiMetafile(
...
CarenResult CarenD2D1Factory7::CreatePathGeometry(
...
CarenResult CarenD2D1Factory7::CreateStrokeStyle(
...
CarenResult CarenD2D1Factory7::GetEffectProperties(
...
CarenResult CarenD2D1Factory7::GetRegisteredEffects(
...
CarenResult CarenD2D1Factory7::RegisterEffectFromStream(
...
/// <param name="Param_QuantidadeBindings">O número de Bindings na matriz(Param_Bindings).</param>
/// <param name="Param_CallbackEffectFactory">Um ponteiro para um Factory estatico para criar oefeito correspondente.</param>
CarenResult CarenD2D1Factory7::RegisterEffectFromString(
	String^ Param_ClassId,
...
CarenResult CarenD2D1Factory7::UnregisterEffect(
	String^ Param_ClassId
)
{
	//Variavel a ser retornada.
...
CarenResult CarenD2D1Factory7::CreateDCRenderTarget(
...
/// </summary>
/// <param name="Param_Out_StateBlock">Retorna uma interface(ICarenD2D1DrawingStateBlock) que contém um ponteiro para o novo bloco de estado de desenhado criado.</param>
CarenResult CarenD2D1Factory7::CreateDrawingStateBlock([Out] ICarenD2D1DrawingStateBlock^% Param_Out_StateBlock)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1Factory7::CreateDxgiSurfaceRenderTarget(
...
CarenResult CarenD2D1Factory7::CreateEllipseGeometry(
...
CarenResult CarenD2D1Factory7::CreateGeometryGroup(
...
CarenResult CarenD2D1Factory7::CreateHwndRenderTarget(
	CA_D2D1_RENDER_TARGET_PROPERTIES^ Param_PropsRenderTarget,
...
CarenResult CarenD2D1Factory7::CreateRectangleGeometry(
...
CarenResult CarenD2D1Factory7::CreateRoundedRectangleGeometry(
...
CarenResult CarenD2D1Factory7::CreateTransformedGeometry(
...
/// <param name="Param_PropsRenderTarget">O modo de renderização, o formato de pixel, as opções de remoção, as informações de DPI e o suporte mínimo directx necessário para renderização de hardware.</param>
/// <param name="Param_Out_RenderTarget">Retorna uma interface(ICarenD2D1RenderTarget) que contém um ponteiro para o objeto criado.</param>
CarenResult CarenD2D1Factory7::CreateWicBitmapRenderTarget(
...
void CarenD2D1Factory7::GetDesktopDpi(
...
/// </summary>
CarenResult CarenD2D1Factory7::ReloadSystemMetrics()
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
