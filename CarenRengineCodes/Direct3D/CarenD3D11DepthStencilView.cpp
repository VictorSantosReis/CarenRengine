...
{
	//Fixa o ponteiro.
	cli::pin_ptr<ID3D11DepthStencilView*> p = &PonteiroTrabalho;

	//Chama o método de ADICIONAR PONTEIRO na classe base(Caren).
	return Caren::Shared_AdicionarPonteiro(Param_PonteiroNativo, reinterpret_cast<IUnknown**>(static_cast<ID3D11DepthStencilView**>(p)));
}
...
//Métodos da interface ICarenD3D11DepthStencilView
...
CarenResult CarenD3D11DepthStencilView::GetResource([Out] ICarenD3D11Resource^% Param_Out_Recurso)
{
...
CarenResult CarenD3D11DepthStencilView::GetDevice(ICaren^ Param_Out_DispositivoD3D11)
{
	//Chama o método na classe de funções compartilhadas do D3D11.
...
CarenResult CarenD3D11DepthStencilView::GetPrivateData(
	String^ Param_Guid,
...
CarenResult CarenD3D11DepthStencilView::SetPrivateData(
	String^ Param_Guid,
	UInt32 Param_TamanhoBuffer, 
...
CarenResult CarenD3D11DepthStencilView::SetPrivateDataInterface(
	String^ Param_Guid, 
