...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD2D1RenderInfo">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD2D1RenderInfo^% Param_Out_CarenD2D1RenderInfo)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);

		//Cria a interface
		Param_Out_CarenD2D1RenderInfo = gcnew CarenD2D1RenderInfo();
