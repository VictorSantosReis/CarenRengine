...
//Destruidor.
CarenD3D11SamplerState::~CarenD3D11SamplerState()
{
...
CarenResult CarenD3D11SamplerState::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD3D11SamplerState::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID3D11SamplerState*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD3D11SamplerState::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID3D11SamplerState*>(Param_PonteiroNativo);
...
CarenResult CarenD3D11SamplerState::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11SamplerState::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11SamplerState::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenD3D11SamplerState::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD3D11SamplerState::ObterCodigoErro()
{
...
/// </summary>
void CarenD3D11SamplerState::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD3D11SamplerState::LiberarReferencia()
{
...
/// </summary>
void CarenD3D11SamplerState::LimparDados()
{
...
/// </summary>
void CarenD3D11SamplerState::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
...
CarenResult CarenD3D11SamplerState::GetDesc(Estruturas::CA_D3D11_SAMPLER_DESC^% Param_Out_DescAmostrador)
{
	...
	PonteiroTrabalho->GetDesc(&DescSampler);

	//Converte e define no parametro de saida a estrutura.
	Param_Out_DescAmostrador = Util.ConverterD3D11_SAMPLER_DESCUnManaged_ToManaged(&DescSampler);
...
CarenResult CarenD3D11SamplerState::ObterDispositivo(ICaren^ Param_Out_DispositivoD3D11)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11SamplerState::ObterDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11SamplerState::DefinirDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11SamplerState::DefinirInterfaceDadosPrivados(
