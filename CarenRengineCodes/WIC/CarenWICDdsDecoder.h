...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por fornecer informações e funcionalidades específicas para o formato de imagem DDS.
/// </summary>
public ref class CarenWICDdsDecoder : public ICarenWICDdsDecoder
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IWICDdsDecoder).
	IWICDdsDecoder* PonteiroTrabalho = NULL;
...
public:
	static operator CarenWICDdsDecoder^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenWICDdsDecoder^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenWICDdsDecoder();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IWICDdsDecoder*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenWICDdsDecoder::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenWICDdsDecoder)
public:
	/// <summary>
