...
public:
	static operator CarenWICDdsEncoder^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenWICDdsEncoder^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenWICDdsEncoder();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IWICDdsEncoder*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenWICDdsEncoder::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
