...
public:
	static operator CarenMFSourceReader^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFSourceReader^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFSourceReader();
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFSourceReader::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
