...
CarenResult CarenSimpleAudioVolume::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<ISimpleAudioVolume*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenSimpleAudioVolume::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ISimpleAudioVolume*>(Param_PonteiroNativo);
...
/// </summary>
void CarenSimpleAudioVolume::LimparDados()
{
