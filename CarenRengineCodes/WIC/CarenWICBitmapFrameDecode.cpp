...
//Destruidor.
CarenWICBitmapFrameDecode::~CarenWICBitmapFrameDecode()
{
...
CarenResult CarenWICBitmapFrameDecode::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenWICBitmapFrameDecode::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<IWICBitmapFrameDecode*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenWICBitmapFrameDecode::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IWICBitmapFrameDecode*>(Param_PonteiroNativo);
...
CarenResult CarenWICBitmapFrameDecode::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICBitmapFrameDecode::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICBitmapFrameDecode::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenWICBitmapFrameDecode::StatusPonteiro()
{
...
/// </summary>
Int32 CarenWICBitmapFrameDecode::ObterCodigoErro()
{
...
/// </summary>
void CarenWICBitmapFrameDecode::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenWICBitmapFrameDecode::LiberarReferencia()
{
...
/// </summary>
void CarenWICBitmapFrameDecode::LimparDados()
{
...
/// </summary>
void CarenWICBitmapFrameDecode::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenWICBitmapFrameDecode();
}



// Métodos da interface proprietária(ICarenWICBitmapFrameDecode)
...
CarenResult CarenWICBitmapFrameDecode::GetColorContexts(
...
CarenResult CarenWICBitmapFrameDecode::GetMetadataQueryReader(
...
CarenResult CarenWICBitmapFrameDecode::GetThumbnail(
...
CarenResult CarenWICBitmapFrameDecode::CopyPalette(ICaren^ Param_Palette)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICBitmapFrameDecode::CopyPixels(
...
CarenResult CarenWICBitmapFrameDecode::GetPixelFormat([Out] String^% Param_Out_FormatoPixel)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICBitmapFrameDecode::GetResolution(
...
CarenResult CarenWICBitmapFrameDecode::GetSize(
