...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por representar o conjunto de transformações implementadas pelo sistema de renderização de efeitos, que fornece funcionalidade fixa.
/// </summary>
public ref class CarenD2D1ConcreteTransform : public ICarenD2D1ConcreteTransform
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID2D1ConcreteTransform).
	ID2D1ConcreteTransform* PonteiroTrabalho = NULL;
...
public:
	static operator CarenD2D1ConcreteTransform^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1ConcreteTransform^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1ConcreteTransform();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1ConcreteTransform*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD2D1ConcreteTransform::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
