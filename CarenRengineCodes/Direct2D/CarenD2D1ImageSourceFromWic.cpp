...
CarenResult CarenD2D1ImageSourceFromWic::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1ImageSourceFromWic*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1ImageSourceFromWic::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1ImageSourceFromWic*>(Param_PonteiroNativo);
...
/// </summary>
Int32 CarenD2D1ImageSourceFromWic::ObterCodigoErro()
{
...
/// </summary>
void CarenD2D1ImageSourceFromWic::LimparDados()
{
