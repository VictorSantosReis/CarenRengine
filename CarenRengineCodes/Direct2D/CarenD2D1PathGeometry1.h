...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por adicionar funcionalidade à ICarenD2D1PathGeometry. Em particular, fornece o método ComputePointAndSegmentAtLength específico 
/// para geometria.
/// </summary>
public ref class CarenD2D1PathGeometry1 : public ICarenD2D1PathGeometry1
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID2D1PathGeometry1).
	ID2D1PathGeometry1* PonteiroTrabalho = NULL;
...
public:
	static operator CarenD2D1PathGeometry1^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1PathGeometry1^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1PathGeometry1();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1PathGeometry1*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD2D1PathGeometry1::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenD2D1PathGeometry1)
public:
	/// <summary>
	...
	virtual CarenResult ComputePointAndSegmentAtLength(
	float Param_Length,
...
public:
	...
	virtual CarenResult GetFigureCount([Out] UInt32% Param_Out_Quantidade);
	...
	virtual CarenResult GetSegmentCount([Out] UInt32% Param_Out_Quantidade);
	...
	virtual CarenResult Open([Out] ICarenD2D1GeometrySink^% Param_Out_GeometrySink);
	...
	virtual CarenResult Stream(ICarenD2D1GeometrySink^ Param_GeometrySink);
