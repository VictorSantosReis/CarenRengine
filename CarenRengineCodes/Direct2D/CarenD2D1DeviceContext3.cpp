...
//Destruidor.
CarenD2D1DeviceContext3::~CarenD2D1DeviceContext3()
{
...
CarenResult CarenD2D1DeviceContext3::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD2D1DeviceContext3::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1DeviceContext3*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1DeviceContext3::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1DeviceContext3*>(Param_PonteiroNativo);
...
CarenResult CarenD2D1DeviceContext3::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1DeviceContext3::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1DeviceContext3::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenD2D1DeviceContext3::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD2D1DeviceContext3::ObterCodigoErro()
{
...
/// </summary>
void CarenD2D1DeviceContext3::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD2D1DeviceContext3::LiberarReferencia()
{
...
/// </summary>
void CarenD2D1DeviceContext3::LimparDados()
{
...
/// </summary>
void CarenD2D1DeviceContext3::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenD2D1DeviceContext3();
}



// Métodos da interface proprietária(ICarenD2D1DeviceContext3)
...
CarenResult CarenD2D1DeviceContext3::CreateSpriteBatch(
...
void CarenD2D1DeviceContext3::DrawSpriteBatch(
...
CarenResult CarenD2D1DeviceContext3::CreateGradientMesh(
...
CarenResult CarenD2D1DeviceContext3::CreateImageSourceFromDxgi(
...
CarenResult CarenD2D1DeviceContext3::CreateImageSourceFromWic(
...
CarenResult CarenD2D1DeviceContext3::CreateInk(
...
CarenResult CarenD2D1DeviceContext3::CreateInkStyle(
...
CarenResult CarenD2D1DeviceContext3::CreateLookupTable3D(
...
CarenResult CarenD2D1DeviceContext3::CreateTransformedImageSource(
...
void CarenD2D1DeviceContext3::DrawGdiMetafile(
...
void CarenD2D1DeviceContext3::DrawGradientMesh(
...
void CarenD2D1DeviceContext3::DrawInk(
...
CarenResult CarenD2D1DeviceContext3::GetGradientMeshWorldBounds(
	ICarenD2D1GradientMesh^ Param_GradientMesh,
...
CarenResult CarenD2D1DeviceContext3::CreateFilledGeometryRealization(
...
/// <param name="Param_Out_GeometryRealization">Retorna uma interface(ICarenD2D1GeometryRealization) que contém um ponteiro para o novo objeto de realização.</param>
CarenResult CarenD2D1DeviceContext3::CreateStrokedGeometryRealization(
	ICarenD2D1Geometry^ Param_Geometria,
	float Param_FlatterningTolerance,
...
void CarenD2D1DeviceContext3::DrawGeometryRealization(
...
CarenResult CarenD2D1DeviceContext3::CreateBitmap(
...
CarenResult CarenD2D1DeviceContext3::CreateBitmapBrush(
	ICarenD2D1Bitmap^ Param_Bitmap,
...
CarenResult CarenD2D1DeviceContext3::CreateBitmapFromDxgiSurface(
...
/// <param name="Param_Out_Bitmap">Retorna uma interface(ICarenD2D1Bitmap1) que contém um ponteiro para um novo objeto bitmap.</param>
CarenResult CarenD2D1DeviceContext3::CreateBitmapFromWicBitmap(
	ICaren^ Param_WicBitmapSource,
	CA_D2D1_BITMAP_PROPERTIES1^ Param_PropsBitmap,
	[Out] ICarenD2D1Bitmap1^% Param_Out_Bitmap)
{
...
CarenResult CarenD2D1DeviceContext3::CreateColorContext(
...
/// <param name="Param_Out_ColorContext">Retorna uma interface(ICarenD2D1ColorContext) que contém um ponteiro para o novo objeto de contexto de cores.</param>
CarenResult CarenD2D1DeviceContext3::CreateColorContextFromFilename(
...
/// <param name="Param_Out_ColorContext">Retorna uma interface(ICarenD2D1ColorContext) que contém um ponteiro para o novo objeto de contexto de cores.</param>
CarenResult CarenD2D1DeviceContext3::CreateColorContextFromWicColorContext(
...
CarenResult CarenD2D1DeviceContext3::CreateCommandList(
...
CarenResult CarenD2D1DeviceContext3::CreateEffect(
...
CarenResult CarenD2D1DeviceContext3::CreateGradientStopCollection(
...
CarenResult CarenD2D1DeviceContext3::CreateImageBrush(
...
CarenResult CarenD2D1DeviceContext3::DrawBitmap(
	ICarenD2D1Bitmap^ Param_Bitmap,
	CA_D2D1_RECT_F^ Param_RetanguloDestino,
...
void CarenD2D1DeviceContext3::DrawGlyphRun(
...
void CarenD2D1DeviceContext3::DrawImage(
	ICarenD2D1Image^ Param_Image,
	CA_D2D1_POINT_2F^ Param_TargetOffset,
...
void CarenD2D1DeviceContext3::FillOpacityMask(
...
void CarenD2D1DeviceContext3::GetDevice(ICaren^ Param_Out_Dispositivo)
{
	//Variaveis a serem utilizadas.
...
CarenResult CarenD2D1DeviceContext3::GetEffectInvalidRectangleCount(
	ICarenD2D1Effect^ Param_Efeito,
...
CarenResult CarenD2D1DeviceContext3::GetEffectInvalidRectangles(
	ICarenD2D1Effect^ Param_Efeito,
...
CarenResult CarenD2D1DeviceContext3::GetEffectRequiredInputRectangles(
	ICarenD2D1Effect^ Param_Efeito,
...
CarenResult CarenD2D1DeviceContext3::GetGlyphRunWorldBounds(
	CA_D2D1_POINT_2F^ Param_BaseLineOrigin,
...
CarenResult CarenD2D1DeviceContext3::GetImageLocalBounds(
	ICarenD2D1Image^ Param_Image,
...
CarenResult CarenD2D1DeviceContext3::GetImageWorldBounds(
	ICarenD2D1Image^ Param_Image,
...
void CarenD2D1DeviceContext3::GetPrimitiveBlend(
...
void CarenD2D1DeviceContext3::GetRenderingControls(
...
CarenResult CarenD2D1DeviceContext3::GetTarget(
...
void CarenD2D1DeviceContext3::GetUnitMode([Out] CA_D2D1_UNIT_MODE Param_Out_Unit)
{
	//Chama o método para realizar a operação.
...
CarenResult CarenD2D1DeviceContext3::InvalidateEffectInputRectangle(
	ICarenD2D1Effect^ Param_Efeito,
...
void CarenD2D1DeviceContext3::IsBufferPrecisionSupported(
	CA_D2D1_BUFFER_PRECISION  Param_BufferPrecision,
...
void CarenD2D1DeviceContext3::IsDxgiFormatSupported(
...
void CarenD2D1DeviceContext3::PushLayer(
...
void CarenD2D1DeviceContext3::SetPrimitiveBlend(CA_D2D1_PRIMITIVE_BLEND Param_PrimitiveBlend)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1DeviceContext3::SetRenderingControls(CA_D2D1_RENDERING_CONTROLS^ Param_ControlesRenderizacao)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void CarenD2D1DeviceContext3::SetTarget(ICarenD2D1Image^ Param_Imagem)
{
	//Variaveis a serem utilizadas.
	ID2D1Image* pMyImage = NULL;
...
void CarenD2D1DeviceContext3::SetUnitMode(CA_D2D1_UNIT_MODE Param_UnitMode)
{
	//Chama o método para realizar a operação.
...
/// </summary>
void CarenD2D1DeviceContext3::BeginDraw()
{
	//Chama o método para realizar a operação.
...
void CarenD2D1DeviceContext3::Clear(CA_D2D1_COLOR_F^ Param_ClearColor)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
CarenResult CarenD2D1DeviceContext3::CreateCompatibleRenderTarget(
...
/// </summary>
/// <param name="Param_Out_BitmapRenderTarget">Retorna a interface (ICarenD2D1BitmapRenderTarget) que contém um ponteiro para um novo alvo de renderização bitmap. O usuário deve inicializar a interface antes de chamar este método.</param>
CarenResult CarenD2D1DeviceContext3::CreateCompatibleRenderTarget(ICaren^ Param_Out_BitmapRenderTarget)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1DeviceContext3::CreateLayer(
...
/// </summary>
/// <param name="Param_Out_Layer">Retorna a interface ICarenD2D1Layer que contém um ponteiro para a nova camada(Layer).</param>
CarenResult CarenD2D1DeviceContext3::CreateLayer([Out] ICarenD2D1Layer^% Param_Out_Layer)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1DeviceContext3::CreateLinearGradientBrush(
...
CarenResult CarenD2D1DeviceContext3::CreateMesh([Out] ICarenD2D1Mesh^% Param_Out_Mesh)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1DeviceContext3::CreateRadialGradientBrush(
...
CarenResult CarenD2D1DeviceContext3::CreateSharedBitmap(
	String^ Param_Riid,
...
CarenResult CarenD2D1DeviceContext3::CreateSolidColorBrush(
...
CarenResult CarenD2D1DeviceContext3::DrawEllipse(
...
CarenResult CarenD2D1DeviceContext3::DrawGeometry(
	ICarenD2D1Geometry^ Param_Geometria,
	ICarenD2D1Brush^ Param_Brush,
	float Param_StrokeWidth,
	ICarenD2D1StrokeStyle^ Param_StrokeStyle)
...
CarenResult CarenD2D1DeviceContext3::DrawGlyphRun(
	CA_D2D1_POINT_2F^ Param_BaseLineOrigin,
	CA_DWRITE_GLYPH_RUN^ Param_GlyphRun,
	ICarenD2D1Brush^ Param_ForegroundBrush,
	CA_DWRITE_MEASURING_MODE Param_MeasuringMode)
...
CarenResult CarenD2D1DeviceContext3::DrawLine(
...
CarenResult CarenD2D1DeviceContext3::DrawRectangle(
...
CarenResult CarenD2D1DeviceContext3::DrawRoundedRectangle(
...
/// <param name="Param_MeasuringMode">Um valor que indica como as métricas do glifo(Glyph) são usadas para medir o texto quando ele é formatado. O valor padrão é DWRITE_MEASURING_MODE_NATURAL.</param>
CarenResult CarenD2D1DeviceContext3::DrawText(
	String^ Param_Texto,
...
/// <param name="Param_Opcoes">Um valor que indica se o texto deve ser encaixado nos limites do pixel e se o texto deve ser cortado no retângulo de layout. O valor padrão é D2D1_DRAW_TEXT_OPTIONS_NONE, 
/// o que indica que o texto deve ser encaixado nos limites do pixel e não deve ser cortado para o retângulo de layout.</param>
CarenResult CarenD2D1DeviceContext3::DrawTextLayout(
...
CarenResult CarenD2D1DeviceContext3::EndDraw(
...
CarenResult CarenD2D1DeviceContext3::FillEllipse(
	CA_D2D1_ELLIPSE^ Param_Ellipse,
	ICarenD2D1Brush^ Param_Brush)
{
	//Variavel a ser retornada.
...
CarenResult CarenD2D1DeviceContext3::FillGeometry(
	ICarenD2D1Geometry^ Param_Geometria,
	ICarenD2D1Brush^ Param_Brush,
...
CarenResult CarenD2D1DeviceContext3::FillMesh(
...
CarenResult CarenD2D1DeviceContext3::FillOpacityMask(
...
CarenResult CarenD2D1DeviceContext3::FillRectangle(
	CA_D2D1_RECT_F^ Param_Rect,
	ICarenD2D1Brush^ Param_Brush)
{
	//Variavel a ser retornada.
...
CarenResult CarenD2D1DeviceContext3::FillRoundedRectangle(
...
/// <param name="Param_Out_Tag1">Quando este método retorna, contém a tag para operações de desenho que causaram erros ou 0 se não houver erros.</param>
/// <param name="Param_Out_Tag2">Quando este método retorna, contém a tag para operações de desenho que causaram erros ou 0 se não houver erros.</param>
CarenResult CarenD2D1DeviceContext3::Flush(
	[Out] UInt64% Param_Out_Tag1,
	[Out] UInt64% Param_Out_Tag2)
{
	//Variavel a ser retornada.
...
void CarenD2D1DeviceContext3::GetAntialiasMode([Out] CA_D2D1_ANTIALIAS_MODE% Param_Out_AntialiasMode)
{
	//Variaveis a serem utilizadas.
...
void CarenD2D1DeviceContext3::GetDpi(
...
void CarenD2D1DeviceContext3::GetMaximumBitmapSize([Out] UInt32% Param_Out_MaximumSize)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1DeviceContext3::GetPixelFormat([Out] CA_D2D1_PIXEL_FORMAT^% Param_Out_PixelFormat)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void CarenD2D1DeviceContext3::GetPixelSize([Out] CA_D2D1_SIZE_U^% Param_Out_PixelSize)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void CarenD2D1DeviceContext3::GetSize([Out] CA_D2D1_SIZE_F^% Param_Out_Size)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void CarenD2D1DeviceContext3::GetTags(
	[Out] UInt64% Param_Out_Tag1,
	[Out] UInt64% Param_Out_Tag2)
{
	//Variaveis a serem utilizadas.
...
void CarenD2D1DeviceContext3::GetTextAntialiasMode([Out] CA_D2D1_TEXT_ANTIALIAS_MODE% Param_Out_TextAntialiasMode)
{
	//Variaveis a serem utilizadas.
...
void CarenD2D1DeviceContext3::GetTextRenderingParams(ICaren^ Param_Out_TextRenderingParams)
{
	//Variaveis a serem utilizadas.
...
void CarenD2D1DeviceContext3::GetTransform([Out] CA_D2D1_MATRIX_3X2_F^% Param_Out_Transform)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void CarenD2D1DeviceContext3::IsSupported(
...
/// ou ICarenD2D1RenderTarget::Flush.
/// </summary>
void CarenD2D1DeviceContext3::PopAxisAlignedClip()
{
	//Chama o método para realizar a operação.
...
/// ou ICarenD2D1RenderTarget::Flush.
/// </summary>
void CarenD2D1DeviceContext3::PopLayer()
{
	//Chama o método para realizar a operação.
...
void CarenD2D1DeviceContext3::PushAxisAlignedClip(
...
CarenResult CarenD2D1DeviceContext3::RestoreDrawingState(ICarenD2D1DrawingStateBlock^ Param_DrawingStateBlock)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1DeviceContext3::SaveDrawingState(ICarenD2D1DrawingStateBlock^ Param_DrawingStateBlock)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
void CarenD2D1DeviceContext3::SetAntialiasMode(CA_D2D1_ANTIALIAS_MODE Param_AntialiasMode)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1DeviceContext3::SetDpi(
	float Param_DpiX,
	float Param_DpiY)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1DeviceContext3::SetTags(
	UInt64 Param_Tag1,
	UInt64 Param_Tag2)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1DeviceContext3::SetTextAntialiasMode(CA_D2D1_TEXT_ANTIALIAS_MODE Param_TextAntialiasMode)
{
	//Chama o método para realizar a operação.
...
CarenResult CarenD2D1DeviceContext3::SetTextRenderingParams(ICaren^ Param_TextRenderingParams)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
void CarenD2D1DeviceContext3::SetTransform(CA_D2D1_MATRIX_3X2_F^ Param_Transform)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void  CarenD2D1DeviceContext3::GetFactory(ICaren^ Param_Out_Factory)
{
	//Variaveis a serem utilizadas.
