...
CarenResult CarenD2D1GeometrySink::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1GeometrySink*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1GeometrySink::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1GeometrySink*>(Param_PonteiroNativo);
...
/// </summary>
Int32 CarenD2D1GeometrySink::ObterCodigoErro()
{
...
/// </summary>
void CarenD2D1GeometrySink::LimparDados()
{
