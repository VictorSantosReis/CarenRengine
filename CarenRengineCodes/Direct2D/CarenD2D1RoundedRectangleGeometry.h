...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por descrever um retângulo arredondado.
/// </summary>
public ref class CarenD2D1RoundedRectangleGeometry : public ICarenD2D1RoundedRectangleGeometry
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID2D1RoundedRectangleGeometry).
	ID2D1RoundedRectangleGeometry* PonteiroTrabalho = NULL;
...
public:
	...
	/// </summary>
	CarenD2D1RoundedRectangleGeometry();
...
public:
	static operator CarenD2D1RoundedRectangleGeometry^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1RoundedRectangleGeometry^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1RoundedRectangleGeometry();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1RoundedRectangleGeometry*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD2D1RoundedRectangleGeometry::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenD2D1RoundedRectangleGeometry)
public:
	/// <summary>
	...
	virtual void GetRoundedRect([Out] CA_D2D1_ROUNDED_RECT^% Param_Out_RoundedRect);
