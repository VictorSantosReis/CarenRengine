...
public:
	static operator CarenWICMetadataQueryWriter^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenWICMetadataQueryWriter^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenWICMetadataQueryWriter();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IWICMetadataQueryWriter*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenWICMetadataQueryWriter::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
