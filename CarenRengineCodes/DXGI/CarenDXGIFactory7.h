...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenDXGIFactory7">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenDXGIFactory7^% Param_Out_CarenDXGIFactory7)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenDXGIFactory7 = gcnew CarenDXGIFactory7();
...
public:
	...
	virtual CarenResult RegistrarEventoModificacaoAdaptador(ICarenWindowsEvent^ Param_HandleEvento, [Out] UInt32% Param_Out_Cookie);
	...
	virtual CarenResult CancelarEventoModificacaoAdaptador(UInt32 Param_Cookie);
...
public:
	...
	virtual CarenResult EnumerarAdaptadorPorPreferenciaGPU(
...
public:
	...
	virtual CarenResult ChecarSuporteRecurso(CA_DXGI_FEATURE Param_Recurso, UInt32 Param_SizeBuffer, ICarenBuffer^% Param_Ref_BufferDescFeature);
...
public:
	...
	virtual CarenResult EnumerarAdaptadoresPorLUID(CA_LUID^ Param_LUID, String^ Param_RIID, [Out] ICaren^ Param_Out_InterfaceAdapter);
	...
	/// <param name="Param_RIID">O identificador globalmente único (GUID) do objeto ICarenDXGIAdapter referenciado pelo parâmetro (Param_InterfaceAdapter).</param>
	/// <param name="Param_Out_InterfaceAdapter">Recebe um ponteiro de interface ICarenDXGIAdapter para o adaptador. </param>
	virtual CarenResult EnumerarWarpAdapter(String^ Param_RIID, [Out] ICaren^ Param_Out_InterfaceAdapter);
...
public:
	...
	virtual CarenResult ObterFlagsCriacao([Out] UInt32% Param_Out_Flags);
