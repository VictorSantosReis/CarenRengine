...
CarenResult CarenWICDdsFrameDecode::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IWICDdsFrameDecode*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenWICDdsFrameDecode::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IWICDdsFrameDecode*>(Param_PonteiroNativo);
...
/// </summary>
Int32 CarenWICDdsFrameDecode::ObterCodigoErro()
{
...
/// </summary>
void CarenWICDdsFrameDecode::LimparDados()
{
