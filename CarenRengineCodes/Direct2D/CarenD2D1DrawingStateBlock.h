...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD2D1DrawingStateBlock">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD2D1DrawingStateBlock^% Param_Out_CarenD2D1DrawingStateBlock)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);

		//Cria a interface
		Param_Out_CarenD2D1DrawingStateBlock = gcnew CarenD2D1DrawingStateBlock();
