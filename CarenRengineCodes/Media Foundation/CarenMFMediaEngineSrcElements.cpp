...
CarenResult CarenMFMediaEngineSrcElements::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IMFMediaEngineSrcElements*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenMFMediaEngineSrcElements::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IMFMediaEngineSrcElements*>(Param_PonteiroNativo);
...
/// </summary>
Int32 CarenMFMediaEngineSrcElements::ObterCodigoErro()
{
...
/// </summary>
void CarenMFMediaEngineSrcElements::LimparDados()
{
