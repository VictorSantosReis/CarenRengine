...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenDXGISurface2">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenDXGISurface2^% Param_Out_CarenDXGISurface2)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenDXGISurface2 = gcnew CarenDXGISurface2();
...
public:
	...
	virtual CarenResult ObterRecurso(String^ Param_RIID, ICaren^ Param_Out_ObjetoRecurso, UInt32% Param_Ref_IndexSubrecurso);
