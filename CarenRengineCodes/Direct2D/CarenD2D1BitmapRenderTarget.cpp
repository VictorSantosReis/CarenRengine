...
#include "../pch.h"
#include "CarenD2D1BitmapRenderTarget.h"

//Destruidor.
CarenD2D1BitmapRenderTarget::~CarenD2D1BitmapRenderTarget()
{
...
CarenResult CarenD2D1BitmapRenderTarget::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD2D1BitmapRenderTarget::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1BitmapRenderTarget*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1BitmapRenderTarget::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1BitmapRenderTarget*>(Param_PonteiroNativo);
...
CarenResult CarenD2D1BitmapRenderTarget::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1BitmapRenderTarget::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1BitmapRenderTarget::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenD2D1BitmapRenderTarget::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD2D1BitmapRenderTarget::ObterCodigoErro()
{
...
/// </summary>
void CarenD2D1BitmapRenderTarget::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD2D1BitmapRenderTarget::LiberarReferencia()
{
...
/// </summary>
void CarenD2D1BitmapRenderTarget::LimparDados()
{
...
/// </summary>
void CarenD2D1BitmapRenderTarget::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenD2D1BitmapRenderTarget();
}



// Métodos da interface proprietária(ICarenD2D1BitmapRenderTarget)
...
CarenResult CarenD2D1BitmapRenderTarget::GetBitmap([Out] ICarenD2D1Bitmap^% Param_Out_Bitmap)
{
	...
	Hr = PonteiroTrabalho->GetBitmap(&pBitmap);
	...
	Resultado = DefinirPonteiroInterface(pBitmap, Param_Out_Bitmap, true);
...
/// </summary>
void CarenD2D1BitmapRenderTarget::BeginDraw()
{
	//Chama o método para realizar a operação.
...
void CarenD2D1BitmapRenderTarget::Clear(CA_D2D1_COLOR_F^ Param_ClearColor)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
CarenResult CarenD2D1BitmapRenderTarget::CreateBitmap(
...
CarenResult CarenD2D1BitmapRenderTarget::CreateBitmapBrush(
...
/// <param name="Param_Out_Bitmap">Retorna a interface ICarenD2D1Bitmap que contém um ponteiro para o novo bitmap.</param>
CarenResult CarenD2D1BitmapRenderTarget::CreateBitmapFromWicBitmap(
...
CarenResult CarenD2D1BitmapRenderTarget::CreateCompatibleRenderTarget(
...
/// </summary>
/// <param name="Param_Out_BitmapRenderTarget">Retorna a interface (ICarenD2D1BitmapRenderTarget) que contém um ponteiro para um novo alvo de renderização bitmap. O usuário deve inicializar a interface antes de chamar este método.</param>
CarenResult CarenD2D1BitmapRenderTarget::CreateCompatibleRenderTarget(ICaren^ Param_Out_BitmapRenderTarget)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1BitmapRenderTarget::CreateGradientStopCollection(
...
CarenResult CarenD2D1BitmapRenderTarget::CreateLayer(
...
/// </summary>
/// <param name="Param_Out_Layer">Retorna a interface ICarenD2D1Layer que contém um ponteiro para a nova camada(Layer).</param>
CarenResult CarenD2D1BitmapRenderTarget::CreateLayer([Out] ICarenD2D1Layer^% Param_Out_Layer)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1BitmapRenderTarget::CreateLinearGradientBrush(
...
CarenResult CarenD2D1BitmapRenderTarget::CreateMesh([Out] ICarenD2D1Mesh^% Param_Out_Mesh)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1BitmapRenderTarget::CreateRadialGradientBrush(
...
CarenResult CarenD2D1BitmapRenderTarget::CreateSharedBitmap(
	String^ Param_Riid,
...
CarenResult CarenD2D1BitmapRenderTarget::CreateSolidColorBrush(
...
CarenResult CarenD2D1BitmapRenderTarget::DrawBitmap(
	ICarenD2D1Bitmap^ Param_Bitmap,
...
CarenResult CarenD2D1BitmapRenderTarget::DrawEllipse(
...
CarenResult CarenD2D1BitmapRenderTarget::DrawGeometry(
...
CarenResult CarenD2D1BitmapRenderTarget::DrawGlyphRun(
...
CarenResult CarenD2D1BitmapRenderTarget::DrawLine(
...
CarenResult CarenD2D1BitmapRenderTarget::DrawRectangle(
...
CarenResult CarenD2D1BitmapRenderTarget::DrawRoundedRectangle(
...
/// <param name="Param_MeasuringMode">Um valor que indica como as métricas do glifo(Glyph) são usadas para medir o texto quando ele é formatado. O valor padrão é DWRITE_MEASURING_MODE_NATURAL.</param>
CarenResult CarenD2D1BitmapRenderTarget::DrawText(
	String^ Param_Texto,
...
/// <param name="Param_Opcoes">Um valor que indica se o texto deve ser encaixado nos limites do pixel e se o texto deve ser cortado no retângulo de layout. O valor padrão é D2D1_DRAW_TEXT_OPTIONS_NONE, 
/// o que indica que o texto deve ser encaixado nos limites do pixel e não deve ser cortado para o retângulo de layout.</param>
CarenResult CarenD2D1BitmapRenderTarget::DrawTextLayout(
...
CarenResult CarenD2D1BitmapRenderTarget::EndDraw(
...
CarenResult CarenD2D1BitmapRenderTarget::FillEllipse(
	CA_D2D1_ELLIPSE^ Param_Ellipse,
	ICarenD2D1Brush^ Param_Brush)
{
	//Variavel a ser retornada.
...
CarenResult CarenD2D1BitmapRenderTarget::FillGeometry(
	ICarenD2D1Geometry^ Param_Geometria,
	ICarenD2D1Brush^ Param_Brush,
...
CarenResult CarenD2D1BitmapRenderTarget::FillMesh(
...
CarenResult CarenD2D1BitmapRenderTarget::FillOpacityMask(
...
CarenResult CarenD2D1BitmapRenderTarget::FillRectangle(
	CA_D2D1_RECT_F^ Param_Rect,
	ICarenD2D1Brush^ Param_Brush)
{
	//Variavel a ser retornada.
...
CarenResult CarenD2D1BitmapRenderTarget::FillRoundedRectangle(
...
/// <param name="Param_Out_Tag1">Quando este método retorna, contém a tag para operações de desenho que causaram erros ou 0 se não houver erros.</param>
/// <param name="Param_Out_Tag2">Quando este método retorna, contém a tag para operações de desenho que causaram erros ou 0 se não houver erros.</param>
CarenResult CarenD2D1BitmapRenderTarget::Flush(
	[Out] UInt64% Param_Out_Tag1,
	[Out] UInt64% Param_Out_Tag2)
{
	//Variavel a ser retornada.
...
void CarenD2D1BitmapRenderTarget::GetAntialiasMode([Out] CA_D2D1_ANTIALIAS_MODE% Param_Out_AntialiasMode)
{
	//Variaveis a serem utilizadas.
...
void CarenD2D1BitmapRenderTarget::GetDpi(
...
void CarenD2D1BitmapRenderTarget::GetMaximumBitmapSize([Out] UInt32% Param_Out_MaximumSize)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1BitmapRenderTarget::GetPixelFormat([Out] CA_D2D1_PIXEL_FORMAT^% Param_Out_PixelFormat)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void CarenD2D1BitmapRenderTarget::GetPixelSize([Out] CA_D2D1_SIZE_U^% Param_Out_PixelSize)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void CarenD2D1BitmapRenderTarget::GetSize([Out] CA_D2D1_SIZE_F^% Param_Out_Size)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void CarenD2D1BitmapRenderTarget::GetTags(
	[Out] UInt64% Param_Out_Tag1,
	[Out] UInt64% Param_Out_Tag2)
{
	//Variaveis a serem utilizadas.
...
void CarenD2D1BitmapRenderTarget::GetTextAntialiasMode([Out] CA_D2D1_TEXT_ANTIALIAS_MODE% Param_Out_TextAntialiasMode)
{
	//Variaveis a serem utilizadas.
...
void CarenD2D1BitmapRenderTarget::GetTextRenderingParams(ICaren^ Param_Out_TextRenderingParams)
{
	//Variaveis a serem utilizadas.
...
void CarenD2D1BitmapRenderTarget::GetTransform([Out] CA_D2D1_MATRIX_3X2_F^% Param_Out_Transform)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void CarenD2D1BitmapRenderTarget::IsSupported(
...
/// ou ICarenD2D1RenderTarget::Flush.
/// </summary>
void CarenD2D1BitmapRenderTarget::PopAxisAlignedClip()
{
	//Chama o método para realizar a operação.
...
/// ou ICarenD2D1RenderTarget::Flush.
/// </summary>
void CarenD2D1BitmapRenderTarget::PopLayer()
{
	//Chama o método para realizar a operação.
...
void CarenD2D1BitmapRenderTarget::PushAxisAlignedClip(
...
void CarenD2D1BitmapRenderTarget::PushLayer(
...
CarenResult CarenD2D1BitmapRenderTarget::RestoreDrawingState(ICarenD2D1DrawingStateBlock^ Param_DrawingStateBlock)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1BitmapRenderTarget::SaveDrawingState(ICarenD2D1DrawingStateBlock^ Param_DrawingStateBlock)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
void CarenD2D1BitmapRenderTarget::SetAntialiasMode(CA_D2D1_ANTIALIAS_MODE Param_AntialiasMode)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1BitmapRenderTarget::SetDpi(
	float Param_DpiX,
	float Param_DpiY)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1BitmapRenderTarget::SetTags(
	UInt64 Param_Tag1,
	UInt64 Param_Tag2)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1BitmapRenderTarget::SetTextAntialiasMode(CA_D2D1_TEXT_ANTIALIAS_MODE Param_TextAntialiasMode)
{
	//Chama o método para realizar a operação.
...
CarenResult CarenD2D1BitmapRenderTarget::SetTextRenderingParams(ICaren^ Param_TextRenderingParams)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
void CarenD2D1BitmapRenderTarget::SetTransform(CA_D2D1_MATRIX_3X2_F^ Param_Transform)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void  CarenD2D1BitmapRenderTarget::GetFactory(ICaren^ Param_Out_Factory)
{
	//Variaveis a serem utilizadas.
