...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por iniciar o Media Skink da Digital Living Network Alliance (DLNA).
/// </summary>
public ref class CarenMFDLNASinkInit : public ICarenMFDLNASinkInit
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IMFDLNASinkInit).
	IMFDLNASinkInit* PonteiroTrabalho = NULL;
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFDLNASinkInit::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenMFDLNASinkInit)
public:
	/// <summary>
	...
	virtual CarenResult Initialize(ICarenMFByteStream^ Param_FluxoBytes, Boolean Param_SuportePALVideoFormat);
};