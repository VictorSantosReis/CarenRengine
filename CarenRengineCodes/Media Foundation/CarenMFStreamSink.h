...
public:
	...
	virtual CarenResult PlaceMarker(Enumeracoes::CA_MFSTREAMSINK_MARKER_TYPE Param_Marcador, CA_PROPVARIANT^ Param_ValorAdicional, CA_PROPVARIANT^ Param_DadosAnexoEvento);
