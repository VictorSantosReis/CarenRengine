...
/// </summary>
void CarenMFRateSupport::LimparDados()
{
...
CarenResult CarenMFRateSupport::ObterTaxaReproduçãoMaisRapida(Enumeracoes::CA_MFRATE_DIRECTION Param_Diracao, Boolean Param_Thin, [Out] float% Param_Out_TaxaReproducao)
{
...
CarenResult CarenMFRateSupport::ObterTaxaReproduçãoMaisLenta(Enumeracoes::CA_MFRATE_DIRECTION Param_Diracao, Boolean Param_Thin, [Out] float% Param_Out_TaxaReproducao)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenMFRateSupport::SuporteTaxaEspecifica(Boolean Param_Thin, float Param_Taxa, [Out] float% Param_Out_TaxaSuportada)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
