...
CarenResult CarenDXGIFactory5::GetParent(
...
CarenResult CarenDXGIFactory5::SetPrivateData(
...
CarenResult CarenDXGIFactory5::GetPrivateData(
	String^ Param_GuidIdentificao, 
...
CarenResult CarenDXGIFactory5::SetPrivateDataInterface(
