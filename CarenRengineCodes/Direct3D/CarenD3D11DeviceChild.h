...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por ser um dispositivo (Filho) para acessar dados utilizado por dispositivos.
/// </summary>
public ref class CarenD3D11DeviceChild : public ICarenD3D11DeviceChild
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID3D11DeviceChild).
	ID3D11DeviceChild* PonteiroTrabalho = NULL;
...
public:
	static operator CarenD3D11DeviceChild^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD3D11DeviceChild^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD3D11DeviceChild();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID3D11DeviceChild*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD3D11DeviceChild::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
