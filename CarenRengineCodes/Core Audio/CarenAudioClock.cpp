...
CarenResult CarenAudioClock::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IAudioClock*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenAudioClock::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IAudioClock*>(Param_PonteiroNativo);
...
/// </summary>
void CarenAudioClock::LimparDados()
{
