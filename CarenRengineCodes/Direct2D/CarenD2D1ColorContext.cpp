...
//Destruidor.
CarenD2D1ColorContext::~CarenD2D1ColorContext()
{
...
CarenResult CarenD2D1ColorContext::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD2D1ColorContext::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1ColorContext*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1ColorContext::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1ColorContext*>(Param_PonteiroNativo);
...
CarenResult CarenD2D1ColorContext::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD2D1ColorContext::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenD2D1ColorContext::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD2D1ColorContext::ObterCodigoErro()
{
...
/// </summary>
void CarenD2D1ColorContext::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD2D1ColorContext::LiberarReferencia()
{
...
/// </summary>
void CarenD2D1ColorContext::LimparDados()
{
...
/// </summary>
void CarenD2D1ColorContext::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenD2D1ColorContext();
}



// Métodos da interface proprietária(ICarenD2D1ColorContext)
...
CarenResult CarenD2D1ColorContext::GetProfile(
