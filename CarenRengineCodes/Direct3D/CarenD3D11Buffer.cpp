...
//Destruidor.
CarenD3D11Buffer::~CarenD3D11Buffer()
{
...
CarenResult CarenD3D11Buffer::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD3D11Buffer::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID3D11Buffer*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD3D11Buffer::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID3D11Buffer*>(Param_PonteiroNativo);
...
CarenResult CarenD3D11Buffer::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Buffer::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Buffer::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenD3D11Buffer::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD3D11Buffer::ObterCodigoErro()
{
...
/// </summary>
void CarenD3D11Buffer::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD3D11Buffer::LiberarReferencia()
{
...
/// </summary>
void CarenD3D11Buffer::LimparDados()
{
...
/// </summary>
void CarenD3D11Buffer::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
...
CarenResult CarenD3D11Buffer::ObterPropriedadesRecurso([Out] Estruturas::CA_D3D11_BUFFER_DESC^% Param_Out_DescBuffer)
{
	...
	PonteiroTrabalho->GetDesc(&pBufferDesc);

	//Converte a estrutura nativa para uma gerenciada.
	Param_Out_DescBuffer = Util.ConverterD3D11_BUFFER_DESCUnamaged_ToManaged(&pBufferDesc);
...
CarenResult CarenD3D11Buffer::ObterPrioridadeDespejo([Out] Enumeracoes::CA_DXGI_PRIORIDADE_RECURSO% Param_Out_Prioridade)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Buffer::ObterTipo([Out] Enumeracoes::CA_D3D11_TIPO_RECURSO% Param_Out_TipoRecurso)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Buffer::DefinirPrioridadeDespejo(Enumeracoes::CA_DXGI_PRIORIDADE_RECURSO Param_PrioridadeRecurso)
{
...
CarenResult CarenD3D11Buffer::ObterDispositivo(ICaren^ Param_Out_DispositivoD3D11)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Buffer::ObterDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11Buffer::DefinirDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11Buffer::DefinirInterfaceDadosPrivados(
