...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por representar um fluxo WIC para referenciar conteúdo de imagem e metadados.
/// </summary>
public ref class CarenWICStream : public ICarenWICStream
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IWICStream).
	IWICStream* PonteiroTrabalho = NULL;
...
public:
	static operator CarenWICStream^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenWICStream^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenWICStream();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IWICStream*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenWICStream::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenWICStream)
public:
	/// <summary>
	...
	virtual CarenResult InitializeFromFilename(
	...
	virtual CarenResult InitializeFromIStream(ICarenStream^ Param_Fluxo);
	...
	virtual CarenResult InitializeFromIStreamRegion(
