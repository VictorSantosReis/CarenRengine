...
CarenResult CarenD2D1GradientStopCollection1::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1GradientStopCollection1*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1GradientStopCollection1::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1GradientStopCollection1*>(Param_PonteiroNativo);
...
/// </summary>
Int32 CarenD2D1GradientStopCollection1::ObterCodigoErro()
{
...
/// </summary>
void CarenD2D1GradientStopCollection1::LimparDados()
{
