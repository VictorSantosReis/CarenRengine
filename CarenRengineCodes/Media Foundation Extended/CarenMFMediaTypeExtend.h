...
public ref class CarenMFMediaTypeExtend : public ICarenMFMediaTypeExtend
{
	...
	//Ponteiro para a interface (IMFMediaType).
...
public:
	static operator CarenMFMediaTypeExtend^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFMediaTypeExtend^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFMediaTypeExtend();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFMediaType*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFMediaTypeExtend::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
