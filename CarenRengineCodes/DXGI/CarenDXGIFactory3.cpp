...
CarenResult CarenDXGIFactory3::GetCreationFlags(
...
/// reiniciado.</param>
CarenResult CarenDXGIFactory3::GetSharedResourceAdapterLuid(
...
CarenResult CarenDXGIFactory3::IsWindowedStereoEnabled(
...
CarenResult CarenDXGIFactory3::RegisterOcclusionStatusEvent(
...
CarenResult CarenDXGIFactory3::RegisterOcclusionStatusWindow(
...
/// registro do evento de notificação que (Param_Evento) especifica.</param>
CarenResult CarenDXGIFactory3::RegisterStereoStatusEvent(
	ICarenEvent^ Param_Evento, 
	[Out] UInt32% Param_Out_Cookie)
{
	//Chama o método na classe de funções compartilhadas do DXGI.
...
/// de notificação que (Param_WinMensagemCode) especifica.</param>
CarenResult CarenDXGIFactory3::RegisterStereoStatusWindow(
	IntPtr Param_HandleJanela, 
	UInt32 Param_WinMensagemCode, 
	[Out] UInt32% Param_Out_Cookie)
{
...
CarenResult CarenDXGIFactory3::UnregisterOcclusionStatus(
	UInt32 Param_Cookie)
{
	//Chama o método na classe de funções compartilhadas do DXGI.
...
/// </summary>
/// <param name="Param_Cookie">Um valor-chave para a janela ou evento para cancelar o registro. Esse valor é retornado nos métodos de registro de evento e janela desta interface.</param>
CarenResult CarenDXGIFactory3::UnregisterStereoStatus(
	UInt32 Param_Cookie)
{
	//Chama o método na classe de funções compartilhadas do DXGI.
...
CarenResult CarenDXGIFactory3::EnumAdapters1(
...
CarenResult CarenDXGIFactory3::IsCurrent(
...
CarenResult CarenDXGIFactory3::CreateSoftwareAdapter(
...
CarenResult CarenDXGIFactory3::CreateSwapChain(
...
/// <param name="Param_IdAdaptador">O Indice para o adaptador a ser enumerado.</param>
/// <param name="Param_Out_Adaptador">Recebe um ponteiro para a interface do adaptador no indice especificado. O chamador é responsável por liberar a interface.</param>
CarenResult CarenDXGIFactory3::EnumAdapters(
	UInt32 Param_IdAdaptador, 
	[Out] ICarenDXGIAdapter^% Param_Out_Adaptador)
{
	//Chama o método na classe de funções compartilhadas do DXGI.
...
CarenResult CarenDXGIFactory3::GetWindowAssociation(
...
CarenResult CarenDXGIFactory3::MakeWindowAssociation(
	IntPtr Param_HandleJanela, 
