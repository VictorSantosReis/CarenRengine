...
//Destruidor.
CarenD3D11Predicate::~CarenD3D11Predicate()
{
...
CarenResult CarenD3D11Predicate::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD3D11Predicate::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID3D11Predicate*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD3D11Predicate::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID3D11Predicate*>(Param_PonteiroNativo);
...
CarenResult CarenD3D11Predicate::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Predicate::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Predicate::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenD3D11Predicate::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD3D11Predicate::ObterCodigoErro()
{
...
/// </summary>
void CarenD3D11Predicate::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD3D11Predicate::LiberarReferencia()
{
...
/// </summary>
void CarenD3D11Predicate::LimparDados()
{
...
/// </summary>
void CarenD3D11Predicate::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
...
CarenResult CarenD3D11Predicate::GetDesc([Out] Estruturas::CA_D3D11_QUERY_DESC^% Param_Out_DescConsulta)
{
