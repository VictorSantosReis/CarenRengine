...
CarenResult CarenMFMediaEngineNeedKeyNotify::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IMFMediaEngineNeedKeyNotify*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenMFMediaEngineNeedKeyNotify::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IMFMediaEngineNeedKeyNotify*>(Param_PonteiroNativo);
...
/// </summary>
void CarenMFMediaEngineNeedKeyNotify::LimparDados()
{
