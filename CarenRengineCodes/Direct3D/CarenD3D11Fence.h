...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD3D11Fence">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD3D11Fence^% Param_Out_CarenD3D11Fence)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenD3D11Fence = gcnew CarenD3D11Fence();
