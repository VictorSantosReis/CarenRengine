...
CarenResult CarenD3D11PixelShader::GetDevice(ICaren^ Param_Out_DispositivoD3D11)
{
...
CarenResult CarenD3D11PixelShader::GetPrivateData(
	String^ Param_Guid,
...
CarenResult CarenD3D11PixelShader::SetPrivateData(
	String^ Param_Guid,
...
CarenResult CarenD3D11PixelShader::SetPrivateDataInterface(
