...
CarenResult CarenD2D1Factory6::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD2D1Factory6::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1Factory6*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1Factory6::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1Factory6*>(Param_PonteiroNativo);
...
CarenResult CarenD2D1Factory6::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1Factory6::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1Factory6::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenD2D1Factory6::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD2D1Factory6::ObterCodigoErro()
{
...
/// </summary>
void CarenD2D1Factory6::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD2D1Factory6::LiberarReferencia()
{
...
/// </summary>
void CarenD2D1Factory6::LimparDados()
{
...
/// </summary>
void CarenD2D1Factory6::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenD2D1Factory6();
}



// Métodos da interface proprietária(ICarenD2D1Factory6)
...
CarenResult CarenD2D1Factory6::CreateDevice(
...
CarenResult CarenD2D1Factory6::CreateDrawingStateBlock(
...
CarenResult CarenD2D1Factory6::CreateGdiMetafile(
...
CarenResult CarenD2D1Factory6::CreatePathGeometry(
...
CarenResult CarenD2D1Factory6::CreateStrokeStyle(
...
CarenResult CarenD2D1Factory6::GetEffectProperties(
...
CarenResult CarenD2D1Factory6::GetRegisteredEffects(
...
CarenResult CarenD2D1Factory6::RegisterEffectFromStream(
...
/// <param name="Param_QuantidadeBindings">O número de Bindings na matriz(Param_Bindings).</param>
/// <param name="Param_CallbackEffectFactory">Um ponteiro para um Factory estatico para criar oefeito correspondente.</param>
CarenResult CarenD2D1Factory6::RegisterEffectFromString(
	String^ Param_ClassId,
...
CarenResult CarenD2D1Factory6::UnregisterEffect(
	String^ Param_ClassId
)
{
	//Variavel a ser retornada.
...
CarenResult CarenD2D1Factory6::CreateDCRenderTarget(
...
/// </summary>
/// <param name="Param_Out_StateBlock">Retorna uma interface(ICarenD2D1DrawingStateBlock) que contém um ponteiro para o novo bloco de estado de desenhado criado.</param>
CarenResult CarenD2D1Factory6::CreateDrawingStateBlock([Out] ICarenD2D1DrawingStateBlock^% Param_Out_StateBlock)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1Factory6::CreateDxgiSurfaceRenderTarget(
...
CarenResult CarenD2D1Factory6::CreateEllipseGeometry(
...
CarenResult CarenD2D1Factory6::CreateGeometryGroup(
...
CarenResult CarenD2D1Factory6::CreateHwndRenderTarget(
	CA_D2D1_RENDER_TARGET_PROPERTIES^ Param_PropsRenderTarget,
...
CarenResult CarenD2D1Factory6::CreateRectangleGeometry(
...
CarenResult CarenD2D1Factory6::CreateRoundedRectangleGeometry(
...
CarenResult CarenD2D1Factory6::CreateTransformedGeometry(
...
/// <param name="Param_PropsRenderTarget">O modo de renderização, o formato de pixel, as opções de remoção, as informações de DPI e o suporte mínimo directx necessário para renderização de hardware.</param>
/// <param name="Param_Out_RenderTarget">Retorna uma interface(ICarenD2D1RenderTarget) que contém um ponteiro para o objeto criado.</param>
CarenResult CarenD2D1Factory6::CreateWicBitmapRenderTarget(
...
void CarenD2D1Factory6::GetDesktopDpi(
...
/// </summary>
CarenResult CarenD2D1Factory6::ReloadSystemMetrics()
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
