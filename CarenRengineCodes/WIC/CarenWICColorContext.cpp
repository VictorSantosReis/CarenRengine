...
CarenResult CarenWICColorContext::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IWICColorContext*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenWICColorContext::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IWICColorContext*>(Param_PonteiroNativo);
...
/// </summary>
void CarenWICColorContext::LimparDados()
{
