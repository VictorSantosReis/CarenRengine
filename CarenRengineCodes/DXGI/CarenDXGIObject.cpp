...
CarenResult CarenDXGIObject::GetParent(
...
CarenResult CarenDXGIObject::SetPrivateData(
...
CarenResult CarenDXGIObject::GetPrivateData(
	String^ Param_GuidIdentificao, 
...
CarenResult CarenDXGIObject::SetPrivateDataInterface(
