...
public:
	static operator CarenDXGIFactory2^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenDXGIFactory2^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenDXGIFactory2();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IDXGIFactory2*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenDXGIFactory2::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
