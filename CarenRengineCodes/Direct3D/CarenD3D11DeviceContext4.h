...
public:
	static operator CarenD3D11DeviceContext4^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD3D11DeviceContext4^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD3D11DeviceContext4();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID3D11DeviceContext4*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD3D11DeviceContext4::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
...
public:
	...
	virtual CarenResult Signal(ICarenD3D11Fence^ Param_Fence, UInt64 Param_Valor);
	...
	virtual CarenResult Wait(ICarenD3D11Fence^ Param_Fence, UInt64 Param_Valor);
...
public:
	...
	virtual CarenResult GetHardwareProtectionState([Out] bool% Param_Out_ProtecaoHardwareHabilitada);
	...
	virtual CarenResult SetHardwareProtectionState(bool Param_EstadoProtecao);
