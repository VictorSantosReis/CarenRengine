...
CarenResult CarenD2D1DeviceContext5::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1DeviceContext5*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1DeviceContext5::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1DeviceContext5*>(Param_PonteiroNativo);
...
/// </summary>
Int32 CarenD2D1DeviceContext5::ObterCodigoErro()
{
...
/// </summary>
void CarenD2D1DeviceContext5::LimparDados()
{
