...
public:
	static operator CarenMFPresentationTimeSource^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFPresentationTimeSource^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFPresentationTimeSource(false);

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFPresentationTimeSource*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFPresentationTimeSource::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
