...
public:
	static operator CarenDXGIDevice2^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenDXGIDevice2^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenDXGIDevice2();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IDXGIDevice2*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenDXGIDevice2::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
