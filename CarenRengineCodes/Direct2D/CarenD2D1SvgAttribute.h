...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por descrever um atributo SVG.
/// </summary>
public ref class CarenD2D1SvgAttribute : public ICarenD2D1SvgAttribute
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID2D1SvgAttribute).
...
public:
	static operator CarenD2D1SvgAttribute^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1SvgAttribute^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1SvgAttribute();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1SvgAttribute*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD2D1SvgAttribute::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
