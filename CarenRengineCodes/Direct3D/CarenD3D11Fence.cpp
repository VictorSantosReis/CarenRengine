...
CarenResult CarenD3D11Fence::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
	...
	Hr = (reinterpret_cast<ID3D11Fence*>(PonteiroTrabalho))->QueryInterface(GuidInterface, (LPVOID*)&pInterfaceSolcitada);
...
CarenResult CarenD3D11Fence::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<ID3D11Fence*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD3D11Fence::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID3D11Fence*>(Param_PonteiroNativo);
...
{
	//Adiciona uma referência ao ponteiro
	(reinterpret_cast<ID3D11Fence*>(PonteiroTrabalho))->AddRef();
}
...
void CarenD3D11Fence::LiberarReferencia()
{
	...
	ULONG RefCount = (reinterpret_cast<ID3D11Fence*>(PonteiroTrabalho))->Release();
...
/// </summary>
void CarenD3D11Fence::LimparDados()
{
