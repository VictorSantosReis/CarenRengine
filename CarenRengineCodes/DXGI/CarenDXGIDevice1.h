...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenDXGIDevice1">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenDXGIDevice1^% Param_Out_CarenDXGIDevice1)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenDXGIDevice1 = gcnew CarenDXGIDevice1();
