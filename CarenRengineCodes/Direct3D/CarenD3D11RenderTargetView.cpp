...
//Destruidor.
CarenD3D11RenderTargetView::~CarenD3D11RenderTargetView()
{
...
CarenResult CarenD3D11RenderTargetView::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD3D11RenderTargetView::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID3D11RenderTargetView*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD3D11RenderTargetView::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID3D11RenderTargetView*>(Param_PonteiroNativo);
...
CarenResult CarenD3D11RenderTargetView::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11RenderTargetView::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11RenderTargetView::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenD3D11RenderTargetView::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD3D11RenderTargetView::ObterCodigoErro()
{
...
/// </summary>
void CarenD3D11RenderTargetView::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD3D11RenderTargetView::LiberarReferencia()
{
...
/// </summary>
void CarenD3D11RenderTargetView::LimparDados()
{
...
/// </summary>
void CarenD3D11RenderTargetView::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenD3D11RenderTargetView();
}


//Métodos da interface proprietaria.

CarenResult CarenD3D11RenderTargetView::GetDesc(Estruturas::CA_D3D11_RENDER_TARGET_VIEW_DESC^% Param_Out_DescRenderDestino)
{
...
CarenResult CarenD3D11RenderTargetView::ObterRecurso([Out] ICarenD3D11Resource^% Param_Out_Recurso)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11RenderTargetView::ObterDispositivo(ICaren^ Param_Out_DispositivoD3D11)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11RenderTargetView::ObterDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11RenderTargetView::DefinirDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11RenderTargetView::DefinirInterfaceDadosPrivados(
