...
#include "../pch.h"
#include "CarenD2D1EffectContext.h"
...
CarenResult CarenD2D1EffectContext::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD2D1EffectContext::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1EffectContext*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1EffectContext::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1EffectContext*>(Param_PonteiroNativo);
...
CarenResult CarenD2D1EffectContext::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1EffectContext::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1EffectContext::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenD2D1EffectContext::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD2D1EffectContext::ObterCodigoErro()
{
...
/// </summary>
void CarenD2D1EffectContext::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD2D1EffectContext::LiberarReferencia()
{
...
/// </summary>
void CarenD2D1EffectContext::LimparDados()
{
...
/// </summary>
void CarenD2D1EffectContext::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
...
CarenResult CarenD2D1EffectContext::CheckFeatureSupport(
...
CarenResult CarenD2D1EffectContext::CreateBlendTransform(
...
CarenResult CarenD2D1EffectContext::CreateBorderTransform(
...
CarenResult CarenD2D1EffectContext::CreateBoundsAdjustmentTransform(
...
CarenResult CarenD2D1EffectContext::CreateColorContext(
...
/// <param name="Param_Out_ColorContext">Retorna um ponteiro para a interface(ICarenD2D1ColorContext) como novo objeto de conexto de cor.</param>
CarenResult CarenD2D1EffectContext::CreateColorContextFromFilename(
...
/// <param name="Param_Out_ColorContext">Retorna um ponteiro para a interface(ICarenD2D1ColorContext) como novo objeto de conexto de cor.</param>
CarenResult CarenD2D1EffectContext::CreateColorContextFromWicColorContext(
...
CarenResult CarenD2D1EffectContext::CreateEffect(
...
CarenResult CarenD2D1EffectContext::CreateOffsetTransform(
...
CarenResult CarenD2D1EffectContext::CreateResourceTexture(
...
CarenResult CarenD2D1EffectContext::CreateTransformNodeFromEffect(
...
CarenResult CarenD2D1EffectContext::CreateVertexBuffer(
...
CarenResult CarenD2D1EffectContext::FindResourceTexture(
String^ Param_IdRecurso,
[Out] ICarenD2D1ResourceTexture^% Param_Out_RecursoTextura)
{
	//Variavel a ser retornada.
...
CarenResult CarenD2D1EffectContext::FindVertexBuffer(
String^ Param_IdRecurso,
[Out] ICarenD2D1VertexBuffer^% Param_Out_VertexBuffer)
{
	//Variavel a ser retornada.
...
void CarenD2D1EffectContext::GetDpi(
...
CarenResult CarenD2D1EffectContext::GetMaximumSupportedFeatureLevel(
...
void CarenD2D1EffectContext::IsBufferPrecisionSupported(
...
void CarenD2D1EffectContext::IsShaderLoaded(
...
CarenResult CarenD2D1EffectContext::LoadComputeShader(
String^ Param_IdRecurso,
...
/// <param name="Param_ShaderBuffer">O buffer que contém o sombreador para registrar.</param>
/// <param name="Param_ShaderBufferSize">O tamanho do Buffer em bytes.</param>
CarenResult CarenD2D1EffectContext::LoadPixelShader(
String^ Param_IdRecurso,
ICarenBuffer^ Param_ShaderBuffer,
UInt32 Param_ShaderBufferSize)
{
...
/// <param name="Param_ShaderBuffer">O buffer que contém o sombreador para registrar.</param>
/// <param name="Param_ShaderBufferSize">O tamanho do Buffer em bytes.</param>
CarenResult CarenD2D1EffectContext::LoadVertexShader(
String^ Param_IdRecurso,
ICarenBuffer^ Param_ShaderBuffer,
UInt32 Param_ShaderBufferSize)
{
