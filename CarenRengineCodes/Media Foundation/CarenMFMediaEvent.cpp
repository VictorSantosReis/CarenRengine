...
{
	//Fixa o ponteiro.
	cli::pin_ptr<IMFMediaEvent*> p = &PonteiroTrabalho;
...
CarenResult CarenMFMediaEvent::GetValue([Out] CA_PROPVARIANT^% Param_Out_ValorEvento)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenMFMediaEvent::Compare(
...
CarenResult CarenMFMediaEvent::CompareItem(
...
CarenResult CarenMFMediaEvent::GetAllocatedBlob(
		String^ Param_GuidChave, 
...
CarenResult CarenMFMediaEvent::GetAllocatedString(
		String^ Param_GuidChave, 
...
CarenResult CarenMFMediaEvent::GetBlob(
		String^ Param_GuidChave, 
...
CarenResult CarenMFMediaEvent::GetBlobSize(
	String^ Param_GuidChave, 
...
CarenResult CarenMFMediaEvent::GetDouble(
		String^ Param_GuidChave, 
...
/// <param name="Param_Out_Valor">Recebe o valor referente ao valor da chave solicitada</param>
CarenResult CarenMFMediaEvent::GetGUID(
		String^ Param_GuidChave, 
...
/// <param name="Param_Out_Valor">Recebe o valor referente ao valor da chave solicitada</param>
CarenResult CarenMFMediaEvent::GetItem(
		String^ Param_GuidChave, 
...
/// <param name="Param_Out_Valor">Recebe o valor referente ao valor da chave solicitada</param>
CarenResult CarenMFMediaEvent::GetItemByIndex(
		UInt32 Param_IdItem, 
...
CarenResult CarenMFMediaEvent::GetItemType(
		String^ Param_GuidChave, 
...
/// <param name="Param_Out_Valor">Recebe o valor referente ao valor da chave solicitada.</param>
CarenResult CarenMFMediaEvent::GetString(
		String^ Param_GuidChave, 
...
CarenResult CarenMFMediaEvent::GetStringLength(
		String^ Param_GuidChave, 
...
/// <param name="Param_Out_Valor">Recebe o valor referente ao valor da chave solicitada</param>
CarenResult CarenMFMediaEvent::GetUINT32(
		String^ Param_GuidChave, 
...
/// <param name="Param_Out_Valor">Recebe o valor referente ao valor da chave solicitada</param>
CarenResult CarenMFMediaEvent::GetUINT64(
		String^ Param_GuidChave, 
...
CarenResult CarenMFMediaEvent::_MFGetAttributeRatio(
		String^ Param_GuidChave, 
...
CarenResult CarenMFMediaEvent::_MFGetAttributeSize(
		String^ Param_GuidChave, 
		[Out] UInt32% Param_Out_Largura, 
...
CarenResult CarenMFMediaEvent::GetUnknown(
		String^ Param_GuidChave, 
...
CarenResult CarenMFMediaEvent::SetBlob(
		String^ Param_GuidChave, 
...
CarenResult CarenMFMediaEvent::SetDouble(
		String^ Param_GuidChave, 
		Double Param_Valor)
{
	//Chama o método na classe de funções compartilhadas da Media Foundation.
...
/// <param name="Param_GuidChave">O GUID para a chave que vai receber o valor.</param>
/// <param name="Param_Valor">O valor a ser definido na chave especificada.</param>
CarenResult CarenMFMediaEvent::SetGUID(
		String^ Param_GuidChave, 
		String^ Param_Valor)
{
	//Chama o método na classe de funções compartilhadas da Media Foundation.
...
CarenResult CarenMFMediaEvent::SetItem(
		String^ Param_GuidChave, 
...
/// <param name="Param_GuidChave">O GUID para a chave que vai receber o valor.</param>
/// <param name="Param_Valor">O valor a ser definido na chave especificada.</param>
CarenResult CarenMFMediaEvent::SetString(
		String^ Param_GuidChave, 
		String^ Param_Valor)
{
	//Chama o método na classe de funções compartilhadas da Media Foundation.
...
/// <param name="Param_GuidChave">O GUID para a chave que vai receber o valor.</param>
/// <param name="Param_Valor">O valor a ser definido na chave especificada.</param>
CarenResult CarenMFMediaEvent::SetUINT32(
		String^ Param_GuidChave, 
		UInt32 Param_Valor)
{
	//Chama o método na classe de funções compartilhadas da Media Foundation.
...
/// <param name="Param_GuidChave">O GUID para a chave que vai receber o valor.</param>
/// <param name="Param_Valor">O valor a ser definido na chave especificada.</param>
CarenResult CarenMFMediaEvent::SetUINT64(
		String^ Param_GuidChave, 
		UInt64 Param_Valor)
{
	//Chama o método na classe de funções compartilhadas da Media Foundation.
...
CarenResult CarenMFMediaEvent::_MFSetAttributeRatio(
		String^ Param_GuidChave, 
...
CarenResult CarenMFMediaEvent::_MFSetAttributeSize(
		String^ Param_GuidChave, 
...
CarenResult CarenMFMediaEvent::SetUnknown(
		String^ Param_GuidChave, 
