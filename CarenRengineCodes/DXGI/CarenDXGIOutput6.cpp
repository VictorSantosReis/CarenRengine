...
{
	//Fixa o ponteiro.
	cli::pin_ptr<IDXGIOutput6*> p = &PonteiroTrabalho;

	//Chama o método de ADICIONAR PONTEIRO na classe base(Caren).
	return Caren::Shared_AdicionarPonteiro(Param_PonteiroNativo, reinterpret_cast<IUnknown**>(static_cast<IDXGIOutput6**>(p)));
}
...
CarenResult CarenDXGIOutput6::GetParent(
...
CarenResult CarenDXGIOutput6::SetPrivateData(
...
CarenResult CarenDXGIOutput6::GetPrivateData(
	String^ Param_GuidIdentificao, 
...
CarenResult CarenDXGIOutput6::SetPrivateDataInterface(
