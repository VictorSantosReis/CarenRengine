...
CarenResult CarenD3D11Device1::CriarBlendState1([Out] CA_D3D11_BLEND_DESC1^% Param_Out_DescBlend, [Out] ICarenD3D11BlendState1^% Param_Out_BlendState)
{
...
CarenResult CarenD3D11Device1::CriarContextoDiferido1(UInt32 Param_ContextFlags, [Out] ICarenD3D11DeviceContext1^% Param_Out_ContextoDiferido)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Device1::CriarDispositivoEstadoContexto(
...
CarenResult CarenD3D11Device1::CriarEstadoRasterizador1(
...
CarenResult CarenD3D11Device1::ObterContextoImediato1([Out] ICarenD3D11DeviceContext1^% Param_Out_ContextoImediato)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Device1::AbrirRecursoCompartilhado1(
...
/// <param name="Param_Ref_InterfaceRecurso">Retorna um ponteiro para a interface de recurso requisitada no (Param_RIIDInterface). Este parametro 
/// não pode ser NULO.</param>
CarenResult CarenD3D11Device1::AbrirRecursoCompartilhadoPorNome(
				String^ Param_Nome, 
...
CarenResult CarenD3D11Device1::VerificarContador(
...
CarenResult CarenD3D11Device1::VerificarInformacoesContador([Out] Estruturas::CA_D3D11_INFO_CONTADOR^% Param_Out_InfoContador)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Device1::VerificarRecursosSuportados(
...
CarenResult CarenD3D11Device1::CriarBlendState(
...
CarenResult CarenD3D11Device1::CriarBuffer(
...
CarenResult CarenD3D11Device1::CriarClassLinkage([Out] ICarenD3D11ClassLinkage^% Param_Out_ClassLinkage)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Device1::CriarShaderCompute(
...
CarenResult CarenD3D11Device1::CriarContador(
	Estruturas::CA_D3D11_DESC_CONTADOR^% Param_DescContador,
...
CarenResult CarenD3D11Device1::CriarContextoDiferido(
...
CarenResult CarenD3D11Device1::CriarDepthStencilState(
...
CarenResult CarenD3D11Device1::CriarDepthStencilView(
...
CarenResult CarenD3D11Device1::CriarShaderDomain(
...
CarenResult CarenD3D11Device1::CriarShaderGeometry(
	ICaren^ Param_ShaderByteCode,
	UInt64 Param_TamanhoByteCode,
	ICarenD3D11ClassLinkage^ Param_Linkage,
	Boolean Param_ValidarParametros,
...
/// <param name="Param_ValidarParametros">Defina True para validar os outros parmetros. Param_Out_GeometryShader retorna NULL se esse paramêtro for verdadeiro.</param>
/// <param name="Param_Out_GeometryShader">Recebe a interface do Geometry Shader.</param>
CarenResult CarenD3D11Device1::CriarShaderGeometryComSaidaFluxo
(
	ICaren^ Param_ShaderByteCode,
	UInt64 Param_TamanhoByteCode,
...
CarenResult CarenD3D11Device1::CriarHullShader(
	ICaren^ Param_ShaderByteCode,
	UInt64 Param_TamanhoByteCode,
	ICarenD3D11ClassLinkage^ Param_Linkage,
...
CarenResult CarenD3D11Device1::CriarObjetoEntradaLayout(
...
CarenResult CarenD3D11Device1::CriarPixelShader(
	ICaren^ Param_ShaderByteCode,
	UInt64 Param_TamanhoByteCode,
	ICarenD3D11ClassLinkage^ Param_Linkage,
	Boolean Param_ValidarParametros,
...
CarenResult CarenD3D11Device1::CriarQuery(
...
CarenResult CarenD3D11Device1::CriarEstadoRasterizador(
...
CarenResult CarenD3D11Device1::CriarVisualizadorRenderizacaoDestino(
	ICarenD3D11Resource^ Param_Resource,
...
CarenResult CarenD3D11Device1::CriarSamplerState(
...
CarenResult CarenD3D11Device1::CriarVisualizadoRescursoShader(
...
CarenResult CarenD3D11Device1::CriarTextura1D(
...
CarenResult CarenD3D11Device1::CriarTextura2D(
...
CarenResult CarenD3D11Device1::CriarTextura3D(
...
CarenResult CarenD3D11Device1::CriarVisãoRecursoAcessoNaoOrdenado(
	ICarenD3D11Resource^ Param_Recurso,
...
CarenResult CarenD3D11Device1::CriarShaderVertice(
	ICaren^ Param_ShaderByteCode,
	UInt64 Param_TamanhoByteCode,
	ICarenD3D11ClassLinkage^ Param_Linkage,
	Boolean Param_ValidarParametros,
...
CarenResult CarenD3D11Device1::ObterFlagsCriaçãoDevice([Out] Enumeracoes::CA_D3D11_CRIACAO_DISPOSITIVO_FLAGS% Param_Out_Flags)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenD3D11Device1::ObterRazãoDispositivoRemovido()
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Device1::ObterSinalizadoresModoExceção([Out] Enumeracoes::CA_D3D11_RAISE_FLAG% Param_Out_Except)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Device1::ObterNivelRecurso([Out] Enumeracoes::CA_D3D_NIVEL_RECURSO% Param_Out_NivelRecurso)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Device1::ObterContextoImediato([Out] ICarenD3D11DeviceContext^% Param_Out_ImediateContextInterface)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Device1::ObterDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11Device1::AbrirRecursoCompartilhado(
	IntPtr Param_Handle,
...
CarenResult CarenD3D11Device1::DefinirSinalizadoresModoExceção(UInt32 Param_RaiseFlags)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Device1::DefinirDadosPrivados(
	String^ Param_Guid,
	UInt32 Param_TamanhoBuffer,
...
CarenResult CarenD3D11Device1::DefinirPrivateDataInterface(
	String^ Param_Guid,
