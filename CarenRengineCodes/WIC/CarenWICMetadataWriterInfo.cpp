...
CarenResult CarenWICMetadataWriterInfo::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IWICMetadataWriterInfo*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenWICMetadataWriterInfo::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IWICMetadataWriterInfo*>(Param_PonteiroNativo);
...
/// </summary>
Int32 CarenWICMetadataWriterInfo::ObterCodigoErro()
{
...
/// </summary>
void CarenWICMetadataWriterInfo::LimparDados()
{
