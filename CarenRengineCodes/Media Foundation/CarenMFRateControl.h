...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por obter ou definir a taxa de reprodução.
/// </summary>
public ref class CarenMFRateControl :public ICarenMFRateControl
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IMFRateControl).
	IMFRateControl* PonteiroTrabalho = NULL;
...
public:
	static operator CarenMFRateControl^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFRateControl^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFRateControl();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFRateControl*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFRateControl::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
