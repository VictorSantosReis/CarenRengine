...
#include "../NativeClassForEvents/CLN_IMFNetResourceFilter.h"
...
public:
	static operator CarenMFNetResourceFilter^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFNetResourceFilter^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFNetResourceFilter();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFNetResourceFilter*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFNetResourceFilter::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
