...
/// <summary>
/// [CLASSE COM PROBLEMA] Classe responsável por expor métodos que fornecem informações básicas sobre o leitor de metadados registrado.
/// </summary>
public ref class CarenWICMetadataReaderInfo : public ICarenWICMetadataReaderInfo
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IWICMetadataReaderInfo).
	IWICMetadataReaderInfo* PonteiroTrabalho = NULL;
...
public:
	static operator CarenWICMetadataReaderInfo^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenWICMetadataReaderInfo^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenWICMetadataReaderInfo();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IWICMetadataReaderInfo*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenWICMetadataReaderInfo::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenWICMetadataReaderInfo)
public:
	/// <summary>
	...
	virtual CarenResult CreateInstance([Out] ICarenWICMetadataReader^% Param_Out_MetadataReader);
	...
	virtual CarenResult GetPatterns(
	...
	virtual CarenResult MatchesPattern(
	String^ Param_GuidContainerFormat,
