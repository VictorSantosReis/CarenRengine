...
CarenResult CarenD2D1Factory::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1Factory*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1Factory::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1Factory*>(Param_PonteiroNativo);
...
/// </summary>
Int32 CarenD2D1Factory::ObterCodigoErro()
{
...
/// </summary>
void CarenD2D1Factory::LimparDados()
{
