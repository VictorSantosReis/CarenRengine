...
CarenResult CarenDXGIFactory3::GetParent(
...
CarenResult CarenDXGIFactory3::SetPrivateData(
...
CarenResult CarenDXGIFactory3::GetPrivateData(
	String^ Param_GuidIdentificao, 
...
CarenResult CarenDXGIFactory3::SetPrivateDataInterface(
