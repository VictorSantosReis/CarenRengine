...
public:
	static operator CarenDXGISwapChain1^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenDXGISwapChain1^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenDXGISwapChain1();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IDXGISwapChain1*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenDXGISwapChain1::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
