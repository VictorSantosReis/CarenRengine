...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD2D1RoundedRectangleGeometry">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD2D1RoundedRectangleGeometry^% Param_Out_CarenD2D1RoundedRectangleGeometry)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);

		//Cria a interface
		Param_Out_CarenD2D1RoundedRectangleGeometry = gcnew CarenD2D1RoundedRectangleGeometry();
