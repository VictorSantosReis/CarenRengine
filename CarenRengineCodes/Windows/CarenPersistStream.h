...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável permitir a economia e o carregamento de objetos que usam um fluxo serial simples para suas necessidades de armazenamento.
/// </summary>
public ref class CarenPersistStream : public ICarenPersistStream
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IPersistStream).
	IPersistStream* PonteiroTrabalho = NULL;
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenPersistStream::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
