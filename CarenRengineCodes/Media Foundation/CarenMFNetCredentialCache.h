...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por obter credenciais do cache de credenciais.
/// </summary>
public ref class CarenMFNetCredentialCache : public ICarenMFNetCredentialCache
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IMFNetCredentialCache).
	IMFNetCredentialCache* PonteiroTrabalho = NULL;
...
public:
	static operator CarenMFNetCredentialCache^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFNetCredentialCache^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFNetCredentialCache(false);

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFNetCredentialCache*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFNetCredentialCache::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenMFNetCredentialCache)
public:
	/// <summary>
	...
	virtual CarenResult GetCredential(
	String^ Param_Url, 
	String^ Param_Realm, 
	...
	virtual CarenResult SetUserOptions(
	ICarenMFNetCredential^ Param_Credencial, 
