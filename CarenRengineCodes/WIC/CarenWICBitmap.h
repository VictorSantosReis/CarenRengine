...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por definir métodos que adicionam o conceito de gravabilidade e representações estáticas na memória de bitmaps ao ICarenWICBitmapSource.
/// </summary>
public ref class CarenWICBitmap : public ICarenWICBitmap
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IWICBitmap).
	IWICBitmap* PonteiroTrabalho = NULL;
...
public:
	static operator CarenWICBitmap^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenWICBitmap^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenWICBitmap();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IWICBitmap*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenWICBitmap::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenWICBitmap)
public:
	/// <summary>
