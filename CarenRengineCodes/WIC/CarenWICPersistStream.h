...
public:
	static operator CarenWICPersistStream^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenWICPersistStream^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenWICPersistStream();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IWICPersistStream*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenWICPersistStream::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
