...
CarenResult CarenDXGISwapChain1::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IDXGISwapChain1*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenDXGISwapChain1::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IDXGISwapChain1*>(Param_PonteiroNativo);
...
/// </summary>
void CarenDXGISwapChain1::LimparDados()
{
...
CarenResult CarenDXGISwapChain1::AlterarTamanhoBuffers(UInt32 Param_NumeroBuffers, UInt32 Param_Largura, UInt32 Param_Altura, Enumeracoes::CA_DXGI_FORMATO Param_NovoFormato, Enumeracoes::CA_DXGI_SWAP_CHAIN_FLAG Param_SwapChainFlags)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
