...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por representar uma geometria que foi transformada.
/// </summary>
public ref class CarenD2D1TransformedGeometry : public ICarenD2D1TransformedGeometry
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID2D1TransformedGeometry).
	ID2D1TransformedGeometry* PonteiroTrabalho = NULL;
...
public:
	static operator CarenD2D1TransformedGeometry^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1TransformedGeometry^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1TransformedGeometry();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1TransformedGeometry*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD2D1TransformedGeometry::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenD2D1TransformedGeometry)
public:
	/// <summary>
	...
	virtual CarenResult GetSourceGeometry([Out] ICarenD2D1Geometry^% Param_Out_SourceGeometry);
