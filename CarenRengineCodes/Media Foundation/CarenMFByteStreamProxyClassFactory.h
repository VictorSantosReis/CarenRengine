...
public ref class CarenMFByteStreamProxyClassFactory : public ICarenMFByteStreamProxyClassFactory
{
	...
	//Ponteiro para a interface (IMFByteStreamProxyClassFactory).
	IMFByteStreamProxyClassFactory* PonteiroTrabalho = NULL;
...
public:
	static operator CarenMFByteStreamProxyClassFactory^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFByteStreamProxyClassFactory^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFByteStreamProxyClassFactory();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFByteStreamProxyClassFactory*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFByteStreamProxyClassFactory::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenMFByteStreamProxyClassFactory)
public:
	/// <summary>
