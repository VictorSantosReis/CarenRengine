...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por representar um recurso que fornece ações comuns em todos os recursos(DirectX 11).
/// </summary>
public ref class CarenD3D11Resource : public ICarenD3D11Resource
{
	/////////////////////////////////////////
...
public:
	static operator CarenD3D11Resource^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD3D11Resource^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD3D11Resource();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID3D11Resource*>(Param_Pointer.ToPointer());
...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD3D11Resource">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD3D11Resource^% Param_Out_CarenD3D11Resource)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenD3D11Resource = gcnew CarenD3D11Resource();
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD3D11Resource::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
