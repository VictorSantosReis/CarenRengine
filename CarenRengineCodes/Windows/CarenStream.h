...
public:
	static operator CarenStream^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenStream^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenStream();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IStream*>(Param_Pointer.ToPointer());
