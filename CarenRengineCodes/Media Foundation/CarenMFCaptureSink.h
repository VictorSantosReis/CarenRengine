...
public ref class CarenMFCaptureSink : public ICarenMFCaptureSink
{
	...
	//Ponteiro para a interface (IMFCaptureSink).
	IMFCaptureSink* PonteiroTrabalho = NULL;
...
public:
	static operator CarenMFCaptureSink^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFCaptureSink^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFCaptureSink();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFCaptureSink*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFCaptureSink::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
