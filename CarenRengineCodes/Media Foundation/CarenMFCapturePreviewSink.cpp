...
CarenResult CarenMFCapturePreviewSink::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IMFCapturePreviewSink*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenMFCapturePreviewSink::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IMFCapturePreviewSink*>(Param_PonteiroNativo);
...
/// </summary>
void CarenMFCapturePreviewSink::LimparDados()
{
