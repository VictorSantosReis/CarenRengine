...
{
	//Fixa o ponteiro.
	cli::pin_ptr<IDXGIAdapter3*> p = &PonteiroTrabalho;

	//Chama o método de ADICIONAR PONTEIRO na classe base(Caren).
	return Caren::Shared_AdicionarPonteiro(Param_PonteiroNativo, reinterpret_cast<IUnknown**>(static_cast<IDXGIAdapter3**>(p)));
}
...
CarenResult CarenDXGIAdapter3::GetParent(
...
CarenResult CarenDXGIAdapter3::SetPrivateData(
...
CarenResult CarenDXGIAdapter3::GetPrivateData(
	String^ Param_GuidIdentificao, 
...
CarenResult CarenDXGIAdapter3::SetPrivateDataInterface(
