...
CarenResult CarenD3D11CommandList::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD3D11CommandList::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID3D11CommandList*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD3D11CommandList::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID3D11CommandList*>(Param_PonteiroNativo);
...
CarenResult CarenD3D11CommandList::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11CommandList::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11CommandList::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenD3D11CommandList::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD3D11CommandList::ObterCodigoErro()
{
...
/// </summary>
void CarenD3D11CommandList::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD3D11CommandList::LiberarReferencia()
{
...
/// </summary>
void CarenD3D11CommandList::LimparDados()
{
...
/// </summary>
void CarenD3D11CommandList::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
...
CarenResult CarenD3D11CommandList::ObterFlagsContexto([Out] UInt32% Param_Out_SinalizadoresContexto)
{
	...
	Param_Out_SinalizadoresContexto = PonteiroTrabalho->GetContextFlags();
...
CarenResult CarenD3D11CommandList::ObterDispositivo(ICaren^ Param_Out_DispositivoD3D11)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11CommandList::ObterDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11CommandList::DefinirDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11CommandList::DefinirInterfaceDadosPrivados(
