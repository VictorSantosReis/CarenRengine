...
//Destruidor.
CarenWICMetadataHandlerInfo::~CarenWICMetadataHandlerInfo()
{
...
CarenResult CarenWICMetadataHandlerInfo::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenWICMetadataHandlerInfo::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<IWICMetadataHandlerInfo*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenWICMetadataHandlerInfo::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IWICMetadataHandlerInfo*>(Param_PonteiroNativo);
...
CarenResult CarenWICMetadataHandlerInfo::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICMetadataHandlerInfo::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICMetadataHandlerInfo::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenWICMetadataHandlerInfo::StatusPonteiro()
{
...
/// </summary>
Int32 CarenWICMetadataHandlerInfo::ObterCodigoErro()
{
...
/// </summary>
void CarenWICMetadataHandlerInfo::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenWICMetadataHandlerInfo::LiberarReferencia()
{
...
/// </summary>
void CarenWICMetadataHandlerInfo::LimparDados()
{
...
/// </summary>
void CarenWICMetadataHandlerInfo::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenWICMetadataHandlerInfo();
}



// Métodos da interface proprietária(ICarenWICMetadataHandlerInfo)
...
CarenResult CarenWICMetadataHandlerInfo::DoesRequireFixedSize([Out] Boolean% Param_Out_FixedSize)
{
...
CarenResult CarenWICMetadataHandlerInfo::DoesRequireFullStream([Out] Boolean% Param_Out_RequerFullStream)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICMetadataHandlerInfo::DoesSupportPadding([Out] Boolean% Param_Out_SuportaPadding)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICMetadataHandlerInfo::GetContainerFormats(
...
CarenResult CarenWICMetadataHandlerInfo::GetDeviceManufacturer(
...
CarenResult CarenWICMetadataHandlerInfo::GetDeviceModels(
UInt32 Param_TamanhoBufferString,
...
CarenResult CarenWICMetadataHandlerInfo::GetMetadataFormat([Out] String^% Param_Out_GuidFormatoMetadata)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICMetadataHandlerInfo::GetAuthor(
...
CarenResult CarenWICMetadataHandlerInfo::GetCLSID([Out] String^% Param_Out_CLSID)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICMetadataHandlerInfo::GetComponentType([Out] CA_WICComponentType% Param_Out_Type)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICMetadataHandlerInfo::GetFriendlyName(
...
CarenResult CarenWICMetadataHandlerInfo::GetSigningStatus([Out] CA_WICComponentSigning% Param_Out_Status)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICMetadataHandlerInfo::GetSpecVersion(
...
CarenResult CarenWICMetadataHandlerInfo::GetVendorGUID([Out] String^% Param_Out_GuidVendor)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICMetadataHandlerInfo::GetVersion(
