...
public:
	static operator CarenDXGISurface2^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenDXGISurface2^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenDXGISurface2();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IDXGISurface2*>(Param_Pointer.ToPointer());
