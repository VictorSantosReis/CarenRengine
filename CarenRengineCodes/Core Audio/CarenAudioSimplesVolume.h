...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenAudioSimplesVolume">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenSimpleAudioVolume^% Param_Out_CarenAudioSimplesVolume)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenAudioSimplesVolume = gcnew CarenSimpleAudioVolume();
