...
CarenResult CarenD3D11GeometryShader::GetDevice(ICaren^ Param_Out_DispositivoD3D11)
{
...
CarenResult CarenD3D11GeometryShader::GetPrivateData(
	String^ Param_Guid,
...
CarenResult CarenD3D11GeometryShader::SetPrivateData(
	String^ Param_Guid,
...
CarenResult CarenD3D11GeometryShader::SetPrivateDataInterface(
