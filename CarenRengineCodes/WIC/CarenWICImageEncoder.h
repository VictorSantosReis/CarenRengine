...
public:
	static operator CarenWICImageEncoder^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenWICImageEncoder^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenWICImageEncoder();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IWICImageEncoder*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenWICImageEncoder::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
