...
CarenResult CarenD3D11ShaderResourceView::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD3D11ShaderResourceView::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID3D11ShaderResourceView*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD3D11ShaderResourceView::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID3D11ShaderResourceView*>(Param_PonteiroNativo);
...
CarenResult CarenD3D11ShaderResourceView::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11ShaderResourceView::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11ShaderResourceView::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenD3D11ShaderResourceView::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD3D11ShaderResourceView::ObterCodigoErro()
{
...
/// </summary>
void CarenD3D11ShaderResourceView::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD3D11ShaderResourceView::LiberarReferencia()
{
...
/// </summary>
void CarenD3D11ShaderResourceView::LimparDados()
{
...
/// </summary>
void CarenD3D11ShaderResourceView::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenD3D11ShaderResourceView();
}
...
CarenResult CarenD3D11ShaderResourceView::GetDesc([Out] Estruturas::CA_D3D11_SHADER_RESOURCE_VIEW_DESC^% Param_Out_DescSombreadorRecurso)
{
...
CarenResult CarenD3D11ShaderResourceView::ObterRecurso([Out] ICarenD3D11Resource^% Param_Out_Recurso)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11ShaderResourceView::ObterDispositivo(ICaren^ Param_Out_DispositivoD3D11)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11ShaderResourceView::ObterDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11ShaderResourceView::DefinirDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11ShaderResourceView::DefinirInterfaceDadosPrivados(
