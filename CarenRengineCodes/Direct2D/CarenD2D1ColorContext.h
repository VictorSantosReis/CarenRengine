...
/// <summary>
/// (Concluida - Fase de Testes) - Classe responsável por representar um contexto de cores que pode ser usado com um objeto ICarenD2D1Bitmap1.
/// </summary>
public ref class CarenD2D1ColorContext : public ICarenD2D1ColorContext
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID2D1ColorContext).
...
public:
	static operator CarenD2D1ColorContext^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1ColorContext^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1ColorContext();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1ColorContext*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD2D1ColorContext::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
