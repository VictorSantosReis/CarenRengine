...
public:
	static operator CarenWICBitmapSourceTransform^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenWICBitmapSourceTransform^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenWICBitmapSourceTransform();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IWICBitmapSourceTransform*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenWICBitmapSourceTransform::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
