...
public:
	static operator CarenWICBitmapCodecInfo^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenWICBitmapCodecInfo^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenWICBitmapCodecInfo();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IWICBitmapCodecInfo*>(Param_Pointer.ToPointer());
