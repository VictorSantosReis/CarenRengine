...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável pelo controle de nível de volume do áudio principal do SAR(Streaming Audio Render) e o sistema de 
/// captura de áudio.
/// </summary>
public ref class CarenMFSimpleAudioVolume :public ICarenMFSimpleAudioVolume
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IMFSimpleAudioVolume).
...
public:
	static operator CarenMFSimpleAudioVolume^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFSimpleAudioVolume^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFSimpleAudioVolume();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFSimpleAudioVolume*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFSimpleAudioVolume::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
