...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD2D1RenderTarget">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD2D1RenderTarget^% Param_Out_CarenD2D1RenderTarget)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);

		//Cria a interface
		Param_Out_CarenD2D1RenderTarget = gcnew CarenD2D1RenderTarget();
