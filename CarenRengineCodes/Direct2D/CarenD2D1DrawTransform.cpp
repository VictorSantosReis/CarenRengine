...
#include "../pch.h"
#include "CarenD2D1DrawTransform.h"
...
CarenResult CarenD2D1DrawTransform::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD2D1DrawTransform::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1DrawTransform*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1DrawTransform::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1DrawTransform*>(Param_PonteiroNativo);
...
CarenResult CarenD2D1DrawTransform::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1DrawTransform::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1DrawTransform::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenD2D1DrawTransform::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD2D1DrawTransform::ObterCodigoErro()
{
...
/// </summary>
void CarenD2D1DrawTransform::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD2D1DrawTransform::LiberarReferencia()
{
...
/// </summary>
void CarenD2D1DrawTransform::LimparDados()
{
...
/// </summary>
void CarenD2D1DrawTransform::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenD2D1DrawTransform();
}



// Métodos da interface proprietária(ICarenD2D1DrawTransform)
...
CarenResult CarenD2D1DrawTransform::SetDrawInfo(ICarenD2D1DrawInfo^ Param_DrawInfo)
{
	...
	//Variaveis a serem utilizadas.
	Utilidades Util;
	ID2D1DrawInfo* pDrawInfo = NULL;

	//Recupera um ponteiro para o draw info
	Resultado = RecuperarPonteiroCaren(Param_DrawInfo, &pDrawInfo);

	//Sai do método em caso de erro
	SairOnError(Resultado);

	//Chama o método para realizar a operação.
	Hr = PonteiroTrabalho->SetDrawInfo(pDrawInfo);
...
CarenResult CarenD2D1DrawTransform::MapInputRectsToOutputRect(
...
CarenResult CarenD2D1DrawTransform::MapInvalidRect(
...
CarenResult CarenD2D1DrawTransform::MapOutputRectToInputRects(
...
void CarenD2D1DrawTransform::GetInputCount([Out] UInt32% Param_Out_Quantidade)
{
	//Chama o método para realizar a operação.
