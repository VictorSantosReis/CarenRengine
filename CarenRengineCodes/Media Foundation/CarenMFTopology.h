...
public:
	static operator CarenMFTopology^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFTopology^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFTopology(false);

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFTopology*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFTopology::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
