...
CarenResult CarenDXGIFactory7::RegisterAdaptersChangedEvent(
	ICarenEvent^ Param_HandleEvento, 
	[Out] UInt32% Param_Out_Cookie)
{
	//Chama o método na classe de funções compartilhadas do DXGI.
	return Shared_DXGIFactory::RegisterAdaptersChangedEvent(PonteiroTrabalho,
		Param_HandleEvento,
		Param_Out_Cookie
	);
}
...
CarenResult CarenDXGIFactory7::UnregisterAdaptersChangedEvent(
	UInt32 Param_Cookie)
{
	//Chama o método na classe de funções compartilhadas do DXGI.
	return Shared_DXGIFactory::UnregisterAdaptersChangedEvent(PonteiroTrabalho,
		Param_Cookie
	);
}
...
{
	//Chama o método na classe de funções compartilhadas do DXGI.
	return Shared_DXGIFactory::EnumAdapterByGpuPreference(PonteiroTrabalho,
		Param_IndexAdaptador,
		Param_PreferenciaGPU,
		Param_RIID,
		Param_Out_Adaptador
	);
}
...
CarenResult CarenDXGIFactory7::CheckFeatureSupport(
...
CarenResult CarenDXGIFactory7::EnumAdapterByLuid(
	CA_LUID^ Param_LUID, 
	String^ Param_RIID, 
...
/// <param name="Param_RIID">O identificador globalmente único (GUID) do objeto ICarenDXGIAdapter referenciado pelo parâmetro (Param_InterfaceAdapter).</param>
/// <param name="Param_Out_InterfaceAdapter">Recebe um ponteiro de interface ICarenDXGIAdapter para o adaptador. </param>
CarenResult CarenDXGIFactory7::EnumWarpAdapter(
	String^ Param_RIID, 
	[Out] ICaren^ Param_Out_InterfaceAdapter)
{
	//Chama o método na classe de funções compartilhadas do DXGI.
...
CarenResult CarenDXGIFactory7::GetCreationFlags(
...
/// reiniciado.</param>
CarenResult CarenDXGIFactory7::GetSharedResourceAdapterLuid(
...
CarenResult CarenDXGIFactory7::IsWindowedStereoEnabled(
...
CarenResult CarenDXGIFactory7::RegisterOcclusionStatusEvent(
...
CarenResult CarenDXGIFactory7::RegisterOcclusionStatusWindow(
...
/// registro do evento de notificação que (Param_Evento) especifica.</param>
CarenResult CarenDXGIFactory7::RegisterStereoStatusEvent(
	ICarenEvent^ Param_Evento, 
	[Out] UInt32% Param_Out_Cookie)
{
	//Chama o método na classe de funções compartilhadas do DXGI.
...
/// de notificação que (Param_WinMensagemCode) especifica.</param>
CarenResult CarenDXGIFactory7::RegisterStereoStatusWindow(
	IntPtr Param_HandleJanela, 
	UInt32 Param_WinMensagemCode, 
	[Out] UInt32% Param_Out_Cookie)
{
...
CarenResult CarenDXGIFactory7::UnregisterOcclusionStatus(
	UInt32 Param_Cookie)
{
	//Chama o método na classe de funções compartilhadas do DXGI.
...
/// </summary>
/// <param name="Param_Cookie">Um valor-chave para a janela ou evento para cancelar o registro. Esse valor é retornado nos métodos de registro de evento e janela desta interface.</param>
CarenResult CarenDXGIFactory7::UnregisterStereoStatus(
	UInt32 Param_Cookie)
{
	//Chama o método na classe de funções compartilhadas do DXGI.
...
CarenResult CarenDXGIFactory7::EnumAdapters1(
...
CarenResult CarenDXGIFactory7::IsCurrent(
...
CarenResult CarenDXGIFactory7::CreateSoftwareAdapter(
...
CarenResult CarenDXGIFactory7::CreateSwapChain(
...
/// <param name="Param_IdAdaptador">O Indice para o adaptador a ser enumerado.</param>
/// <param name="Param_Out_Adaptador">Recebe um ponteiro para a interface do adaptador no indice especificado. O chamador é responsável por liberar a interface.</param>
CarenResult CarenDXGIFactory7::EnumAdapters(
	UInt32 Param_IdAdaptador, 
	[Out] ICarenDXGIAdapter^% Param_Out_Adaptador)
{
	//Chama o método na classe de funções compartilhadas do DXGI.
...
CarenResult CarenDXGIFactory7::GetWindowAssociation(
...
CarenResult CarenDXGIFactory7::MakeWindowAssociation(
	IntPtr Param_HandleJanela, 
...
CarenResult CarenDXGIFactory7::GetParent(
...
CarenResult CarenDXGIFactory7::SetPrivateData(
...
CarenResult CarenDXGIFactory7::GetPrivateData(
	String^ Param_GuidIdentificao, 
...
CarenResult CarenDXGIFactory7::SetPrivateDataInterface(
