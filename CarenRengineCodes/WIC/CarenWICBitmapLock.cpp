...
CarenResult CarenWICBitmapLock::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IWICBitmapLock*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenWICBitmapLock::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IWICBitmapLock*>(Param_PonteiroNativo);
...
/// </summary>
void CarenWICBitmapLock::LimparDados()
{
