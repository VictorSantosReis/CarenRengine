...
CarenResult CarenD3D11ShaderResourceView1::ObterRecurso([Out] ICarenD3D11Resource^% Param_Out_Recurso)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11ShaderResourceView1::ObterDispositivo(ICaren^ Param_Out_DispositivoD3D11)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11ShaderResourceView1::ObterDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11ShaderResourceView1::DefinirDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11ShaderResourceView1::DefinirInterfaceDadosPrivados(
