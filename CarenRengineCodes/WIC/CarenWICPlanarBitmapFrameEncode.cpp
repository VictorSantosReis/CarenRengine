...
CarenResult CarenWICPlanarBitmapFrameEncode::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IWICPlanarBitmapFrameEncode*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenWICPlanarBitmapFrameEncode::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IWICPlanarBitmapFrameEncode*>(Param_PonteiroNativo);
...
/// </summary>
void CarenWICPlanarBitmapFrameEncode::LimparDados()
{
