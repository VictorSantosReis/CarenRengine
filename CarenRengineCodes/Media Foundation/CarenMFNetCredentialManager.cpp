...
CarenResult CarenMFNetCredentialManager::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IMFNetCredentialManager*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenMFNetCredentialManager::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IMFNetCredentialManager*>(Param_PonteiroNativo);
...
/// </summary>
void CarenMFNetCredentialManager::LimparDados()
{
