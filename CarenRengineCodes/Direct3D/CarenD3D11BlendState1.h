...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD3D11BlendState1">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD3D11BlendState1^% Param_Out_CarenD3D11BlendState1)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenD3D11BlendState1 = gcnew CarenD3D11BlendState1();
...
public:
	...
	virtual CarenResult ObterDescriçaoEstado1([Out] Estruturas::CA_D3D11_BLEND_DESC1^% Param_Out_DescEstado);
...
public:
	...
	/// </summary>
	/// <param name="Param_Out_DescEstado">Retorna uma estrutura com a descrição de um misturador de estado(Blend State).</param>
	virtual CarenResult ObterDescriçaoEstado([Out] Estruturas::CA_D3D11_BLEND_DESC^% Param_Out_DescEstado);
