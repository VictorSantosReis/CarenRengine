...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por executar todas as mesmas funções da interface ICarenD2D1DeviceContext4, além de permitir a criação de contextos 
/// de cores e documentos Svg.
/// </summary>
public ref class CarenD2D1DeviceContext5 : public ICarenD2D1DeviceContext5
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID2D1DeviceContext5).
	ID2D1DeviceContext5* PonteiroTrabalho = NULL;
...
public:
	static operator CarenD2D1DeviceContext5^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1DeviceContext5^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1DeviceContext5();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1DeviceContext5*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD2D1DeviceContext5::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
