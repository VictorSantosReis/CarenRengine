...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por representar um objeto que pode receber comandos de desenho. Interfaces que herdam do ICarenD2D1RenderTarget tornam os comandos de 
/// desenho que recebem de diferentes maneiras.
/// </summary>
public ref class CarenD2D1RenderTarget : public ICarenD2D1RenderTarget
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID2D1RenderTarget).
	ID2D1RenderTarget* PonteiroTrabalho = NULL;
...
public:
	static operator CarenD2D1RenderTarget^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1RenderTarget^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1RenderTarget();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1RenderTarget*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD2D1RenderTarget::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
