...
#include "../pch.h"
#include "CarenMFCaptureEngineOnSampleCallback2.h"
...
//Construtor
CarenMFCaptureEngineOnSampleCallback2::CarenMFCaptureEngineOnSampleCallback2(Boolean Param_CriarInterface)
{
	//Verifica se deve criar a classe ou não.
	if (Param_CriarInterface)
		PonteiroTrabalho = new CLN_IMFCaptureEngineOnSampleCallback2();
}
...
CarenResult CarenMFCaptureEngineOnSampleCallback2::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenMFCaptureEngineOnSampleCallback2::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<IMFCaptureEngineOnSampleCallback2*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenMFCaptureEngineOnSampleCallback2::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IMFCaptureEngineOnSampleCallback2*>(Param_PonteiroNativo);
...
CarenResult CarenMFCaptureEngineOnSampleCallback2::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenMFCaptureEngineOnSampleCallback2::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenMFCaptureEngineOnSampleCallback2::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenMFCaptureEngineOnSampleCallback2::StatusPonteiro()
{
...
/// </summary>
Int32 CarenMFCaptureEngineOnSampleCallback2::ObterCodigoErro()
{
...
/// </summary>
void CarenMFCaptureEngineOnSampleCallback2::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenMFCaptureEngineOnSampleCallback2::LiberarReferencia()
{
...
/// </summary>
void CarenMFCaptureEngineOnSampleCallback2::LimparDados()
{
...
/// </summary>
void CarenMFCaptureEngineOnSampleCallback2::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenMFCaptureEngineOnSampleCallback2();
}



// Métodos da interface proprietária(ICarenMFCaptureEngineOnSampleCallback2)
