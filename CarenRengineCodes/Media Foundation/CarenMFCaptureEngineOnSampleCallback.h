...
#include "../NativeClassForEvents/CLN_IMFCaptureEngineOnSampleCallback.h"
...
public ref class CarenMFCaptureEngineOnSampleCallback : public ICarenMFCaptureEngineOnSampleCallback
{
	...
	//Ponteiro para a interface (IMFCaptureEngineOnSampleCallback).
	IMFCaptureEngineOnSampleCallback* PonteiroTrabalho = NULL;
...
public:
	static operator CarenMFCaptureEngineOnSampleCallback^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFCaptureEngineOnSampleCallback^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFCaptureEngineOnSampleCallback(false);

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFCaptureEngineOnSampleCallback*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFCaptureEngineOnSampleCallback::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenMFCaptureEngineOnSampleCallback)
public:
	/// <summary>
