...
/// Essa é uma extensão da classe(CarenMF2DBuffer).
/// </summary>
public ref class CarenMF2DBuffer2 :public ICarenMF2DBuffer2
{
	/////////////////////////////////////////
...
public:
	static operator CarenMF2DBuffer2^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMF2DBuffer2^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMF2DBuffer2();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMF2DBuffer2*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMF2DBuffer2::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenMF2DBuffer2)
public:
	/// <summary>
	...
	virtual CarenResult Copy2DTo(ICarenMF2DBuffer2^% Param_Interface2DBufferDestino);
