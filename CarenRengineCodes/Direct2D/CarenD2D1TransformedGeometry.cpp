...
//Destruidor.
CarenD2D1TransformedGeometry::~CarenD2D1TransformedGeometry()
{
...
CarenResult CarenD2D1TransformedGeometry::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD2D1TransformedGeometry::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1TransformedGeometry*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1TransformedGeometry::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1TransformedGeometry*>(Param_PonteiroNativo);
...
CarenResult CarenD2D1TransformedGeometry::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1TransformedGeometry::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1TransformedGeometry::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenD2D1TransformedGeometry::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD2D1TransformedGeometry::ObterCodigoErro()
{
...
/// </summary>
void CarenD2D1TransformedGeometry::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD2D1TransformedGeometry::LiberarReferencia()
{
...
/// </summary>
void CarenD2D1TransformedGeometry::LimparDados()
{
...
/// </summary>
void CarenD2D1TransformedGeometry::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenD2D1TransformedGeometry();
}



// Métodos da interface proprietária(ICarenD2D1TransformedGeometry)
...
CarenResult CarenD2D1TransformedGeometry::GetSourceGeometry([Out] ICarenD2D1Geometry^% Param_Out_SourceGeometry)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);

	//Variaveis a serem utilizadas.
	ID2D1Geometry* pGeometryOut = NULL;

	//Chama o método para realizar a operação.
	PonteiroTrabalho->GetSourceGeometry(&pGeometryOut);

	//Cria a interface gerenciada que vai conter o ponteiro.
	Param_Out_SourceGeometry = gcnew CarenD2D1Geometry();

	//Define o ponteiro na interface gerenciada.
	Resultado = Param_Out_SourceGeometry->AdicionarPonteiro(pGeometryOut);

	//Verifica se não houve erro
	if (!CarenSucesso(Resultado))
	{
		//Falhou ao definir o ponteiro na interface de saida.

		//Libera a referência recuperada
		pGeometryOut->Release();
		pGeometryOut = NULL;
		Param_Out_SourceGeometry->Finalizar();
		Param_Out_SourceGeometry = nullptr;
	}
...
void CarenD2D1TransformedGeometry::GetTransform([Out] CA_D2D1_MATRIX_3X2_F^% Param_Out_Transform)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
	...
	//Converte a estrutura nativa para a gerenicada e define no parametro de saida.
	Param_Out_Transform = Util.ConverterD2D1_MATRIX_3X2_FUnmanagedToManaged(&OutTransform);
}
...
CarenResult CarenD2D1TransformedGeometry::CombineWithGeometry(
...
CarenResult CarenD2D1TransformedGeometry::CompareWithGeometry(
	ICarenD2D1Geometry^ Param_GeometriaEntrada,
	CA_D2D1_MATRIX_3X2_F^ Param_InputGeometryTransform,
	float Param_FlatteningTolerance,
...
CarenResult CarenD2D1TransformedGeometry::ComputeArea(
...
CarenResult CarenD2D1TransformedGeometry::ComputeLength(
	CA_D2D1_MATRIX_3X2_F^ Param_WorldTransform,
	float Param_FlatteningTolerance,
...
CarenResult CarenD2D1TransformedGeometry::ComputePointAtLength(
	float Param_Length,
	CA_D2D1_MATRIX_3X2_F^ Param_WorldTransform,
	float Param_FlatteningTolerance,
...
CarenResult CarenD2D1TransformedGeometry::FillContainsPoint(
...
CarenResult CarenD2D1TransformedGeometry::GetBounds(
	CA_D2D1_MATRIX_3X2_F^ Param_WorldTransform,
...
CarenResult CarenD2D1TransformedGeometry::GetWidenedBounds(
...
CarenResult CarenD2D1TransformedGeometry::Outline(
	CA_D2D1_MATRIX_3X2_F^ Param_WorldTransform,
	float Param_FlatteningTolerance,
...
CarenResult CarenD2D1TransformedGeometry::Simplify(
...
CarenResult CarenD2D1TransformedGeometry::StrokeContainsPoint(
	CA_D2D1_POINT_2F^ Param_Point,
	float Param_StrokeWidth,
	ICarenD2D1StrokeStyle^ Param_StrokeStyle,
	CA_D2D1_MATRIX_3X2_F^ Param_WorldTransform,
...
CarenResult CarenD2D1TransformedGeometry::Tessellate(
	CA_D2D1_MATRIX_3X2_F^ Param_WorldTransform,
	float Param_FlatteningTolerance,
...
CarenResult CarenD2D1TransformedGeometry::Widen(
	float Param_StrokeWidth,
	ICarenD2D1StrokeStyle^ Param_StrokeStyle,
	CA_D2D1_MATRIX_3X2_F^ Param_WorldTransform,
	float Param_FlatteningTolerance,
...
void CarenD2D1TransformedGeometry::GetFactory(ICaren^ Param_Out_Factory)
{
	//Variaveis a serem utilizadas.
