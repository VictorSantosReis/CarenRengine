...
//Destruidor.
CarenD3D11DepthStencilState::~CarenD3D11DepthStencilState()
{
...
CarenResult CarenD3D11DepthStencilState::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD3D11DepthStencilState::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID3D11DepthStencilState*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD3D11DepthStencilState::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID3D11DepthStencilState*>(Param_PonteiroNativo);
...
CarenResult CarenD3D11DepthStencilState::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11DepthStencilState::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11DepthStencilState::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenD3D11DepthStencilState::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD3D11DepthStencilState::ObterCodigoErro()
{
...
/// </summary>
void CarenD3D11DepthStencilState::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD3D11DepthStencilState::LiberarReferencia()
{
...
/// </summary>
void CarenD3D11DepthStencilState::LimparDados()
{
...
/// </summary>
void CarenD3D11DepthStencilState::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenD3D11DepthStencilState();
}
...
CarenResult CarenD3D11DepthStencilState::GetDesc([Out] Estruturas::CA_D3D11_DEPTH_STENCIL_DESC^% Param_Out_DescEstadoStencil)
{
	...
	PonteiroTrabalho->GetDesc(&DescDepthStencil);

	//Converte a estrutur nativa e define no parametro de saida.
	Param_Out_DescEstadoStencil = Util.ConverterD3D11_DEPTH_STENCIL_DESCUnManaged_ToManaged(&DescDepthStencil);
...
CarenResult CarenD3D11DepthStencilState::ObterDispositivo(ICaren^ Param_Out_DispositivoD3D11)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11DepthStencilState::ObterDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11DepthStencilState::DefinirDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11DepthStencilState::DefinirInterfaceDadosPrivados(
