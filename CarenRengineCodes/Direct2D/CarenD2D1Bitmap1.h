...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD2D1Bitmap1">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD2D1Bitmap1^% Param_Out_CarenD2D1Bitmap1)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);

		//Cria a interface
		Param_Out_CarenD2D1Bitmap1 = gcnew CarenD2D1Bitmap1();
