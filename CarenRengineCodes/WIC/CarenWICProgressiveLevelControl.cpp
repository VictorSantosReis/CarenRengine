...
CarenResult CarenWICProgressiveLevelControl::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IWICProgressiveLevelControl*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenWICProgressiveLevelControl::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IWICProgressiveLevelControl*>(Param_PonteiroNativo);
...
/// </summary>
Int32 CarenWICProgressiveLevelControl::ObterCodigoErro()
{
...
/// </summary>
void CarenWICProgressiveLevelControl::LimparDados()
{
