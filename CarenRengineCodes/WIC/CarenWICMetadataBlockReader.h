...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por expor métodos que fornecem acesso a todos os blocos de metadados de nível superior do codec.
/// </summary>
public ref class CarenWICMetadataBlockReader : public ICarenWICMetadataBlockReader
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IWICMetadataBlockReader).
	IWICMetadataBlockReader* PonteiroTrabalho = NULL;
...
public:
	static operator CarenWICMetadataBlockReader^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenWICMetadataBlockReader^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenWICMetadataBlockReader();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IWICMetadataBlockReader*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenWICMetadataBlockReader::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
