...
#include "../pch.h"
#include "CarenWICBitmapCodecInfo.h"

//Destruidor.
CarenWICBitmapCodecInfo::~CarenWICBitmapCodecInfo()
{
...
CarenResult CarenWICBitmapCodecInfo::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenWICBitmapCodecInfo::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<IWICBitmapCodecInfo*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenWICBitmapCodecInfo::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IWICBitmapCodecInfo*>(Param_PonteiroNativo);
...
CarenResult CarenWICBitmapCodecInfo::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICBitmapCodecInfo::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICBitmapCodecInfo::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenWICBitmapCodecInfo::StatusPonteiro()
{
...
/// </summary>
Int32 CarenWICBitmapCodecInfo::ObterCodigoErro()
{
...
/// </summary>
void CarenWICBitmapCodecInfo::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenWICBitmapCodecInfo::LiberarReferencia()
{
...
/// </summary>
void CarenWICBitmapCodecInfo::LimparDados()
{
...
/// </summary>
void CarenWICBitmapCodecInfo::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenWICBitmapCodecInfo();
}



// Métodos da interface proprietária(ICarenWICBitmapCodecInfo)
...
CarenResult CarenWICBitmapCodecInfo::DoesSupportAnimation([Out] Boolean% Param_Out_SuporteAnimacao)
{
...
CarenResult CarenWICBitmapCodecInfo::DoesSupportChromakey([Out] Boolean% Param_Out_SuporteChromakey)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICBitmapCodecInfo::DoesSupportLossless([Out] Boolean% Param_Out_SuporteLossLess)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICBitmapCodecInfo::DoesSupportMultiframe([Out] Boolean% Param_Out_SuporteMultiframe)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICBitmapCodecInfo::GetColorManagementVersion(
UInt32 Param_Size,
...
CarenResult CarenWICBitmapCodecInfo::GetContainerFormat([Out] String^% Param_Out_GuidFormatoContainer)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICBitmapCodecInfo::GetDeviceManufacturer(
UInt32 Param_Size,
...
CarenResult CarenWICBitmapCodecInfo::GetDeviceModels(
UInt32 Param_Size,
...
CarenResult CarenWICBitmapCodecInfo::GetFileExtensions(
UInt32 Param_Size,
...
CarenResult CarenWICBitmapCodecInfo::GetMimeTypes(
UInt32 Param_Size,
...
CarenResult CarenWICBitmapCodecInfo::GetPixelFormats(
UInt32 Param_Size,
...
CarenResult CarenWICBitmapCodecInfo::MatchesMimeType(
...
CarenResult CarenWICBitmapCodecInfo::GetAuthor(
...
CarenResult CarenWICBitmapCodecInfo::GetCLSID([Out] String^% Param_Out_CLSID)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICBitmapCodecInfo::GetComponentType([Out] CA_WICComponentType% Param_Out_Type)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICBitmapCodecInfo::GetFriendlyName(
...
CarenResult CarenWICBitmapCodecInfo::GetSigningStatus([Out] CA_WICComponentSigning% Param_Out_Status)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICBitmapCodecInfo::GetSpecVersion(
...
CarenResult CarenWICBitmapCodecInfo::GetVendorGUID([Out] String^% Param_Out_GuidVendor)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICBitmapCodecInfo::GetVersion(
