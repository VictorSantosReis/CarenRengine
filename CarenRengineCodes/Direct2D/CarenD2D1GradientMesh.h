...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD2D1GradientMesh">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD2D1GradientMesh^% Param_Out_CarenD2D1GradientMesh)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);

		//Cria a interface
		Param_Out_CarenD2D1GradientMesh = gcnew CarenD2D1GradientMesh();
