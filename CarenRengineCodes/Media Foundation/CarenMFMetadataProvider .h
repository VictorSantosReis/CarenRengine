...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável  por recuperar metadados de uma fonte de mídia ou outro objeto. Se uma fonte de mídia suportar essa interface, ela deve expor a 
/// interface como um serviço.
/// </summary>
public ref class CarenMFMetadataProvider  : public ICarenMFMetadataProvider 
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IMFMetadataProvider ).
	IMFMetadataProvider * PonteiroTrabalho = NULL;
...
public:
	static operator CarenMFMetadataProvider ^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFMetadataProvider ^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFMetadataProvider ();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFMetadataProvider *>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFMetadataProvider ::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
