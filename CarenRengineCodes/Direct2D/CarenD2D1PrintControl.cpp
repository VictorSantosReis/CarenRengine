...
CarenResult CarenD2D1PrintControl::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1PrintControl*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1PrintControl::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1PrintControl*>(Param_PonteiroNativo);
...
/// </summary>
Int32 CarenD2D1PrintControl::ObterCodigoErro()
{
...
/// </summary>
void CarenD2D1PrintControl::LimparDados()
{
