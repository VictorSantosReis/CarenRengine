...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por criar recursos Direct2D. Esta interface também permite a criação de objetos ICarenD2D1Device5.
/// </summary>
public ref class CarenD2D1Factory6 : public ICarenD2D1Factory6
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID2D1Factory6).
	ID2D1Factory6* PonteiroTrabalho = NULL;
...
public:
	static operator CarenD2D1Factory6^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1Factory6^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1Factory6();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1Factory6*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD2D1Factory6::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
