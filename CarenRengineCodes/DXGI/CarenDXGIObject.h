...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenDXGIObject">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenDXGIObject^% Param_Out_CarenDXGIObject)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenDXGIObject = gcnew CarenDXGIObject();
