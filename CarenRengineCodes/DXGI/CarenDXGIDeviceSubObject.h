...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenDXGIDeviceSubObject">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenDXGIDeviceSubObject^% Param_Out_CarenDXGIDeviceSubObject)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenDXGIDeviceSubObject = gcnew CarenDXGIDeviceSubObject();
