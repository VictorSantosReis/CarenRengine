...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por expor métodos que produzem uma fonte de bitmap invertida (horizontal ou vertical) e / ou girada 
/// (em incrementos de 90 graus). As rotações são feitas antes do flip.
/// </summary>
public ref class CarenWICBitmapFlipRotator : public ICarenWICBitmapFlipRotator
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IWICBitmapFlipRotator).
	IWICBitmapFlipRotator* PonteiroTrabalho = NULL;
...
public:
	static operator CarenWICBitmapFlipRotator^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenWICBitmapFlipRotator^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenWICBitmapFlipRotator();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IWICBitmapFlipRotator*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenWICBitmapFlipRotator::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenWICBitmapFlipRotator)
public:
	/// <summary>
