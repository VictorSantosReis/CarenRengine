...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por desvrever um retângulo bidimensional.
/// </summary>
public ref class CarenD2D1RectangleGeometry : public ICarenD2D1RectangleGeometry
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID2D1RectangleGeometry).
...
public:
	static operator CarenD2D1RectangleGeometry^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1RectangleGeometry^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1RectangleGeometry();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1RectangleGeometry*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD2D1RectangleGeometry::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenD2D1RectangleGeometry)
public:
	/// <summary>
	...
	virtual void GetRect([Out] CA_D2D1_RECT_F^% Param_Out_Rect);
