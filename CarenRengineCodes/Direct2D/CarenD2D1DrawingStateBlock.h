...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por representar o estado de desenho de um alvo de renderização: o modo antialiasing, a transformação, as tags e as opções de 
/// renderização de texto.
/// </summary>
public ref class CarenD2D1DrawingStateBlock : public ICarenD2D1DrawingStateBlock
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID2D1DrawingStateBlock).
...
public:
	static operator CarenD2D1DrawingStateBlock^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1DrawingStateBlock^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1DrawingStateBlock();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1DrawingStateBlock*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD2D1DrawingStateBlock::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
