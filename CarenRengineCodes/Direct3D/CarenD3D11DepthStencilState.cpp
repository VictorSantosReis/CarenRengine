...
CarenResult CarenD3D11DepthStencilState::GetDevice(ICaren^ Param_Out_DispositivoD3D11)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11DepthStencilState::GetPrivateData(
	String^ Param_Guid,
...
CarenResult CarenD3D11DepthStencilState::SetPrivateData(
	String^ Param_Guid,
...
CarenResult CarenD3D11DepthStencilState::SetPrivateDataInterface(
