...
/// <summary>
/// (Concluido - Fase de Testes) - Classe implementada por aplicativos para fornecer credenciais de usuário para uma fonte de rede.
/// </summary>
public ref class CarenMFNetCredentialManager : public ICarenMFNetCredentialManager
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IMFNetCredentialManager).
	IMFNetCredentialManager* PonteiroTrabalho = NULL;
...
public:
	static operator CarenMFNetCredentialManager^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFNetCredentialManager^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFNetCredentialManager();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFNetCredentialManager*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFNetCredentialManager::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenMFNetCredentialManager)
public:
	/// <summary>
	...
	virtual CarenResult BeginGetCredentials(
	...
	virtual CarenResult EndGetCredentials(
