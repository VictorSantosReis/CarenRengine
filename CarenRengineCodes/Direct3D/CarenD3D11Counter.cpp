...
//Destruidor.
CarenD3D11Counter::~CarenD3D11Counter()
{
...
CarenResult CarenD3D11Counter::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD3D11Counter::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID3D11Counter*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD3D11Counter::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID3D11Counter*>(Param_PonteiroNativo);
...
CarenResult CarenD3D11Counter::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Counter::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Counter::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenD3D11Counter::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD3D11Counter::ObterCodigoErro()
{
...
/// </summary>
void CarenD3D11Counter::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD3D11Counter::LiberarReferencia()
{
...
/// </summary>
void CarenD3D11Counter::LimparDados()
{
...
/// </summary>
void CarenD3D11Counter::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
...
CarenResult CarenD3D11Counter::GetDesc([Out] Estruturas::CA_D3D11_DESC_CONTADOR^% Param_Out_DescContador)
{
	...
	//Variaveis a serem utilizadas.
	Utilidades Util;
	D3D11_COUNTER_DESC DescCount;

	//Chama o método para realizar a operação
	PonteiroTrabalho->GetDesc(&DescCount);

	//Converte a estrutura nativa e define no parametro de saida.
	Param_Out_DescContador = Util.ConverterD3D11_COUNTER_DESCUnManaged_ToManaged(&DescCount);
...
CarenResult CarenD3D11Counter::ObterDispositivo(ICaren^ Param_Out_DispositivoD3D11)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Counter::ObterDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11Counter::DefinirDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11Counter::DefinirInterfaceDadosPrivados(
