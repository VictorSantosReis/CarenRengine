...
CarenResult CarenWICBitmapClipper::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenWICBitmapClipper::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<IWICBitmapClipper*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenWICBitmapClipper::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IWICBitmapClipper*>(Param_PonteiroNativo);
...
CarenResult CarenWICBitmapClipper::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICBitmapClipper::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICBitmapClipper::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenWICBitmapClipper::StatusPonteiro()
{
...
/// </summary>
Int32 CarenWICBitmapClipper::ObterCodigoErro()
{
...
/// </summary>
void CarenWICBitmapClipper::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenWICBitmapClipper::LiberarReferencia()
{
...
/// </summary>
void CarenWICBitmapClipper::LimparDados()
{
...
/// </summary>
void CarenWICBitmapClipper::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenWICBitmapClipper();
}



// Métodos da interface proprietária(ICarenWICBitmapClipper)
...
CarenResult CarenWICBitmapClipper::Initialize(
...
CA_WICRect^ Param_RectClip)
{
	...
	WICRect* pRectClip = NULL;

	//Recupera o ponteiro para a interface de fonte do bitmap.
	Resultado = RecuperarPonteiroCaren(Param_Source, &pBitmapSource);

	//Sai do método em caso de erro.
	SairOnError(Resultado);

	//Converte a estrutura
	pRectClip = Util.ConverterWICRectManaged_ToUnManaged(Param_RectClip);

	//Chama o método para realizar a operação.
	Hr = PonteiroTrabalho->Initialize(pBitmapSource, pRectClip);
...
Done:;
	...
	DeletarEstruturaSafe(&pRectClip);
...
CarenResult CarenWICBitmapClipper::CopyPalette(ICaren^ Param_Palette)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICBitmapClipper::CopyPixels(
...
CarenResult CarenWICBitmapClipper::GetPixelFormat([Out] String^% Param_Out_FormatoPixel)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICBitmapClipper::GetResolution(
...
CarenResult CarenWICBitmapClipper::GetSize(
