...
CarenResult CarenD3D11RasterizerState2::GetDevice(ICaren^ Param_Out_DispositivoD3D11)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11RasterizerState2::GetPrivateData(
	String^ Param_Guid,
...
CarenResult CarenD3D11RasterizerState2::SetPrivateData(
	String^ Param_Guid,
...
CarenResult CarenD3D11RasterizerState2::SetPrivateDataInterface(
