...
public:
	static operator CarenWICMetadataWriter^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenWICMetadataWriter^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenWICMetadataWriter();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IWICMetadataWriter*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenWICMetadataWriter::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
