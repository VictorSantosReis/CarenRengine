...
CarenResult CarenDXGIFactory2::GetParent(
...
CarenResult CarenDXGIFactory2::SetPrivateData(
...
CarenResult CarenDXGIFactory2::GetPrivateData(
	String^ Param_GuidIdentificao, 
...
CarenResult CarenDXGIFactory2::SetPrivateDataInterface(
