...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável permitir o gerenciamento de configurações de fluxo para uma fonte de mídia multiplexada.
/// </summary>
public ref class CarenMFMuxStreamMediaTypeManager : public ICarenMFMuxStreamMediaTypeManager
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IMFMuxStreamMediaTypeManager).
	IMFMuxStreamMediaTypeManager* PonteiroTrabalho = NULL;
...
public:
	...
	/// </summary>
	CarenMFMuxStreamMediaTypeManager();
...
public:
	static operator CarenMFMuxStreamMediaTypeManager^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFMuxStreamMediaTypeManager^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFMuxStreamMediaTypeManager();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFMuxStreamMediaTypeManager*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFMuxStreamMediaTypeManager::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenMFMuxStreamMediaTypeManager)
public:
	/// <summary>
	...
	virtual CarenResult AddStreamConfiguration(UInt64 Param_ullStreamMask);
	...
	virtual CarenResult GetMediaType(
	...
	virtual CarenResult GetStreamConfiguration(
	...
	virtual CarenResult GetStreamConfigurationCount([Out] UInt32% Param_Out_Quantidade);
	...
	virtual CarenResult GetStreamCount([Out] UInt32% Param_Out_QuantidadeFluxos);

	/// <summary>
	/// Desregistra uma configuração de fluxo, que define um conjunto de subfluxos que podem ser incluídos na saída multiplexada.
	/// </summary>
	/// <param name="Param_ullStreamMask">Um valor de máscara de bits onde os bits que estão ligados representam os índices dos subfluxos incluídos na configuração do fluxo.</param>
	virtual CarenResult RemoveStreamConfiguration(UInt64 Param_ullStreamMask);
};