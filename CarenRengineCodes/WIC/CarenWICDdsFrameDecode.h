...
public:
	static operator CarenWICDdsFrameDecode^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenWICDdsFrameDecode^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenWICDdsFrameDecode();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IWICDdsFrameDecode*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenWICDdsFrameDecode::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
