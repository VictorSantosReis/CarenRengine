...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por representar um ICarenWICBitmapSource que converte os dados da imagem de um formato de pixel para outro, manipulando 
/// pontilhamento e meio-tom em formatos indexados, tradução de paleta e limiar alfa. 
/// </summary>
public ref class CarenWICFormatConverter : public ICarenWICFormatConverter
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IWICFormatConverter).
	IWICFormatConverter* PonteiroTrabalho = NULL;
...
public:
	static operator CarenWICFormatConverter^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenWICFormatConverter^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenWICFormatConverter();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IWICFormatConverter*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenWICFormatConverter::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenWICFormatConverter)
public:
	/// <summary>
	...
	virtual CarenResult CanConvert(
