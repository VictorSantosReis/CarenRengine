...
public:
	static operator CarenD3D11Texture1D^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD3D11Texture1D^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD3D11Texture1D();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID3D11Texture1D*>(Param_Pointer.ToPointer());
