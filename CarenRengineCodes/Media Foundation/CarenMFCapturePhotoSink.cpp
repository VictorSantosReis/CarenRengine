...
#include "../pch.h"
#include "CarenMFCapturePhotoSink.h"

//Destruidor.
CarenMFCapturePhotoSink::~CarenMFCapturePhotoSink()
{
...
CarenResult CarenMFCapturePhotoSink::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenMFCapturePhotoSink::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<IMFCapturePhotoSink*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenMFCapturePhotoSink::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IMFCapturePhotoSink*>(Param_PonteiroNativo);
...
CarenResult CarenMFCapturePhotoSink::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenMFCapturePhotoSink::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenMFCapturePhotoSink::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenMFCapturePhotoSink::StatusPonteiro()
{
...
/// </summary>
Int32 CarenMFCapturePhotoSink::ObterCodigoErro()
{
...
/// </summary>
void CarenMFCapturePhotoSink::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenMFCapturePhotoSink::LiberarReferencia()
{
...
/// </summary>
void CarenMFCapturePhotoSink::LimparDados()
{
...
/// </summary>
void CarenMFCapturePhotoSink::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenMFCapturePhotoSink();
}



// Métodos da interface proprietária(ICarenMFCapturePhotoSink)
...
/// <returns></returns>
CarenResult CarenMFCapturePhotoSink::SetOutputByteStream(ICarenMFByteStream^ Param_ByteStream)
{
...
/// <returns></returns>
CarenResult CarenMFCapturePhotoSink::SetOutputFileName(String^ Param_Url)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// <returns></returns>
CarenResult CarenMFCapturePhotoSink::SetSampleCallback(ICarenMFCaptureEngineOnSampleCallback^ Param_Callback)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenMFCapturePhotoSink::AddStream(
...
CarenResult CarenMFCapturePhotoSink::GetOutputMediaType(
...
CarenResult CarenMFCapturePhotoSink::GetService(
	UInt32 Param_SinkStreamIndex,
...
/// </summary>
CarenResult CarenMFCapturePhotoSink::Prepare()
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenMFCapturePhotoSink::RemoveAllStreams()
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
