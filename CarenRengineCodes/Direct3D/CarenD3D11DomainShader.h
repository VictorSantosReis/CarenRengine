...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por representar um Sombreador de domínio gerencia um programa executável (um sombreado de domínio) que controla o estágio de sombreamento de domínio.
/// </summary>
public ref class CarenD3D11DomainShader : public ICarenD3D11DomainShader
{
	/////////////////////////////////////////
...
public:
	static operator CarenD3D11DomainShader^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD3D11DomainShader^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD3D11DomainShader();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID3D11DomainShader*>(Param_Pointer.ToPointer());
...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD3D11DomainShader">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD3D11DomainShader^% Param_Out_CarenD3D11DomainShader)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenD3D11DomainShader = gcnew CarenD3D11DomainShader();
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD3D11DomainShader::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
