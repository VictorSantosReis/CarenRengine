...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por encapsular métodos que recuperam dados da GPU de forma Assincrona.
/// </summary>
public ref class CarenD3D11Asynchronous :public ICarenD3D11Asynchronous
{
	/////////////////////////////////////////
...
public:
	static operator CarenD3D11Asynchronous^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD3D11Asynchronous^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD3D11Asynchronous();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID3D11Asynchronous*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD3D11Asynchronous::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
...
public:
	...
	virtual CarenResult GetDevice([Out] ICaren^ Param_Out_DispositivoD3D11);
