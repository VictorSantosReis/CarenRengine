...
CarenResult CarenMFAudioStreamVolume::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IMFAudioStreamVolume*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenMFAudioStreamVolume::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IMFAudioStreamVolume*>(Param_PonteiroNativo);
...
/// </summary>
void CarenMFAudioStreamVolume::LimparDados()
{
