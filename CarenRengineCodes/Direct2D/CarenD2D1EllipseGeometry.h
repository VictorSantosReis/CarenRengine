...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD2D1EllipseGeometry">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD2D1EllipseGeometry^% Param_Out_CarenD2D1EllipseGeometry)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);

		//Cria a interface
		Param_Out_CarenD2D1EllipseGeometry = gcnew CarenD2D1EllipseGeometry();
