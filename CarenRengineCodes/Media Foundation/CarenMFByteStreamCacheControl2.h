...
public ref class CarenMFByteStreamCacheControl2 : public ICarenMFByteStreamCacheControl2
{
	...
	//Ponteiro para a interface (IMFByteStreamCacheControl2).
	IMFByteStreamCacheControl2* PonteiroTrabalho = NULL;
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFByteStreamCacheControl2::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenMFByteStreamCacheControl2)
public:
	/// <summary>
