...
public ref class CarenMFByteStreamBuffering : public ICarenMFByteStreamBuffering
{
	...
	//Ponteiro para a interface (IMFByteStreamBuffering).
	IMFByteStreamBuffering* PonteiroTrabalho = NULL;
...
public:
	static operator CarenMFByteStreamBuffering^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFByteStreamBuffering^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFByteStreamBuffering();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFByteStreamBuffering*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFByteStreamBuffering::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenMFByteStreamBuffering)
public:
	/// <summary>
