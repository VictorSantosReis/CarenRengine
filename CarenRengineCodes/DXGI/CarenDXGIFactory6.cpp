...
CarenResult CarenDXGIFactory6::GetParent(
...
CarenResult CarenDXGIFactory6::SetPrivateData(
...
CarenResult CarenDXGIFactory6::GetPrivateData(
	String^ Param_GuidIdentificao, 
...
CarenResult CarenDXGIFactory6::SetPrivateDataInterface(
