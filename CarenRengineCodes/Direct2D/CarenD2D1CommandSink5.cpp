...
//Destruidor.
CarenD2D1CommandSink5::~CarenD2D1CommandSink5()
{
	//Define que a classe foi descartada
	Prop_DisposedClasse = true;
}
//Construtor
CarenD2D1CommandSink5::CarenD2D1CommandSink5(Boolean Param_CriarInterface)
{
	//Verifica se deve ou não criar uma interface.
	if (Param_CriarInterface)
	{
		//Cria a implementação da interface
		PonteiroTrabalho = new CLN_ID2D1CommandSink5();
	}
	else
	{
...
CarenResult CarenD2D1CommandSink5::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD2D1CommandSink5::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1CommandSink5*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1CommandSink5::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1CommandSink5*>(Param_PonteiroNativo);
...
CarenResult CarenD2D1CommandSink5::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1CommandSink5::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1CommandSink5::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenD2D1CommandSink5::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD2D1CommandSink5::ObterCodigoErro()
{
...
/// </summary>
void CarenD2D1CommandSink5::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD2D1CommandSink5::LiberarReferencia()
{
...
/// </summary>
void CarenD2D1CommandSink5::LimparDados()
{
...
/// </summary>
void CarenD2D1CommandSink5::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenD2D1CommandSink5();
}



// Métodos da interface proprietaria ICarenD2D1CommandSink5
...
void CarenD2D1CommandSink5::RegistrarCallback()
{
	...
	//Configura os delegates da CarenD2D1CommandSink5
	Callback_OnBlendImage = gcnew DelegateNativo_Evento_OnBlendImage(this, &CarenD2D1CommandSink5::EncaminharEvento_OnBlendImage);

	//Configura os delegates da CarenD2D1CommandSink4
	Callback_OnSetPrimitiveBlend2 = gcnew DelegateNativo_Evento_OnSetPrimitiveBlend2(this, &CarenD2D1CommandSink5::EncaminharEvento_OnSetPrimitiveBlend2);

	//Configura os delegates da CarenD2D1CommandSink3
	Callback_OnDrawSpriteBatch = gcnew DelegateNativo_Evento_OnDrawSpriteBatch(this, &CarenD2D1CommandSink5::EncaminharEvento_OnDrawSpriteBatch);

	//Configura os delegates da CarenD2D1CommandSink2
	Callback_OnDrawGdiMetafile1 = gcnew DelegateNativo_Evento_OnDrawGdiMetafile1(this, &CarenD2D1CommandSink5::EncaminharEvento_OnDrawGdiMetafile1);
	Callback_OnDrawGradientMesh = gcnew DelegateNativo_Evento_OnDrawGradientMesh(this, &CarenD2D1CommandSink5::EncaminharEvento_OnDrawGradientMesh);
	Callback_OnDrawInk = gcnew DelegateNativo_Evento_OnDrawInk(this, &CarenD2D1CommandSink5::EncaminharEvento_OnDrawInk);

	//Configura os delegates da CarenD2D1CommandSink1
	Callback_OnSetPrimitiveBlend1 = gcnew DelegateNativo_Evento_OnSetPrimitiveBlend1(this, &CarenD2D1CommandSink5::EncaminharEvento_OnSetPrimitiveBlend1);

	//Configura os delegates da CarenD2D1CommandSink
	Callback_OnBeginDraw = gcnew DelegateNativo_Evento_OnBeginDraw(this, &CarenD2D1CommandSink5::EncaminharEvento_OnBeginDraw);
	Callback_OnEndDraw = gcnew DelegateNativo_Evento_OnEndDraw(this, &CarenD2D1CommandSink5::EncaminharEvento_OnEndDraw);
	Callback_OnSetAntialiasMode = gcnew DelegateNativo_Evento_OnSetAntialiasMode(this, &CarenD2D1CommandSink5::EncaminharEvento_OnSetAntialiasMode);
	Callback_OnSetTags = gcnew DelegateNativo_Evento_OnSetTags(this, &CarenD2D1CommandSink5::EncaminharEvento_OnSetTags);
	Callback_OnSetTextAntialiasMode = gcnew DelegateNativo_Evento_OnSetTextAntialiasMode(this, &CarenD2D1CommandSink5::EncaminharEvento_OnSetTextAntialiasMode);
	Callback_OnSetTextRenderingParams = gcnew DelegateNativo_Evento_OnSetTextRenderingParams(this, &CarenD2D1CommandSink5::EncaminharEvento_OnSetTextRenderingParams);
	Callback_OnSetTransform = gcnew DelegateNativo_Evento_OnSetTransform(this, &CarenD2D1CommandSink5::EncaminharEvento_OnSetTransform);
	Callback_OnSetPrimitiveBlend = gcnew DelegateNativo_Evento_OnSetPrimitiveBlend(this, &CarenD2D1CommandSink5::EncaminharEvento_OnSetPrimitiveBlend);
	Callback_OnSetUnitMode = gcnew DelegateNativo_Evento_OnSetUnitMode(this, &CarenD2D1CommandSink5::EncaminharEvento_OnSetUnitMode);
	Callback_OnClear = gcnew DelegateNativo_Evento_OnClear(this, &CarenD2D1CommandSink5::EncaminharEvento_OnClear);
	Callback_OnDrawGlyphRun = gcnew DelegateNativo_Evento_OnDrawGlyphRun(this, &CarenD2D1CommandSink5::EncaminharEvento_OnDrawGlyphRun);
	Callback_OnDrawLine = gcnew DelegateNativo_Evento_OnDrawLine(this, &CarenD2D1CommandSink5::EncaminharEvento_OnDrawLine);
	Callback_OnDrawGeometry = gcnew DelegateNativo_Evento_OnDrawGeometry(this, &CarenD2D1CommandSink5::EncaminharEvento_OnDrawGeometry);
	Callback_OnDrawRectangle = gcnew DelegateNativo_Evento_OnDrawRectangle(this, &CarenD2D1CommandSink5::EncaminharEvento_OnDrawRectangle);
	Callback_OnDrawBitmap = gcnew DelegateNativo_Evento_OnDrawBitmap(this, &CarenD2D1CommandSink5::EncaminharEvento_OnDrawBitmap);
	Callback_OnDrawImage = gcnew DelegateNativo_Evento_OnDrawImage(this, &CarenD2D1CommandSink5::EncaminharEvento_OnDrawImage);
	Callback_OnDrawGdiMetafile = gcnew DelegateNativo_Evento_OnDrawGdiMetafile(this, &CarenD2D1CommandSink5::EncaminharEvento_OnDrawGdiMetafile);
	Callback_OnFillMesh = gcnew DelegateNativo_Evento_OnFillMesh(this, &CarenD2D1CommandSink5::EncaminharEvento_OnFillMesh);
	Callback_OnFillOpacityMask = gcnew DelegateNativo_Evento_OnFillOpacityMask(this, &CarenD2D1CommandSink5::EncaminharEvento_OnFillOpacityMask);
	Callback_OnFillGeometry = gcnew DelegateNativo_Evento_OnFillGeometry(this, &CarenD2D1CommandSink5::EncaminharEvento_OnFillGeometry);
	Callback_OnFillRectangle = gcnew DelegateNativo_Evento_OnFillRectangle(this, &CarenD2D1CommandSink5::EncaminharEvento_OnFillRectangle);
	Callback_OnPushAxisAlignedClip = gcnew DelegateNativo_Evento_OnPushAxisAlignedClip(this, &CarenD2D1CommandSink5::EncaminharEvento_OnPushAxisAlignedClip);
	Callback_OnPushLayer = gcnew DelegateNativo_Evento_OnPushLayer(this, &CarenD2D1CommandSink5::EncaminharEvento_OnPushLayer);
	Callback_OnPopAxisAlignedClip = gcnew DelegateNativo_Evento_OnPopAxisAlignedClip(this, &CarenD2D1CommandSink5::EncaminharEvento_OnPopAxisAlignedClip);
	Callback_OnPopLayer = gcnew DelegateNativo_Evento_OnPopLayer(this, &CarenD2D1CommandSink5::EncaminharEvento_OnPopLayer);



	//Converte os delegates para ponteiros do IntPtr da CarenD2D1CommandSink5
	IntPtr Pointer_OnBlendImage = Util.ConverterDelegateToPointer(Callback_OnBlendImage);

	//Converte os delegates para ponteiros do IntPtr da CarenD2D1CommandSink4
	IntPtr Pointer_OnSetPrimitiveBlend2 = Util.ConverterDelegateToPointer(Callback_OnSetPrimitiveBlend2);
	...
	//Aloca a Handle para cada delegate que fornece o método de chamada do evento na classe CarenD2D1CommandSink5
	gHandle_Delegate_OnBlendImage = Util.AlocarPointerDelegate(Pointer_OnBlendImage);

	//Aloca a Handle para cada delegate que fornece o método de chamada do evento na classe CarenD2D1CommandSink4
	gHandle_Delegate_OnSetPrimitiveBlend2 = Util.AlocarPointerDelegate(Pointer_OnSetPrimitiveBlend2);
	...
	//Registra os delegates criados para os delegates nativo na classe CLN_ID2D1CommandSink5 que envia os eventos.
	((CLN_ID2D1CommandSink5*)PonteiroTrabalho)->Evento_BlendImage = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink5_EventoNativo_BlendImage>(Pointer_OnBlendImage);

	//Registra os delegates criados para os delegates nativo na classe CLN_ID2D1CommandSink4 que envia os eventos.
	((CLN_ID2D1CommandSink5*)PonteiroTrabalho)->Evento_SetPrimitiveBlend2 = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink5_EventoNativo_SetPrimitiveBlend2>(Pointer_OnSetPrimitiveBlend2);

	//Registra os delegates criados para os delegates nativo na classe CLN_ID2D1CommandSink3 que envia os eventos.
	((CLN_ID2D1CommandSink5*)PonteiroTrabalho)->Evento_DrawSpriteBatch = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink5_EventoNativo_DrawSpriteBatch>(Pointer_OnDrawSpriteBatch);

	//Registra os delegates criados para os delegates nativo na classe CLN_ID2D1CommandSink2 que envia os eventos.
	((CLN_ID2D1CommandSink5*)PonteiroTrabalho)->Evento_DrawInk = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink5_EventoNativo_DrawInk>(Pointer_OnDrawInk);
	((CLN_ID2D1CommandSink5*)PonteiroTrabalho)->Evento_DrawGdiMetafile1 = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink5_EventoNativo_DrawGdiMetafile1>(Pointer_OnDrawGdiMetafile1);
	((CLN_ID2D1CommandSink5*)PonteiroTrabalho)->Evento_DrawGradientMesh = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink5_EventoNativo_DrawGradientMesh>(Pointer_OnDrawGradientMesh);

	//Registra os delegates criados para os delegates nativo na classe CLN_ID2D1CommandSink1 que envia os eventos.
	((CLN_ID2D1CommandSink5*)PonteiroTrabalho)->Evento_SetPrimitiveBlend1 = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink5_EventoNativo_SetPrimitiveBlend1>(Pointer_OnSetPrimitiveBlend1);

	//Registra os delegates criados para os delegates nativo na classe CLN_ID2D1CommandSink que envia os eventos.
	((CLN_ID2D1CommandSink5*)PonteiroTrabalho)->Evento_BeginDraw = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink5_EventoNativo_BeginDraw>(Pointer_OnBeginDraw);
	((CLN_ID2D1CommandSink5*)PonteiroTrabalho)->Evento_EndDraw = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink5_EventoNativo_EndDraw>(Pointer_OnEndDraw);
	((CLN_ID2D1CommandSink5*)PonteiroTrabalho)->Evento_SetAntialiasMode = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink5_EventoNativo_SetAntialiasMode>(Pointer_OnSetAntialiasMode);
	((CLN_ID2D1CommandSink5*)PonteiroTrabalho)->Evento_SetTags = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink5_EventoNativo_SetTags>(Pointer_OnSetTags);
	((CLN_ID2D1CommandSink5*)PonteiroTrabalho)->Evento_SetTextAntialiasMode = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink5_EventoNativo_SetTextAntialiasMode>(Pointer_OnSetTextAntialiasMode);
	((CLN_ID2D1CommandSink5*)PonteiroTrabalho)->Evento_SetTextRenderingParams = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink5_EventoNativo_SetTextRenderingParams>(Pointer_OnSetTextRenderingParams);
	((CLN_ID2D1CommandSink5*)PonteiroTrabalho)->Evento_SetTransform = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink5_EventoNativo_SetTransform>(Pointer_OnSetTransform);
	((CLN_ID2D1CommandSink5*)PonteiroTrabalho)->Evento_SetPrimitiveBlend = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink5_EventoNativo_SetPrimitiveBlend>(Pointer_OnSetPrimitiveBlend);
	((CLN_ID2D1CommandSink5*)PonteiroTrabalho)->Evento_SetUnitMode = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink5_EventoNativo_SetUnitMode>(Pointer_OnSetUnitMode);
	((CLN_ID2D1CommandSink5*)PonteiroTrabalho)->Evento_Clear = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink5_EventoNativo_Clear>(Pointer_OnClear);
	((CLN_ID2D1CommandSink5*)PonteiroTrabalho)->Evento_DrawGlyphRun = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink5_EventoNativo_DrawGlyphRun>(Pointer_OnDrawGlyphRun);
	((CLN_ID2D1CommandSink5*)PonteiroTrabalho)->Evento_DrawLine = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink5_EventoNativo_DrawLine>(Pointer_OnDrawLine);
	((CLN_ID2D1CommandSink5*)PonteiroTrabalho)->Evento_DrawGeometry = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink5_EventoNativo_DrawGeometry>(Pointer_OnDrawGeometry);
	((CLN_ID2D1CommandSink5*)PonteiroTrabalho)->Evento_DrawRectangle = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink5_EventoNativo_DrawRectangle>(Pointer_OnDrawRectangle);
	((CLN_ID2D1CommandSink5*)PonteiroTrabalho)->Evento_DrawBitmap = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink5_EventoNativo_DrawBitmap>(Pointer_OnDrawBitmap);
	((CLN_ID2D1CommandSink5*)PonteiroTrabalho)->Evento_DrawImage = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink5_EventoNativo_DrawImage>(Pointer_OnDrawImage);
	((CLN_ID2D1CommandSink5*)PonteiroTrabalho)->Evento_DrawGdiMetafile = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink5_EventoNativo_DrawGdiMetafile>(Pointer_OnDrawGdiMetafile);
	((CLN_ID2D1CommandSink5*)PonteiroTrabalho)->Evento_FillMesh = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink5_EventoNativo_FillMesh>(Pointer_OnFillMesh);
	((CLN_ID2D1CommandSink5*)PonteiroTrabalho)->Evento_FillOpacityMask = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink5_EventoNativo_FillOpacityMask>(Pointer_OnFillOpacityMask);
	((CLN_ID2D1CommandSink5*)PonteiroTrabalho)->Evento_FillGeometry = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink5_EventoNativo_FillGeometry>(Pointer_OnFillGeometry);
	((CLN_ID2D1CommandSink5*)PonteiroTrabalho)->Evento_FillRectangle = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink5_EventoNativo_FillRectangle>(Pointer_OnFillRectangle);
	((CLN_ID2D1CommandSink5*)PonteiroTrabalho)->Evento_PushAxisAlignedClip = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink5_EventoNativo_PushAxisAlignedClip>(Pointer_OnPushAxisAlignedClip);
	((CLN_ID2D1CommandSink5*)PonteiroTrabalho)->Evento_PushLayer = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink5_EventoNativo_PushLayer>(Pointer_OnPushLayer);
	((CLN_ID2D1CommandSink5*)PonteiroTrabalho)->Evento_PopAxisAlignedClip = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink5_EventoNativo_PopAxisAlignedClip>(Pointer_OnPopAxisAlignedClip);
	((CLN_ID2D1CommandSink5*)PonteiroTrabalho)->Evento_PopLayer = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink5_EventoNativo_PopLayer>(Pointer_OnPopLayer);
}
...
{
	//Libera o ponteiro para todos os eventos da CarenD2D1CommandSink5
	gHandle_Delegate_OnBlendImage.Free();

	//Libera o ponteiro para todos os eventos da CarenD2D1CommandSink4
	gHandle_Delegate_OnSetPrimitiveBlend2.Free();
	...
	CLN_ID2D1CommandSink5* pVarPointer = (CLN_ID2D1CommandSink5*)PonteiroTrabalho;


	//Libera os ponteiros da CarenD2D1CommandSink4

	if (ObjetoValido(pVarPointer->Evento_BlendImage))
	{
		//Descarta o delegate.
		pVarPointer->Evento_BlendImage = NULL;
	}


	//Libera os ponteiros da CarenD2D1CommandSink4

	if (ObjetoValido(pVarPointer->Evento_SetPrimitiveBlend2))
	{
		//Descarta o delegate.
		pVarPointer->Evento_SetPrimitiveBlend2 = NULL;
	}
...
// Métodos internos que são chamados pela classe nativa para notificar os eventos ocorridos para classe CarenD2D1CommandSink5

/// <summary>
/// Método responsável por encaminhar o (Evento) nativo (OnBlendImage) da classe (ID2D1CommandSink5) para o usuário em classe gerenciada.
/// </summary>
void CarenD2D1CommandSink5::EncaminharEvento_OnBlendImage(
	...
	D2D1_INTERPOLATION_MODE interpolationMode)
{
	//Variaveis
	Utilidades Util;
	ICarenD2D1Image^ D2dImage = nullptr;
	CA_D2D1_BLEND_MODE BlendMode = static_cast<CA_D2D1_BLEND_MODE>(blendMode);
	CA_D2D1_POINT_2F^ PointTargetOffset = nullptr;
	CA_D2D1_RECT_F^ RectImageRectangle = nullptr;
	CA_D2D1_INTERPOLATION_MODE InterpoMode = static_cast<CA_D2D1_INTERPOLATION_MODE>(interpolationMode);

	//Cria a interface gerenciada.
	D2dImage = gcnew CarenD2D1Image();

	//Define o ponteiro na interface.
	D2dImage->AdicionarPonteiro(image);

	//Converte as estruturas se validas
	PointTargetOffset = ObjetoValido(targetOffset) ? Util.ConverterD2D1_POINT_2FUnmanagedToManaged(const_cast<D2D1_POINT_2F*>(targetOffset)) : nullptr;
	RectImageRectangle = ObjetoValido(imageRectangle) ? Util.ConverterD2D1_RECT_FUnmanagedToManaged(const_cast<D2D1_RECT_F*>(imageRectangle)) : nullptr;

	//Chama o evento
	OnBlendImage(D2dImage, BlendMode, PointTargetOffset, RectImageRectangle, InterpoMode);
}


// Métodos internos que são chamados pela classe nativa para notificar os eventos ocorridos para classe CarenD2D1CommandSink4

/// <summary>
/// Método responsável por encaminhar o (Evento) nativo (OnSetPrimitiveBlend2) da classe (ID2D1CommandSink4) para o usuário em classe gerenciada.
/// </summary>
void CarenD2D1CommandSink5::EncaminharEvento_OnSetPrimitiveBlend2(D2D1_PRIMITIVE_BLEND primitiveBlend)
{
	//Chama o evento.
	OnSetPrimitiveBlend2(static_cast<CA_D2D1_PRIMITIVE_BLEND>(primitiveBlend));
}
...
/// </summary>
void CarenD2D1CommandSink5::EncaminharEvento_OnDrawSpriteBatch(
...
/// </summary>
void CarenD2D1CommandSink5::EncaminharEvento_OnDrawGdiMetafile1(
...
/// </summary>
void CarenD2D1CommandSink5::EncaminharEvento_OnDrawGradientMesh(_In_ ID2D1GradientMesh* gradientMesh)
{
	//Variaveis
...
/// </summary>
void CarenD2D1CommandSink5::EncaminharEvento_OnDrawInk(
	_In_ ID2D1Ink* ink,
...
/// </summary>
void CarenD2D1CommandSink5::EncaminharEvento_OnSetPrimitiveBlend1(D2D1_PRIMITIVE_BLEND primitiveBlend)
{
	//Chama o evento.
...
/// </summary>
void CarenD2D1CommandSink5::EncaminharEvento_OnBeginDraw()
{
...
/// </summary>
void CarenD2D1CommandSink5::EncaminharEvento_OnClear(_In_opt_ CONST D2D1_COLOR_F* color)
{
...
/// </summary>
void CarenD2D1CommandSink5::EncaminharEvento_OnDrawBitmap(
	_In_ ID2D1Bitmap* bitmap,
	_In_opt_ CONST D2D1_RECT_F* destinationRectangle,
	FLOAT opacity,
	D2D1_INTERPOLATION_MODE interpolationMode,
...
/// </summary>
void CarenD2D1CommandSink5::EncaminharEvento_OnDrawGdiMetafile(
	_In_ ID2D1GdiMetafile* gdiMetafile,
	_In_opt_ CONST D2D1_POINT_2F* targetOffset)
{
	//Variaveis
...
/// </summary>
void CarenD2D1CommandSink5::EncaminharEvento_OnDrawGeometry(
...
/// </summary>
void CarenD2D1CommandSink5::EncaminharEvento_OnDrawGlyphRun(
...
/// </summary>
void CarenD2D1CommandSink5::EncaminharEvento_OnDrawImage(
	_In_ ID2D1Image* image,
	_In_opt_ CONST D2D1_POINT_2F* targetOffset,
	_In_opt_ CONST D2D1_RECT_F* imageRectangle,
	D2D1_INTERPOLATION_MODE interpolationMode,
...
/// </summary>
void CarenD2D1CommandSink5::EncaminharEvento_OnDrawLine(
...
/// </summary>
void CarenD2D1CommandSink5::EncaminharEvento_OnDrawRectangle(
...
/// </summary>
void CarenD2D1CommandSink5::EncaminharEvento_OnEndDraw()
{
	//Chama o evento.
	OnEndDraw();
}
...
/// </summary>
void CarenD2D1CommandSink5::EncaminharEvento_OnFillGeometry(
	_In_ ID2D1Geometry* geometry,
	_In_ ID2D1Brush* brush,
...
/// </summary>
void CarenD2D1CommandSink5::EncaminharEvento_OnFillMesh(
	_In_ ID2D1Mesh* mesh,
	_In_ ID2D1Brush* brush)
{
	//Variaveis
...
/// </summary>
void CarenD2D1CommandSink5::EncaminharEvento_OnFillOpacityMask(
...
/// </summary>
void CarenD2D1CommandSink5::EncaminharEvento_OnFillRectangle(
	_In_ CONST D2D1_RECT_F* rect,
	_In_ ID2D1Brush* brush)
{
	//Variaveis
...
/// </summary>
void CarenD2D1CommandSink5::EncaminharEvento_OnPopAxisAlignedClip()
{
	//Chama o evento.
...
/// </summary>
void CarenD2D1CommandSink5::EncaminharEvento_OnPopLayer()
{
	//Chama o evento.
	OnPopLayer();
}
...
/// </summary>
void CarenD2D1CommandSink5::EncaminharEvento_OnPushAxisAlignedClip(
...
/// </summary>
void CarenD2D1CommandSink5::EncaminharEvento_OnPushLayer(
...
/// </summary>
void CarenD2D1CommandSink5::EncaminharEvento_OnSetAntialiasMode(D2D1_ANTIALIAS_MODE antialiasMode)
{
	//Chama o evento.
...
/// </summary>
void CarenD2D1CommandSink5::EncaminharEvento_OnSetPrimitiveBlend(D2D1_PRIMITIVE_BLEND primitiveBlend)
{
	//Chama o evento.
...
/// </summary>
void CarenD2D1CommandSink5::EncaminharEvento_OnSetTags(
	D2D1_TAG tag1,
	D2D1_TAG tag2)
{
	//Chama o evento.
...
/// </summary>
void CarenD2D1CommandSink5::EncaminharEvento_OnSetTextAntialiasMode(D2D1_TEXT_ANTIALIAS_MODE textAntialiasMode)
{
	//Chama o evento.
...
/// </summary>
void CarenD2D1CommandSink5::EncaminharEvento_OnSetTextRenderingParams(_In_opt_ IDWriteRenderingParams* textRenderingParams)
{
	//Variaveis
...
/// </summary>
void CarenD2D1CommandSink5::EncaminharEvento_OnSetTransform(_In_ CONST D2D1_MATRIX_3X2_F* transform)
{
	//Variaveis
	Utilidades Util;
...
/// </summary>
void CarenD2D1CommandSink5::EncaminharEvento_OnSetUnitMode(D2D1_UNIT_MODE unitMode)
{
	//Chama o evento.
