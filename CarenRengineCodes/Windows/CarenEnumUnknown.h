...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por enumerar objetos com a interface IUnknown. Pode ser usado para enumerar através dos objetos em um componente contendo 
/// vários objetos.
/// </summary>
public ref class CarenEnumUnknown : public ICarenEnumUnknown
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IEnumUnknown).
	IEnumUnknown* PonteiroTrabalho = NULL;
...
public:
	static operator CarenEnumUnknown^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenEnumUnknown^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenEnumUnknown();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IEnumUnknown*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenEnumUnknown::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenEnumUnknown)
public:
	/// <summary>
	...
	virtual CarenResult Clone([Out] ICarenEnumUnknown^% Param_Out_EnumClone);
	...
	virtual CarenResult Skip(UInt32 Param_QuantidadeSkip);
};