...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por expor métodos usados para criar componentes para o WIC, como decodificadores, codificadores e conversores de formato de pixel. 
/// </summary>
public ref class CarenWICImagingFactory : public ICarenWICImagingFactory
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IWICImagingFactory).
	IWICImagingFactory* PonteiroTrabalho = NULL;
...
public:
	...
	/// </summary>
	CarenWICImagingFactory();

	/// <summary>
	/// Inicializa a classe e cria um ponteiro para a interface nativa (IWICImagingFactory). Permite especificar o contexto que vai gerencia a interface.
	/// </summary>
	...
	CarenWICImagingFactory(CA_CLSCTX Param_Context);
...
public:
	static operator CarenWICImagingFactory^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenWICImagingFactory^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenWICImagingFactory();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IWICImagingFactory*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenWICImagingFactory::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
