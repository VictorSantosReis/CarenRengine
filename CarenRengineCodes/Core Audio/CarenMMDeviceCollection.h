...
/// <summary>
/// (Concluido - Fase de testes) - Classe responsável por manter uma coleção de dispositivos de Áudio.
/// </summary>
public ref class CarenMMDeviceCollection :public ICarenMMDeviceCollection
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IMMDeviceCollection).
	IMMDeviceCollection* PonteiroTrabalho = NULL;
...
public:
	static operator CarenMMDeviceCollection^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMMDeviceCollection^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMMDeviceCollection();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMMDeviceCollection*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMMDeviceCollection::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
...
public:
	...
	virtual CarenResult Item(UInt32 Param_IdDispositivo, [Out] ICarenMMDevice^% Param_Out_Dispositivo);
};
