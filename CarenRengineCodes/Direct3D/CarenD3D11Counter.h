...
/// <summary>
/// (Concluido - Fase de Teste) - Classe responsável por encapsular métodos medem o desempenho da GPU.
/// </summary>
public ref class CarenD3D11Counter : public ICarenD3D11Counter
{
	/////////////////////////////////////////
...
public:
	static operator CarenD3D11Counter^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD3D11Counter^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD3D11Counter();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID3D11Counter*>(Param_Pointer.ToPointer());
...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD3D11Counter">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD3D11Counter^% Param_Out_CarenD3D11Counter)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenD3D11Counter = gcnew CarenD3D11Counter();
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD3D11Counter::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
...
public:
	...
	virtual CarenResult GetDesc([Out] Estruturas::CA_D3D11_DESC_CONTADOR^% Param_Out_DescContador);
