...
{
	//Fixa o ponteiro.
	cli::pin_ptr<ID3D11Device1*> p = &PonteiroTrabalho;

	//Chama o método de ADICIONAR PONTEIRO na classe base(Caren).
	return Caren::Shared_AdicionarPonteiro(Param_PonteiroNativo, reinterpret_cast<IUnknown**>(static_cast<ID3D11Device1**>(p)));
}
...
CarenResult CarenD3D11Device1::CreateBlendState1(
...
CarenResult CarenD3D11Device1::CreateDeferredContext1(
...
CarenResult CarenD3D11Device1::CreatePredicate(
...
CarenResult CarenD3D11Device1::GetCreationFlags([Out] Enumeracoes::CA_D3D11_CREATE_DEVICE_FLAG% Param_Out_Flags)
{
	//Chama o método na classe de funções compartilhadas do D3D11.
...
CarenResult CarenD3D11Device1::GetFeatureLevel([Out] Enumeracoes::CA_D3D_FEATURE_LEVEL% Param_Out_NivelRecurso)
{
	//Chama o método na classe de funções compartilhadas do D3D11.
