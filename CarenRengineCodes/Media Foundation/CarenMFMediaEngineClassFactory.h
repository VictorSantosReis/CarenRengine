...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por criar uma instância do Media Engine.
/// </summary>
public ref class CarenMFMediaEngineClassFactory : public ICarenMFMediaEngineClassFactory
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IMFMediaEngineClassFactory).
	IMFMediaEngineClassFactory* PonteiroTrabalho = NULL;
...
public:
	...
	/// </summary>
	CarenMFMediaEngineClassFactory();
...
public:
	static operator CarenMFMediaEngineClassFactory^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFMediaEngineClassFactory^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFMediaEngineClassFactory();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFMediaEngineClassFactory*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFMediaEngineClassFactory::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
