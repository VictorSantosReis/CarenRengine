...
CarenResult CarenMFContentProtectionManager::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IMFContentProtectionManager*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenMFContentProtectionManager::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IMFContentProtectionManager*>(Param_PonteiroNativo);
...
/// </summary>
void CarenMFContentProtectionManager::LimparDados()
{
