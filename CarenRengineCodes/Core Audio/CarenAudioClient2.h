...
/// <summary>
/// (Concluido - Fase de Testes) - Classe derivada da interface ICarenAudioClient, com um conjunto de métodos adicionais que permitem que um cliente de áudio da Windows Audio Session API (WASAPI)
...
/// </summary>
public ref class CarenAudioClient2 : public ICarenAudioClient2
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IAudioClient2).
	IAudioClient2* PonteiroTrabalho = NULL;
...
public:
	static operator CarenAudioClient2^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenAudioClient2^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenAudioClient2();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IAudioClient2*>(Param_Pointer.ToPointer());
	...
	generic <typename TypeClass, typename TypeInterface>
		virtual TypeInterface As(cli::array<Object^>^ Param_Args)
		{
			...
			catch (const std::exception&)
			{
				...
				System::Console::WriteLine(String::Concat(ICarenAudioClient2::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
