...
CarenResult CarenD3D11DeviceContext4::Signal(
	ICarenD3D11Fence^ Param_Fence, 
	UInt64 Param_Valor)
{
	//Chama o método na classe de funções compartilhadas do D3D11.
	return Shared_Direct3D11DeviceContext::Signal(PonteiroTrabalho, 
		Param_Fence, 
		Param_Valor);
}
...
CarenResult CarenD3D11DeviceContext4::Wait(
	ICarenD3D11Fence^ Param_Fence, 
	UInt64 Param_Valor)
{
	//Chama o método na classe de funções compartilhadas do D3D11.
	return Shared_Direct3D11DeviceContext::Wait(PonteiroTrabalho, 
		Param_Fence, 
		Param_Valor);
}
...
CarenResult CarenD3D11DeviceContext4::Flush1(
...
CarenResult CarenD3D11DeviceContext4::DiscardView1(
...
CarenResult CarenD3D11DeviceContext4::GetResourceMinLOD(
