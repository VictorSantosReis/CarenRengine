...
public:
	static operator CarenWICPlanarBitmapSourceTransform^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenWICPlanarBitmapSourceTransform^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenWICPlanarBitmapSourceTransform();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IWICPlanarBitmapSourceTransform*>(Param_Pointer.ToPointer());
