...
/// </summary>
public ref class CarenD2D1CommandList : public ICarenD2D1CommandList
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID2D1CommandList).
...
public:
	static operator CarenD2D1CommandList^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1CommandList^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1CommandList();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1CommandList*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD2D1CommandList::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenD2D1CommandList)
public:
	/// <summary>
	...
	virtual CarenResult Stream(ICarenD2D1CommandSink^ Param_Sink);
