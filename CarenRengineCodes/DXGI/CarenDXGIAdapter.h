...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por representar um subsistema de exibição (incluindo um ou mais GPUs, DACs e memória de vídeo).
/// </summary>
public ref class CarenDXGIAdapter : public ICarenDXGIAdapter
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IDXGIAdapter).
	IDXGIAdapter* PonteiroTrabalho = NULL;
...
public:
	static operator CarenDXGIAdapter^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenDXGIAdapter^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenDXGIAdapter();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IDXGIAdapter*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenDXGIAdapter::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
