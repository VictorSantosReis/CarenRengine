...
/// a CarenDXGIOutput2 para verificar se há suporte a sobreposição.
/// </summary>
public ref class CarenDXGIOutput3 : public ICarenDXGIOutput3
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IDXGIOutput3 ).
	IDXGIOutput3* PonteiroTrabalho = NULL;
...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenDXGIOutput3">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenDXGIOutput3^% Param_Out_CarenDXGIOutput3)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenDXGIOutput3 = gcnew CarenDXGIOutput3();
