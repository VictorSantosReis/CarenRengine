...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por controlar o nível de volume de áudio em diferentes canais de audio no SAR(Streaming Audio Render).
/// </summary>
public ref class CarenMFAudioStreamVolume :public ICarenMFAudioStreamVolume
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IMFAudioStreamVolume).
...
public:
	static operator CarenMFAudioStreamVolume^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFAudioStreamVolume^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFAudioStreamVolume();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFAudioStreamVolume*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFAudioStreamVolume::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
