...
public:
	static operator CarenD3D11ClassLinkage^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD3D11ClassLinkage^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD3D11ClassLinkage();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID3D11ClassLinkage*>(Param_Pointer.ToPointer());
