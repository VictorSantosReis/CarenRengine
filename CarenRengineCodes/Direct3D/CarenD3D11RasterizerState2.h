...
/// </summary>
public ref class CarenD3D11RasterizerState2 : public ICarenD3D11RasterizerState2
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID3D11RasterizerState2).
	ID3D11RasterizerState2* PonteiroTrabalho = NULL;
...
public:
	static operator CarenD3D11RasterizerState2^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD3D11RasterizerState2^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD3D11RasterizerState2();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID3D11RasterizerState2*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD3D11RasterizerState2::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
...
public:
	...
	/// </summary>
	/// <param name="Param_Out_DescRasterizador">Retorna uma estrutura que contém a descrição do rasterizador de estado.</param>
	virtual CarenResult GetDesc1([Out] Estruturas::CA_D3D11_RASTERIZER_DESC1^% Param_Out_DescRasterizador);
