...
//Destruidor.
CarenD2D1RoundedRectangleGeometry::~CarenD2D1RoundedRectangleGeometry()
{
...
CarenResult CarenD2D1RoundedRectangleGeometry::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD2D1RoundedRectangleGeometry::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1RoundedRectangleGeometry*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1RoundedRectangleGeometry::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1RoundedRectangleGeometry*>(Param_PonteiroNativo);
...
CarenResult CarenD2D1RoundedRectangleGeometry::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1RoundedRectangleGeometry::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1RoundedRectangleGeometry::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenD2D1RoundedRectangleGeometry::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD2D1RoundedRectangleGeometry::ObterCodigoErro()
{
...
/// </summary>
void CarenD2D1RoundedRectangleGeometry::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD2D1RoundedRectangleGeometry::LiberarReferencia()
{
...
/// </summary>
void CarenD2D1RoundedRectangleGeometry::LimparDados()
{
...
/// </summary>
void CarenD2D1RoundedRectangleGeometry::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenD2D1RoundedRectangleGeometry();
}



// Métodos da interface proprietária(ICarenD2D1RoundedRectangleGeometry)
...
void CarenD2D1RoundedRectangleGeometry::GetRoundedRect([Out] CA_D2D1_ROUNDED_RECT^% Param_Out_RoundedRect)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
	D2D1_ROUNDED_RECT OutRoundedRect = { };

	//Chama o método para realizar a operação.
	PonteiroTrabalho->GetRoundedRect(&OutRoundedRect);

	//Converte a estrutura nativa e define no parametro de saida.
	Param_Out_RoundedRect = Util.ConverterD2D1_ROUNDED_RECTUnmanagedToManaged(&OutRoundedRect);
}
...
CarenResult CarenD2D1RoundedRectangleGeometry::CombineWithGeometry(
...
CarenResult CarenD2D1RoundedRectangleGeometry::CompareWithGeometry(
	ICarenD2D1Geometry^ Param_GeometriaEntrada,
	CA_D2D1_MATRIX_3X2_F^ Param_InputGeometryTransform,
	float Param_FlatteningTolerance,
...
CarenResult CarenD2D1RoundedRectangleGeometry::ComputeArea(
...
CarenResult CarenD2D1RoundedRectangleGeometry::ComputeLength(
	CA_D2D1_MATRIX_3X2_F^ Param_WorldTransform,
	float Param_FlatteningTolerance,
...
CarenResult CarenD2D1RoundedRectangleGeometry::ComputePointAtLength(
	float Param_Length,
	CA_D2D1_MATRIX_3X2_F^ Param_WorldTransform,
	float Param_FlatteningTolerance,
...
CarenResult CarenD2D1RoundedRectangleGeometry::FillContainsPoint(
...
CarenResult CarenD2D1RoundedRectangleGeometry::GetBounds(
	CA_D2D1_MATRIX_3X2_F^ Param_WorldTransform,
...
CarenResult CarenD2D1RoundedRectangleGeometry::GetWidenedBounds(
...
CarenResult CarenD2D1RoundedRectangleGeometry::Outline(
	CA_D2D1_MATRIX_3X2_F^ Param_WorldTransform,
	float Param_FlatteningTolerance,
...
CarenResult CarenD2D1RoundedRectangleGeometry::Simplify(
...
CarenResult CarenD2D1RoundedRectangleGeometry::StrokeContainsPoint(
	CA_D2D1_POINT_2F^ Param_Point,
	float Param_StrokeWidth,
	ICarenD2D1StrokeStyle^ Param_StrokeStyle,
	CA_D2D1_MATRIX_3X2_F^ Param_WorldTransform,
...
CarenResult CarenD2D1RoundedRectangleGeometry::Tessellate(
	CA_D2D1_MATRIX_3X2_F^ Param_WorldTransform,
	float Param_FlatteningTolerance,
...
CarenResult CarenD2D1RoundedRectangleGeometry::Widen(
	float Param_StrokeWidth,
	ICarenD2D1StrokeStyle^ Param_StrokeStyle,
	CA_D2D1_MATRIX_3X2_F^ Param_WorldTransform,
	float Param_FlatteningTolerance,
...
void CarenD2D1RoundedRectangleGeometry::GetFactory(ICaren^ Param_Out_Factory)
{
	//Variaveis a serem utilizadas.
