...
CarenResult CarenWICDevelopRawNotificationCallback::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IWICDevelopRawNotificationCallback*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenWICDevelopRawNotificationCallback::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IWICDevelopRawNotificationCallback*>(Param_PonteiroNativo);
...
/// </summary>
void CarenWICDevelopRawNotificationCallback::LimparDados()
{
