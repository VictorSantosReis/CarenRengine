...
//Destruidor.
CarenDXGIOutput6::~CarenDXGIOutput6()
{
...
CarenResult CarenDXGIOutput6::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
	...
	Hr = (reinterpret_cast<IDXGIOutput6*>(PonteiroTrabalho))->QueryInterface(GuidInterface, (LPVOID*)&pInterfaceSolcitada);
...
CarenResult CarenDXGIOutput6::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<IDXGIOutput6*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenDXGIOutput6::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IDXGIOutput6*>(Param_PonteiroNativo);
...
CarenResult CarenDXGIOutput6::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenDXGIOutput6::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenDXGIOutput6::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenDXGIOutput6::StatusPonteiro()
{
...
/// </summary>
Int32 CarenDXGIOutput6::ObterCodigoErro()
{
...
/// </summary>
void CarenDXGIOutput6::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
	(reinterpret_cast<IDXGIOutput6*>(PonteiroTrabalho))->AddRef();
}

/// <summary>
/// (Release) - 'Decrementa' a contagem de referência do objeto COM atual.
/// </summary>
void CarenDXGIOutput6::LiberarReferencia()
{
	//Libera a referência e obtém a quantidade atual.
	ULONG RefCount = (reinterpret_cast<IDXGIOutput6*>(PonteiroTrabalho))->Release();
...
/// </summary>
void CarenDXGIOutput6::LimparDados()
{
...
/// </summary>
void CarenDXGIOutput6::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
...
CarenResult CarenDXGIOutput6::ObterDescricao1([Out] CA_DXGI_OUTPUT_DESC1^% Param_Out_Desc)
{
	...
	//Chama o método para realizar a operação.
	Hr = PonteiroTrabalho->GetDesc1(&OutDesc);
