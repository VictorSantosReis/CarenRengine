...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por representar um recurso de geometria e define um conjunto de métodos auxiliares para manipular e medir formas geométricas.
/// </summary>
public ref class CarenD2D1Geometry : public ICarenD2D1Geometry
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID2D1Geometry).
	ID2D1Geometry* PonteiroTrabalho = NULL;
...
public:
	static operator CarenD2D1Geometry^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1Geometry^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1Geometry();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1Geometry*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD2D1Geometry::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
