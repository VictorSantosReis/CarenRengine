...
/// Esta interface executa todas as mesmas funções da interface ICarenD2D1Device2. 
/// </summary>
public ref class CarenD2D1Device3 : public ICarenD2D1Device3
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID2D1Device3).
	ID2D1Device3* PonteiroTrabalho = NULL;
...
public:
	static operator CarenD2D1Device3^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1Device3^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1Device3();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1Device3*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD2D1Device3::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
