...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por representar um contexto de dispositivo; é usado para realizar comandos de renderização.
/// </summary>
public ref class CarenD3D11DeviceContext : public ICarenD3D11DeviceContext
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID3D11DeviceContext).
	ID3D11DeviceContext* PonteiroTrabalho = NULL;


	//Contrutor e destruidor da classe.
public:
	~CarenD3D11DeviceContext();
...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD3D11DeviceContext">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD3D11DeviceContext^% Param_Out_CarenD3D11DeviceContext)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenD3D11DeviceContext = gcnew CarenD3D11DeviceContext();
