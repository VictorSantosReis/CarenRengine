...
CarenResult CarenD3D11DomainShader::GetDevice(ICaren^ Param_Out_DispositivoD3D11)
{
...
CarenResult CarenD3D11DomainShader::GetPrivateData(
	String^ Param_Guid,
...
CarenResult CarenD3D11DomainShader::SetPrivateData(
	String^ Param_Guid,
...
CarenResult CarenD3D11DomainShader::SetPrivateDataInterface(
