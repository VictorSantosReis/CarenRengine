...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por expor métodos que transformam um ICarenWICBitmapSource de um contexto de cores para outro.
/// </summary>
public ref class CarenWICColorTransform : public ICarenWICColorTransform
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IWICColorTransform).
	IWICColorTransform* PonteiroTrabalho = NULL;
...
public:
	static operator CarenWICColorTransform^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenWICColorTransform^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenWICColorTransform();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IWICColorTransform*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenWICColorTransform::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenWICColorTransform)
public:
	/// <summary>
