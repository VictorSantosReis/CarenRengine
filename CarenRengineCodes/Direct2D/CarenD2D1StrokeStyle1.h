...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD2D1StrokeStyle1">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD2D1StrokeStyle1^% Param_Out_CarenD2D1StrokeStyle1)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);

		//Cria a interface
		Param_Out_CarenD2D1StrokeStyle1 = gcnew CarenD2D1StrokeStyle1();
