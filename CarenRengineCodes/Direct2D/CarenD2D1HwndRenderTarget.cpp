...
//Destruidor.
CarenD2D1HwndRenderTarget::~CarenD2D1HwndRenderTarget()
{
...
CarenResult CarenD2D1HwndRenderTarget::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD2D1HwndRenderTarget::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1HwndRenderTarget*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1HwndRenderTarget::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1HwndRenderTarget*>(Param_PonteiroNativo);
...
CarenResult CarenD2D1HwndRenderTarget::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1HwndRenderTarget::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1HwndRenderTarget::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenD2D1HwndRenderTarget::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD2D1HwndRenderTarget::ObterCodigoErro()
{
...
/// </summary>
void CarenD2D1HwndRenderTarget::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD2D1HwndRenderTarget::LiberarReferencia()
{
...
/// </summary>
void CarenD2D1HwndRenderTarget::LimparDados()
{
...
/// </summary>
void CarenD2D1HwndRenderTarget::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenD2D1HwndRenderTarget();
}



// Métodos da interface proprietária(ICarenD2D1HwndRenderTarget)
...
void CarenD2D1HwndRenderTarget::CheckWindowState([Out] CA_D2D1_WINDOW_STATE% Param_Out_WindowState)
{
	//Variaveis a serem utilizadas.
	D2D1_WINDOW_STATE OutWinState;

	//Chama o método para realizar a operação.
	OutWinState = PonteiroTrabalho->CheckWindowState();

	//Converte e define no parametro de saida.
	Param_Out_WindowState = static_cast<CA_D2D1_WINDOW_STATE>(OutWinState);
}
...
void CarenD2D1HwndRenderTarget::GetHwnd([Out] IntPtr% Param_Out_Hwnd)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
	HWND pHandle = NULL;
	...
	//Chama o método para realizar a operação.
	pHandle = PonteiroTrabalho->GetHwnd();
...
CarenResult CarenD2D1HwndRenderTarget::Resize(CA_D2D1_SIZE_U^ Param_PixelSize)
{
	...
	//Variaveis a serem utilizadas.
	Utilidades Util;
	D2D1_SIZE_U* pSizePixel = NULL;

	//Converte a estrutura
	pSizePixel = Util.ConverterD2D1_SIZE_UManagedToUnmanaged(Param_PixelSize);

	//Chama o método para realizar a operação.
	Hr = PonteiroTrabalho->Resize(pSizePixel);
...
Done:;
	...
	DeletarEstruturaSafe(&pSizePixel);
...
/// </summary>
void CarenD2D1HwndRenderTarget::BeginDraw()
{
	//Chama o método para realizar a operação.
...
void CarenD2D1HwndRenderTarget::Clear(CA_D2D1_COLOR_F^ Param_ClearColor)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
CarenResult CarenD2D1HwndRenderTarget::CreateBitmap(
...
CarenResult CarenD2D1HwndRenderTarget::CreateBitmapBrush(
...
/// <param name="Param_Out_Bitmap">Retorna a interface ICarenD2D1Bitmap que contém um ponteiro para o novo bitmap.</param>
CarenResult CarenD2D1HwndRenderTarget::CreateBitmapFromWicBitmap(
...
CarenResult CarenD2D1HwndRenderTarget::CreateCompatibleRenderTarget(
...
/// </summary>
/// <param name="Param_Out_BitmapRenderTarget">Retorna a interface (ICarenD2D1BitmapRenderTarget) que contém um ponteiro para um novo alvo de renderização bitmap. O usuário deve inicializar a interface antes de chamar este método.</param>
CarenResult CarenD2D1HwndRenderTarget::CreateCompatibleRenderTarget(ICaren^ Param_Out_BitmapRenderTarget)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1HwndRenderTarget::CreateGradientStopCollection(
...
CarenResult CarenD2D1HwndRenderTarget::CreateLayer(
...
/// </summary>
/// <param name="Param_Out_Layer">Retorna a interface ICarenD2D1Layer que contém um ponteiro para a nova camada(Layer).</param>
CarenResult CarenD2D1HwndRenderTarget::CreateLayer([Out] ICarenD2D1Layer^% Param_Out_Layer)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1HwndRenderTarget::CreateLinearGradientBrush(
...
CarenResult CarenD2D1HwndRenderTarget::CreateMesh([Out] ICarenD2D1Mesh^% Param_Out_Mesh)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1HwndRenderTarget::CreateRadialGradientBrush(
...
CarenResult CarenD2D1HwndRenderTarget::CreateSharedBitmap(
	String^ Param_Riid,
...
CarenResult CarenD2D1HwndRenderTarget::CreateSolidColorBrush(
...
CarenResult CarenD2D1HwndRenderTarget::DrawBitmap(
	ICarenD2D1Bitmap^ Param_Bitmap,
...
CarenResult CarenD2D1HwndRenderTarget::DrawEllipse(
...
CarenResult CarenD2D1HwndRenderTarget::DrawGeometry(
...
CarenResult CarenD2D1HwndRenderTarget::DrawGlyphRun(
...
CarenResult CarenD2D1HwndRenderTarget::DrawLine(
...
CarenResult CarenD2D1HwndRenderTarget::DrawRectangle(
...
CarenResult CarenD2D1HwndRenderTarget::DrawRoundedRectangle(
...
/// <param name="Param_MeasuringMode">Um valor que indica como as métricas do glifo(Glyph) são usadas para medir o texto quando ele é formatado. O valor padrão é DWRITE_MEASURING_MODE_NATURAL.</param>
CarenResult CarenD2D1HwndRenderTarget::DrawText(
	String^ Param_Texto,
...
/// <param name="Param_Opcoes">Um valor que indica se o texto deve ser encaixado nos limites do pixel e se o texto deve ser cortado no retângulo de layout. O valor padrão é D2D1_DRAW_TEXT_OPTIONS_NONE, 
/// o que indica que o texto deve ser encaixado nos limites do pixel e não deve ser cortado para o retângulo de layout.</param>
CarenResult CarenD2D1HwndRenderTarget::DrawTextLayout(
...
CarenResult CarenD2D1HwndRenderTarget::EndDraw(
...
CarenResult CarenD2D1HwndRenderTarget::FillEllipse(
	CA_D2D1_ELLIPSE^ Param_Ellipse,
	ICarenD2D1Brush^ Param_Brush)
{
	//Variavel a ser retornada.
...
CarenResult CarenD2D1HwndRenderTarget::FillGeometry(
	ICarenD2D1Geometry^ Param_Geometria,
	ICarenD2D1Brush^ Param_Brush,
...
CarenResult CarenD2D1HwndRenderTarget::FillMesh(
...
CarenResult CarenD2D1HwndRenderTarget::FillOpacityMask(
...
CarenResult CarenD2D1HwndRenderTarget::FillRectangle(
	CA_D2D1_RECT_F^ Param_Rect,
	ICarenD2D1Brush^ Param_Brush)
{
	//Variavel a ser retornada.
...
CarenResult CarenD2D1HwndRenderTarget::FillRoundedRectangle(
...
/// <param name="Param_Out_Tag1">Quando este método retorna, contém a tag para operações de desenho que causaram erros ou 0 se não houver erros.</param>
/// <param name="Param_Out_Tag2">Quando este método retorna, contém a tag para operações de desenho que causaram erros ou 0 se não houver erros.</param>
CarenResult CarenD2D1HwndRenderTarget::Flush(
	[Out] UInt64% Param_Out_Tag1,
	[Out] UInt64% Param_Out_Tag2)
{
	//Variavel a ser retornada.
...
void CarenD2D1HwndRenderTarget::GetAntialiasMode([Out] CA_D2D1_ANTIALIAS_MODE% Param_Out_AntialiasMode)
{
	//Variaveis a serem utilizadas.
...
void CarenD2D1HwndRenderTarget::GetDpi(
...
void CarenD2D1HwndRenderTarget::GetMaximumBitmapSize([Out] UInt32% Param_Out_MaximumSize)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1HwndRenderTarget::GetPixelFormat([Out] CA_D2D1_PIXEL_FORMAT^% Param_Out_PixelFormat)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void CarenD2D1HwndRenderTarget::GetPixelSize([Out] CA_D2D1_SIZE_U^% Param_Out_PixelSize)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void CarenD2D1HwndRenderTarget::GetSize([Out] CA_D2D1_SIZE_F^% Param_Out_Size)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void CarenD2D1HwndRenderTarget::GetTags(
	[Out] UInt64% Param_Out_Tag1,
	[Out] UInt64% Param_Out_Tag2)
{
	//Variaveis a serem utilizadas.
...
void CarenD2D1HwndRenderTarget::GetTextAntialiasMode([Out] CA_D2D1_TEXT_ANTIALIAS_MODE% Param_Out_TextAntialiasMode)
{
	//Variaveis a serem utilizadas.
...
void CarenD2D1HwndRenderTarget::GetTextRenderingParams(ICaren^ Param_Out_TextRenderingParams)
{
	//Variaveis a serem utilizadas.
...
void CarenD2D1HwndRenderTarget::GetTransform([Out] CA_D2D1_MATRIX_3X2_F^% Param_Out_Transform)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void CarenD2D1HwndRenderTarget::IsSupported(
...
/// ou ICarenD2D1RenderTarget::Flush.
/// </summary>
void CarenD2D1HwndRenderTarget::PopAxisAlignedClip()
{
	//Chama o método para realizar a operação.
...
/// ou ICarenD2D1RenderTarget::Flush.
/// </summary>
void CarenD2D1HwndRenderTarget::PopLayer()
{
	//Chama o método para realizar a operação.
...
void CarenD2D1HwndRenderTarget::PushAxisAlignedClip(
...
void CarenD2D1HwndRenderTarget::PushLayer(
...
CarenResult CarenD2D1HwndRenderTarget::RestoreDrawingState(ICarenD2D1DrawingStateBlock^ Param_DrawingStateBlock)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1HwndRenderTarget::SaveDrawingState(ICarenD2D1DrawingStateBlock^ Param_DrawingStateBlock)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
void CarenD2D1HwndRenderTarget::SetAntialiasMode(CA_D2D1_ANTIALIAS_MODE Param_AntialiasMode)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1HwndRenderTarget::SetDpi(
	float Param_DpiX,
	float Param_DpiY)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1HwndRenderTarget::SetTags(
	UInt64 Param_Tag1,
	UInt64 Param_Tag2)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1HwndRenderTarget::SetTextAntialiasMode(CA_D2D1_TEXT_ANTIALIAS_MODE Param_TextAntialiasMode)
{
	//Chama o método para realizar a operação.
...
CarenResult CarenD2D1HwndRenderTarget::SetTextRenderingParams(ICaren^ Param_TextRenderingParams)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
void CarenD2D1HwndRenderTarget::SetTransform(CA_D2D1_MATRIX_3X2_F^ Param_Transform)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void  CarenD2D1HwndRenderTarget::GetFactory(ICaren^ Param_Out_Factory)
{
	//Variaveis a serem utilizadas.
