...
public:
	static operator CarenMFTranscodeSinkInfoProvider^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFTranscodeSinkInfoProvider^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFTranscodeSinkInfoProvider();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFTranscodeSinkInfoProvider*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFTranscodeSinkInfoProvider::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
