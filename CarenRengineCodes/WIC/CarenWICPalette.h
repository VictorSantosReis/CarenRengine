...
public:
	static operator CarenWICPalette^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenWICPalette^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenWICPalette();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IWICPalette*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenWICPalette::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
