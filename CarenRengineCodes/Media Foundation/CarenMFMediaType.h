...
public:
	static operator CarenMFMediaType^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFMediaType^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFMediaType(false);
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFMediaType::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
