...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por renderizar instruções de desenho para uma janela.
/// </summary>
public ref class CarenD2D1HwndRenderTarget : public ICarenD2D1HwndRenderTarget
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID2D1HwndRenderTarget).
	ID2D1HwndRenderTarget* PonteiroTrabalho = NULL;
...
public:
	static operator CarenD2D1HwndRenderTarget^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1HwndRenderTarget^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1HwndRenderTarget();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1HwndRenderTarget*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD2D1HwndRenderTarget::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenD2D1HwndRenderTarget)
public:
	/// <summary>
	...
	virtual void CheckWindowState([Out] CA_D2D1_WINDOW_STATE% Param_Out_WindowState);
	...
	virtual void GetHwnd([Out] IntPtr% Param_Out_Hwnd);
	...
	virtual CarenResult Resize(CA_D2D1_SIZE_U^ Param_PixelSize);
