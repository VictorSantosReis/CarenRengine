...
/// <summary>
/// (Concluida - Fase de Testes) - Classe responsável por representar uma forma complexa que pode ser composta de arcos, curvas e linhas.
/// </summary>
public ref class CarenD2D1PathGeometry : public ICarenD2D1PathGeometry
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID2D1PathGeometry).
	ID2D1PathGeometry* PonteiroTrabalho = NULL;
...
public:
	static operator CarenD2D1PathGeometry^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1PathGeometry^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1PathGeometry();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1PathGeometry*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD2D1PathGeometry::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
