...
public:
	static operator CarenMFMediaSourceExtension^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFMediaSourceExtension^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFMediaSourceExtension();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFMediaSourceExtension*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFMediaSourceExtension::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
