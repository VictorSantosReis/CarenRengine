...
CarenResult CarenMFTopologyNodeAttributeEditor::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenMFTopologyNodeAttributeEditor::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<IMFTopologyNodeAttributeEditor*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenMFTopologyNodeAttributeEditor::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IMFTopologyNodeAttributeEditor*>(Param_PonteiroNativo);
...
CarenResult CarenMFTopologyNodeAttributeEditor::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenMFTopologyNodeAttributeEditor::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenMFTopologyNodeAttributeEditor::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenMFTopologyNodeAttributeEditor::StatusPonteiro()
{
...
/// </summary>
Int32 CarenMFTopologyNodeAttributeEditor::ObterCodigoErro()
{
...
/// </summary>
void CarenMFTopologyNodeAttributeEditor::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenMFTopologyNodeAttributeEditor::LiberarReferencia()
{
...
/// </summary>
void CarenMFTopologyNodeAttributeEditor::LimparDados()
{
...
/// </summary>
void CarenMFTopologyNodeAttributeEditor::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenMFTopologyNodeAttributeEditor();
}
