...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por expor métodos que fornecem informações sobre um codificador.
/// </summary>
public ref class CarenWICBitmapEncoderInfo : public ICarenWICBitmapEncoderInfo
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IWICBitmapEncoderInfo).
	IWICBitmapEncoderInfo* PonteiroTrabalho = NULL;
...
public:
	static operator CarenWICBitmapEncoderInfo^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenWICBitmapEncoderInfo^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenWICBitmapEncoderInfo();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IWICBitmapEncoderInfo*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenWICBitmapEncoderInfo::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenWICBitmapEncoderInfo)
public:
	/// <summary>
	...
	virtual CarenResult CreateInstance(ICaren^ Param_Out_BitmapEncoder);
