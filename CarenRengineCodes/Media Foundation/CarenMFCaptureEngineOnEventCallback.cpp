...
#include "../pch.h"
#include "CarenMFCaptureEngineOnEventCallback.h"
...
CarenResult CarenMFCaptureEngineOnEventCallback::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenMFCaptureEngineOnEventCallback::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<IMFCaptureEngineOnEventCallback*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenMFCaptureEngineOnEventCallback::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IMFCaptureEngineOnEventCallback*>(Param_PonteiroNativo);
...
CarenResult CarenMFCaptureEngineOnEventCallback::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenMFCaptureEngineOnEventCallback::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenMFCaptureEngineOnEventCallback::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenMFCaptureEngineOnEventCallback::StatusPonteiro()
{
...
/// </summary>
Int32 CarenMFCaptureEngineOnEventCallback::ObterCodigoErro()
{
...
/// </summary>
void CarenMFCaptureEngineOnEventCallback::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenMFCaptureEngineOnEventCallback::LiberarReferencia()
{
...
/// </summary>
void CarenMFCaptureEngineOnEventCallback::LimparDados()
{
...
/// </summary>
void CarenMFCaptureEngineOnEventCallback::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenMFCaptureEngineOnEventCallback();
}



// Métodos da interface proprietária(ICarenMFCaptureEngineOnEventCallback)
