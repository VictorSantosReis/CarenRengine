...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por fornecer ao Media Engine uma lista de recursos de mídia.
/// </summary>
public ref class CarenMFMediaEngineSrcElements : public ICarenMFMediaEngineSrcElements
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IMFMediaEngineSrcElements).
	IMFMediaEngineSrcElements* PonteiroTrabalho = NULL;
...
public:
	static operator CarenMFMediaEngineSrcElements^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFMediaEngineSrcElements^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFMediaEngineSrcElements();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFMediaEngineSrcElements*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFMediaEngineSrcElements::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
