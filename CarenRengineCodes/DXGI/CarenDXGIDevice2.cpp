...
{
	//Fixa o ponteiro.
	cli::pin_ptr<IDXGIDevice2*> p = &PonteiroTrabalho;

	//Chama o método de ADICIONAR PONTEIRO na classe base(Caren).
	return Caren::Shared_AdicionarPonteiro(Param_PonteiroNativo, reinterpret_cast<IUnknown**>(static_cast<IDXGIDevice2**>(p)));
}
...
CarenResult CarenDXGIDevice2::GetParent(
...
CarenResult CarenDXGIDevice2::SetPrivateData(
...
CarenResult CarenDXGIDevice2::GetPrivateData(
	String^ Param_GuidIdentificao, 
...
CarenResult CarenDXGIDevice2::SetPrivateDataInterface(
