...
CarenResult CarenMFMediaTimeRange::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IMFMediaTimeRange*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenMFMediaTimeRange::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IMFMediaTimeRange*>(Param_PonteiroNativo);
...
/// </summary>
Int32 CarenMFMediaTimeRange::ObterCodigoErro()
{
...
/// </summary>
void CarenMFMediaTimeRange::LimparDados()
{
