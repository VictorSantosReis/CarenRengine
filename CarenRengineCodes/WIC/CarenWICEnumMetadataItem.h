...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por expor métodos que fornecem serviços de enumeração para itens de metadados individuais.
/// </summary>
public ref class CarenWICEnumMetadataItem : public ICarenWICEnumMetadataItem
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IWICEnumMetadataItem).
	IWICEnumMetadataItem* PonteiroTrabalho = NULL;
...
public:
	static operator CarenWICEnumMetadataItem^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenWICEnumMetadataItem^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenWICEnumMetadataItem();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IWICEnumMetadataItem*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenWICEnumMetadataItem::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenWICEnumMetadataItem)
public:
	/// <summary>
	...
	virtual CarenResult Clone([Out] ICarenWICEnumMetadataItem^% Param_Out_EnumMetadata);
	...
	virtual CarenResult Skip(UInt64 Param_Quantidade);
};