...
/// </summary>
public ref class CarenD2D1EffectContext1 : public ICarenD2D1EffectContext1
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID2D1EffectContext1).
	ID2D1EffectContext1* PonteiroTrabalho = NULL;
...
public:
	static operator CarenD2D1EffectContext1^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1EffectContext1^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1EffectContext1();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1EffectContext1*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD2D1EffectContext1::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenD2D1EffectContext1)
public:
	/// <summary>
