...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por permitir que um cliente acesse os controles de sessão e controles de volume para ambas as sessões de áudio de processo e processo específico.
/// </summary>
public ref class CarenAudioSessionManager : public ICarenAudioSessionManager
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IAudioSessionManager).
	IAudioSessionManager* PonteiroTrabalho = NULL;
...
public:
	static operator CarenAudioSessionManager^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenAudioSessionManager^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenAudioSessionManager();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IAudioSessionManager*>(Param_Pointer.ToPointer());
...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenAudioGerenciadorSessao">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenAudioSessionManager^% Param_Out_CarenAudioGerenciadorSessao)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenAudioGerenciadorSessao = gcnew CarenAudioSessionManager();
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenAudioSessionManager::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenAudioSessionManager)
public:
	/// <summary>
	...
	virtual CarenResult GetAudioSessionControl(String^ Param_GuidSessaoAudio, UInt32 Param_FlagsFluxo, [Out] ICarenAudioSessionControl^% Param_Out_ControleSessaoAudio);
	...
	virtual CarenResult GetSimpleAudioVolume(String^ Param_GuidSessaoAudio, UInt32 Param_FlagsFluxo, [Out] ICarenSimpleAudioVolume^% Param_Out_ControladorSimplesVolume);
};