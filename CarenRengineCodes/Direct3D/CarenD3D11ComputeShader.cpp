...
CarenResult CarenD3D11ComputeShader::GetDevice(ICaren^ Param_Out_DispositivoD3D11)
{
...
CarenResult CarenD3D11ComputeShader::GetPrivateData(
	String^ Param_Guid,
...
CarenResult CarenD3D11ComputeShader::SetPrivateData(
	String^ Param_Guid,
...
CarenResult CarenD3D11ComputeShader::SetPrivateDataInterface(
