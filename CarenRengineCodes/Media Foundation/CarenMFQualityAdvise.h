...
public ref class CarenMFQualityAdvise : public ICarenMFQualityAdvise
{
	...
	//Ponteiro para a interface (IMFQualityAdvise).
	IMFQualityAdvise* PonteiroTrabalho = NULL;
...
public:
	static operator CarenMFQualityAdvise^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFQualityAdvise^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFQualityAdvise();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFQualityAdvise*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFQualityAdvise::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
