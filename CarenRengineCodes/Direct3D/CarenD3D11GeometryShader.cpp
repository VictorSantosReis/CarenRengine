...
//Destruidor.
CarenD3D11GeometryShader::~CarenD3D11GeometryShader()
{
...
CarenResult CarenD3D11GeometryShader::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD3D11GeometryShader::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID3D11GeometryShader*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD3D11GeometryShader::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID3D11GeometryShader*>(Param_PonteiroNativo);
...
CarenResult CarenD3D11GeometryShader::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11GeometryShader::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11GeometryShader::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenD3D11GeometryShader::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD3D11GeometryShader::ObterCodigoErro()
{
...
/// </summary>
void CarenD3D11GeometryShader::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD3D11GeometryShader::LiberarReferencia()
{
...
/// </summary>
void CarenD3D11GeometryShader::LimparDados()
{
...
/// </summary>
void CarenD3D11GeometryShader::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
...
CarenResult CarenD3D11GeometryShader::ObterDispositivo(ICaren^ Param_Out_DispositivoD3D11)
{
...
CarenResult CarenD3D11GeometryShader::ObterDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11GeometryShader::DefinirDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11GeometryShader::DefinirInterfaceDadosPrivados(
