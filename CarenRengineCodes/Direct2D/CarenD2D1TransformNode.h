...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD2D1TransformNode">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD2D1TransformNode^% Param_Out_CarenD2D1TransformNode)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);

		//Cria a interface
		Param_Out_CarenD2D1TransformNode = gcnew CarenD2D1TransformNode();
