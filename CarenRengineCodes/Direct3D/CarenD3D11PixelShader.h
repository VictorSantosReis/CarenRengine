...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por representar um Sombreador de Pixel que gerencia um programa que controla o estágio de sombreamento de pixel.
/// </summary>
public ref class CarenD3D11PixelShader :public ICarenD3D11PixelShader
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID3D11PixelShader).
	ID3D11PixelShader* PonteiroTrabalho = NULL;
...
public:
	static operator CarenD3D11PixelShader^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD3D11PixelShader^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD3D11PixelShader();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID3D11PixelShader*>(Param_Pointer.ToPointer());
...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD3D11PixelShader">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD3D11PixelShader^% Param_Out_CarenD3D11PixelShader)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenD3D11PixelShader = gcnew CarenD3D11PixelShader();
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD3D11PixelShader::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
