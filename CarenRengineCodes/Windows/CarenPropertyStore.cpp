...
CarenResult CarenPropertyStore::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IPropertyStore*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenPropertyStore::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IPropertyStore*>(Param_PonteiroNativo);
...
/// </summary>
Int32 CarenPropertyStore::ObterCodigoErro()
{
...
/// </summary>
void CarenPropertyStore::LimparDados()
{
