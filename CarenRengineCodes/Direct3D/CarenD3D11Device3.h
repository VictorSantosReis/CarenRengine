...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por representar um adaptador virtual; é usado para criar recursos. A ICarenD3D11Device3 adiciona novos 
/// métodos aos da ICarenD3D11Device2.
/// </summary>
public ref class CarenD3D11Device3 : public ICarenD3D11Device3
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID3D11Device3).
	ID3D11Device3* PonteiroTrabalho = NULL;
