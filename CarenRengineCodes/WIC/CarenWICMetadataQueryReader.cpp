...
CarenResult CarenWICMetadataQueryReader::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IWICMetadataQueryReader*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenWICMetadataQueryReader::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IWICMetadataQueryReader*>(Param_PonteiroNativo);
...
/// </summary>
Int32 CarenWICMetadataQueryReader::ObterCodigoErro()
{
...
/// </summary>
void CarenWICMetadataQueryReader::LimparDados()
{
