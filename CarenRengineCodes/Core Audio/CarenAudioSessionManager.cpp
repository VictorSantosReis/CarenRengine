...
CarenResult CarenAudioSessionManager::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IAudioSessionManager*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenAudioSessionManager::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IAudioSessionManager*>(Param_PonteiroNativo);
...
/// </summary>
void CarenAudioSessionManager::LimparDados()
{
