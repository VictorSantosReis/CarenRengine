...
#include "../NativeClassForEvents/CLN_IMFSourceOpenMonitor.h"
...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por receber notificações de uma fonte de rede sobre o progresso de uma operação aberta assíncrona.
/// </summary>
public ref class CarenMFSourceOpenMonitor : public ICarenMFSourceOpenMonitor
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IMFSourceOpenMonitor).
...
public:
	...
	/// </summary>
	virtual event ICarenMFSourceOpenMonitor::Delegate_OnSourceEvent^ OnSourceEvent;
...
private:
	...
	/////////////////////////////////////////////////////////////////////////////////////////////
	//DELEGATES UTILIZADOS PARA RECEBER OS EVENTOS NATIVOS DA CLASSE (CLN_IMFSourceOpenMonitor)//
	/////////////////////////////////////////////////////////////////////////////////////////////

	/// <summary>
	/// Delegate nativo que vai conter o método que vai receber o evento(OnSourceEvent) nativo da classe (CLN_IMFSourceOpenMonitor) para ser enviado ao usuário.
	/// </summary>
	delegate HRESULT DelegateNativo_Evento_OnSourceEvent(__RPC__in_opt IMFMediaEvent*);
	DelegateNativo_Evento_OnSourceEvent^ Callback_OnSourceEvent = nullptr;

	//(HANDLES ALOCADAS DOS EVENTOS)
private:
	/// <summary>
	/// Contém a Handle alocada para o delegate (DelegateNativo_Evento_OnSourceEvent).
	/// </summary>
	GCHandle gHandle_Delegate_OnSourceEvent;
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFSourceOpenMonitor::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenMFSourceOpenMonitor)
public:
	/// <summary>
	...
	//Métodos que são utilizados para receberem os eventos da classe nativa (CLN_IMFSourceOpenMonitor).
public:
	/// <summary>
	...
	/// </summary>
	virtual HRESULT EncaminharEvento_OnSourceEvent(__RPC__in_opt IMFMediaEvent* pEvent);
};