		...
		public:
			...
			SDKBase::Enumeracoes::CA_MEDIA_SUBTYPES ConverterGUIDSubtipoMidia_ToMidia_SubTipo(GUID Param_GuidSubTipoMidia)
			{
				...
				if (MEDIASUBTYPE_RAW_AAC1 == Param_GuidSubTipoMidia)
				{
					...
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoAudio_RAW_ACC1;

				}
				else if (MFAudioFormat_AAC == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoAudio_AAC;

				}
				else if (MFAudioFormat_ADTS == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoAudio_ADTS;

				}
				else if (MFAudioFormat_ALAC == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoAudio_ALAC;

				}
				else if (MFAudioFormat_AMR_NB == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoAudio_AMR_NB;

				}
				else if (MFAudioFormat_AMR_WB == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoAudio_AMR_WB;

				}
				else if (MFAudioFormat_AMR_WP == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoAudio_AMR_WP;

				}
				else if (MFAudioFormat_Dolby_AC3 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoAudio_Dolby_AC3;

				}
				else if (MFAudioFormat_Dolby_AC3_SPDIF == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoAudio_Dolby_AC3_SPDIF;

				}
				else if (MFAudioFormat_Dolby_DDPlus == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoAudio_Dolby_DDPlus;

				}
				else if (MFAudioFormat_DRM == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoAudio_DRM;

				}
				else if (MFAudioFormat_DTS == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoAudio_DTS;

				}
				else if (MFAudioFormat_FLAC == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoAudio_FLAC;

				}
				else if (MFAudioFormat_Float == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoAudio_Float;

				}
				else if (MFAudioFormat_Float_SpatialObjects == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoAudio_Float_SpatialObjects;

				}
				else if (MFAudioFormat_MP3 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoAudio_MP3;

				}
				else if (MFAudioFormat_MPEG == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoAudio_MPEG;

				}
				else if (MFAudioFormat_MSP1 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoAudio_MSP1;

				}
				else if (MFAudioFormat_Opus == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoAudio_Opus;

				}
				else if (MFAudioFormat_PCM == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoAudio_PCM;

				}
				else if (MFAudioFormat_WMASPDIF == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoAudio_WMASPDIF;

				}
				else if (MFAudioFormat_WMAudio_Lossless == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoAudio_WMAudio_Lossless;

				}
				else if (MFAudioFormat_WMAudioV8 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoAudio_WMAudioV8;

				}
				else if (MFAudioFormat_WMAudioV9 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoAudio_WMAudioV9;
				...
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_RGB8;

				}
				else if (MFVideoFormat_RGB555 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_RGB555;

				}
				else if (MFVideoFormat_RGB565 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_RGB565;

				}
				else if (MFVideoFormat_RGB24 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_RGB24;

				}
				else if (MFVideoFormat_RGB32 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_RGB32;

				}
				else if (MFVideoFormat_ARGB32 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_ARGB32;

				}
				else if (MFVideoFormat_A2R10G10B10 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_A2R10G10B10;

				}
				else if (MFVideoFormat_A16B16G16R16F == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_A16B16G16R16F;

				}
				else if (MFVideoFormat_AI44 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_AI44;

				}
				else if (MFVideoFormat_AYUV == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_AYUV;

				}
				else if (MFVideoFormat_I420 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_I420;

				}
				else if (MFVideoFormat_IYUV == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_IYUV;

				}
				else if (MFVideoFormat_NV11 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_NV11;

				}
				else if (MFVideoFormat_NV12 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_NV12;

				}
				else if (MFVideoFormat_UYVY == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_UYVY;

				}
				else if (MFVideoFormat_Y41P == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_Y41P;

				}
				else if (MFVideoFormat_Y41T == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_Y41T;

				}
				else if (MFVideoFormat_Y42T == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_Y42T;

				}
				else if (MFVideoFormat_YUY2 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_YUY2;

				}
				else if (MFVideoFormat_YVU9 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_YVU9;

				}
				else if (MFVideoFormat_YV12 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_YV12;

				}
				else if (MFVideoFormat_YVYU == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_YVYU;

				}
				else if (MFVideoFormat_P010 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_P010;

				}
				else if (MFVideoFormat_P016 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_P016;

				}
				else if (MFVideoFormat_P210 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_P210;

				}
				else if (MFVideoFormat_P216 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_P216;

				}
				else if (MFVideoFormat_v210 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_v210;

				}
				else if (MFVideoFormat_v216 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_v216;

				}
				else if (MFVideoFormat_v410 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_v410;

				}
				else if (MFVideoFormat_Y210 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_Y210;

				}
				else if (MFVideoFormat_Y216 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_Y216;

				}
				else if (MFVideoFormat_Y410 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_Y410;

				}
				else if (MFVideoFormat_Y416 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_Y416;

				}
				else if (MFVideoFormat_L8 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_L8;

				}
				else if (MFVideoFormat_L16 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_L16;

				}
				else if (MFVideoFormat_D16 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_D16;

				}
				else if (MFVideoFormat_DV25 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_DV25;

				}
				else if (MFVideoFormat_DV50 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_DV50;

				}
				else if (MFVideoFormat_DVC == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_DVC;

				}
				else if (MFVideoFormat_DVH1 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_DVH1;

				}
				else if (MFVideoFormat_DVHD == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_DVHD;

				}
				else if (MFVideoFormat_DVSD == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_DVSD;

				}
				else if (MFVideoFormat_DVSL == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_DVSL;

				}
				else if (MFVideoFormat_H263 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_H263;

				}
				else if (MFVideoFormat_H264 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_H264;

				}
				else if (MFVideoFormat_H265 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_H265;

				}
				else if (MFVideoFormat_H264_ES == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_H264_ES;

				}
				else if (MFVideoFormat_HEVC == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_HEVC;

				}
				else if (MFVideoFormat_HEVC_ES == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_HEVC_ES;

				}
				else if (MFVideoFormat_M4S2 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_M4S2;

				}
				else if (MFVideoFormat_MJPG == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_MJPG;

				}
				else if (MFVideoFormat_MP43 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_MP43;

				}
				else if (MFVideoFormat_MP4S == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_MP4S;

				}
				else if (MFVideoFormat_MP4V == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_MP4V;
				...
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_VP80;

				}
				else if (MFVideoFormat_VP90 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_VP90;

				}
				else if (MFVideoFormat_MPG1 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_MPG1;

				}
				else if (MFVideoFormat_MSS1 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_MSS1;

				}
				else if (MFVideoFormat_MSS2 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_MSS2;

				}
				else if (MFVideoFormat_WMV1 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_WMV1;

				}
				else if (MFVideoFormat_WMV2 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_WMV2;

				}
				else if (MFVideoFormat_WMV3 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_WMV3;

				}
				else if (MFVideoFormat_WVC1 == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_WVC1;

				}
				else if (MFVideoFormat_420O == Param_GuidSubTipoMidia)
				{
					//Define o formato principal da mídia e o seu Guid.
					FormatoTipoPrincipal = CA_MEDIA_SUBTYPES::FormatoVideo_420O;
