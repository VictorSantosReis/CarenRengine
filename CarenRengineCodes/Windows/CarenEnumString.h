...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por enumerar strings. LPWSTR é o tipo que indica um ponteiro para uma sequência de caracteres wide, ou Unicode. 
/// </summary>
public ref class CarenEnumString : public ICarenEnumString
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IEnumString).
	IEnumString* PonteiroTrabalho = NULL;
...
public:
	static operator CarenEnumString^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenEnumString^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenEnumString();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IEnumString*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenEnumString::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenEnumString)
public:
	/// <summary>
	...
	virtual CarenResult Clone([Out] ICarenEnumString^% Param_Out_EnumString);
	...
	virtual CarenResult Skip(UInt32 Param_CountSkip);
};