...
CarenResult CarenWICPersistStream::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IWICPersistStream*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenWICPersistStream::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IWICPersistStream*>(Param_PonteiroNativo);
...
/// </summary>
void CarenWICPersistStream::LimparDados()
{
