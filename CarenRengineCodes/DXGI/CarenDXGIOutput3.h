...
public:
	static operator CarenDXGIOutput3^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenDXGIOutput3^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenDXGIOutput3();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IDXGIOutput3*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenDXGIOutput3::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
