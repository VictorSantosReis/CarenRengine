...
CarenResult CarenD3D11Resource::GetEvictionPriority([Out] Enumeracoes::CA_DXGI_PRIORIDADE_RECURSO% Param_Out_Prioridade)
{
...
CarenResult CarenD3D11Resource::GetType([Out] Enumeracoes::CA_D3D11_TIPO_RECURSO% Param_Out_TipoRecurso)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Resource::SetEvictionPriority(Enumeracoes::CA_DXGI_PRIORIDADE_RECURSO Param_PrioridadeRecurso)
{
...
CarenResult CarenD3D11Resource::GetDevice(ICaren^ Param_Out_DispositivoD3D11)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Resource::GetPrivateData(
	String^ Param_Guid,
...
CarenResult CarenD3D11Resource::SetPrivateData(
	String^ Param_Guid,
...
CarenResult CarenD3D11Resource::SetPrivateDataInterface(
