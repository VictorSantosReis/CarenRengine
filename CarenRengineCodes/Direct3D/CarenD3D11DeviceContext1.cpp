...
{
	//Fixa o ponteiro.
	cli::pin_ptr<ID3D11DeviceContext1*> p = &PonteiroTrabalho;

	//Chama o método de ADICIONAR PONTEIRO na classe base(Caren).
	return Caren::Shared_AdicionarPonteiro(Param_PonteiroNativo, reinterpret_cast<IUnknown**>(static_cast<ID3D11DeviceContext1**>(p)));
}
/// <summary>
/// Método responsável por adicionar um novo ponteiro nativo a classe atual.
/// Este método não é responsável por adicionar uma nova referência ao objeto COM.
...
CarenResult CarenD3D11DeviceContext1::DiscardView1(
...
CarenResult CarenD3D11DeviceContext1::GetResourceMinLOD(
