...
{
	/// <summary>
	/// Uma estrutura que serve como resolvedor de parâmetros opcionais.
	/// </summary>
	/// <typeparam name="TypeObject">O tipo do objeto a ser passado para o pârametro.</typeparam>
	generic<typename TypeObject>
		public value struct CarenParamResolver
		{
		...
		public:
			...
			CarenParamResolver(TypeObject Param_Objeto, Boolean Param_IgnoreParameter)
			{
			...
			CarenParamResolver(Boolean Param_IgnoreParamter)
			{
