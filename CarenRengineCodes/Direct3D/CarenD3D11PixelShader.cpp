...
//Destruidor.
CarenD3D11PixelShader::~CarenD3D11PixelShader()
{
...
CarenResult CarenD3D11PixelShader::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD3D11PixelShader::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID3D11PixelShader*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD3D11PixelShader::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID3D11PixelShader*>(Param_PonteiroNativo);
...
CarenResult CarenD3D11PixelShader::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11PixelShader::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11PixelShader::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenD3D11PixelShader::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD3D11PixelShader::ObterCodigoErro()
{
...
/// </summary>
void CarenD3D11PixelShader::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD3D11PixelShader::LiberarReferencia()
{
...
/// </summary>
void CarenD3D11PixelShader::LimparDados()
{
...
/// </summary>
void CarenD3D11PixelShader::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
...
CarenResult CarenD3D11PixelShader::ObterDispositivo(ICaren^ Param_Out_DispositivoD3D11)
{
...
CarenResult CarenD3D11PixelShader::ObterDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11PixelShader::DefinirDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11PixelShader::DefinirInterfaceDadosPrivados(
