...
/// <summary>
/// (Concluido - Fase de testes) - Classe responsável por permitir a recuperação do dispositivo ligado a objetos DXGI herdados.
/// </summary>
public ref class CarenDXGIDeviceSubObject : public ICarenDXGIDeviceSubObject
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IDXGIDeviceSubObject).
	IDXGIDeviceSubObject* PonteiroTrabalho = NULL;
...
public:
	static operator CarenDXGIDeviceSubObject^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenDXGIDeviceSubObject^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenDXGIDeviceSubObject();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IDXGIDeviceSubObject*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenDXGIDeviceSubObject::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
