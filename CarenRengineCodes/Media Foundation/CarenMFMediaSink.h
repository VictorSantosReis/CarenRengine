...
public:
	static operator CarenMFMediaSink^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFMediaSink^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFMediaSink();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFMediaSink*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFMediaSink::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
