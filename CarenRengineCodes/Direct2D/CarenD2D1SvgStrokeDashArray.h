...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por descrever um valor SVG stroke-dasharray.
/// </summary>
public ref class CarenD2D1SvgStrokeDashArray : public ICarenD2D1SvgStrokeDashArray
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID2D1SvgStrokeDashArray).
...
public:
	static operator CarenD2D1SvgStrokeDashArray^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1SvgStrokeDashArray^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1SvgStrokeDashArray();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1SvgStrokeDashArray*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD2D1SvgStrokeDashArray::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenD2D1SvgStrokeDashArray)
public:
	/// <summary>
	...
	virtual CarenResult RemoveDashesAtEnd(UInt32 Param_DashesCount);
	...
	virtual CarenResult UpdateDashes(
