...
public:
	static operator CarenD2D1Device^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1Device^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1Device();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1Device*>(Param_Pointer.ToPointer());
