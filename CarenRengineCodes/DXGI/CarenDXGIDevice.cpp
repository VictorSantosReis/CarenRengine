...
CarenResult CarenDXGIDevice::GetParent(
...
CarenResult CarenDXGIDevice::SetPrivateData(
...
CarenResult CarenDXGIDevice::GetPrivateData(
	String^ Param_GuidIdentificao, 
...
CarenResult CarenDXGIDevice::SetPrivateDataInterface(
