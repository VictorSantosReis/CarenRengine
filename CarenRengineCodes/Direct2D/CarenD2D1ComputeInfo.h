...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responável por permitir a especificação de informações para um pass de renderização de sombreamento de computação (compute-shader rendering).
/// </summary>
public ref class CarenD2D1ComputeInfo : public ICarenD2D1ComputeInfo
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID2D1ComputeInfo).
	ID2D1ComputeInfo* PonteiroTrabalho = NULL;
...
public:
	static operator CarenD2D1ComputeInfo^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1ComputeInfo^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1ComputeInfo();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1ComputeInfo*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD2D1ComputeInfo::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenD2D1ComputeInfo)
public:
	/// <summary>
	...
	virtual CarenResult SetComputeShader(String^ Param_ShaderId);
	...
	virtual CarenResult SetComputeShaderConstantBuffer(
