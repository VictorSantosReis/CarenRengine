...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por representar uma interface de visões de recursos obscuros que especifica os subrecursos que um Shader pode acessar durante 
/// a renderização.
/// </summary>
public ref class CarenD3D11ShaderResourceView1 : public ICarenD3D11ShaderResourceView1
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID3D11ShaderResourceView1).
...
public:
	static operator CarenD3D11ShaderResourceView1^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD3D11ShaderResourceView1^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD3D11ShaderResourceView1();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID3D11ShaderResourceView1*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD3D11ShaderResourceView1::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenD3D11ShaderResourceView1)
public:
	/// <summary>
	...
	virtual CarenResult GetDesc1([Out] Estruturas::CA_D3D11_SHADER_RESOURCE_VIEW_DESC1^% Param_Out_DescSombreadorRecurso);
