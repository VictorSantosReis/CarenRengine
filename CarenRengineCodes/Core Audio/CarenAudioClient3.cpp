...
CarenResult CarenAudioClient3::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IAudioClient3*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenAudioClient3::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IAudioClient3*>(Param_PonteiroNativo);
...
/// </summary>
Int32 CarenAudioClient3::ObterCodigoErro()
{
