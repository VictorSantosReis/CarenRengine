...
public:
	static operator CarenD2D1ComputeTransform^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1ComputeTransform^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1ComputeTransform();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1ComputeTransform*>(Param_Pointer.ToPointer());
