...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por expor métodos para gerenciamento de cores.
/// </summary>
public ref class CarenWICColorContext : public ICarenWICColorContext
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IWICColorContext).
	IWICColorContext* PonteiroTrabalho = NULL;
...
public:
	static operator CarenWICColorContext^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenWICColorContext^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenWICColorContext();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IWICColorContext*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenWICColorContext::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenWICColorContext)
public:
	/// <summary>
	...
	virtual CarenResult GetExifColorSpace([Out] UInt32% Param_Out_Valor);
	...
	virtual CarenResult GetProfileBytes(
	...
	virtual CarenResult GetType([Out] CA_WICColorContextType% Param_Out_Type);
	...
	virtual CarenResult InitializeFromExifColorSpace(UInt32 Param_Valor);

	/// <summary>
	/// Inicializa o contexto de cores a partir do arquivo dado. 
	/// </summary>
	/// <param name="Param_NomeArquivo">A url para o arquivo.</param>
	virtual CarenResult InitializeFromFilename(String^ Param_NomeArquivo);
	...
	virtual CarenResult InitializeFromMemory(
