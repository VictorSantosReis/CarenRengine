...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por implmenetar um único método de suporte a displays de taxa de atualização variável.
/// </summary>
public ref class CarenDXGIFactory5 : public ICarenDXGIFactory5
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IDXGIFactory5).
...
public:
	static operator CarenDXGIFactory5^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenDXGIFactory5^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenDXGIFactory5();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IDXGIFactory5*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenDXGIFactory5::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
