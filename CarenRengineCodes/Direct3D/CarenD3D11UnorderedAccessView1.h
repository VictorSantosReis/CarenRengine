...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD3D11UnorderedAccessView1">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD3D11UnorderedAccessView1^% Param_Out_CarenD3D11UnorderedAccessView1)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenD3D11UnorderedAccessView1 = gcnew CarenD3D11UnorderedAccessView1();
...
public:
	...
	virtual CarenResult ObterRecurso([Out] ICarenD3D11Resource^% Param_Out_Recurso);
