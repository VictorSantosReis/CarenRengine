...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por expor métodos que fornecem informações sobre um decodificador.
/// </summary>
public ref class CarenWICBitmapDecoderInfo : public ICarenWICBitmapDecoderInfo
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IWICBitmapDecoderInfo).
	IWICBitmapDecoderInfo* PonteiroTrabalho = NULL;
...
public:
	static operator CarenWICBitmapDecoderInfo^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenWICBitmapDecoderInfo^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenWICBitmapDecoderInfo();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IWICBitmapDecoderInfo*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenWICBitmapDecoderInfo::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenWICBitmapDecoderInfo)
public:
	/// <summary>
	...
	virtual CarenResult CreateInstance(ICaren^ Param_Out_IBitmapDecoder);
