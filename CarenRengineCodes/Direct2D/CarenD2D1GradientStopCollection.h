...
/// </summary>
public ref class CarenD2D1GradientStopCollection : public ICarenD2D1GradientStopCollection
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID2D1GradientStopCollection).
...
public:
	static operator CarenD2D1GradientStopCollection^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1GradientStopCollection^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1GradientStopCollection();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1GradientStopCollection*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD2D1GradientStopCollection::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
