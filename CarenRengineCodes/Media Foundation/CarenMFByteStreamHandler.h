...
public:
	static operator CarenMFByteStreamHandler^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFByteStreamHandler^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFByteStreamHandler();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFByteStreamHandler*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFByteStreamHandler::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
