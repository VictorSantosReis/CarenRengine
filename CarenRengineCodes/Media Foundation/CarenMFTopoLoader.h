...
public:
	static operator CarenMFTopoLoader^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFTopoLoader^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFTopoLoader(false);

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFTopoLoader*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFTopoLoader::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
