...
/// </summary>
public ref class CarenDXGIDevice3 : public ICarenDXGIDevice3
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IDXGIDevice3).
	IDXGIDevice3* PonteiroTrabalho = NULL;
...
public:
	static operator CarenDXGIDevice3^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenDXGIDevice3^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenDXGIDevice3();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IDXGIDevice3*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenDXGIDevice3::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
