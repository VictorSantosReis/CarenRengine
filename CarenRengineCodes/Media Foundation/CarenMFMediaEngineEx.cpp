...
CarenResult CarenMFMediaEngineEx::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IMFMediaEngineEx*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenMFMediaEngineEx::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IMFMediaEngineEx*>(Param_PonteiroNativo);
...
/// </summary>
void CarenMFMediaEngineEx::LimparDados()
{
