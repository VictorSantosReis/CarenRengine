...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenDXGIFactory5">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenDXGIFactory5^% Param_Out_CarenDXGIFactory5)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenDXGIFactory5 = gcnew CarenDXGIFactory5();
