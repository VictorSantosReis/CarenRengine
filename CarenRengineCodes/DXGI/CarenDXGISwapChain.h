...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por implementar uma ou mais superfícies para armazenar dados processados antes de apresentá-los a uma saída.
/// </summary>
public ref class CarenDXGISwapChain : public ICarenDXGISwapChain
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IDXGISwapChain).
	IDXGISwapChain* PonteiroTrabalho = NULL;
...
public:
	static operator CarenDXGISwapChain^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenDXGISwapChain^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenDXGISwapChain();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IDXGISwapChain*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenDXGISwapChain::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
