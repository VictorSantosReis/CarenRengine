...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por acessar e manipular a imagem de desktop duplicada. 
/// </summary>
public ref class CarenDXGIOutputDuplication : public ICarenDXGIOutputDuplication
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IDXGIOutputDuplication).
	IDXGIOutputDuplication* PonteiroTrabalho = NULL;
...
public:
	static operator CarenDXGIOutputDuplication^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenDXGIOutputDuplication^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenDXGIOutputDuplication();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IDXGIOutputDuplication*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenDXGIOutputDuplication::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenDXGIOutputDuplication)
public:
	/// <summary>
