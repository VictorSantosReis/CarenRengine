...
CarenResult CarenD2D1EllipseGeometry::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD2D1EllipseGeometry::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1EllipseGeometry*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1EllipseGeometry::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1EllipseGeometry*>(Param_PonteiroNativo);
...
CarenResult CarenD2D1EllipseGeometry::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1EllipseGeometry::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1EllipseGeometry::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenD2D1EllipseGeometry::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD2D1EllipseGeometry::ObterCodigoErro()
{
...
/// </summary>
void CarenD2D1EllipseGeometry::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD2D1EllipseGeometry::LiberarReferencia()
{
...
/// </summary>
void CarenD2D1EllipseGeometry::LimparDados()
{
...
/// </summary>
void CarenD2D1EllipseGeometry::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenD2D1EllipseGeometry();
}



// Métodos da interface proprietária(ICarenD2D1EllipseGeometry)
...
void CarenD2D1EllipseGeometry::GetEllipse([Out] CA_D2D1_ELLIPSE^% Param_Out_Ellipse)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
	D2D1_ELLIPSE OutEllipse = { };

	//Chama o método para realizar a operação.
	PonteiroTrabalho->GetEllipse(&OutEllipse);

	//Converte a estrutura gerenciada para a nativa.
	Param_Out_Ellipse = Util.ConverterD2D1_ELLIPSEUnmanagedToManaged(&OutEllipse);
}
...
CarenResult CarenD2D1EllipseGeometry::CombineWithGeometry(
...
CarenResult CarenD2D1EllipseGeometry::CompareWithGeometry(
	ICarenD2D1Geometry^ Param_GeometriaEntrada,
	CA_D2D1_MATRIX_3X2_F^ Param_InputGeometryTransform,
	float Param_FlatteningTolerance,
...
CarenResult CarenD2D1EllipseGeometry::ComputeArea(
...
CarenResult CarenD2D1EllipseGeometry::ComputeLength(
	CA_D2D1_MATRIX_3X2_F^ Param_WorldTransform,
	float Param_FlatteningTolerance,
...
CarenResult CarenD2D1EllipseGeometry::ComputePointAtLength(
	float Param_Length,
	CA_D2D1_MATRIX_3X2_F^ Param_WorldTransform,
	float Param_FlatteningTolerance,
...
CarenResult CarenD2D1EllipseGeometry::FillContainsPoint(
...
CarenResult CarenD2D1EllipseGeometry::GetBounds(
	CA_D2D1_MATRIX_3X2_F^ Param_WorldTransform,
...
CarenResult CarenD2D1EllipseGeometry::GetWidenedBounds(
...
CarenResult CarenD2D1EllipseGeometry::Outline(
	CA_D2D1_MATRIX_3X2_F^ Param_WorldTransform,
	float Param_FlatteningTolerance,
...
CarenResult CarenD2D1EllipseGeometry::Simplify(
...
CarenResult CarenD2D1EllipseGeometry::StrokeContainsPoint(
	CA_D2D1_POINT_2F^ Param_Point,
	float Param_StrokeWidth,
	ICarenD2D1StrokeStyle^ Param_StrokeStyle,
	CA_D2D1_MATRIX_3X2_F^ Param_WorldTransform,
...
CarenResult CarenD2D1EllipseGeometry::Tessellate(
	CA_D2D1_MATRIX_3X2_F^ Param_WorldTransform,
	float Param_FlatteningTolerance,
...
CarenResult CarenD2D1EllipseGeometry::Widen(
	float Param_StrokeWidth,
	ICarenD2D1StrokeStyle^ Param_StrokeStyle,
	CA_D2D1_MATRIX_3X2_F^ Param_WorldTransform,
	float Param_FlatteningTolerance,
...
void CarenD2D1EllipseGeometry::GetFactory(ICaren^ Param_Out_Factory)
{
	//Variaveis a serem utilizadas.
