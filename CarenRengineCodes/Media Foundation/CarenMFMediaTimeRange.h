...
public:
	static operator CarenMFMediaTimeRange^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFMediaTimeRange^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFMediaTimeRange();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFMediaTimeRange*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFMediaTimeRange::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
