...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por representar um Shader de computação que gerencia uma programa executavel.
/// </summary>
public ref class CarenD3D11ComputeShader :public ICarenD3D11ComputeShader
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID3D11ComputeShader).
	ID3D11ComputeShader* PonteiroTrabalho = NULL;
...
public:
	static operator CarenD3D11ComputeShader^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD3D11ComputeShader^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD3D11ComputeShader();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID3D11ComputeShader*>(Param_Pointer.ToPointer());
...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD3D11ComputeShader">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD3D11ComputeShader^% Param_Out_CarenD3D11ComputeShader)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenD3D11ComputeShader = gcnew CarenD3D11ComputeShader();
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD3D11ComputeShader::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
