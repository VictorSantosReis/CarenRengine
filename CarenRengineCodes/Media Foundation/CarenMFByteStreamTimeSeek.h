...
public ref class CarenMFByteStreamTimeSeek : public ICarenMFByteStreamTimeSeek
{
	...
	//Ponteiro para a interface (IMFByteStreamTimeSeek).
	IMFByteStreamTimeSeek* PonteiroTrabalho = NULL;
...
public:
	static operator CarenMFByteStreamTimeSeek^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFByteStreamTimeSeek^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFByteStreamTimeSeek();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFByteStreamTimeSeek*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFByteStreamTimeSeek::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenMFByteStreamTimeSeek)
public:
	/// <summary>
