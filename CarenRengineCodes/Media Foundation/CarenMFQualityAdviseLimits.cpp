...
{
	//Fixa o ponteiro.
	cli::pin_ptr<IMFQualityAdviseLimits*> p = &PonteiroTrabalho;

	//Chama o método de ADICIONAR PONTEIRO na classe base(Caren).
	return Caren::Shared_AdicionarPonteiro(Param_PonteiroNativo, reinterpret_cast<IUnknown**>(static_cast<IMFQualityAdviseLimits**>(p)));
}
