...
CarenResult CarenWICBitmapCodecProgressNotification::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IWICBitmapCodecProgressNotification*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenWICBitmapCodecProgressNotification::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IWICBitmapCodecProgressNotification*>(Param_PonteiroNativo);
...
/// </summary>
void CarenWICBitmapCodecProgressNotification::LimparDados()
{
