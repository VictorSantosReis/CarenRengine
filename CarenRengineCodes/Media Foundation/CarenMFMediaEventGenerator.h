...
/// <summary>
/// Classe responsável por recuperar eventos de qualquer objeto do Media Foundation que gere eventos. 
/// </summary>
...
public:
	static operator CarenMFMediaEventGenerator^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFMediaEventGenerator^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFMediaEventGenerator();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFMediaEventGenerator*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFMediaEventGenerator::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
