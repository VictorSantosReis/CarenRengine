...
{
	//Fixa o ponteiro.
	cli::pin_ptr<ID3D11RasterizerState1*> p = &PonteiroTrabalho;

	//Chama o método de ADICIONAR PONTEIRO na classe base(Caren).
	return Caren::Shared_AdicionarPonteiro(Param_PonteiroNativo, reinterpret_cast<IUnknown**>(static_cast<ID3D11RasterizerState1**>(p)));
}
...
CarenResult CarenD3D11RasterizerState1::GetDesc([Out] Estruturas::CA_D3D11_RASTERIZER_DESC^% Param_Out_DescRasterizador)
{
	//Chama o método na classe de funções compartilhadas do D3D11.
