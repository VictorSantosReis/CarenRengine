...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por representar um bitmap que pode ser usado como uma superfície para um ICarenD2D1DeviceContext ou mapeado na memória do sistema, e pode 
/// conter informações adicionais de contexto de cores.
/// </summary>
public ref class CarenD2D1Bitmap1 : public ICarenD2D1Bitmap1
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID2D1Bitmap1).
	ID2D1Bitmap1* PonteiroTrabalho = NULL;
...
public:
	static operator CarenD2D1Bitmap1^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1Bitmap1^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1Bitmap1();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1Bitmap1*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD2D1Bitmap1::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
...
public:
	...
	virtual CarenResult GetColorContext(
	...
	virtual CarenResult GetSurface(ICaren^ Param_Out_DxgiSurface);
