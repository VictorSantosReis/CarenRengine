...
CarenResult CarenD2D1SvgAttribute::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1SvgAttribute*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1SvgAttribute::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1SvgAttribute*>(Param_PonteiroNativo);
...
/// </summary>
Int32 CarenD2D1SvgAttribute::ObterCodigoErro()
{
...
/// </summary>
void CarenD2D1SvgAttribute::LimparDados()
{
