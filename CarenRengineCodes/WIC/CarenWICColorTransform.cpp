...
//Destruidor.
CarenWICColorTransform::~CarenWICColorTransform()
{
...
CarenResult CarenWICColorTransform::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenWICColorTransform::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<IWICColorTransform*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenWICColorTransform::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IWICColorTransform*>(Param_PonteiroNativo);
...
CarenResult CarenWICColorTransform::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICColorTransform::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICColorTransform::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenWICColorTransform::StatusPonteiro()
{
...
/// </summary>
Int32 CarenWICColorTransform::ObterCodigoErro()
{
...
/// </summary>
void CarenWICColorTransform::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenWICColorTransform::LiberarReferencia()
{
...
/// </summary>
void CarenWICColorTransform::LimparDados()
{
...
/// </summary>
void CarenWICColorTransform::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenWICColorTransform();
}



// Métodos da interface proprietária(ICarenWICColorTransform)
...
CarenResult CarenWICColorTransform::Initialize(
...
String^ Param_GuidFormatoPixelDestino)
{
	...
	IWICColorContext* pFonteColorContext = NULL;
	IWICColorContext* pDestinoColorContext = NULL;
	GUID GuidPixelDestino = GUID_NULL;
	...
	//Recupera o ponteiro para o contexto de cores fonte.
	Resultado = RecuperarPonteiroCaren(Param_FonteContexto, &pFonteColorContext);

	//Sai do método em caso de erro.
	SairOnError(Resultado);

	//Recupera o ponteiro para o contexto de cores de destino.
	Resultado = RecuperarPonteiroCaren(Param_DestinoContexto, &pDestinoColorContext);

	//Sai do método em caso de erro.
	SairOnError(Resultado);

	//Converte a string para o guid do pixel
	GuidPixelDestino = Util.CreateGuidFromString(Param_GuidFormatoPixelDestino);

	//Chama o método para realizar a operação.
	Hr = PonteiroTrabalho->Initialize(pBitmapSource, pFonteColorContext, pDestinoColorContext, GuidPixelDestino);
...
CarenResult CarenWICColorTransform::CopyPalette(ICaren^ Param_Palette)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICColorTransform::CopyPixels(
...
CarenResult CarenWICColorTransform::GetPixelFormat([Out] String^% Param_Out_FormatoPixel)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICColorTransform::GetResolution(
...
CarenResult CarenWICColorTransform::GetSize(
