...
public:
	static operator CarenMFFinalizableMediaSink^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFFinalizableMediaSink^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFFinalizableMediaSink();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFFinalizableMediaSink*>(Param_Pointer.ToPointer());
