...
namespace CarenRengine
{
	...
	namespace MediaFoundation
	{
		...
		public interface class ICarenMFAttributes : ICaren
		{
			...
			CarenResult Compare(ICarenMFAttributes^ Param_InterfaceCompare, CA_MF_ATTRIBUTES_MATCH_TYPE Param_TipoComparação, OutParam Boolean% Param_Out_Resultado);
		...
		public interface class ICarenMFMediaEventGenerator : ICaren
		{
			...
			CarenResult QueueEvent(Enumeracoes::CA_MediaEventType Param_TipoEvento, String^ Param_GuidExtendedType, Int32 Param_HResultCode, CA_PROPVARIANT^ Param_Dados);
		};
		...
		public interface class ICarenMFCaptureSource : ICaren
		{
			...
			/// <param name="Param_RIID">O identificador de interface (IID) da interface que está sendo solicitada. O valor deve ser IID_IMFSourceReader. Se o valor não estiver definido para IID_IMFSourceReader,a chamada falhará e retornará ER_E_INVALIDARG.</param>
