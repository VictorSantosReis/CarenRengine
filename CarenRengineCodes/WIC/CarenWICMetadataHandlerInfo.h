...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por expor métodos que fornecem informações básicas sobre o manipulador de metadados registrado.
/// </summary>
public ref class CarenWICMetadataHandlerInfo : public ICarenWICMetadataHandlerInfo
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IWICMetadataHandlerInfo).
	IWICMetadataHandlerInfo* PonteiroTrabalho = NULL;
...
public:
	static operator CarenWICMetadataHandlerInfo^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenWICMetadataHandlerInfo^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenWICMetadataHandlerInfo();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IWICMetadataHandlerInfo*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenWICMetadataHandlerInfo::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
