...
public:
	...
	virtual CarenResult ClonarDe(ICarenMFTopologyNode^ Param_NodeClone);
	...
	virtual CarenResult ConectarSaida(UInt32 Param_IndexFluxoSaida, ICarenMFTopologyNode^ Param_NoConexao, UInt32 Param_IndexFluxoEntrada);
	...
	virtual CarenResult DesconectarSaida(UInt32 Param_IndexSaida);
	...
	virtual CarenResult ObterEntrada(UInt32 Param_IndexEntrada, [Out] ICarenMFTopologyNode^% Param_Out_NoConectado, [Out] UInt32% Param_Out_IndexFluxoSaida);
	...
	virtual CarenResult ObterQuantidadeEntradas([Out] UInt32% Param_Out_QuantidadeFluxosEntrada);
	...
	virtual CarenResult ObterTipoMidiaPreferencialEntrada(UInt32 Param_IndexEntrada, [Out] ICarenMFMediaType^% Param_Out_TipoMidiaPreferencial);
	...
	virtual CarenResult ObterTipoNode([Out] Enumeracoes::CA_TOPOLOGY_TYPE% Param_Out_TipoNode);
	...
	virtual CarenResult ObterSaida(UInt32 Param_IndexSaidaFluxo, [Out] ICarenMFTopologyNode^% Param_Out_NodeConexao, [Out] UInt32% Param_Out_IndexEntradaFluxo);
	...
	virtual CarenResult ObterQuantidadeSaidas([Out] UInt32% Param_Out_QuantidadeFluxosSaida);
	...
	virtual CarenResult ObterTipoMidiaPreferencialSaida(UInt32 Param_IndexSaida, [Out] ICarenMFMediaType^% Param_Out_TipoMidiaPreferencial);
	...
	virtual CarenResult ObterTopoNodeID([Out] UInt64% Param_Out_IdentificadorNode);
	...
	virtual CarenResult DefinirTipoMidiaPreferencialEntrada(UInt32 Param_IndexFluxoEntrada, ICarenMFMediaType^ Param_TipoMidia);
	...
	virtual CarenResult DefinirObjeto(ICaren^ Param_Objeto);
	...
	virtual CarenResult DefinirTipoMidiaPreferencialSaida(UInt32 Param_IndexFluxoSaida, ICarenMFMediaType^ Param_TipoMidia);
	...
	virtual CarenResult DefinirTopoNodeID(UInt64 Param_IdentificadorNode);
