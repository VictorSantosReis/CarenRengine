...
//Destruidor.
CarenD2D1DrawingStateBlock::~CarenD2D1DrawingStateBlock()
{
...
CarenResult CarenD2D1DrawingStateBlock::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD2D1DrawingStateBlock::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1DrawingStateBlock*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1DrawingStateBlock::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1DrawingStateBlock*>(Param_PonteiroNativo);
...
CarenResult CarenD2D1DrawingStateBlock::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1DrawingStateBlock::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1DrawingStateBlock::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenD2D1DrawingStateBlock::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD2D1DrawingStateBlock::ObterCodigoErro()
{
...
/// </summary>
void CarenD2D1DrawingStateBlock::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD2D1DrawingStateBlock::LiberarReferencia()
{
...
/// </summary>
void CarenD2D1DrawingStateBlock::LimparDados()
{
...
/// </summary>
void CarenD2D1DrawingStateBlock::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenD2D1DrawingStateBlock();
}
...
void CarenD2D1DrawingStateBlock::GetDescription([Out] CA_D2D1_DRAWING_STATE_DESCRIPTION^% Param_Out_DescEstado)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
CarenResult CarenD2D1DrawingStateBlock::GetTextRenderingParams(ICaren^ Param_Out_TextRenderingParams)
{
...
void CarenD2D1DrawingStateBlock::SetDescription(CA_D2D1_DRAWING_STATE_DESCRIPTION^ Param_DescEstado)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
CarenResult CarenD2D1DrawingStateBlock::SetTextRenderingParams(ICaren^ Param_TextRenderingParams)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
void CarenD2D1DrawingStateBlock::GetFactory(ICaren^ Param_Out_Factory)
{
	//Variaveis a serem utilizadas.
