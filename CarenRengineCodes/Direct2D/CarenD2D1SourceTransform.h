...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD2D1SourceTransform">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD2D1SourceTransform^% Param_Out_CarenD2D1SourceTransform)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);

		//Cria a interface
		Param_Out_CarenD2D1SourceTransform = gcnew CarenD2D1SourceTransform();
