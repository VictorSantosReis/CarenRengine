...
/// <summary>
/// Classe responsável por Uma implementação especializada dos cálculos de Shantzis para uma transformação implementada na GPU.
/// </summary>
public ref class CarenD2D1DrawTransform : public ICarenD2D1DrawTransform
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID2D1DrawTransform).
...
public:
	static operator CarenD2D1DrawTransform^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1DrawTransform^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1DrawTransform();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1DrawTransform*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD2D1DrawTransform::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenD2D1DrawTransform)
public:
	/// <summary>
	...
	virtual CarenResult SetDrawInfo(ICarenD2D1DrawInfo^ Param_DrawInfo);
