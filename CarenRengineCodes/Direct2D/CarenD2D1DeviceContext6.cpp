...
#include "../pch.h"
#include "CarenD2D1DeviceContext6.h"

//Destruidor.
CarenD2D1DeviceContext6::~CarenD2D1DeviceContext6()
{
...
CarenResult CarenD2D1DeviceContext6::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD2D1DeviceContext6::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1DeviceContext6*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1DeviceContext6::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1DeviceContext6*>(Param_PonteiroNativo);
...
CarenResult CarenD2D1DeviceContext6::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1DeviceContext6::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1DeviceContext6::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenD2D1DeviceContext6::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD2D1DeviceContext6::ObterCodigoErro()
{
...
/// </summary>
void CarenD2D1DeviceContext6::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD2D1DeviceContext6::LiberarReferencia()
{
...
/// </summary>
void CarenD2D1DeviceContext6::LimparDados()
{
...
/// </summary>
void CarenD2D1DeviceContext6::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenD2D1DeviceContext6();
}



// Métodos da interface proprietária(ICarenD2D1DeviceContext6)
...
void CarenD2D1DeviceContext6::BlendImage(
...
CA_D2D1_INTERPOLATION_MODE Param_ModoInterpolacao)
{
	...
	D2D1_POINT_2F* pTargetOffset = NULL;//Pode ser NULO.
	D2D1_RECT_F* pRetanguloImagem = NULL;//Pode ser NULO.

	//Recupera o ponteiro para a interface da imagem.
	RecuperarPonteiroCaren(Param_Imagem, &pImage);

	//Converte as estruturas.
	pTargetOffset = ObjetoGerenciadoValido(Param_TargetOffset) ? Util.ConverterD2D1_POINT_2FManagedToUnmanaged(Param_TargetOffset) : NULL;
	pRetanguloImagem = ObjetoGerenciadoValido(Param_RetanguloImagem) ? Util.ConverterD2D1_RECT_FManagedToUnmanaged(Param_RetanguloImagem) : NULL;

	//Chama o método para realizar a operação.
	PonteiroTrabalho->BlendImage
	(
		pImage,
		static_cast<D2D1_BLEND_MODE>(Param_BlendMode),
		pTargetOffset,
		pRetanguloImagem,
		static_cast<D2D1_INTERPOLATION_MODE>(Param_ModoInterpolacao)
	);

	//Libera a memória utilizada pelas estruturas
	DeletarEstruturaSafe(&pTargetOffset);
	DeletarEstruturaSafe(&pRetanguloImagem);
}
...
CarenResult CarenD2D1DeviceContext6::CreateColorContextFromDxgiColorSpace(
...
/// <param name="Param_Out_ColorContext">Retorna uma interface(ICarenD2D1ColorContext1) que contém um ponteiro para o novo contexto do dispositivo.</param>
CarenResult CarenD2D1DeviceContext6::CreateColorContextFromSimpleColorProfile(
...
CarenResult CarenD2D1DeviceContext6::CreateSvgDocument(
...
void CarenD2D1DeviceContext6::DrawSvgDocument(ICarenD2D1SvgDocument^ Param_SvgDocumento)
{
	//Variaveis a serem utilizadas.
...
CarenResult CarenD2D1DeviceContext6::CreateSvgGlyphStyle(
...
void CarenD2D1DeviceContext6::DrawColorBitmapGlyphRun(
...
void CarenD2D1DeviceContext6::DrawSvgGlyphRun(
	CA_D2D1_POINT_2F^ Param_BaselineOrigin,
	CA_DWRITE_GLYPH_RUN^ Param_GlyphRun,
...
void CarenD2D1DeviceContext6::DrawText(
	String^ Param_Texto,
...
/// <param name="Param_ColorPaletteIndex">O índice usado para selecionar uma paleta de cores dentro de uma fonte de cor.</param>
/// <param name="Param_Opcoes">Um valor que indica se o texto deve ser encaixado nos limites do pixel e se o texto deve ser cortado no retângulo de layout. O valor padrão é D2D1_DRAW_TEXT_OPTIONS_NONE, o que indica que o texto deve ser encaixado nos limites do pixel e não deve ser cortado para o retângulo de layout.</param>
void CarenD2D1DeviceContext6::DrawTextLayout(
...
CarenResult CarenD2D1DeviceContext6::GetColorBitmapGlyphImage(
	CA_DWRITE_GLYPH_IMAGE_FORMATS Param_GlyphImageFormat,
...
CarenResult CarenD2D1DeviceContext6::GetSvgGlyphImage(
	CA_D2D1_POINT_2F^ Param_GlyphOrigin,
	ICaren^ Param_FontFace,
	float Param_FontSize,
	UInt16 Param_GlyphIndex,
...
CarenResult CarenD2D1DeviceContext6::CreateSpriteBatch(
...
void CarenD2D1DeviceContext6::DrawSpriteBatch(
...
CarenResult CarenD2D1DeviceContext6::CreateGradientMesh(
...
CarenResult CarenD2D1DeviceContext6::CreateImageSourceFromDxgi(
...
CarenResult CarenD2D1DeviceContext6::CreateImageSourceFromWic(
...
CarenResult CarenD2D1DeviceContext6::CreateInk(
...
CarenResult CarenD2D1DeviceContext6::CreateInkStyle(
...
CarenResult CarenD2D1DeviceContext6::CreateLookupTable3D(
...
CarenResult CarenD2D1DeviceContext6::CreateTransformedImageSource(
...
void CarenD2D1DeviceContext6::DrawGdiMetafile(
...
void CarenD2D1DeviceContext6::DrawGradientMesh(
...
void CarenD2D1DeviceContext6::DrawInk(
...
CarenResult CarenD2D1DeviceContext6::GetGradientMeshWorldBounds(
	ICarenD2D1GradientMesh^ Param_GradientMesh,
...
CarenResult CarenD2D1DeviceContext6::CreateFilledGeometryRealization(
...
/// <param name="Param_Out_GeometryRealization">Retorna uma interface(ICarenD2D1GeometryRealization) que contém um ponteiro para o novo objeto de realização.</param>
CarenResult CarenD2D1DeviceContext6::CreateStrokedGeometryRealization(
	ICarenD2D1Geometry^ Param_Geometria,
	float Param_FlatterningTolerance,
...
void CarenD2D1DeviceContext6::DrawGeometryRealization(
...
CarenResult CarenD2D1DeviceContext6::CreateBitmap(
...
CarenResult CarenD2D1DeviceContext6::CreateBitmapBrush(
	ICarenD2D1Bitmap^ Param_Bitmap,
...
CarenResult CarenD2D1DeviceContext6::CreateBitmapFromDxgiSurface(
...
/// <param name="Param_Out_Bitmap">Retorna uma interface(ICarenD2D1Bitmap1) que contém um ponteiro para um novo objeto bitmap.</param>
CarenResult CarenD2D1DeviceContext6::CreateBitmapFromWicBitmap(
	ICaren^ Param_WicBitmapSource,
	CA_D2D1_BITMAP_PROPERTIES1^ Param_PropsBitmap,
	[Out] ICarenD2D1Bitmap1^% Param_Out_Bitmap)
{
...
CarenResult CarenD2D1DeviceContext6::CreateColorContext(
...
/// <param name="Param_Out_ColorContext">Retorna uma interface(ICarenD2D1ColorContext) que contém um ponteiro para o novo objeto de contexto de cores.</param>
CarenResult CarenD2D1DeviceContext6::CreateColorContextFromFilename(
...
/// <param name="Param_Out_ColorContext">Retorna uma interface(ICarenD2D1ColorContext) que contém um ponteiro para o novo objeto de contexto de cores.</param>
CarenResult CarenD2D1DeviceContext6::CreateColorContextFromWicColorContext(
...
CarenResult CarenD2D1DeviceContext6::CreateCommandList(
...
CarenResult CarenD2D1DeviceContext6::CreateEffect(
...
CarenResult CarenD2D1DeviceContext6::CreateGradientStopCollection(
...
CarenResult CarenD2D1DeviceContext6::CreateImageBrush(
...
CarenResult CarenD2D1DeviceContext6::DrawBitmap(
	ICarenD2D1Bitmap^ Param_Bitmap,
	CA_D2D1_RECT_F^ Param_RetanguloDestino,
...
void CarenD2D1DeviceContext6::DrawGlyphRun(
	CA_D2D1_POINT_2F^ Param_BaseLineOrigin,
	CA_DWRITE_GLYPH_RUN^ Param_GlyphRun,
...
void CarenD2D1DeviceContext6::DrawImage(
	ICarenD2D1Image^ Param_Image,
	CA_D2D1_POINT_2F^ Param_TargetOffset,
	CA_D2D1_RECT_F^ Param_RetanguloImagem,
	CA_D2D1_INTERPOLATION_MODE Param_InterpolationMode,
...
void CarenD2D1DeviceContext6::FillOpacityMask(
...
void CarenD2D1DeviceContext6::GetDevice(ICaren^ Param_Out_Dispositivo)
{
	//Variaveis a serem utilizadas.
...
CarenResult CarenD2D1DeviceContext6::GetEffectInvalidRectangleCount(
	ICarenD2D1Effect^ Param_Efeito,
...
CarenResult CarenD2D1DeviceContext6::GetEffectInvalidRectangles(
	ICarenD2D1Effect^ Param_Efeito,
...
CarenResult CarenD2D1DeviceContext6::GetEffectRequiredInputRectangles(
	ICarenD2D1Effect^ Param_Efeito,
...
CarenResult CarenD2D1DeviceContext6::GetGlyphRunWorldBounds(
	CA_D2D1_POINT_2F^ Param_BaseLineOrigin,
...
CarenResult CarenD2D1DeviceContext6::GetImageLocalBounds(
	ICarenD2D1Image^ Param_Image,
...
CarenResult CarenD2D1DeviceContext6::GetImageWorldBounds(
	ICarenD2D1Image^ Param_Image,
...
void CarenD2D1DeviceContext6::GetPrimitiveBlend(
...
void CarenD2D1DeviceContext6::GetRenderingControls(
...
CarenResult CarenD2D1DeviceContext6::GetTarget(
...
void CarenD2D1DeviceContext6::GetUnitMode([Out] CA_D2D1_UNIT_MODE Param_Out_Unit)
{
	//Chama o método para realizar a operação.
...
CarenResult CarenD2D1DeviceContext6::InvalidateEffectInputRectangle(
	ICarenD2D1Effect^ Param_Efeito,
...
void CarenD2D1DeviceContext6::IsBufferPrecisionSupported(
	CA_D2D1_BUFFER_PRECISION  Param_BufferPrecision,
...
void CarenD2D1DeviceContext6::IsDxgiFormatSupported(
...
void CarenD2D1DeviceContext6::PushLayer(
...
void CarenD2D1DeviceContext6::SetPrimitiveBlend(CA_D2D1_PRIMITIVE_BLEND Param_PrimitiveBlend)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1DeviceContext6::SetRenderingControls(CA_D2D1_RENDERING_CONTROLS^ Param_ControlesRenderizacao)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void CarenD2D1DeviceContext6::SetTarget(ICarenD2D1Image^ Param_Imagem)
{
	//Variaveis a serem utilizadas.
	ID2D1Image* pMyImage = NULL;
...
void CarenD2D1DeviceContext6::SetUnitMode(CA_D2D1_UNIT_MODE Param_UnitMode)
{
	//Chama o método para realizar a operação.
...
/// </summary>
void CarenD2D1DeviceContext6::BeginDraw()
{
	//Chama o método para realizar a operação.
...
void CarenD2D1DeviceContext6::Clear(CA_D2D1_COLOR_F^ Param_ClearColor)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
CarenResult CarenD2D1DeviceContext6::CreateCompatibleRenderTarget(
...
/// </summary>
/// <param name="Param_Out_BitmapRenderTarget">Retorna a interface (ICarenD2D1BitmapRenderTarget) que contém um ponteiro para um novo alvo de renderização bitmap. O usuário deve inicializar a interface antes de chamar este método.</param>
CarenResult CarenD2D1DeviceContext6::CreateCompatibleRenderTarget(ICaren^ Param_Out_BitmapRenderTarget)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1DeviceContext6::CreateLayer(
...
/// </summary>
/// <param name="Param_Out_Layer">Retorna a interface ICarenD2D1Layer que contém um ponteiro para a nova camada(Layer).</param>
CarenResult CarenD2D1DeviceContext6::CreateLayer([Out] ICarenD2D1Layer^% Param_Out_Layer)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1DeviceContext6::CreateLinearGradientBrush(
...
CarenResult CarenD2D1DeviceContext6::CreateMesh([Out] ICarenD2D1Mesh^% Param_Out_Mesh)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1DeviceContext6::CreateRadialGradientBrush(
...
CarenResult CarenD2D1DeviceContext6::CreateSharedBitmap(
	String^ Param_Riid,
...
CarenResult CarenD2D1DeviceContext6::CreateSolidColorBrush(
...
CarenResult CarenD2D1DeviceContext6::DrawEllipse(
...
CarenResult CarenD2D1DeviceContext6::DrawGeometry(
	ICarenD2D1Geometry^ Param_Geometria,
	ICarenD2D1Brush^ Param_Brush,
	float Param_StrokeWidth,
	ICarenD2D1StrokeStyle^ Param_StrokeStyle)
...
CarenResult CarenD2D1DeviceContext6::DrawGlyphRun(
	CA_D2D1_POINT_2F^ Param_BaseLineOrigin,
	CA_DWRITE_GLYPH_RUN^ Param_GlyphRun,
	ICarenD2D1Brush^ Param_ForegroundBrush,
	CA_DWRITE_MEASURING_MODE Param_MeasuringMode)
...
CarenResult CarenD2D1DeviceContext6::DrawLine(
...
CarenResult CarenD2D1DeviceContext6::DrawRectangle(
...
CarenResult CarenD2D1DeviceContext6::DrawRoundedRectangle(
...
/// <param name="Param_MeasuringMode">Um valor que indica como as métricas do glifo(Glyph) são usadas para medir o texto quando ele é formatado. O valor padrão é DWRITE_MEASURING_MODE_NATURAL.</param>
CarenResult CarenD2D1DeviceContext6::DrawText(
	String^ Param_Texto,
...
/// <param name="Param_Opcoes">Um valor que indica se o texto deve ser encaixado nos limites do pixel e se o texto deve ser cortado no retângulo de layout. O valor padrão é D2D1_DRAW_TEXT_OPTIONS_NONE, 
/// o que indica que o texto deve ser encaixado nos limites do pixel e não deve ser cortado para o retângulo de layout.</param>
CarenResult CarenD2D1DeviceContext6::DrawTextLayout(
...
CarenResult CarenD2D1DeviceContext6::EndDraw(
...
CarenResult CarenD2D1DeviceContext6::FillEllipse(
	CA_D2D1_ELLIPSE^ Param_Ellipse,
	ICarenD2D1Brush^ Param_Brush)
{
	//Variavel a ser retornada.
...
CarenResult CarenD2D1DeviceContext6::FillGeometry(
	ICarenD2D1Geometry^ Param_Geometria,
	ICarenD2D1Brush^ Param_Brush,
...
CarenResult CarenD2D1DeviceContext6::FillMesh(
...
CarenResult CarenD2D1DeviceContext6::FillOpacityMask(
...
CarenResult CarenD2D1DeviceContext6::FillRectangle(
	CA_D2D1_RECT_F^ Param_Rect,
	ICarenD2D1Brush^ Param_Brush)
{
	//Variavel a ser retornada.
...
CarenResult CarenD2D1DeviceContext6::FillRoundedRectangle(
...
/// <param name="Param_Out_Tag1">Quando este método retorna, contém a tag para operações de desenho que causaram erros ou 0 se não houver erros.</param>
/// <param name="Param_Out_Tag2">Quando este método retorna, contém a tag para operações de desenho que causaram erros ou 0 se não houver erros.</param>
CarenResult CarenD2D1DeviceContext6::Flush(
	[Out] UInt64% Param_Out_Tag1,
	[Out] UInt64% Param_Out_Tag2)
{
	//Variavel a ser retornada.
...
void CarenD2D1DeviceContext6::GetAntialiasMode([Out] CA_D2D1_ANTIALIAS_MODE% Param_Out_AntialiasMode)
{
	//Variaveis a serem utilizadas.
...
void CarenD2D1DeviceContext6::GetDpi(
...
void CarenD2D1DeviceContext6::GetMaximumBitmapSize([Out] UInt32% Param_Out_MaximumSize)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1DeviceContext6::GetPixelFormat([Out] CA_D2D1_PIXEL_FORMAT^% Param_Out_PixelFormat)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void CarenD2D1DeviceContext6::GetPixelSize([Out] CA_D2D1_SIZE_U^% Param_Out_PixelSize)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void CarenD2D1DeviceContext6::GetSize([Out] CA_D2D1_SIZE_F^% Param_Out_Size)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void CarenD2D1DeviceContext6::GetTags(
	[Out] UInt64% Param_Out_Tag1,
	[Out] UInt64% Param_Out_Tag2)
{
	//Variaveis a serem utilizadas.
...
void CarenD2D1DeviceContext6::GetTextAntialiasMode([Out] CA_D2D1_TEXT_ANTIALIAS_MODE% Param_Out_TextAntialiasMode)
{
	//Variaveis a serem utilizadas.
...
void CarenD2D1DeviceContext6::GetTextRenderingParams(ICaren^ Param_Out_TextRenderingParams)
{
	//Variaveis a serem utilizadas.
...
void CarenD2D1DeviceContext6::GetTransform([Out] CA_D2D1_MATRIX_3X2_F^% Param_Out_Transform)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void CarenD2D1DeviceContext6::IsSupported(
...
/// ou ICarenD2D1RenderTarget::Flush.
/// </summary>
void CarenD2D1DeviceContext6::PopAxisAlignedClip()
{
	//Chama o método para realizar a operação.
...
/// ou ICarenD2D1RenderTarget::Flush.
/// </summary>
void CarenD2D1DeviceContext6::PopLayer()
{
	//Chama o método para realizar a operação.
...
void CarenD2D1DeviceContext6::PushAxisAlignedClip(
...
CarenResult CarenD2D1DeviceContext6::RestoreDrawingState(ICarenD2D1DrawingStateBlock^ Param_DrawingStateBlock)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1DeviceContext6::SaveDrawingState(ICarenD2D1DrawingStateBlock^ Param_DrawingStateBlock)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
void CarenD2D1DeviceContext6::SetAntialiasMode(CA_D2D1_ANTIALIAS_MODE Param_AntialiasMode)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1DeviceContext6::SetDpi(
	float Param_DpiX,
	float Param_DpiY)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1DeviceContext6::SetTags(
	UInt64 Param_Tag1,
	UInt64 Param_Tag2)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1DeviceContext6::SetTextAntialiasMode(CA_D2D1_TEXT_ANTIALIAS_MODE Param_TextAntialiasMode)
{
	//Chama o método para realizar a operação.
...
CarenResult CarenD2D1DeviceContext6::SetTextRenderingParams(ICaren^ Param_TextRenderingParams)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
void CarenD2D1DeviceContext6::SetTransform(CA_D2D1_MATRIX_3X2_F^ Param_Transform)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void  CarenD2D1DeviceContext6::GetFactory(ICaren^ Param_Out_Factory)
{
	//Variaveis a serem utilizadas.
