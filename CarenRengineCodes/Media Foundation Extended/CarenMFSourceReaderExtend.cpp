...
/// <returns></returns>
CarenResult CarenMFSourceReaderExtend::ExReadSampleAsync(UInt32 Param_StreamIndex)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenMFSourceReaderExtend::GetPresentationAttribute(UInt32 Param_IdFluxo, String^ Param_GuidAtributo, [Out] CA_PROPVARIANT^% Param_Out_ValorAtributo)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
