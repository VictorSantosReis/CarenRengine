...
CarenResult CarenWICMetadataBlockWriter::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IWICMetadataBlockWriter*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenWICMetadataBlockWriter::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IWICMetadataBlockWriter*>(Param_PonteiroNativo);
...
/// </summary>
Int32 CarenWICMetadataBlockWriter::ObterCodigoErro()
{
...
/// </summary>
void CarenWICMetadataBlockWriter::LimparDados()
{
