...
public:
	static operator CarenD3D11Device5^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD3D11Device5^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD3D11Device5();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID3D11Device5*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD3D11Device5::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
...
public:
	...
	virtual CarenResult CreateFence(
	...
	virtual CarenResult OpenSharedFence(
		IntPtr Param_Handle,
		String^ Param_RIIDInterface,
		ICarenD3D11Fence^% Param_Ref_FenceInterface);
