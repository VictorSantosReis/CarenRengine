...
#include "../pch.h"
#include "CarenD2D1Device6.h"

//Destruidor.
CarenD2D1Device6::~CarenD2D1Device6()
{
...
CarenResult CarenD2D1Device6::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD2D1Device6::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1Device6*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1Device6::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1Device6*>(Param_PonteiroNativo);
...
CarenResult CarenD2D1Device6::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1Device6::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1Device6::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenD2D1Device6::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD2D1Device6::ObterCodigoErro()
{
...
/// </summary>
void CarenD2D1Device6::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD2D1Device6::LiberarReferencia()
{
...
/// </summary>
void CarenD2D1Device6::LimparDados()
{
...
/// </summary>
void CarenD2D1Device6::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenD2D1Device6();
}



// Métodos da interface proprietária(ICarenD2D1Device6)
...
CarenResult CarenD2D1Device6::CreateDeviceContext(
...
[Out] ICarenD2D1DeviceContext6^% Param_Out_ContextoDispositivo6)
{
	...
	//Variaveis a serem utilizadas.
	ID2D1DeviceContext6* pOutContexto = NULL;
	...
	Param_Out_ContextoDispositivo6 = gcnew CarenD2D1DeviceContext6();

	//Define o ponteiro na interface.
	Resultado = DefinirPonteiroInterface(pOutContexto, Param_Out_ContextoDispositivo6);
...
// Métodos da interface (ICarenD2D1Device5)
	...
	[Out] ICarenD2D1DeviceContext5^% Param_Out_ContextoDispositivo5)
{
	...
	//Variaveis a serem utilizadas.
	ID2D1DeviceContext5* pOutContexto = NULL;
	...
	//Cria a interface a ser retornada.
	Param_Out_ContextoDispositivo5 = gcnew CarenD2D1DeviceContext5();

	//Define o ponteiro na interface.
	Resultado = DefinirPonteiroInterface(pOutContexto, Param_Out_ContextoDispositivo5);
	...
	[Out] ICarenD2D1DeviceContext4^% Param_Out_ContextoDispositivo4)
{
	...
	//Variaveis a serem utilizadas.
	ID2D1DeviceContext4* pOutContexto = NULL;
	...
	//Cria a interface a ser retornada.
	Param_Out_ContextoDispositivo4 = gcnew CarenD2D1DeviceContext4();

	//Define o ponteiro na interface.
	Resultado = DefinirPonteiroInterface(pOutContexto, Param_Out_ContextoDispositivo4);
...
void CarenD2D1Device6::GetMaximumColorGlyphCacheMemory([Out] UInt64% Param_Out_MaximoInBytes)
{
	//Chama o método para realizar a operação.
	Param_Out_MaximoInBytes = PonteiroTrabalho->GetMaximumColorGlyphCacheMemory();
}
...
void CarenD2D1Device6::SetMaximumColorGlyphCacheMemory(UInt64 Param_MaximumInBytes)
{
	//Chama o método para realizar a operação.
	PonteiroTrabalho->SetMaximumColorGlyphCacheMemory(Param_MaximumInBytes);
}
	...
	[Out] ICarenD2D1DeviceContext3^% Param_Out_ContextoDispositivo3)
{
	...
	//Variaveis a serem utilizadas.
	ID2D1DeviceContext3* pOutContexto = NULL;
	...
	//Cria a interface a ser retornada.
	Param_Out_ContextoDispositivo3 = gcnew CarenD2D1DeviceContext3();

	//Define o ponteiro na interface.
	Resultado = DefinirPonteiroInterface(pOutContexto, Param_Out_ContextoDispositivo3);
...
void CarenD2D1Device6::FlushDeviceContexts(ICarenD2D1Bitmap^ Param_Bitmap)
{
	//Variaveis a serem utilizadas.
...
CarenResult CarenD2D1Device6::GetDxgiDevice([Out] ICarenDXGIDevice^% Param_Out_DxgiDevice)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1Device6::CreateDeviceContext(CA_D2D1_DEVICE_CONTEXT_OPTIONS Param_Opcoes, [Out] ICarenD2D1DeviceContext1^% Param_Out_ContextoDispositivo1)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
void CarenD2D1Device6::GetRenderingPriority(
...
void CarenD2D1Device6::SetRenderingPriority(CA_D2D1_RENDERING_PRIORITY Param_Prioridade)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1Device6::ClearResources(UInt32 Param_Miliseconds)
{
	//Chama o método para realizar a operação.
...
CarenResult CarenD2D1Device6::CreatePrintControl(
...
void CarenD2D1Device6::GetMaximumTextureMemory([Out] UInt64% Param_Out_MaxSizeMemory)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1Device6::SetMaximumTextureMemory(UInt64 Param_MaxSizeMemory)
{
	//Chama o método para realizar a operação.
