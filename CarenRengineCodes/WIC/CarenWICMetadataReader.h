...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por expor métodos que fornecem acesso ao conteúdo de metadados sublinhado. Essa interface é implementada por fornecedores 
/// independentes de software (ISVs) para criar novos leitores de metadados.
/// </summary>
public ref class CarenWICMetadataReader : public ICarenWICMetadataReader
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IWICMetadataReader).
	IWICMetadataReader* PonteiroTrabalho = NULL;
...
public:
	static operator CarenWICMetadataReader^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenWICMetadataReader^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenWICMetadataReader();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IWICMetadataReader*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenWICMetadataReader::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
