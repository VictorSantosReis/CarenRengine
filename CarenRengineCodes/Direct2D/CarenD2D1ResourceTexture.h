...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por rastreiar uma textura de recurso criada por transformação.
/// </summary>
public ref class CarenD2D1ResourceTexture : public ICarenD2D1ResourceTexture
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID2D1ResourceTexture).
...
public:
	static operator CarenD2D1ResourceTexture^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1ResourceTexture^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1ResourceTexture();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1ResourceTexture*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD2D1ResourceTexture::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenD2D1ResourceTexture)
public:
	/// <summary>
