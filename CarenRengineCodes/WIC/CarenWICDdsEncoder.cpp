...
CarenResult CarenWICDdsEncoder::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IWICDdsEncoder*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenWICDdsEncoder::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IWICDdsEncoder*>(Param_PonteiroNativo);
...
/// </summary>
void CarenWICDdsEncoder::LimparDados()
{
