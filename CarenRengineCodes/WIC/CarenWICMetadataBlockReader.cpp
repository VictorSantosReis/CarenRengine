...
#include "../pch.h"
#include "CarenWICMetadataBlockReader.h"
...
CarenResult CarenWICMetadataBlockReader::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenWICMetadataBlockReader::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<IWICMetadataBlockReader*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenWICMetadataBlockReader::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IWICMetadataBlockReader*>(Param_PonteiroNativo);
...
CarenResult CarenWICMetadataBlockReader::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICMetadataBlockReader::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICMetadataBlockReader::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenWICMetadataBlockReader::StatusPonteiro()
{
...
/// </summary>
Int32 CarenWICMetadataBlockReader::ObterCodigoErro()
{
...
/// </summary>
void CarenWICMetadataBlockReader::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenWICMetadataBlockReader::LiberarReferencia()
{
...
/// </summary>
void CarenWICMetadataBlockReader::LimparDados()
{
...
/// </summary>
void CarenWICMetadataBlockReader::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenWICMetadataBlockReader();
}



// Métodos da interface proprietária(ICarenWICMetadataBlockReader)
...
CarenResult CarenWICMetadataBlockReader::GetContainerFormat([Out] String^% Param_Out_GuidFormatoContainer)
{
...
CarenResult CarenWICMetadataBlockReader::GetCount([Out] UInt32% Param_Out_Quantidade)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICMetadataBlockReader::GetEnumerator([Out] ICarenEnumUnknown^% Param_Out_EnumMetadata)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICMetadataBlockReader::GetReaderByIndex(
UInt32 Param_Index,
