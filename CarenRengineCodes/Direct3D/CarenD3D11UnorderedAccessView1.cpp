...
CarenResult CarenD3D11UnorderedAccessView1::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
	...
	Hr = (reinterpret_cast<ID3D11UnorderedAccessView1*>(PonteiroTrabalho))->QueryInterface(GuidInterface, (LPVOID*)&pInterfaceSolcitada);
...
CarenResult CarenD3D11UnorderedAccessView1::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<ID3D11UnorderedAccessView1*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD3D11UnorderedAccessView1::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID3D11UnorderedAccessView1*>(Param_PonteiroNativo);
...
/// </summary>
Int32 CarenD3D11UnorderedAccessView1::ObterCodigoErro()
{
...
{
	//Adiciona uma referência ao ponteiro
	(reinterpret_cast<ID3D11UnorderedAccessView1*>(PonteiroTrabalho))->AddRef();
}
...
void CarenD3D11UnorderedAccessView1::LiberarReferencia()
{
	...
	ULONG RefCount = (reinterpret_cast<ID3D11UnorderedAccessView1*>(PonteiroTrabalho))->Release();
...
/// </summary>
void CarenD3D11UnorderedAccessView1::LimparDados()
{
...
CarenResult CarenD3D11UnorderedAccessView1::ObterRecurso([Out] ICarenD3D11Resource^% Param_Out_Recurso)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11UnorderedAccessView1::ObterDispositivo(ICaren^ Param_Out_DispositivoD3D11)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11UnorderedAccessView1::ObterDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11UnorderedAccessView1::DefinirDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11UnorderedAccessView1::DefinirInterfaceDadosPrivados(
