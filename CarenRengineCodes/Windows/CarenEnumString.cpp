...
CarenResult CarenEnumString::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IEnumString*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenEnumString::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IEnumString*>(Param_PonteiroNativo);
...
/// </summary>
Int32 CarenEnumString::ObterCodigoErro()
{
...
/// </summary>
void CarenEnumString::LimparDados()
{
