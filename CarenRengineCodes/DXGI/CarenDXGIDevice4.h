...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenDXGIDevice4">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenDXGIDevice4^% Param_Out_CarenDXGIDevice4)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenDXGIDevice4 = gcnew CarenDXGIDevice4();
...
public:
	...
	virtual CarenResult OfertarRecursos1(
	...
	virtual CarenResult RecuperarRecursos1(
