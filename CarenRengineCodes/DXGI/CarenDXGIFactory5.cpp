...
CarenResult CarenDXGIFactory5::CheckFeatureSupport(
...
CarenResult CarenDXGIFactory5::EnumAdapterByLuid(
	CA_LUID^ Param_LUID, 
	String^ Param_RIID, 
...
/// <param name="Param_RIID">O identificador globalmente único (GUID) do objeto ICarenDXGIAdapter referenciado pelo parâmetro (Param_InterfaceAdapter).</param>
/// <param name="Param_Out_InterfaceAdapter">Recebe um ponteiro de interface ICarenDXGIAdapter para o adaptador. </param>
CarenResult CarenDXGIFactory5::EnumWarpAdapter(
	String^ Param_RIID, 
	[Out] ICaren^ Param_Out_InterfaceAdapter)
{
	//Chama o método na classe de funções compartilhadas do DXGI.
...
CarenResult CarenDXGIFactory5::GetCreationFlags(
...
/// reiniciado.</param>
CarenResult CarenDXGIFactory5::GetSharedResourceAdapterLuid(
...
CarenResult CarenDXGIFactory5::IsWindowedStereoEnabled(
...
CarenResult CarenDXGIFactory5::RegisterOcclusionStatusEvent(
...
CarenResult CarenDXGIFactory5::RegisterOcclusionStatusWindow(
...
/// registro do evento de notificação que (Param_Evento) especifica.</param>
CarenResult CarenDXGIFactory5::RegisterStereoStatusEvent(
	ICarenEvent^ Param_Evento, 
	[Out] UInt32% Param_Out_Cookie)
{
	//Chama o método na classe de funções compartilhadas do DXGI.
...
/// de notificação que (Param_WinMensagemCode) especifica.</param>
CarenResult CarenDXGIFactory5::RegisterStereoStatusWindow(
	IntPtr Param_HandleJanela, 
	UInt32 Param_WinMensagemCode, 
	[Out] UInt32% Param_Out_Cookie)
{
...
CarenResult CarenDXGIFactory5::UnregisterOcclusionStatus(
	UInt32 Param_Cookie)
{
	//Chama o método na classe de funções compartilhadas do DXGI.
...
/// </summary>
/// <param name="Param_Cookie">Um valor-chave para a janela ou evento para cancelar o registro. Esse valor é retornado nos métodos de registro de evento e janela desta interface.</param>
CarenResult CarenDXGIFactory5::UnregisterStereoStatus(
	UInt32 Param_Cookie)
{
	//Chama o método na classe de funções compartilhadas do DXGI.
...
CarenResult CarenDXGIFactory5::EnumAdapters1(
...
CarenResult CarenDXGIFactory5::IsCurrent(
...
CarenResult CarenDXGIFactory5::CreateSoftwareAdapter(
...
CarenResult CarenDXGIFactory5::CreateSwapChain(
...
/// <param name="Param_IdAdaptador">O Indice para o adaptador a ser enumerado.</param>
/// <param name="Param_Out_Adaptador">Recebe um ponteiro para a interface do adaptador no indice especificado. O chamador é responsável por liberar a interface.</param>
CarenResult CarenDXGIFactory5::EnumAdapters(
	UInt32 Param_IdAdaptador, 
	[Out] ICarenDXGIAdapter^% Param_Out_Adaptador)
{
	//Chama o método na classe de funções compartilhadas do DXGI.
...
CarenResult CarenDXGIFactory5::GetWindowAssociation(
...
CarenResult CarenDXGIFactory5::MakeWindowAssociation(
	IntPtr Param_HandleJanela, 
