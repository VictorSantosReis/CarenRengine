...
CarenResult CarenD2D1CommandSink::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1CommandSink*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1CommandSink::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1CommandSink*>(Param_PonteiroNativo);
...
/// </summary>
void CarenD2D1CommandSink::LimparDados()
{
