...
CarenResult CarenMFMediaEngineClassFactory::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IMFMediaEngineClassFactory*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenMFMediaEngineClassFactory::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IMFMediaEngineClassFactory*>(Param_PonteiroNativo);
...
/// </summary>
void CarenMFMediaEngineClassFactory::LimparDados()
{
