...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por representar um adaptador virtual; é usado para criar recursos. A ICarenD3D11Device1 adiciona novos 
/// métodos aos da ICarenD3D11Device.
/// </summary>
public ref class CarenD3D11Device1 : public ICarenD3D11Device1
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID3D11Device1).
	ID3D11Device1* PonteiroTrabalho = NULL;
...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD3D11Device1">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD3D11Device1^% Param_Out_CarenD3D11Device1)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenD3D11Device1 = gcnew CarenD3D11Device1();
