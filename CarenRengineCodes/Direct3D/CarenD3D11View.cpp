...
CarenResult CarenD3D11View::GetResource([Out] ICarenD3D11Resource^% Param_Out_Recurso)
{
...
CarenResult CarenD3D11View::GetDevice(ICaren^ Param_Out_DispositivoD3D11)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11View::GetPrivateData(
	String^ Param_Guid,
...
CarenResult CarenD3D11View::SetPrivateData(
	String^ Param_Guid,
...
CarenResult CarenD3D11View::SetPrivateDataInterface(
