...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD3D11Multithread">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD3D11Multithread^% Param_Out_CarenD3D11Multithread)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenD3D11Multithread = gcnew CarenD3D11Multithread();
