...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD2D1Brush">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD2D1Brush^% Param_Out_CarenD2D1Brush)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);

		//Cria a interface
		Param_Out_CarenD2D1Brush = gcnew CarenD2D1Brush();
