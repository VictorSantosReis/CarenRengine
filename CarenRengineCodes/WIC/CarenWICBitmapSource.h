...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por expor métodos que se referem a uma fonte da qual os pixels são recuperados, mas não podem ser gravados novamente.
/// </summary>
public ref class CarenWICBitmapSource : public ICarenWICBitmapSource
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IWICBitmapSource).
	IWICBitmapSource* PonteiroTrabalho = NULL;
...
public:
	static operator CarenWICBitmapSource^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenWICBitmapSource^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenWICBitmapSource();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IWICBitmapSource*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenWICBitmapSource::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
