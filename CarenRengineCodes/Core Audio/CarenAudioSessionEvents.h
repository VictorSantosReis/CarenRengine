...
public:
	static operator CarenAudioSessionEvents^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenAudioSessionEvents^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenAudioSessionEvents(false);

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IAudioSessionEvents*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenAudioSessionEvents::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
