...
#include "../pch.h"
#include "CarenMFVideoRenderer.h"
...
CarenResult CarenMFVideoRenderer::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenMFVideoRenderer::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<IMFVideoRenderer*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenMFVideoRenderer::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IMFVideoRenderer*>(Param_PonteiroNativo);
...
CarenResult CarenMFVideoRenderer::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenMFVideoRenderer::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenMFVideoRenderer::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenMFVideoRenderer::StatusPonteiro()
{
...
/// </summary>
Int32 CarenMFVideoRenderer::ObterCodigoErro()
{
...
/// </summary>
void CarenMFVideoRenderer::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenMFVideoRenderer::LiberarReferencia()
{
...
/// </summary>
void CarenMFVideoRenderer::LimparDados()
{
...
/// </summary>
void CarenMFVideoRenderer::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
