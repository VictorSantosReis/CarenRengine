...
//Destruidor.
CarenD3D11DeviceChild::~CarenD3D11DeviceChild()
{
...
CarenResult CarenD3D11DeviceChild::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD3D11DeviceChild::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID3D11DeviceChild*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD3D11DeviceChild::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID3D11DeviceChild*>(Param_PonteiroNativo);
...
CarenResult CarenD3D11DeviceChild::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11DeviceChild::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11DeviceChild::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenD3D11DeviceChild::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD3D11DeviceChild::ObterCodigoErro()
{
...
/// </summary>
void CarenD3D11DeviceChild::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD3D11DeviceChild::LiberarReferencia()
{
...
/// </summary>
void CarenD3D11DeviceChild::LimparDados()
{
...
/// </summary>
void CarenD3D11DeviceChild::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
...
CarenResult CarenD3D11DeviceChild::ObterDispositivo(ICaren^ Param_Out_DispositivoD3D11)
{
...
CarenResult CarenD3D11DeviceChild::ObterDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11DeviceChild::DefinirDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11DeviceChild::DefinirInterfaceDadosPrivados(
