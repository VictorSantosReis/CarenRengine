...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenDXGISwapChain">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenDXGISwapChain^% Param_Out_CarenDXGISwapChain)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenDXGISwapChain = gcnew CarenDXGISwapChain();
