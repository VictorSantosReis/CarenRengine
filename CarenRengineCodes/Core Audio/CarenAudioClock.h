...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenAudioRelogio">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenAudioClock^% Param_Out_CarenAudioRelogio)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenAudioRelogio = gcnew CarenAudioClock();
...
public:
	...
	virtual CarenResult ObterCaracteristicas([Out] UInt32% Param_Out_Caracteristicas);
	...
	virtual CarenResult ObterFrequencia([Out] UInt64% Param_Out_Frequencia);
	...
	virtual CarenResult ObterPosicao([Out] UInt64% Param_Out_Posicao, [Out] UInt64% Param_Out_QPCPosicao);
};