...
CarenResult CarenMFMediaEngineNotify::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IMFMediaEngineNotify*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenMFMediaEngineNotify::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IMFMediaEngineNotify*>(Param_PonteiroNativo);
...
/// </summary>
void CarenMFMediaEngineNotify::LimparDados()
{
