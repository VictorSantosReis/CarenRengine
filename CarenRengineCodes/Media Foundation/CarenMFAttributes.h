...
public:
	static operator CarenMFAttributes^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFAttributes^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFAttributes();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFAttributes*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFAttributes::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
