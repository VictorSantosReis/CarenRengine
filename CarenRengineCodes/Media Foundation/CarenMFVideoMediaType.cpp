...
{
	//Fixa o ponteiro.
	cli::pin_ptr<IMFVideoMediaType*> p = &PonteiroTrabalho;
...
//ICarenMFVideoMediaType não possui métodos próprios.
...
CarenResult CarenMFVideoMediaType::IsEqual(ICarenMFMediaType^ Param_MidiaCompare, [Out] CA_MF_MEDIATYPE_EQUAL% Param_Out_ResultadoCompare)
{
	//Variavel que vai retornar o resultado do método.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenMFVideoMediaType::Compare(
...
CarenResult CarenMFVideoMediaType::CompareItem(
...
CarenResult CarenMFVideoMediaType::GetAllocatedBlob(
		String^ Param_GuidChave, 
...
CarenResult CarenMFVideoMediaType::GetAllocatedString(
		String^ Param_GuidChave, 
...
CarenResult CarenMFVideoMediaType::GetBlob(
		String^ Param_GuidChave, 
...
CarenResult CarenMFVideoMediaType::GetBlobSize(
	String^ Param_GuidChave, 
...
CarenResult CarenMFVideoMediaType::GetDouble(
		String^ Param_GuidChave, 
...
/// <param name="Param_Out_Valor">Recebe o valor referente ao valor da chave solicitada</param>
CarenResult CarenMFVideoMediaType::GetGUID(
		String^ Param_GuidChave, 
...
/// <param name="Param_Out_Valor">Recebe o valor referente ao valor da chave solicitada</param>
CarenResult CarenMFVideoMediaType::GetItem(
		String^ Param_GuidChave, 
...
/// <param name="Param_Out_Valor">Recebe o valor referente ao valor da chave solicitada</param>
CarenResult CarenMFVideoMediaType::GetItemByIndex(
		UInt32 Param_IdItem, 
...
CarenResult CarenMFVideoMediaType::GetItemType(
		String^ Param_GuidChave, 
...
/// <param name="Param_Out_Valor">Recebe o valor referente ao valor da chave solicitada.</param>
CarenResult CarenMFVideoMediaType::GetString(
		String^ Param_GuidChave, 
...
CarenResult CarenMFVideoMediaType::GetStringLength(
		String^ Param_GuidChave, 
...
/// <param name="Param_Out_Valor">Recebe o valor referente ao valor da chave solicitada</param>
CarenResult CarenMFVideoMediaType::GetUINT32(
		String^ Param_GuidChave, 
...
/// <param name="Param_Out_Valor">Recebe o valor referente ao valor da chave solicitada</param>
CarenResult CarenMFVideoMediaType::GetUINT64(
		String^ Param_GuidChave, 
...
CarenResult CarenMFVideoMediaType::_MFGetAttributeRatio(
		String^ Param_GuidChave, 
...
CarenResult CarenMFVideoMediaType::_MFGetAttributeSize(
		String^ Param_GuidChave, 
		[Out] UInt32% Param_Out_Largura, 
...
CarenResult CarenMFVideoMediaType::GetUnknown(
		String^ Param_GuidChave, 
...
CarenResult CarenMFVideoMediaType::SetBlob(
		String^ Param_GuidChave, 
...
CarenResult CarenMFVideoMediaType::SetDouble(
		String^ Param_GuidChave, 
		Double Param_Valor)
{
	//Chama o método na classe de funções compartilhadas da Media Foundation.
...
/// <param name="Param_GuidChave">O GUID para a chave que vai receber o valor.</param>
/// <param name="Param_Valor">O valor a ser definido na chave especificada.</param>
CarenResult CarenMFVideoMediaType::SetGUID(
		String^ Param_GuidChave, 
		String^ Param_Valor)
{
	//Chama o método na classe de funções compartilhadas da Media Foundation.
...
CarenResult CarenMFVideoMediaType::SetItem(
		String^ Param_GuidChave, 
...
/// <param name="Param_GuidChave">O GUID para a chave que vai receber o valor.</param>
/// <param name="Param_Valor">O valor a ser definido na chave especificada.</param>
CarenResult CarenMFVideoMediaType::SetString(
		String^ Param_GuidChave, 
		String^ Param_Valor)
{
	//Chama o método na classe de funções compartilhadas da Media Foundation.
...
/// <param name="Param_GuidChave">O GUID para a chave que vai receber o valor.</param>
/// <param name="Param_Valor">O valor a ser definido na chave especificada.</param>
CarenResult CarenMFVideoMediaType::SetUINT32(
		String^ Param_GuidChave, 
		UInt32 Param_Valor)
{
	//Chama o método na classe de funções compartilhadas da Media Foundation.
...
/// <param name="Param_GuidChave">O GUID para a chave que vai receber o valor.</param>
/// <param name="Param_Valor">O valor a ser definido na chave especificada.</param>
CarenResult CarenMFVideoMediaType::SetUINT64(
		String^ Param_GuidChave, 
		UInt64 Param_Valor)
{
	//Chama o método na classe de funções compartilhadas da Media Foundation.
...
CarenResult CarenMFVideoMediaType::_MFSetAttributeRatio(
		String^ Param_GuidChave, 
...
CarenResult CarenMFVideoMediaType::_MFSetAttributeSize(
		String^ Param_GuidChave, 
...
CarenResult CarenMFVideoMediaType::SetUnknown(
		String^ Param_GuidChave, 
