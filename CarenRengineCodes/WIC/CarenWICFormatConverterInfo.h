...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por expor métodos que fornecem informações sobre um conversor de formato de pixel.  
/// </summary>
public ref class CarenWICFormatConverterInfo : public ICarenWICFormatConverterInfo
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IWICFormatConverterInfo).
	IWICFormatConverterInfo* PonteiroTrabalho = NULL;
...
public:
	static operator CarenWICFormatConverterInfo^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenWICFormatConverterInfo^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenWICFormatConverterInfo();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IWICFormatConverterInfo*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenWICFormatConverterInfo::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenWICFormatConverterInfo)
public:
	/// <summary>
	...
	virtual CarenResult CreateInstance([Out] ICarenWICFormatConverter^% Param_Out_Converter);
