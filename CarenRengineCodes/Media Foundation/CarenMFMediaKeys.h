...
public:
	static operator CarenMFMediaKeys^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFMediaKeys^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFMediaKeys();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFMediaKeys*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFMediaKeys::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
