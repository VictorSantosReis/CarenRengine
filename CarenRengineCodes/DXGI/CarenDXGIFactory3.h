...
/// </summary>
public ref class CarenDXGIFactory3 : public ICarenDXGIFactory3
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IDXGIFactory3).
	IDXGIFactory3* PonteiroTrabalho = NULL;
...
public:
	static operator CarenDXGIFactory3^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenDXGIFactory3^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenDXGIFactory3();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IDXGIFactory3*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenDXGIFactory3::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
