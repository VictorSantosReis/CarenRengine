...
CarenResult CarenMFMediaKeySession::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IMFMediaKeySession*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenMFMediaKeySession::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IMFMediaKeySession*>(Param_PonteiroNativo);
...
/// </summary>
Int32 CarenMFMediaKeySession::ObterCodigoErro()
{
...
/// </summary>
void CarenMFMediaKeySession::LimparDados()
{
