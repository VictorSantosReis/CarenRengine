...
//Destruidor.
CarenD3D11Texture3D::~CarenD3D11Texture3D()
{
...
CarenResult CarenD3D11Texture3D::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD3D11Texture3D::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID3D11Texture3D*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD3D11Texture3D::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID3D11Texture3D*>(Param_PonteiroNativo);
...
CarenResult CarenD3D11Texture3D::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Texture3D::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Texture3D::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenD3D11Texture3D::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD3D11Texture3D::ObterCodigoErro()
{
...
/// </summary>
void CarenD3D11Texture3D::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD3D11Texture3D::LiberarReferencia()
{
...
/// </summary>
void CarenD3D11Texture3D::LimparDados()
{
...
/// </summary>
void CarenD3D11Texture3D::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
...
CarenResult CarenD3D11Texture3D::GetDesc([Out] Estruturas::CA_D3D11_TEXTURE3D_DESC^% Param_Out_PropsTextura3D)
{
...
CarenResult CarenD3D11Texture3D::ObterPrioridadeDespejo([Out] Enumeracoes::CA_DXGI_PRIORIDADE_RECURSO% Param_Out_Prioridade)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Texture3D::ObterTipo([Out] Enumeracoes::CA_D3D11_TIPO_RECURSO% Param_Out_TipoRecurso)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Texture3D::DefinirPrioridadeDespejo(Enumeracoes::CA_DXGI_PRIORIDADE_RECURSO Param_PrioridadeRecurso)
{
...
CarenResult CarenD3D11Texture3D::ObterDispositivo(ICaren^ Param_Out_DispositivoD3D11)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Texture3D::ObterDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11Texture3D::DefinirDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11Texture3D::DefinirInterfaceDadosPrivados(
