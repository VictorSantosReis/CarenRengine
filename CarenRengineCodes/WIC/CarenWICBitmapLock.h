...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por expor métodos que suportam o método Lock.
/// </summary>
public ref class CarenWICBitmapLock : public ICarenWICBitmapLock
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IWICBitmapLock).
	IWICBitmapLock* PonteiroTrabalho = NULL;
...
public:
	static operator CarenWICBitmapLock^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenWICBitmapLock^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenWICBitmapLock();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IWICBitmapLock*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenWICBitmapLock::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenWICBitmapLock)
public:
	/// <summary>
	...
	virtual CarenResult GetDataPointer(
	...
	virtual CarenResult GetStride([Out] UInt32% Param_Out_Stride);
};