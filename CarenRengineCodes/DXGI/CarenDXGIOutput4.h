...
public:
	static operator CarenDXGIOutput4^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenDXGIOutput4^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenDXGIOutput4();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IDXGIOutput4*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenDXGIOutput4::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
