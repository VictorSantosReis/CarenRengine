...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por definir um objeto que pinta uma área. Interfaces derivadas do ICarenD2D1Brush descrevem como a área é pintada.
/// </summary>
public ref class CarenD2D1Brush : public ICarenD2D1Brush
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID2D1Brush).
	ID2D1Brush* PonteiroTrabalho = NULL;
...
public:
	static operator CarenD2D1Brush^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1Brush^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1Brush();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1Brush*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD2D1Brush::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
