...
/// </summary>
public ref class CarenD3D11Texture2D :public ICarenD3D11Texture2D
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID3D11Texture2D).
	ID3D11Texture2D* PonteiroTrabalho = NULL;
...
public:
	static operator CarenD3D11Texture2D^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD3D11Texture2D^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD3D11Texture2D();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID3D11Texture2D*>(Param_Pointer.ToPointer());
...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD3D11Texture2D">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD3D11Texture2D^% Param_Out_CarenD3D11Texture2D)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenD3D11Texture2D = gcnew CarenD3D11Texture2D();
