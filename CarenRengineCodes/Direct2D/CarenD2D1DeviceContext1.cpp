...
//Destruidor.
CarenD2D1DeviceContext1::~CarenD2D1DeviceContext1()
{
...
CarenResult CarenD2D1DeviceContext1::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD2D1DeviceContext1::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1DeviceContext1*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1DeviceContext1::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1DeviceContext1*>(Param_PonteiroNativo);
...
CarenResult CarenD2D1DeviceContext1::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1DeviceContext1::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1DeviceContext1::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenD2D1DeviceContext1::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD2D1DeviceContext1::ObterCodigoErro()
{
...
/// </summary>
void CarenD2D1DeviceContext1::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD2D1DeviceContext1::LiberarReferencia()
{
...
/// </summary>
void CarenD2D1DeviceContext1::LimparDados()
{
...
/// </summary>
void CarenD2D1DeviceContext1::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenD2D1DeviceContext1();
}



// Métodos da interface proprietária(ICarenD2D1DeviceContext1)
...
CarenResult CarenD2D1DeviceContext1::CreateFilledGeometryRealization(
...
/// <param name="Param_Out_GeometryRealization">Retorna uma interface(ICarenD2D1GeometryRealization) que contém um ponteiro para o novo objeto de realização.</param>
CarenResult CarenD2D1DeviceContext1::CreateStrokedGeometryRealization(
ICarenD2D1Geometry^ Param_Geometria,
float Param_FlatterningTolerance,
...
void CarenD2D1DeviceContext1::DrawGeometryRealization(
...
CarenResult CarenD2D1DeviceContext1::CreateBitmap(
...
CarenResult CarenD2D1DeviceContext1::CreateBitmapBrush(
...
CarenResult CarenD2D1DeviceContext1::CreateBitmapFromDxgiSurface(
...
/// <param name="Param_Out_Bitmap">Retorna uma interface(ICarenD2D1Bitmap1) que contém um ponteiro para um novo objeto bitmap.</param>
CarenResult CarenD2D1DeviceContext1::CreateBitmapFromWicBitmap(
...
CarenResult CarenD2D1DeviceContext1::CreateColorContext(
...
/// <param name="Param_Out_ColorContext">Retorna uma interface(ICarenD2D1ColorContext) que contém um ponteiro para o novo objeto de contexto de cores.</param>
CarenResult CarenD2D1DeviceContext1::CreateColorContextFromFilename(
...
/// <param name="Param_Out_ColorContext">Retorna uma interface(ICarenD2D1ColorContext) que contém um ponteiro para o novo objeto de contexto de cores.</param>
CarenResult CarenD2D1DeviceContext1::CreateColorContextFromWicColorContext(
...
CarenResult CarenD2D1DeviceContext1::CreateCommandList(
...
CarenResult CarenD2D1DeviceContext1::CreateEffect(
...
CarenResult CarenD2D1DeviceContext1::CreateGradientStopCollection(
...
CarenResult CarenD2D1DeviceContext1::CreateImageBrush(
...
CarenResult CarenD2D1DeviceContext1::DrawBitmap(
	ICarenD2D1Bitmap^ Param_Bitmap,
...
void CarenD2D1DeviceContext1::DrawGdiMetafile(
...
void CarenD2D1DeviceContext1::DrawGlyphRun(
...
void CarenD2D1DeviceContext1::DrawImage(
	ICarenD2D1Image^ Param_Image,
	CA_D2D1_POINT_2F^ Param_TargetOffset,
...
void CarenD2D1DeviceContext1::FillOpacityMask(
...
void CarenD2D1DeviceContext1::GetDevice(ICaren^ Param_Out_Dispositivo)
{
	//Variaveis a serem utilizadas.
...
CarenResult CarenD2D1DeviceContext1::GetEffectInvalidRectangleCount(
	ICarenD2D1Effect^ Param_Efeito,
...
CarenResult CarenD2D1DeviceContext1::GetEffectInvalidRectangles(
	ICarenD2D1Effect^ Param_Efeito,
...
CarenResult CarenD2D1DeviceContext1::GetEffectRequiredInputRectangles(
	ICarenD2D1Effect^ Param_Efeito,
...
CarenResult CarenD2D1DeviceContext1::GetGlyphRunWorldBounds(
	CA_D2D1_POINT_2F^ Param_BaseLineOrigin,
...
CarenResult CarenD2D1DeviceContext1::GetImageLocalBounds(
	ICarenD2D1Image^ Param_Image,
...
CarenResult CarenD2D1DeviceContext1::GetImageWorldBounds(
	ICarenD2D1Image^ Param_Image,
...
void CarenD2D1DeviceContext1::GetPrimitiveBlend(
...
void CarenD2D1DeviceContext1::GetRenderingControls(
...
CarenResult CarenD2D1DeviceContext1::GetTarget(
...
void CarenD2D1DeviceContext1::GetUnitMode([Out] CA_D2D1_UNIT_MODE Param_Out_Unit)
{
	//Chama o método para realizar a operação.
...
CarenResult CarenD2D1DeviceContext1::InvalidateEffectInputRectangle(
	ICarenD2D1Effect^ Param_Efeito,
...
void CarenD2D1DeviceContext1::IsBufferPrecisionSupported(
	CA_D2D1_BUFFER_PRECISION  Param_BufferPrecision,
...
void CarenD2D1DeviceContext1::IsDxgiFormatSupported(
...
void CarenD2D1DeviceContext1::PushLayer(
...
void CarenD2D1DeviceContext1::SetPrimitiveBlend(CA_D2D1_PRIMITIVE_BLEND Param_PrimitiveBlend)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1DeviceContext1::SetRenderingControls(CA_D2D1_RENDERING_CONTROLS^ Param_ControlesRenderizacao)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void CarenD2D1DeviceContext1::SetTarget(ICarenD2D1Image^ Param_Imagem)
{
	//Variaveis a serem utilizadas.
	ID2D1Image* pMyImage = NULL;
...
void CarenD2D1DeviceContext1::SetUnitMode(CA_D2D1_UNIT_MODE Param_UnitMode)
{
	//Chama o método para realizar a operação.
...
/// </summary>
void CarenD2D1DeviceContext1::BeginDraw()
{
	//Chama o método para realizar a operação.
...
void CarenD2D1DeviceContext1::Clear(CA_D2D1_COLOR_F^ Param_ClearColor)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
CarenResult CarenD2D1DeviceContext1::CreateCompatibleRenderTarget(
...
/// </summary>
/// <param name="Param_Out_BitmapRenderTarget">Retorna a interface (ICarenD2D1BitmapRenderTarget) que contém um ponteiro para um novo alvo de renderização bitmap. O usuário deve inicializar a interface antes de chamar este método.</param>
CarenResult CarenD2D1DeviceContext1::CreateCompatibleRenderTarget(ICaren^ Param_Out_BitmapRenderTarget)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1DeviceContext1::CreateLayer(
...
/// </summary>
/// <param name="Param_Out_Layer">Retorna a interface ICarenD2D1Layer que contém um ponteiro para a nova camada(Layer).</param>
CarenResult CarenD2D1DeviceContext1::CreateLayer([Out] ICarenD2D1Layer^% Param_Out_Layer)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1DeviceContext1::CreateLinearGradientBrush(
...
CarenResult CarenD2D1DeviceContext1::CreateMesh([Out] ICarenD2D1Mesh^% Param_Out_Mesh)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1DeviceContext1::CreateRadialGradientBrush(
...
CarenResult CarenD2D1DeviceContext1::CreateSharedBitmap(
	String^ Param_Riid,
...
CarenResult CarenD2D1DeviceContext1::CreateSolidColorBrush(
...
CarenResult CarenD2D1DeviceContext1::DrawEllipse(
...
CarenResult CarenD2D1DeviceContext1::DrawGeometry(
	ICarenD2D1Geometry^ Param_Geometria,
	ICarenD2D1Brush^ Param_Brush,
	float Param_StrokeWidth,
	ICarenD2D1StrokeStyle^ Param_StrokeStyle)
...
CarenResult CarenD2D1DeviceContext1::DrawGlyphRun(
	CA_D2D1_POINT_2F^ Param_BaseLineOrigin,
	CA_DWRITE_GLYPH_RUN^ Param_GlyphRun,
	ICarenD2D1Brush^ Param_ForegroundBrush,
	CA_DWRITE_MEASURING_MODE Param_MeasuringMode)
...
CarenResult CarenD2D1DeviceContext1::DrawLine(
...
CarenResult CarenD2D1DeviceContext1::DrawRectangle(
...
CarenResult CarenD2D1DeviceContext1::DrawRoundedRectangle(
...
/// <param name="Param_MeasuringMode">Um valor que indica como as métricas do glifo(Glyph) são usadas para medir o texto quando ele é formatado. O valor padrão é DWRITE_MEASURING_MODE_NATURAL.</param>
CarenResult CarenD2D1DeviceContext1::DrawText(
	String^ Param_Texto,
...
/// <param name="Param_Opcoes">Um valor que indica se o texto deve ser encaixado nos limites do pixel e se o texto deve ser cortado no retângulo de layout. O valor padrão é D2D1_DRAW_TEXT_OPTIONS_NONE, 
/// o que indica que o texto deve ser encaixado nos limites do pixel e não deve ser cortado para o retângulo de layout.</param>
CarenResult CarenD2D1DeviceContext1::DrawTextLayout(
...
CarenResult CarenD2D1DeviceContext1::EndDraw(
...
CarenResult CarenD2D1DeviceContext1::FillEllipse(
	CA_D2D1_ELLIPSE^ Param_Ellipse,
	ICarenD2D1Brush^ Param_Brush)
{
	//Variavel a ser retornada.
...
CarenResult CarenD2D1DeviceContext1::FillGeometry(
	ICarenD2D1Geometry^ Param_Geometria,
	ICarenD2D1Brush^ Param_Brush,
...
CarenResult CarenD2D1DeviceContext1::FillMesh(
...
CarenResult CarenD2D1DeviceContext1::FillOpacityMask(
...
CarenResult CarenD2D1DeviceContext1::FillRectangle(
	CA_D2D1_RECT_F^ Param_Rect,
	ICarenD2D1Brush^ Param_Brush)
{
	//Variavel a ser retornada.
...
CarenResult CarenD2D1DeviceContext1::FillRoundedRectangle(
...
/// <param name="Param_Out_Tag1">Quando este método retorna, contém a tag para operações de desenho que causaram erros ou 0 se não houver erros.</param>
/// <param name="Param_Out_Tag2">Quando este método retorna, contém a tag para operações de desenho que causaram erros ou 0 se não houver erros.</param>
CarenResult CarenD2D1DeviceContext1::Flush(
	[Out] UInt64% Param_Out_Tag1,
	[Out] UInt64% Param_Out_Tag2)
{
	//Variavel a ser retornada.
...
void CarenD2D1DeviceContext1::GetAntialiasMode([Out] CA_D2D1_ANTIALIAS_MODE% Param_Out_AntialiasMode)
{
	//Variaveis a serem utilizadas.
...
void CarenD2D1DeviceContext1::GetDpi(
...
void CarenD2D1DeviceContext1::GetMaximumBitmapSize([Out] UInt32% Param_Out_MaximumSize)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1DeviceContext1::GetPixelFormat([Out] CA_D2D1_PIXEL_FORMAT^% Param_Out_PixelFormat)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void CarenD2D1DeviceContext1::GetPixelSize([Out] CA_D2D1_SIZE_U^% Param_Out_PixelSize)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void CarenD2D1DeviceContext1::GetSize([Out] CA_D2D1_SIZE_F^% Param_Out_Size)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void CarenD2D1DeviceContext1::GetTags(
	[Out] UInt64% Param_Out_Tag1,
	[Out] UInt64% Param_Out_Tag2)
{
	//Variaveis a serem utilizadas.
...
void CarenD2D1DeviceContext1::GetTextAntialiasMode([Out] CA_D2D1_TEXT_ANTIALIAS_MODE% Param_Out_TextAntialiasMode)
{
	//Variaveis a serem utilizadas.
...
void CarenD2D1DeviceContext1::GetTextRenderingParams(ICaren^ Param_Out_TextRenderingParams)
{
	//Variaveis a serem utilizadas.
...
void CarenD2D1DeviceContext1::GetTransform([Out] CA_D2D1_MATRIX_3X2_F^% Param_Out_Transform)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void CarenD2D1DeviceContext1::IsSupported(
...
/// ou ICarenD2D1RenderTarget::Flush.
/// </summary>
void CarenD2D1DeviceContext1::PopAxisAlignedClip()
{
	//Chama o método para realizar a operação.
...
/// ou ICarenD2D1RenderTarget::Flush.
/// </summary>
void CarenD2D1DeviceContext1::PopLayer()
{
	//Chama o método para realizar a operação.
...
void CarenD2D1DeviceContext1::PushAxisAlignedClip(
...
CarenResult CarenD2D1DeviceContext1::RestoreDrawingState(ICarenD2D1DrawingStateBlock^ Param_DrawingStateBlock)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1DeviceContext1::SaveDrawingState(ICarenD2D1DrawingStateBlock^ Param_DrawingStateBlock)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
void CarenD2D1DeviceContext1::SetAntialiasMode(CA_D2D1_ANTIALIAS_MODE Param_AntialiasMode)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1DeviceContext1::SetDpi(
	float Param_DpiX,
	float Param_DpiY)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1DeviceContext1::SetTags(
	UInt64 Param_Tag1,
	UInt64 Param_Tag2)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1DeviceContext1::SetTextAntialiasMode(CA_D2D1_TEXT_ANTIALIAS_MODE Param_TextAntialiasMode)
{
	//Chama o método para realizar a operação.
...
CarenResult CarenD2D1DeviceContext1::SetTextRenderingParams(ICaren^ Param_TextRenderingParams)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
void CarenD2D1DeviceContext1::SetTransform(CA_D2D1_MATRIX_3X2_F^ Param_Transform)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void  CarenD2D1DeviceContext1::GetFactory(ICaren^ Param_Out_Factory)
{
	//Variaveis a serem utilizadas.
