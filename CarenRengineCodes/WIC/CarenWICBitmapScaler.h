...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por representar uma versão redimensionada do bitmap de entrada usando um algoritmo de reamostragem ou filtragem.
/// </summary>
public ref class CarenWICBitmapScaler : public ICarenWICBitmapScaler
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IWICBitmapScaler).
	IWICBitmapScaler* PonteiroTrabalho = NULL;
...
public:
	static operator CarenWICBitmapScaler^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenWICBitmapScaler^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenWICBitmapScaler();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IWICBitmapScaler*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenWICBitmapScaler::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenWICBitmapScaler)
public:
	/// <summary>
