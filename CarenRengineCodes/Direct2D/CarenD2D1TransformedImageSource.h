...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD2D1TransformedImageSource">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD2D1TransformedImageSource^% Param_Out_CarenD2D1TransformedImageSource)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenD2D1TransformedImageSource = gcnew CarenD2D1TransformedImageSource();
