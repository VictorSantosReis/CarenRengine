...
namespace CoreAudio_AudioCaptureTest
{
    ...
    {
        //ESTE PROJETO TEM COMO OBJETO MOSTRAR COMO FUNCIONA O PROCESSO DE CAPTURA DE DADOS DE ÁUDIO DE UM DISPOSITIVO(MICROFONE).
        //O PROJETO UTILIZA DAS APIS DA CORE AUDIO, MAIS PRECISAMENTE AS APIS: WASAPI, MMDEVICE
        //O PROJETO MOSTRA COMO ENUMERAR OS DISPOSITIVOS DE CAPTURA DISPONIVEIS NO SISTEMA ATUAL E COMO CONFIGURAR TODOS OS PASSOS
        //NECESSÁRIOS PARA PODER CAPTURAR E ESCREVER OS DADOS NO ARQUIVO.
        //O ARQUIVO FINAL DEVE SER OBRIGATORIAMENTE UM ARQUIVO (.WAV) PARA PODER REPRODUZIR CORRETAMENTE NO SISTEMA.
        //É POSSIVEL UTILIZAR APIS DA MEDIA FOUNDATION PARA REALIZAR O MESMO PROCESSO DE CAPTURA E ESCRITA DOS DADOS, DANDO A POSSIBILIDADE
        //DE CRIAR ARQUIVOS .MP3 OU .AAC POR EXEMPLO.
        ...
        private void Btn_AtivarDispositivo_Click(object sender, EventArgs e)
        {
            ...
            ShowMensagem($"O dispositivo de captura '{Cbx_ListCaptureAudioDevices.Items[Cbx_ListCaptureAudioDevices.SelectedIndex]}' foi ativado e está pronto para uso!");
