...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por representar um (Sombreador de Casco) que controla um programa executável (um Sombreador de Casco) que controle o estágio de Sombreamento de Casco.
/// </summary>
public ref class CarenD3D11HullShader : public ICarenD3D11HullShader
{
	/////////////////////////////////////////
   //Objeto gerenciado por essa interface.//
   /////////////////////////////////////////

   //Ponteiro para a interface (ID3D11HullShader).
	ID3D11HullShader* PonteiroTrabalho = NULL;
...
public:
	static operator CarenD3D11HullShader^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD3D11HullShader^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD3D11HullShader();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID3D11HullShader*>(Param_Pointer.ToPointer());
...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD3D11HullShader">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD3D11HullShader^% Param_Out_CarenD3D11HullShader)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenD3D11HullShader = gcnew CarenD3D11HullShader();
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD3D11HullShader::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
