...
CarenResult CarenAudioCaptureClient::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IAudioCaptureClient*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenAudioCaptureClient::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IAudioCaptureClient*>(Param_PonteiroNativo);
...
/// </summary>
Int32 CarenAudioCaptureClient::ObterCodigoErro()
{
...
/// </summary>
void CarenAudioCaptureClient::LimparDados()
{
...
CarenResult CarenAudioCaptureClient::ObterBuffer(
...
CarenResult CarenAudioCaptureClient::ObterProximoTamanhoPacote([Out] UInt32% Param_Out_FramesProximoPacote)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenAudioCaptureClient::LiberarBuffer(UInt32 Param_NumeroFramesLidos)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
