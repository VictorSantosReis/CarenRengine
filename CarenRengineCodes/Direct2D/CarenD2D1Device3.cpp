...
#include "../pch.h"
#include "CarenD2D1Device3.h"

//Destruidor.
CarenD2D1Device3::~CarenD2D1Device3()
{
...
CarenResult CarenD2D1Device3::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD2D1Device3::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1Device3*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1Device3::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1Device3*>(Param_PonteiroNativo);
...
CarenResult CarenD2D1Device3::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1Device3::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1Device3::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenD2D1Device3::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD2D1Device3::ObterCodigoErro()
{
...
/// </summary>
void CarenD2D1Device3::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD2D1Device3::LiberarReferencia()
{
...
/// </summary>
void CarenD2D1Device3::LimparDados()
{
...
/// </summary>
void CarenD2D1Device3::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenD2D1Device3();
}



// Métodos da interface proprietária(ICarenD2D1Device3)
...
CarenResult CarenD2D1Device3::CreateDeviceContext(
...
void CarenD2D1Device3::FlushDeviceContexts(ICarenD2D1Bitmap^ Param_Bitmap)
{
	//Variaveis a serem utilizadas.
...
CarenResult CarenD2D1Device3::GetDxgiDevice([Out] ICarenDXGIDevice^% Param_Out_DxgiDevice)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1Device3::CreateDeviceContext(CA_D2D1_DEVICE_CONTEXT_OPTIONS Param_Opcoes, [Out] ICarenD2D1DeviceContext1^% Param_Out_ContextoDispositivo1)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
void CarenD2D1Device3::GetRenderingPriority(
...
void CarenD2D1Device3::SetRenderingPriority(CA_D2D1_RENDERING_PRIORITY Param_Prioridade)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1Device3::ClearResources(UInt32 Param_Miliseconds)
{
	//Chama o método para realizar a operação.
...
CarenResult CarenD2D1Device3::CreatePrintControl(
...
void CarenD2D1Device3::GetMaximumTextureMemory([Out] UInt64% Param_Out_MaxSizeMemory)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1Device3::SetMaximumTextureMemory(UInt64 Param_MaxSizeMemory)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1Device3::GetFactory(ICaren^ Param_Out_Factory)
{
	//Variaveis a serem utilizadas.
