...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por representar um contexto de dispositivo; é usado para realizar comandos de renderização. O ICarenD3D11DeviceContext3 
/// adiciona novos métodos aos do ICarenD3D11DeviceContext2.
/// </summary>
public ref class CarenD3D11DeviceContext3 : public ICarenD3D11DeviceContext3
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID3D11DeviceContext3).
	ID3D11DeviceContext3* PonteiroTrabalho = NULL;


	//Contrutor e destruidor da classe.
public:
	~CarenD3D11DeviceContext3();
...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD3D11DeviceContext3">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD3D11DeviceContext3^% Param_Out_CarenD3D11DeviceContext3)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenD3D11DeviceContext3 = gcnew CarenD3D11DeviceContext3();
