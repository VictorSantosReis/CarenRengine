...
CarenResult CarenMFDXGIBuffer::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IMFDXGIBuffer*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenMFDXGIBuffer::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IMFDXGIBuffer*>(Param_PonteiroNativo);
...
/// </summary>
void CarenMFDXGIBuffer::LimparDados()
{
