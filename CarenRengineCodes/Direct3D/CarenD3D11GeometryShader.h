...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por representar um Sombreador de Geometria gerencia um programa executável (um Sombreado de Geometria) que controla o estágio de Sombreamento de Geometria.
/// </summary>
public ref class CarenD3D11GeometryShader : public ICarenD3D11GeometryShader
{
	/////////////////////////////////////////
...
public:
	static operator CarenD3D11GeometryShader^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD3D11GeometryShader^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD3D11GeometryShader();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID3D11GeometryShader*>(Param_Pointer.ToPointer());
...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD3D11GeometryShader">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD3D11GeometryShader^% Param_Out_CarenD3D11GeometryShader)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenD3D11GeometryShader = gcnew CarenD3D11GeometryShader();
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD3D11GeometryShader::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
