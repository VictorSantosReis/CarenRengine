...
public:
	...
	/// de trabalho. Se (Param_CriarInterface) for TRUE, o construtor vai criar uma implementação da interface(IMFAsyncCallback).
	/// </summary>
...
public:
	static operator CarenMFAsyncCallback^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFAsyncCallback^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFAsyncCallback(false);

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFAsyncCallback*>(Param_Pointer.ToPointer());
...
private:
	...
	//////////////////////////////////////////////////////////////////////////////////////
	//DELEGATES UTILIZADOS PARA RECEBER O EVENTO NATIVO DA CLASSE (CLN_IMFAsyncCallback)//
	//////////////////////////////////////////////////////////////////////////////////////
...
private:
	/// <summary>
	/// Contém a Handle alocada para o delegate (DelegateNativo_Evento_OnGetParameters).
	/// </summary>
	GCHandle gHandle_Delegate_OnGetParameters;

	/// <summary>
	/// Contém a Handle alocada para o delegate (DelegateNativo_Evento_OnInvoke).
	/// </summary>
	GCHandle gHandle_Delegate_OnInvoke;
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFAsyncCallback::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
...
public:
	...
	//Métodos que são utilizados para receberem os eventos da classe nativa (CLN_IMFAsyncCallback).
public:
	/// <summary>
