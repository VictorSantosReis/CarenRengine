...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por implementar um único método para definir metadados de vídeo.
/// </summary>
public ref class CarenDXGISwapChain4 : public ICarenDXGISwapChain4
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IDXGISwapChain4).
...
public:
	static operator CarenDXGISwapChain4^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenDXGISwapChain4^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenDXGISwapChain4();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IDXGISwapChain4*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenDXGISwapChain4::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
...
public:
	...
	virtual CarenResult SetHDRMetaData(
...
public:
	...
	virtual CarenResult CheckColorSpaceSupport(
	...
	virtual CarenResult GetCurrentBackBufferIndex([Out] UInt32% Param_Out_IndexBackBuffer);
	...
	virtual CarenResult ResizeBuffers1(
	...
	virtual CarenResult SetColorSpace1(CA_DXGI_COLOR_SPACE_TYPE Param_ColorSpace);
...
public:
	...
	virtual CarenResult GetSourceSize(
...
public:
	...
	virtual CarenResult GetFullscreenState(
	...
	virtual CarenResult ResizeBuffers(
	...
	virtual CarenResult SetFullscreenState(
