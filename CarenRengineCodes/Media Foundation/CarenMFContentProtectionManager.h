...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por habilitar a reprodução de conteúdo protegido fornecendo ao aplicativo um ponteiro para um objeto ativador de conteúdo. 
/// </summary>
public ref class CarenMFContentProtectionManager : public ICarenMFContentProtectionManager
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IMFContentProtectionManager).
	IMFContentProtectionManager* PonteiroTrabalho = NULL;
...
public:
	...
	/// </summary>
	CarenMFContentProtectionManager();
...
public:
	static operator CarenMFContentProtectionManager^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFContentProtectionManager^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFContentProtectionManager();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFContentProtectionManager*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFContentProtectionManager::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenMFContentProtectionManager)
public:
	/// <summary>
	...
	virtual CarenResult BeginEnableContent(
	...
	virtual CarenResult EndEnableContent(ICarenMFAsyncResult^ Param_Resultado);
};