...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por criar recursos Direct2D. A interface ID2D1Factory1 é usada para criar dispositivos, registrar e não registrar efeitos e 
/// enumerar propriedades de efeitos.
/// </summary>
public ref class CarenD2D1Factory1 : public ICarenD2D1Factory1
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID2D1Factory1).
	ID2D1Factory1* PonteiroTrabalho = NULL;
...
public:
	static operator CarenD2D1Factory1^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1Factory1^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1Factory1();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1Factory1*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD2D1Factory1::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
