...
#include "../pch.h"
#include "CarenMFQualityAdvise.h"

//Destruidor.
CarenMFQualityAdvise::~CarenMFQualityAdvise()
{
...
CarenResult CarenMFQualityAdvise::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenMFQualityAdvise::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<IMFQualityAdvise*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenMFQualityAdvise::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IMFQualityAdvise*>(Param_PonteiroNativo);
...
CarenResult CarenMFQualityAdvise::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenMFQualityAdvise::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenMFQualityAdvise::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenMFQualityAdvise::StatusPonteiro()
{
...
/// </summary>
Int32 CarenMFQualityAdvise::ObterCodigoErro()
{
...
/// </summary>
void CarenMFQualityAdvise::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenMFQualityAdvise::LiberarReferencia()
{
...
/// </summary>
void CarenMFQualityAdvise::LimparDados()
{
...
/// </summary>
void CarenMFQualityAdvise::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenMFQualityAdvise();
}



// Métodos da interface proprietária(ICarenMFQualityAdvise)
