...
CarenResult CarenWICBitmapEncoderInfo::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IWICBitmapEncoderInfo*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenWICBitmapEncoderInfo::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IWICBitmapEncoderInfo*>(Param_PonteiroNativo);
...
/// </summary>
void CarenWICBitmapEncoderInfo::LimparDados()
{
