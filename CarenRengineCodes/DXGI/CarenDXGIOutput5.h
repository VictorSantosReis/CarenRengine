...
/// a CarenDXGIOutput4 para especificar uma lista de formatos suportados para superfícies de tela cheia(FullScreen).
/// </summary>
public ref class CarenDXGIOutput5 : public ICarenDXGIOutput5
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IDXGIOutput5).
...
public:
	static operator CarenDXGIOutput5^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenDXGIOutput5^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenDXGIOutput5();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IDXGIOutput5*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenDXGIOutput5::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
