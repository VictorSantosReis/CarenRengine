...
CarenResult CarenDXGIAdapter1::GetParent(
...
CarenResult CarenDXGIAdapter1::SetPrivateData(
...
CarenResult CarenDXGIAdapter1::GetPrivateData(
	String^ Param_GuidIdentificao, 
...
CarenResult CarenDXGIAdapter1::SetPrivateDataInterface(
