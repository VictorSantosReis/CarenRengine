...
CarenResult CarenMFSourceOpenMonitor::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IMFSourceOpenMonitor*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenMFSourceOpenMonitor::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IMFSourceOpenMonitor*>(Param_PonteiroNativo);
...
/// </summary>
void CarenMFSourceOpenMonitor::LimparDados()
{
