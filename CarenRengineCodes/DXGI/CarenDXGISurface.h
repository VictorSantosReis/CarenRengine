...
public:
	static operator CarenDXGISurface^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenDXGISurface^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenDXGISurface();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IDXGISurface*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenDXGISurface::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
