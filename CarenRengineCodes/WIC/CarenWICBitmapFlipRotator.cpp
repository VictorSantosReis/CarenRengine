...
//Destruidor.
CarenWICBitmapFlipRotator::~CarenWICBitmapFlipRotator()
{
...
CarenResult CarenWICBitmapFlipRotator::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenWICBitmapFlipRotator::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<IWICBitmapFlipRotator*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenWICBitmapFlipRotator::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IWICBitmapFlipRotator*>(Param_PonteiroNativo);
...
CarenResult CarenWICBitmapFlipRotator::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICBitmapFlipRotator::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICBitmapFlipRotator::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenWICBitmapFlipRotator::StatusPonteiro()
{
...
/// </summary>
Int32 CarenWICBitmapFlipRotator::ObterCodigoErro()
{
...
/// </summary>
void CarenWICBitmapFlipRotator::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenWICBitmapFlipRotator::LiberarReferencia()
{
...
/// </summary>
void CarenWICBitmapFlipRotator::LimparDados()
{
...
/// </summary>
void CarenWICBitmapFlipRotator::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenWICBitmapFlipRotator();
}



// Métodos da interface proprietária(ICarenWICBitmapFlipRotator)
...
CarenResult CarenWICBitmapFlipRotator::Initialize(
...
CA_WICBitmapTransformOptions Param_Opcoes)
{
	...
	WICBitmapTransformOptions OptionsTransfom = static_cast<WICBitmapTransformOptions>(Param_Opcoes);
	...
	Hr = PonteiroTrabalho->Initialize(pBitmapSource, OptionsTransfom);
...
CarenResult CarenWICBitmapFlipRotator::CopyPalette(ICaren^ Param_Palette)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICBitmapFlipRotator::CopyPixels(
...
CarenResult CarenWICBitmapFlipRotator::GetPixelFormat([Out] String^% Param_Out_FormatoPixel)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICBitmapFlipRotator::GetResolution(
...
CarenResult CarenWICBitmapFlipRotator::GetSize(
