...
//Destruidor.
CarenD3D11InputLayout::~CarenD3D11InputLayout()
{
...
CarenResult CarenD3D11InputLayout::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD3D11InputLayout::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID3D11InputLayout*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD3D11InputLayout::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID3D11InputLayout*>(Param_PonteiroNativo);
...
CarenResult CarenD3D11InputLayout::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11InputLayout::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11InputLayout::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenD3D11InputLayout::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD3D11InputLayout::ObterCodigoErro()
{
...
/// </summary>
void CarenD3D11InputLayout::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD3D11InputLayout::LiberarReferencia()
{
...
/// </summary>
void CarenD3D11InputLayout::LimparDados()
{
...
/// </summary>
void CarenD3D11InputLayout::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
...
CarenResult CarenD3D11InputLayout::ObterDispositivo(ICaren^ Param_Out_DispositivoD3D11)
{
...
CarenResult CarenD3D11InputLayout::ObterDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11InputLayout::DefinirDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11InputLayout::DefinirInterfaceDadosPrivados(
