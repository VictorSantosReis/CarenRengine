...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por expor métodos que fornecem informações sobre componentes.
/// </summary>
public ref class CarenWICComponentInfo : public ICarenWICComponentInfo
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IWICComponentInfo).
	IWICComponentInfo* PonteiroTrabalho = NULL;
...
public:
	static operator CarenWICComponentInfo^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenWICComponentInfo^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenWICComponentInfo();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IWICComponentInfo*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenWICComponentInfo::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
