...
//Destruidor.
CarenD3D11RasterizerState1::~CarenD3D11RasterizerState1()
{
...
CarenResult CarenD3D11RasterizerState1::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
	...
	Hr = (reinterpret_cast<ID3D11RasterizerState1*>(PonteiroTrabalho))->QueryInterface(GuidInterface, (LPVOID*)&pInterfaceSolcitada);
...
CarenResult CarenD3D11RasterizerState1::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID3D11RasterizerState1*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD3D11RasterizerState1::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID3D11RasterizerState1*>(Param_PonteiroNativo);
...
CarenResult CarenD3D11RasterizerState1::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11RasterizerState1::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11RasterizerState1::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenD3D11RasterizerState1::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD3D11RasterizerState1::ObterCodigoErro()
{
...
/// </summary>
void CarenD3D11RasterizerState1::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
	(reinterpret_cast<ID3D11RasterizerState1*>(PonteiroTrabalho))->AddRef();
}

/// <summary>
/// (Release) - 'Decrementa' a contagem de referência do objeto COM atual.
/// </summary>
void CarenD3D11RasterizerState1::LiberarReferencia()
{
	//Libera a referência e obtém a quantidade atual.
	ULONG RefCount = (reinterpret_cast<ID3D11RasterizerState1*>(PonteiroTrabalho))->Release();
...
/// </summary>
void CarenD3D11RasterizerState1::LimparDados()
{
...
/// </summary>
void CarenD3D11RasterizerState1::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenD3D11RasterizerState1();
}



//Métodos da interface proprietária(ICarenD3D11RasterizerState1)
...
CarenResult CarenD3D11RasterizerState1::GetDesc1([Out] Estruturas::CA_D3D11_RASTERIZER_DESC1^% Param_Out_DescRasterizador)
{
...
CarenResult CarenD3D11RasterizerState1::GetDesc(Estruturas::CA_D3D11_RASTERIZER_DESC^% Param_Out_DescRasterizador)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11RasterizerState1::ObterDispositivo(ICaren^ Param_Out_DispositivoD3D11)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11RasterizerState1::ObterDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11RasterizerState1::DefinirDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11RasterizerState1::DefinirInterfaceDadosPrivados(
