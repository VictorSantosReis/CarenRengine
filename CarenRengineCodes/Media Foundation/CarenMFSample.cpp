...
CarenResult CarenMFSample::Compare(
...
CarenResult CarenMFSample::CompareItem(
...
CarenResult CarenMFSample::GetAllocatedBlob(
		String^ Param_GuidChave, 
...
CarenResult CarenMFSample::GetAllocatedString(
		String^ Param_GuidChave, 
...
CarenResult CarenMFSample::GetBlob(
		String^ Param_GuidChave, 
...
CarenResult CarenMFSample::GetBlobSize(
	String^ Param_GuidChave, 
...
CarenResult CarenMFSample::GetDouble(
		String^ Param_GuidChave, 
...
/// <param name="Param_Out_Valor">Recebe o valor referente ao valor da chave solicitada</param>
CarenResult CarenMFSample::GetGUID(
		String^ Param_GuidChave, 
...
/// <param name="Param_Out_Valor">Recebe o valor referente ao valor da chave solicitada</param>
CarenResult CarenMFSample::GetItem(
		String^ Param_GuidChave, 
...
/// <param name="Param_Out_Valor">Recebe o valor referente ao valor da chave solicitada</param>
CarenResult CarenMFSample::GetItemByIndex(
		UInt32 Param_IdItem, 
...
CarenResult CarenMFSample::GetItemType(
		String^ Param_GuidChave, 
...
/// <param name="Param_Out_Valor">Recebe o valor referente ao valor da chave solicitada.</param>
CarenResult CarenMFSample::GetString(
		String^ Param_GuidChave, 
...
CarenResult CarenMFSample::GetStringLength(
		String^ Param_GuidChave, 
...
/// <param name="Param_Out_Valor">Recebe o valor referente ao valor da chave solicitada</param>
CarenResult CarenMFSample::GetUINT32(
		String^ Param_GuidChave, 
...
/// <param name="Param_Out_Valor">Recebe o valor referente ao valor da chave solicitada</param>
CarenResult CarenMFSample::GetUINT64(
		String^ Param_GuidChave, 
...
CarenResult CarenMFSample::_MFGetAttributeRatio(
		String^ Param_GuidChave, 
...
CarenResult CarenMFSample::_MFGetAttributeSize(
		String^ Param_GuidChave, 
		[Out] UInt32% Param_Out_Largura, 
...
CarenResult CarenMFSample::GetUnknown(
		String^ Param_GuidChave, 
...
CarenResult CarenMFSample::SetBlob(
		String^ Param_GuidChave, 
...
CarenResult CarenMFSample::SetDouble(
		String^ Param_GuidChave, 
		Double Param_Valor)
{
	//Chama o método na classe de funções compartilhadas da Media Foundation.
...
/// <param name="Param_GuidChave">O GUID para a chave que vai receber o valor.</param>
/// <param name="Param_Valor">O valor a ser definido na chave especificada.</param>
CarenResult CarenMFSample::SetGUID(
		String^ Param_GuidChave, 
		String^ Param_Valor)
{
	//Chama o método na classe de funções compartilhadas da Media Foundation.
...
CarenResult CarenMFSample::SetItem(
		String^ Param_GuidChave, 
...
/// <param name="Param_GuidChave">O GUID para a chave que vai receber o valor.</param>
/// <param name="Param_Valor">O valor a ser definido na chave especificada.</param>
CarenResult CarenMFSample::SetString(
		String^ Param_GuidChave, 
		String^ Param_Valor)
{
	//Chama o método na classe de funções compartilhadas da Media Foundation.
...
/// <param name="Param_GuidChave">O GUID para a chave que vai receber o valor.</param>
/// <param name="Param_Valor">O valor a ser definido na chave especificada.</param>
CarenResult CarenMFSample::SetUINT32(
		String^ Param_GuidChave, 
		UInt32 Param_Valor)
{
	//Chama o método na classe de funções compartilhadas da Media Foundation.
...
/// <param name="Param_GuidChave">O GUID para a chave que vai receber o valor.</param>
/// <param name="Param_Valor">O valor a ser definido na chave especificada.</param>
CarenResult CarenMFSample::SetUINT64(
		String^ Param_GuidChave, 
		UInt64 Param_Valor)
{
	//Chama o método na classe de funções compartilhadas da Media Foundation.
...
CarenResult CarenMFSample::_MFSetAttributeRatio(
		String^ Param_GuidChave, 
...
CarenResult CarenMFSample::_MFSetAttributeSize(
		String^ Param_GuidChave, 
...
CarenResult CarenMFSample::SetUnknown(
		String^ Param_GuidChave, 
