...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenDXGISurface1">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenDXGISurface1^% Param_Out_CarenDXGISurface1)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenDXGISurface1 = gcnew CarenDXGISurface1();
...
public:
	...
	virtual CarenResult ObterDC(Boolean Param_Descartar, [Out] IntPtr% Param_Out_HDCHandle);
	...
	virtual CarenResult LiberarDC(CA_RECT^ Param_Regiao);
