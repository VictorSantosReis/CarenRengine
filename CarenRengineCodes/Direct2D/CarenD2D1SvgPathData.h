...
public:
	static operator CarenD2D1SvgPathData^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1SvgPathData^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1SvgPathData();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1SvgPathData*>(Param_Pointer.ToPointer());
