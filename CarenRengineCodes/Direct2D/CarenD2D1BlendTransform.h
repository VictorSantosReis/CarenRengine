...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD2D1BlendTransform">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD2D1BlendTransform^% Param_Out_CarenD2D1BlendTransform)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);

		//Cria a interface
		Param_Out_CarenD2D1BlendTransform = gcnew CarenD2D1BlendTransform();
