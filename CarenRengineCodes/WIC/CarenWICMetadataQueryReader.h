...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por expor métodos para recuperar itens e blocos de metadados de um decodificador ou de seus quadros de imagem usando 
/// uma expressão de consulta de metadados.
/// </summary>
public ref class CarenWICMetadataQueryReader : public ICarenWICMetadataQueryReader
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IWICMetadataQueryReader).
	IWICMetadataQueryReader* PonteiroTrabalho = NULL;
...
public:
	static operator CarenWICMetadataQueryReader^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenWICMetadataQueryReader^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenWICMetadataQueryReader();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IWICMetadataQueryReader*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenWICMetadataQueryReader::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
