...
#include "../pch.h"
#include "CarenWICImagingFactory.h"


//Destruidor.
CarenWICImagingFactory::~CarenWICImagingFactory()
{
...
CarenWICImagingFactory::CarenWICImagingFactory(CA_CLSCTX Param_Context)
{
	...
	Utilidades Util;
	IWICImagingFactory* vi_pOutImagingFactory = Nulo;
...
CarenResult CarenWICImagingFactory::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenWICImagingFactory::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<IWICImagingFactory*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenWICImagingFactory::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IWICImagingFactory*>(Param_PonteiroNativo);
...
CarenResult CarenWICImagingFactory::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICImagingFactory::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICImagingFactory::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenWICImagingFactory::StatusPonteiro()
{
...
/// </summary>
Int32 CarenWICImagingFactory::ObterCodigoErro()
{
...
/// </summary>
void CarenWICImagingFactory::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenWICImagingFactory::LiberarReferencia()
{
...
/// </summary>
void CarenWICImagingFactory::LimparDados()
{
...
/// </summary>
void CarenWICImagingFactory::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenWICImagingFactory();
}



// Métodos da interface proprietária(ICarenWICImagingFactory)
...
CarenResult CarenWICImagingFactory::CreateBitmap(
UInt32 Param_Width,
UInt32 Param_Height,
...
CarenResult CarenWICImagingFactory::CreateBitmapClipper([Out] ICarenWICBitmapClipper^% Param_Out_BitmapClipper)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICImagingFactory::CreateBitmapFlipRotator([Out] ICarenWICBitmapFlipRotator^% Param_Out_BitmapFlipRotator)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// <param name="Param_Out_Bitmap">Retorna uma interface(ICarenWICBitmap) que contém um ponteiro para o novo bitmap.</param>
CarenResult CarenWICImagingFactory::CreateBitmapFromHBITMAP(
...
/// <param name="Param_Out_Bitmap">Retorna uma interface(ICarenWICBitmap) que contém um ponteiro para o novo bitmap.</param>
CarenResult CarenWICImagingFactory::CreateBitmapFromHICON(
...
/// <param name="Param_Out_Bitmap">Retorna uma interface(ICarenWICBitmap) que contém um ponteiro para o novo bitmap.</param>
CarenResult CarenWICImagingFactory::CreateBitmapFromMemory(
UInt32 Param_Width,
UInt32 Param_Height,
String^ Param_GuidFormatoPixel,
UInt32 Param_Stride,
...
/// <param name="Param_Out_Bitmap">Retorna uma interface(ICarenWICBitmap) que contém um ponteiro para o novo bitmap.</param>
CarenResult CarenWICImagingFactory::CreateBitmapFromSource(
...
/// <param name="Param_Out_Bitmap">Retorna uma interface(ICarenWICBitmap) que contém um ponteiro para o novo bitmap.</param>
CarenResult CarenWICImagingFactory::CreateBitmapFromSourceRect(
ICarenWICBitmapSource^ Param_FonteBitmap,
UInt32 Param_X,
UInt32 Param_Y,
UInt32 Param_Width,
...
CarenResult CarenWICImagingFactory::CreateBitmapScaler([Out] ICarenWICBitmapScaler^% Param_Out_BitmapScaler)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICImagingFactory::CreateColorContext([Out] ICarenWICColorContext^% Param_Out_WicColorContext)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICImagingFactory::CreateColorTransformer([Out] ICarenWICColorTransform^% Param_Out_WicColorTransform)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICImagingFactory::CreateComponentEnumerator(
...
CarenResult CarenWICImagingFactory::CreateComponentInfo(
...
CarenResult CarenWICImagingFactory::CreateDecoder(
...
CarenResult CarenWICImagingFactory::CreateDecoderFromFileHandle(
...
/// <param name="Param_Out_BitmapDecoder">Retorna uma interface(ICarenWICBitmapDecoder) que contém um ponteiro para o novo decodificador.</param>
CarenResult CarenWICImagingFactory::CreateDecoderFromFilename(
...
/// <param name="Param_OpcoesMetadata">As opções de código WIC para usar ao criar o decodificador.</param>
/// <param name="Param_Out_BitmapDecoder">Retorna uma interface(ICarenWICBitmapDecoder) que contém um ponteiro para o novo decodificador.</param>
CarenResult CarenWICImagingFactory::CreateDecoderFromStream(
...
CarenResult CarenWICImagingFactory::CreateEncoder(
String^ Param_GuidFormatoContainer,
String^ Param_GuidVendor,
...
CarenResult CarenWICImagingFactory::CreateFastMetadataEncoderFromDecoder(
...
/// <param name="Param_Out_FastEncoder">Retorna uma interface(ICarenWICFastMetadataEncoder) que contém um ponteiro para o novo codificador rapido de metadados.</param>
CarenResult CarenWICImagingFactory::CreateFastMetadataEncoderFromFrameDecode(
...
CarenResult CarenWICImagingFactory::CreateFormatConverter([Out] ICarenWICFormatConverter^% Param_Out_FormatConverter)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICImagingFactory::CreatePalette([Out] ICarenWICPalette^% Param_Out_WicPaleta)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICImagingFactory::CreateQueryWriter(
...
/// <param name="Param_GuidVendor">O GUID para o vendedor de metadata preferido. Use NULO se não houver fornecedor preferencial.</param>
/// <param name="Param_Out_QueryWriter">Retorna uma interface(ICarenWICMetadataQueryWriter) que contém um ponteiro para o novo escritor de consultas.</param>
CarenResult CarenWICImagingFactory::CreateQueryWriterFromReader(
...
CarenResult CarenWICImagingFactory::CreateStream([Out] ICarenWICStream^% Param_Out_WicStream)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
