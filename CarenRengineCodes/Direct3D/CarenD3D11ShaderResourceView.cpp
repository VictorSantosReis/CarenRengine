...
CarenResult CarenD3D11ShaderResourceView::GetResource([Out] ICarenD3D11Resource^% Param_Out_Recurso)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11ShaderResourceView::GetDevice(ICaren^ Param_Out_DispositivoD3D11)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11ShaderResourceView::GetPrivateData(
	String^ Param_Guid,
...
CarenResult CarenD3D11ShaderResourceView::SetPrivateData(
	String^ Param_Guid,
...
CarenResult CarenD3D11ShaderResourceView::SetPrivateDataInterface(
