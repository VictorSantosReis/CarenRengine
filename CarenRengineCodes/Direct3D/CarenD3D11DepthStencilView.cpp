...
CarenResult CarenD3D11DepthStencilView::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD3D11DepthStencilView::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID3D11DepthStencilView*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD3D11DepthStencilView::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID3D11DepthStencilView*>(Param_PonteiroNativo);
...
CarenResult CarenD3D11DepthStencilView::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11DepthStencilView::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11DepthStencilView::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenD3D11DepthStencilView::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD3D11DepthStencilView::ObterCodigoErro()
{
...
/// </summary>
void CarenD3D11DepthStencilView::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD3D11DepthStencilView::LiberarReferencia()
{
...
/// </summary>
void CarenD3D11DepthStencilView::LimparDados()
{
...
/// </summary>
void CarenD3D11DepthStencilView::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenD3D11DepthStencilView();
}
...
CarenResult CarenD3D11DepthStencilView::GetDesc(Estruturas::CA_D3D11_DEPTH_STENCIL_VIEW_DESC^% Param_Out_DescViewStencil)
{
	...
	//Variaveis a serem utilizadas.
	Utilidades Util;
	D3D11_DEPTH_STENCIL_VIEW_DESC DescViewStencil;

	//Chama o método para realizar a operação.
	PonteiroTrabalho->GetDesc(&DescViewStencil);

	//Converte a estrutura e define no parametro de saida.
	Param_Out_DescViewStencil = Util.ConverterD3D11_DEPTH_STENCIL_VIEW_DESCUnManaged_ToManaged(&DescViewStencil);
...
CarenResult CarenD3D11DepthStencilView::ObterRecurso([Out] ICarenD3D11Resource^% Param_Out_Recurso)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11DepthStencilView::ObterDispositivo(ICaren^ Param_Out_DispositivoD3D11)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11DepthStencilView::ObterDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11DepthStencilView::DefinirDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11DepthStencilView::DefinirInterfaceDadosPrivados(
