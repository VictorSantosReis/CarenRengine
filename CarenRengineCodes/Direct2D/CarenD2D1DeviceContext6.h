...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por executar todas as mesmas funções da interface ICarenD2D1DeviceContext5 existente, além disso permite o acesso 
/// ao método BlendImage.
/// </summary>
public ref class CarenD2D1DeviceContext6 : public ICarenD2D1DeviceContext6
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID2D1DeviceContext6).
	ID2D1DeviceContext6* PonteiroTrabalho = NULL;
...
public:
	static operator CarenD2D1DeviceContext6^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1DeviceContext6^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1DeviceContext6();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1DeviceContext6*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD2D1DeviceContext6::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenD2D1DeviceContext6)
public:
	/// <summary>
	...
	//Métodos da interface(ICarenD2D1DeviceContext5)
public:
	/// <summary>
	...
	virtual CarenResult CreateColorContextFromDxgiColorSpace(
	...
	/// <param name="Param_Out_ColorContext">Retorna uma interface(ICarenD2D1ColorContext1) que contém um ponteiro para o novo contexto do dispositivo.</param>
	virtual CarenResult CreateColorContextFromSimpleColorProfile(
	...
	virtual CarenResult CreateSvgDocument(
	...
	virtual void DrawSvgDocument(ICarenD2D1SvgDocument^ Param_SvgDocumento);
...
public:
	...
	virtual CarenResult CreateSvgGlyphStyle(
	...
	virtual void DrawColorBitmapGlyphRun(
	...
	virtual CarenResult GetColorBitmapGlyphImage(
		CA_DWRITE_GLYPH_IMAGE_FORMATS Param_GlyphImageFormat,
	...
	virtual CarenResult GetSvgGlyphImage(
		CA_D2D1_POINT_2F^ Param_GlyphOrigin,
		ICaren^ Param_FontFace,
		float Param_FontSize,
		UInt16 Param_GlyphIndex,
...
public:
	...
	virtual CarenResult CreateSpriteBatch(
