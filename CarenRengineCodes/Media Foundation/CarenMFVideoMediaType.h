...
public ref class CarenMFVideoMediaType : public ICarenMFVideoMediaType
{
	...
	//Ponteiro para a interface (IMFVideoMediaType).
...
public:
	static operator CarenMFVideoMediaType^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFVideoMediaType^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFVideoMediaType();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFVideoMediaType*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFVideoMediaType::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenMFVideoMediaType)
public:
	//A interface não tem métodos proprios.
