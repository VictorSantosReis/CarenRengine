...
//Destruidor.
CarenD3D11RasterizerState::~CarenD3D11RasterizerState()
{
...
CarenResult CarenD3D11RasterizerState::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD3D11RasterizerState::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID3D11RasterizerState*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD3D11RasterizerState::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID3D11RasterizerState*>(Param_PonteiroNativo);
...
CarenResult CarenD3D11RasterizerState::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11RasterizerState::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11RasterizerState::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenD3D11RasterizerState::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD3D11RasterizerState::ObterCodigoErro()
{
...
/// </summary>
void CarenD3D11RasterizerState::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD3D11RasterizerState::LiberarReferencia()
{
...
/// </summary>
void CarenD3D11RasterizerState::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenD3D11RasterizerState();
}
...
CarenResult CarenD3D11RasterizerState::GetDesc([Out] Estruturas::CA_D3D11_RASTERIZER_DESC^% Param_Out_DescRasterizador)
{
...
CarenResult CarenD3D11RasterizerState::ObterDispositivo(ICaren^ Param_Out_DispositivoD3D11)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11RasterizerState::ObterDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11RasterizerState::DefinirDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11RasterizerState::DefinirInterfaceDadosPrivados(
