...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD2D1CommandList">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD2D1CommandList^% Param_Out_CarenD2D1CommandList)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);

		//Cria a interface
		Param_Out_CarenD2D1CommandList = gcnew CarenD2D1CommandList();
