...
/// </summary>
public ref class Caren : public ICaren
{
	/////////////////////////////////////////
...
public:
	...
	/// </summary>
	/// <param name="Param_Out_Caren">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICaren^% Param_Out_Caren)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_Caren = gcnew Caren();
