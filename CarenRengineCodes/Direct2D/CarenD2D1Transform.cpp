...
CarenResult CarenD2D1Transform::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1Transform*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1Transform::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1Transform*>(Param_PonteiroNativo);
...
/// </summary>
Int32 CarenD2D1Transform::ObterCodigoErro()
{
...
/// </summary>
void CarenD2D1Transform::LimparDados()
{
