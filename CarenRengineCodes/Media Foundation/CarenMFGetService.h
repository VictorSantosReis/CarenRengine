...
/// <summary>
/// Classe responsável por consultar serviços(Interfaces) no objeto nativo a qual essa classe foi obtida.
/// </summary>
public ref class CarenMFGetService : public ICarenMFGetService
{
	/////////////////////////////////////////
...
public:
	static operator CarenMFGetService^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFGetService^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFGetService();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFGetService*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFGetService::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface ICarenMFGetService
public:
	/// <summary>
