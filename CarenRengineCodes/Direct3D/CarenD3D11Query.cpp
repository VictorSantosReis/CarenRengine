...
CarenResult CarenD3D11Query::GetDevice(ICaren^ Param_Out_DispositivoD3D11)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Query::GetPrivateData(
	String^ Param_Guid,
...
CarenResult CarenD3D11Query::SetPrivateData(
	String^ Param_Guid,
...
CarenResult CarenD3D11Query::SetPrivateDataInterface(
