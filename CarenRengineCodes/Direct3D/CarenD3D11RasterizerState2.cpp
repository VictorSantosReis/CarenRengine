...
CarenResult CarenD3D11RasterizerState2::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
	...
	Hr = (reinterpret_cast<ID3D11RasterizerState2*>(PonteiroTrabalho))->QueryInterface(GuidInterface, (LPVOID*)&pInterfaceSolcitada);
...
CarenResult CarenD3D11RasterizerState2::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID3D11RasterizerState2*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD3D11RasterizerState2::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID3D11RasterizerState2*>(Param_PonteiroNativo);
...
CarenResult CarenD3D11RasterizerState2::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11RasterizerState2::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11RasterizerState2::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenD3D11RasterizerState2::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD3D11RasterizerState2::ObterCodigoErro()
{
...
/// </summary>
void CarenD3D11RasterizerState2::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
	(reinterpret_cast<ID3D11RasterizerState2*>(PonteiroTrabalho))->AddRef();
}

/// <summary>
/// (Release) - 'Decrementa' a contagem de referência do objeto COM atual.
/// </summary>
void CarenD3D11RasterizerState2::LiberarReferencia()
{
	//Libera a referência e obtém a quantidade atual.
	ULONG RefCount = (reinterpret_cast<ID3D11RasterizerState2*>(PonteiroTrabalho))->Release();
...
/// </summary>
void CarenD3D11RasterizerState2::LimparDados()
{
...
/// </summary>
void CarenD3D11RasterizerState2::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenD3D11RasterizerState2();
}
...
CarenResult CarenD3D11RasterizerState2::ObterDispositivo(ICaren^ Param_Out_DispositivoD3D11)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11RasterizerState2::ObterDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11RasterizerState2::DefinirDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11RasterizerState2::DefinirInterfaceDadosPrivados(
