...
CarenResult CarenPersistStream::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IPersistStream*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenPersistStream::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IPersistStream*>(Param_PonteiroNativo);
...
/// </summary>
Int32 CarenPersistStream::ObterCodigoErro()
{
...
/// </summary>
void CarenPersistStream::LimparDados()
{
