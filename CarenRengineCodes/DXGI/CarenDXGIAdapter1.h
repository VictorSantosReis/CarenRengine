...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por representar um subsistema de exibição (incluindo uma ou mais GPU' s, DACs e memória de vídeo). 
/// </summary>
public ref class CarenDXGIAdapter1 : public ICarenDXGIAdapter1
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IDXGIAdapter1).
	IDXGIAdapter1* PonteiroTrabalho = NULL;
...
public:
	static operator CarenDXGIAdapter1^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenDXGIAdapter1^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenDXGIAdapter1();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IDXGIAdapter1*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenDXGIAdapter1::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
