...
CarenResult CarenD3D11Asynchronous::GetDevice(ICaren^ Param_Out_DispositivoD3D11)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Asynchronous::GetPrivateData(
	String^ Param_Guid,
...
CarenResult CarenD3D11Asynchronous::SetPrivateData(
	String^ Param_Guid,
...
CarenResult CarenD3D11Asynchronous::SetPrivateDataInterface(
