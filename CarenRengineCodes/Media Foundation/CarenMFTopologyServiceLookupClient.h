...
public:
	...
	/// </summary>
	/// <param name="Param_Out_ServiceLookupClient">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenMFTopologyServiceLookupClient^% Param_Out_ServiceLookupClient)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_ServiceLookupClient = gcnew CarenMFTopologyServiceLookupClient();
