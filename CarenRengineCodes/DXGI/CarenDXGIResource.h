...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenDXGIResource">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenDXGIResource^% Param_Out_CarenDXGIResource)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenDXGIResource = gcnew CarenDXGIResource();
