...
CarenResult CarenD3D11SamplerState::GetDevice(ICaren^ Param_Out_DispositivoD3D11)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11SamplerState::GetPrivateData(
	String^ Param_Guid,
...
CarenResult CarenD3D11SamplerState::SetPrivateData(
	String^ Param_Guid,
...
CarenResult CarenD3D11SamplerState::SetPrivateDataInterface(
