...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por encapsular uma lista de comandos gráficos para reprodução.
/// </summary>
public ref class CarenD3D11CommandList :public ICarenD3D11CommandList
{
	/////////////////////////////////////////
...
public:
	static operator CarenD3D11CommandList^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD3D11CommandList^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD3D11CommandList();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID3D11CommandList*>(Param_Pointer.ToPointer());
...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD3D11CommandList">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD3D11CommandList^% Param_Out_CarenD3D11CommandList)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenD3D11CommandList = gcnew CarenD3D11CommandList();
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD3D11CommandList::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
