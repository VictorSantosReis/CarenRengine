...
CarenResult CarenD3D11InputLayout::GetDevice(ICaren^ Param_Out_DispositivoD3D11)
{
...
CarenResult CarenD3D11InputLayout::GetPrivateData(
	String^ Param_Guid,
...
CarenResult CarenD3D11InputLayout::SetPrivateData(
	String^ Param_Guid,
...
CarenResult CarenD3D11InputLayout::SetPrivateDataInterface(
