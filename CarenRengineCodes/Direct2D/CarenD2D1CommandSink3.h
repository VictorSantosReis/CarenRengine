...
/// </summary>
public ref class CarenD2D1CommandSink3 : public ICarenD2D1CommandSink3
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID2D1CommandSink3).
...
public:
	...
	/// de trabalho. Se (Param_CriarInterface) for TRUE, o construtor vai criar uma implementação da interface(ID2D1CommandSink3).
	/// </summary>
	...
	CarenD2D1CommandSink3(Boolean Param_CriarInterface);
...
public:
	static operator CarenD2D1CommandSink3^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1CommandSink3^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1CommandSink3(false);

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1CommandSink3*>(Param_Pointer.ToPointer());
...
public:
	...
	/// </summary>
	virtual event ICarenD2D1CommandSink3::DelegateOnDrawSpriteBatch^ OnDrawSpriteBatch;
	...
	/// </summary>
	virtual event ICarenD2D1CommandSink2::DelegateOnDrawGdiMetafile1^ OnDrawGdiMetafile1;

	/// <summary>
	/// Evento chamado para notificar a reprodução do comando (DrawGradientMesh).
	/// </summary>
	virtual event ICarenD2D1CommandSink2::DelegateOnDrawGradientMesh^ OnDrawGradientMesh;

	/// <summary>
	/// Evento chamado para notificar a reprodução do comando (DrawInk).
	/// </summary>
	virtual event ICarenD2D1CommandSink2::DelegateOnDrawInk^ OnDrawInk;



	//Eventos da interface ICarenD2D1CommandSink1.

	virtual event ICarenD2D1CommandSink2::DelegateOnSetPrimitiveBlend1^ OnSetPrimitiveBlend1;
	...
	/// </summary>
	virtual event ICarenD2D1CommandSink2::DelegateOnBeginDraw^ OnBeginDraw;

	/// <summary>
	/// Evento chamado para notificar a reprodução do comando (Clear).
	/// </summary>
	virtual event ICarenD2D1CommandSink2::DelegateOnClear^ OnClear;

	/// <summary>
	/// Evento chamado para notificar a reprodução do comando (DrawBitmap).
	/// </summary>
	virtual event ICarenD2D1CommandSink2::DelegateOnDrawBitmap^ OnDrawBitmap;

	/// <summary>
	/// Evento chamado para notificar a reprodução do comando (DrawGdiMetafile).
	/// </summary>
	virtual event ICarenD2D1CommandSink2::DelegateOnDrawGdiMetafile^ OnDrawGdiMetafile;

	/// <summary>
	/// Evento chamado para notificar a reprodução do comando (DrawGeometry).
	/// </summary>
	virtual event ICarenD2D1CommandSink2::DelegateOnDrawGeometry^ OnDrawGeometry;

	/// <summary>
	/// Evento chamado para notificar a reprodução do comando (DrawGlyphRun).
	/// </summary>
	virtual event ICarenD2D1CommandSink2::DelegateOnDrawGlyphRun^ OnDrawGlyphRun;

	/// <summary>
	/// Evento chamado para notificar a reprodução do comando (DrawImage).
	/// </summary>
	virtual event ICarenD2D1CommandSink2::DelegateOnDrawImage^ OnDrawImage;

	/// <summary>
	/// Evento chamado para notificar a reprodução do comando (DrawLine).
	/// </summary>
	virtual event ICarenD2D1CommandSink2::DelegateOnDrawLine^ OnDrawLine;

	/// <summary>
	/// Evento chamado para notificar a reprodução do comando (DrawRectangle).
	/// </summary>
	virtual event ICarenD2D1CommandSink2::DelegateOnDrawRectangle^ OnDrawRectangle;

	/// <summary>
	/// Evento chamado para notificar a reprodução do comando (EndDraw).
	/// </summary>
	virtual event ICarenD2D1CommandSink2::DelegateOnEndDraw^ OnEndDraw;

	/// <summary>
	/// Evento chamado para notificar a reprodução do comando (FillGeometry).
	/// </summary>
	virtual event ICarenD2D1CommandSink2::DelegateOnFillGeometry^ OnFillGeometry;

	/// <summary>
	/// Evento chamado para notificar a reprodução do comando (FillMesh).
	/// </summary>
	virtual event ICarenD2D1CommandSink2::DelegateOnFillMesh^ OnFillMesh;

	/// <summary>
	/// Evento chamado para notificar a reprodução do comando (FillOpacityMask).
	/// </summary>
	virtual event ICarenD2D1CommandSink2::DelegateOnFillOpacityMask^ OnFillOpacityMask;

	/// <summary>
	/// Evento chamado para notificar a reprodução do comando (FillRectangle).
	/// </summary>
	virtual event ICarenD2D1CommandSink2::DelegateOnFillRectangle^ OnFillRectangle;

	/// <summary>
	/// Evento chamado para notificar a reprodução do comando (PopAxisAlignedClip).
	/// </summary>
	virtual event ICarenD2D1CommandSink2::DelegateOnPopAxisAlignedClip^ OnPopAxisAlignedClip;

	/// <summary>
	/// Evento chamado para notificar a reprodução do comando (PopLayer).
	/// </summary>
	virtual event ICarenD2D1CommandSink2::DelegateOnPopLayer^ OnPopLayer;

	/// <summary>
	/// Evento chamado para notificar a reprodução do comando (PushAxisAlignedClip).
	/// </summary>
	virtual event ICarenD2D1CommandSink2::DelegateOnPushAxisAlignedClip^ OnPushAxisAlignedClip;

	/// <summary>
	/// Evento chamado para notificar a reprodução do comando (PushLayer).
	/// </summary>
	virtual event ICarenD2D1CommandSink2::DelegateOnPushLayer^ OnPushLayer;

	/// <summary>
	/// Evento chamado para notificar a reprodução do comando (SetAntialiasMode).
	/// </summary>
	virtual event ICarenD2D1CommandSink2::DelegateOnSetAntialiasMode^ OnSetAntialiasMode;

	/// <summary>
	/// Evento chamado para notificar a reprodução do comando (SetPrimitiveBlend).
	/// </summary>
	virtual event ICarenD2D1CommandSink2::DelegateOnSetPrimitiveBlend^ OnSetPrimitiveBlend;

	/// <summary>
	/// Evento chamado para notificar a reprodução do comando (SetTags).
	/// </summary>
	virtual event ICarenD2D1CommandSink2::DelegateOnSetTags^ OnSetTags;

	/// <summary>
	/// Evento chamado para notificar a reprodução do comando (SetTextAntialiasMode).
	/// </summary>
	virtual event ICarenD2D1CommandSink2::DelegateOnSetTextAntialiasMode^ OnSetTextAntialiasMode;

	/// <summary>
	/// Evento chamado para notificar a reprodução do comando (SetTextRenderingParams).
	/// </summary>
	virtual event ICarenD2D1CommandSink2::DelegateOnSetTextRenderingParams^ OnSetTextRenderingParams;

	/// <summary>
	/// Evento chamado para notificar a reprodução do comando (SetTransform).
	/// </summary>
	virtual event ICarenD2D1CommandSink2::DelegateOnSetTransform^ OnSetTransform;

	/// <summary>
	/// Evento chamado para notificar a reprodução do comando (SetUnitMode).
	/// </summary>
	virtual event ICarenD2D1CommandSink2::DelegateOnSetUnitMode^ OnSetUnitMode;
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD2D1CommandSink3::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenD2D1CommandSink3)
public:
	/// <summary>
