...
CarenResult CarenD3DDeviceContextState::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
	...
	Hr = (reinterpret_cast<ID3DDeviceContextState*>(PonteiroTrabalho))->QueryInterface(GuidInterface, (LPVOID*)&pInterfaceSolcitada);
...
CarenResult CarenD3DDeviceContextState::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID3DDeviceContextState*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD3DDeviceContextState::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID3DDeviceContextState*>(Param_PonteiroNativo);
...
CarenResult CarenD3DDeviceContextState::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3DDeviceContextState::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3DDeviceContextState::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenD3DDeviceContextState::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD3DDeviceContextState::ObterCodigoErro()
{
...
/// </summary>
void CarenD3DDeviceContextState::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
	(reinterpret_cast<ID3DDeviceContextState*>(PonteiroTrabalho))->AddRef();
}

/// <summary>
/// (Release) - 'Decrementa' a contagem de referência do objeto COM atual.
/// </summary>
void CarenD3DDeviceContextState::LiberarReferencia()
{
	//Libera a referência e obtém a quantidade atual.
	ULONG RefCount = (reinterpret_cast<ID3DDeviceContextState*>(PonteiroTrabalho))->Release();
...
/// </summary>
void CarenD3DDeviceContextState::LimparDados()
{
...
/// </summary>
void CarenD3DDeviceContextState::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenD3DDeviceContextState();
}



//Métodos da interface proprietária(ICarenD3DDeviceContextState)
// -> NAO POSSUI MÉTODOS
...
CarenResult CarenD3DDeviceContextState::ObterDispositivo(ICaren^ Param_Out_DispositivoD3D11)
{
...
CarenResult CarenD3DDeviceContextState::ObterDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3DDeviceContextState::DefinirDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3DDeviceContextState::DefinirInterfaceDadosPrivados(
