...
CarenResult CarenMFQualityAdvise2::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IMFQualityAdvise2*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenMFQualityAdvise2::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IMFQualityAdvise2*>(Param_PonteiroNativo);
...
/// </summary>
void CarenMFQualityAdvise2::LimparDados()
{
