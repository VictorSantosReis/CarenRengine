...
/// </summary>
void CarenMFStreamDescriptor::LimparDados()
{
...
CarenResult CarenMFStreamDescriptor::SetItem(String^ Param_GuidChave, Estruturas::CA_PropVariant^ Param_PropVariantValor)
{
	...
	bool ResultCreatePropVar = false;
	...
	//Converte a PropVariant gerenciada para a não gerenciada.
	ResultCreatePropVar = Util.ConvertPropVariantManagedToUnamaged(Param_PropVariantValor, PropVar);

	//Verifica o resultado
	if (!ResultCreatePropVar)
	{
		//Define falha ao converte a propVariant.
		Resultado.AdicionarCodigo(ResultCode::ER_CONVERSAO_PROPVARIANT, false);
