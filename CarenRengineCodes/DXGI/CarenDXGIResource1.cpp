...
CarenResult CarenDXGIResource1::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
	...
	Hr = (reinterpret_cast<IDXGIResource1*>(PonteiroTrabalho))->QueryInterface(GuidInterface, (LPVOID*)&pInterfaceSolcitada);
...
CarenResult CarenDXGIResource1::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IDXGIResource1*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenDXGIResource1::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IDXGIResource1*>(Param_PonteiroNativo);
...
{
	//Adiciona uma referência ao ponteiro
	(reinterpret_cast<IDXGIResource1*>(PonteiroTrabalho))->AddRef();
}
...
void CarenDXGIResource1::LiberarReferencia()
{
	...
	ULONG RefCount = (reinterpret_cast<IDXGIResource1*>(PonteiroTrabalho))->Release();
...
/// </summary>
void CarenDXGIResource1::LimparDados()
{
...
CarenResult CarenDXGIResource1::CriarHandleCompartilhada(
...
CarenResult CarenDXGIResource1::CriarSuperficeSubrecurso(UInt32 Param_Index, ICaren^ Param_Out_DXGISurface2)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenDXGIResource1::ObterPrioridadeDespejo([Out] CA_DXGI_RESOURCE_PRIORITY% Param_Out_PrioridadeDespejo)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenDXGIResource1::ObterHandleCompartilhada([Out] IntPtr% Param_Out_SharedHandle)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenDXGIResource1::ObterUso([Out] CA_DXGI_USAGE% Param_Out_Usage)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenDXGIResource1::DefinirPrioridadeDespejo(CA_DXGI_RESOURCE_PRIORITY Param_PrioridadeDespejo)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenDXGIResource1::ObterDispositivo(String^ Param_RIIDInterface, ICaren^ Param_Out_Objeto)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenDXGIResource1::ObterPaiObjeto(String^ Param_RIIDInterface, ICaren^ Param_Out_ObjetoPai)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenDXGIResource1::DefinirDadosPrivados(String^ Param_GuidIdentificao, UInt32 Param_TamanhoDados, ICaren^ Param_Dados)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenDXGIResource1::ObterDadosPrivados(String^ Param_GuidIdentificao, UInt32% Param_Ref_TamanhoDados, ICaren^ Param_Out_Dados)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenDXGIResource1::DefinirDadosPrivadosInterface(String^ Param_GuidInterface, ICaren^ Param_Interface)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
