...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por representar uma visão estêncil que acessa um recurso de textura durante o teste de profundidade estêncil.
/// </summary>
public ref class CarenD3D11DepthStencilView :public ICarenD3D11DepthStencilView
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID3D11DepthStencilView).
	ID3D11DepthStencilView* PonteiroTrabalho = NULL;
...
public:
	static operator CarenD3D11DepthStencilView^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD3D11DepthStencilView^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD3D11DepthStencilView();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID3D11DepthStencilView*>(Param_Pointer.ToPointer());
...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD3D11DepthStencilView">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD3D11DepthStencilView^% Param_Out_CarenD3D11DepthStencilView)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenD3D11DepthStencilView = gcnew CarenD3D11DepthStencilView();
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD3D11DepthStencilView::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
