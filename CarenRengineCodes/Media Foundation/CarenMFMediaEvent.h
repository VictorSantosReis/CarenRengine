...
public:
	static operator CarenMFMediaEvent^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFMediaEvent^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFMediaEvent();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFMediaEvent*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFMediaEvent::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
...
public:
	...
	virtual CarenResult GetStatus([Out] int% Param_Out_HResultCode);
	...
	virtual CarenResult GetType([Out] Enumeracoes::CA_MediaEventType% Param_Out_TipoEvento);
	...
	virtual CarenResult GetExtendedType([Out] String^% Param_Out_GuidExtendedType);
	...
	virtual CarenResult GetValue([Out] CA_PROPVARIANT^% Param_Out_ValorEvento);
