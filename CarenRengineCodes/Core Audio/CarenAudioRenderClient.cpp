...
CarenResult CarenAudioRenderClient::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IAudioRenderClient*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenAudioRenderClient::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IAudioRenderClient*>(Param_PonteiroNativo);
...
/// </summary>
Int32 CarenAudioRenderClient::ObterCodigoErro()
{
...
/// </summary>
void CarenAudioRenderClient::LimparDados()
{
...
CarenResult CarenAudioRenderClient::ObterBuffer(UInt32 Param_NumeroFramesRequisitados, UInt32 Param_TamanhoFrameInBytes, [Out] ICarenBuffer^% Param_Out_BufferAudio)
{
...
CarenResult CarenAudioRenderClient::LiberarBuffer(UInt32 Param_NumeroFramesEscritos, Enumeracoes::CA_AUDIOCLIENTE_BUFFERFLAGS Param_Flags)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
