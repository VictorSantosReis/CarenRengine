...
//Destruidor.
CarenD2D1BitmapBrush::~CarenD2D1BitmapBrush()
{
...
CarenResult CarenD2D1BitmapBrush::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD2D1BitmapBrush::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1BitmapBrush*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1BitmapBrush::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1BitmapBrush*>(Param_PonteiroNativo);
...
CarenResult CarenD2D1BitmapBrush::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1BitmapBrush::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1BitmapBrush::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenD2D1BitmapBrush::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD2D1BitmapBrush::ObterCodigoErro()
{
...
/// </summary>
void CarenD2D1BitmapBrush::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD2D1BitmapBrush::LiberarReferencia()
{
...
/// </summary>
void CarenD2D1BitmapBrush::LimparDados()
{
...
/// </summary>
void CarenD2D1BitmapBrush::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
...
CarenResult CarenD2D1BitmapBrush::GetBitmap([Out] ICarenD2D1Bitmap^% Param_Out_Bitmap)
{
...
void CarenD2D1BitmapBrush::GetExtendModeX([Out] CA_D2D1_EXTEND_MODE% Param_Out_ExtendModeX)
{
	//Variaveis a serem utilizadas.
...
void CarenD2D1BitmapBrush::GetExtendModeY([Out] CA_D2D1_EXTEND_MODE% Param_Out_ExtendModeY)
{
	//Variaveis a serem utilizadas.
	D2D1_EXTEND_MODE OutExtendMode;
...
void CarenD2D1BitmapBrush::GetInterpolationMode([Out] CA_D2D1_BITMAP_INTERPOLATION_MODE% Param_Out_InterpolationMode)
{
	//Variaveis a serem utilizadas.
...
CarenResult CarenD2D1BitmapBrush::SetBitmap(ICarenD2D1Bitmap^ Param_Bitmap)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
void CarenD2D1BitmapBrush::SetExtendModeX(CA_D2D1_EXTEND_MODE Param_ExtendModeX)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1BitmapBrush::SetExtendModeY(CA_D2D1_EXTEND_MODE Param_ExtendModeY)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1BitmapBrush::SetInterpolationMode(CA_D2D1_BITMAP_INTERPOLATION_MODE Param_InterpolationMode)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1BitmapBrush::GetOpacity([Out] float% Param_Out_Opacidade)
{
...
void CarenD2D1BitmapBrush::GetTransform([Out] CA_D2D1_MATRIX_3X2_F^% Param_Out_Matrix)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
/// Os valores de opacidade são fixados na faixa 0-1 antes de serem múltiplos juntos.</param>
void CarenD2D1BitmapBrush::SetOpacity(float Param_Opacidade)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1BitmapBrush::SetTransform(CA_D2D1_MATRIX_3X2_F^ Param_Transform)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void CarenD2D1BitmapBrush::GetFactory(ICaren^ Param_Out_Factory)
{
	//Variaveis a serem utilizadas.
