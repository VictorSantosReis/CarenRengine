...
public:
	static operator CarenMFCapturePhotoSink^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFCapturePhotoSink^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFCapturePhotoSink();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFCapturePhotoSink*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFCapturePhotoSink::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
