...
CarenResult CarenWICBitmapSource::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenWICBitmapSource::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<IWICBitmapSource*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenWICBitmapSource::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IWICBitmapSource*>(Param_PonteiroNativo);
...
CarenResult CarenWICBitmapSource::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICBitmapSource::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICBitmapSource::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenWICBitmapSource::StatusPonteiro()
{
...
/// </summary>
Int32 CarenWICBitmapSource::ObterCodigoErro()
{
...
/// </summary>
void CarenWICBitmapSource::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenWICBitmapSource::LiberarReferencia()
{
...
/// </summary>
void CarenWICBitmapSource::LimparDados()
{
...
/// </summary>
void CarenWICBitmapSource::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenWICBitmapSource();
}



// Métodos da interface proprietária(ICarenWICBitmapSource)
...
CarenResult CarenWICBitmapSource::CopyPalette(ICaren^ Param_Palette)
{
...
CarenResult CarenWICBitmapSource::CopyPixels(
...
CarenResult CarenWICBitmapSource::GetPixelFormat([Out] String^% Param_Out_FormatoPixel)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenWICBitmapSource::GetResolution(
...
CarenResult CarenWICBitmapSource::GetSize(
