...
//Construtor
CarenWindowsEvent::CarenWindowsEvent()
{
...
CarenResult CarenWindowsEvent::AssociarEvento(IntPtr Param_PonteiroEvento)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenWindowsEvent::RecuperarEvento([Out] IntPtr% Param_Out_Evento)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenWindowsEvent::RecuperarEvento(LPVOID* Param_Out_Evento)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenWindowsEvent::AguardarObjetoUnico(UInt32 Param_TempoMilliseconds)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenWindowsEvent::AguardarObjetoUnicoEx(UInt32 Param_TempoMilliseconds, Boolean Param_Alertavel)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenWindowsEvent::ResetarEvento()
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenWindowsEvent::SinalizarEvento()
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenWindowsEvent::LiberarEvento()
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
