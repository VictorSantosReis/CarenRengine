...
public ref class CarenMFTopologyNodeAttributeEditor :public ICarenMFTopologyNodeAttributeEditor
{
	...
	//Ponteiro para a interface (IMFTopologyNodeAttributeEditor).
...
public:
	static operator CarenMFTopologyNodeAttributeEditor^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFTopologyNodeAttributeEditor^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFTopologyNodeAttributeEditor();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFTopologyNodeAttributeEditor*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFTopologyNodeAttributeEditor::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
