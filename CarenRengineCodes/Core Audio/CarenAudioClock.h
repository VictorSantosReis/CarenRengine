...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por permitir que um cliente monitore a taxa de dados de um fluxo e a posição atual no fluxo.
/// </summary>
public ref class CarenAudioClock : public ICarenAudioClock
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IAudioClock).
	IAudioClock* PonteiroTrabalho = NULL;
...
public:
	static operator CarenAudioClock^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenAudioClock^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenAudioClock();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IAudioClock*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenAudioClock::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenAudioClock)
public:
	/// <summary>
	...
	virtual CarenResult GetCharacteristics([Out] UInt32% Param_Out_Caracteristicas);
	...
	virtual CarenResult GetFrequency([Out] UInt64% Param_Out_Frequencia);
	...
	virtual CarenResult GetPosition([Out] UInt64% Param_Out_Posicao, [Out] UInt64% Param_Out_QPCPosicao);
};