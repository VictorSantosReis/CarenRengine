...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por representar um conjunto de buffers de estado e comando que são usados para renderizar um alvo.
/// </summary>
public ref class CarenD2D1DeviceContext : public ICarenD2D1DeviceContext
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID2D1DeviceContext).
...
public:
	static operator CarenD2D1DeviceContext^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1DeviceContext^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1DeviceContext();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1DeviceContext*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD2D1DeviceContext::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
