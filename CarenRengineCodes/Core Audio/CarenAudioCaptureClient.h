...
public:
	static operator CarenAudioCaptureClient^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenAudioCaptureClient^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenAudioCaptureClient();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IAudioCaptureClient*>(Param_Pointer.ToPointer());
