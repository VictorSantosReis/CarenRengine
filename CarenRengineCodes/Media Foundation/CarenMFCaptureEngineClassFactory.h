...
public ref class CarenMFCaptureEngineClassFactory : public ICarenMFCaptureEngineClassFactory
{
	...
	//Ponteiro para a interface (IMFCaptureEngineClassFactory).
	IMFCaptureEngineClassFactory* PonteiroTrabalho = NULL;
...
public:
	static operator CarenMFCaptureEngineClassFactory^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFCaptureEngineClassFactory^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFCaptureEngineClassFactory();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFCaptureEngineClassFactory*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFCaptureEngineClassFactory::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenMFCaptureEngineClassFactory)
public:
	/// <summary>
