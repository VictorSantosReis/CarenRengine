...
public ref class CarenMFCaptureEngineOnEventCallback : public ICarenMFCaptureEngineOnEventCallback
{
	...
	//Ponteiro para a interface (IMFCaptureEngineOnEventCallback).
	IMFCaptureEngineOnEventCallback* PonteiroTrabalho = NULL;
...
public:
	...
	/// de trabalho. Se (Param_CriarInterface) for TRUE, o construtor vai criar uma implementação interna da (IMFCaptureEngineOnEventCallback).
	/// </summary>
	...
	CarenMFCaptureEngineOnEventCallback(Boolean Param_CriarInterface);
...
public:
	static operator CarenMFCaptureEngineOnEventCallback^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFCaptureEngineOnEventCallback^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFCaptureEngineOnEventCallback(false);

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFCaptureEngineOnEventCallback*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFCaptureEngineOnEventCallback::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenMFCaptureEngineOnEventCallback)
public:
	/// <summary>
