...
CarenResult CarenDXGIDeviceSubObject::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
	...
	Hr = (reinterpret_cast<IDXGIDeviceSubObject*>(PonteiroTrabalho))->QueryInterface(GuidInterface, (LPVOID*)&pInterfaceSolcitada);
...
CarenResult CarenDXGIDeviceSubObject::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IDXGIDeviceSubObject*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenDXGIDeviceSubObject::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IDXGIDeviceSubObject*>(Param_PonteiroNativo);
...
{
	//Adiciona uma referência ao ponteiro
	(reinterpret_cast<IDXGIDeviceSubObject*>(PonteiroTrabalho))->AddRef();
}
...
void CarenDXGIDeviceSubObject::LiberarReferencia()
{
	...
	ULONG RefCount = (reinterpret_cast<IDXGIDeviceSubObject*>(PonteiroTrabalho))->Release();
...
/// </summary>
void CarenDXGIDeviceSubObject::LimparDados()
{
...
CarenResult CarenDXGIDeviceSubObject::ObterDispositivo(String^ Param_RIIDInterface, ICaren^ Param_Out_Objeto)
{
...
CarenResult CarenDXGIDeviceSubObject::ObterPaiObjeto(String^ Param_RIIDInterface, ICaren^ Param_Out_ObjetoPai)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenDXGIDeviceSubObject::DefinirDadosPrivados(String^ Param_GuidIdentificao, UInt32 Param_TamanhoDados, ICaren^ Param_Dados)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenDXGIDeviceSubObject::ObterDadosPrivados(String^ Param_GuidIdentificao, UInt32% Param_Ref_TamanhoDados, ICaren^ Param_Out_Dados)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenDXGIDeviceSubObject::DefinirDadosPrivadosInterface(String^ Param_GuidInterface, ICaren^ Param_Interface)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
