...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por pintar uma área com uma cor sólida.
/// </summary>
public ref class CarenD2D1SolidColorBrush : public ICarenD2D1SolidColorBrush
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID2D1SolidColorBrush).
...
public:
	static operator CarenD2D1SolidColorBrush^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1SolidColorBrush^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1SolidColorBrush();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1SolidColorBrush*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD2D1SolidColorBrush::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
