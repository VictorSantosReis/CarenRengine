...
{
	//Fixa o ponteiro.
	cli::pin_ptr<ID3D11Device5*> p = &PonteiroTrabalho;

	//Chama o método de ADICIONAR PONTEIRO na classe base(Caren).
	return Caren::Shared_AdicionarPonteiro(Param_PonteiroNativo, reinterpret_cast<IUnknown**>(static_cast<ID3D11Device5**>(p)));
}
				...
				ICarenD3D11Fence^% Param_Ref_FenceInterface)
{
	...
	return Shared_D3D11Device::CreateFence(PonteiroTrabalho,
		Param_DadosInicias,
		Param_Flags,
		Param_RIIDInterface,
		Param_Ref_FenceInterface
	);
}
...
{
	//Chama o método na classe de funções compartilhadas do D3D11.
	return Shared_D3D11Device::OpenSharedFence(PonteiroTrabalho,
		Param_Handle,
		Param_RIIDInterface,
		Param_Ref_FenceInterface
	);
...
CarenResult CarenD3D11Device5::CreateBlendState1(
...
CarenResult CarenD3D11Device5::CreateDeferredContext1(
	UInt32 Param_ContextFlags, 
...
CarenResult CarenD3D11Device5::CreatePredicate(
