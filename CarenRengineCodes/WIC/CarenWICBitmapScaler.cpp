...
CarenResult CarenWICBitmapScaler::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IWICBitmapScaler*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenWICBitmapScaler::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IWICBitmapScaler*>(Param_PonteiroNativo);
...
/// </summary>
Int32 CarenWICBitmapScaler::ObterCodigoErro()
{
...
/// </summary>
void CarenWICBitmapScaler::LimparDados()
{
