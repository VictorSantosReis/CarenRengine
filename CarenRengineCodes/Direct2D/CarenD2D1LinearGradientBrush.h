...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por pintar uma área com um gradiente linear.
/// </summary>
public ref class CarenD2D1LinearGradientBrush : public ICarenD2D1LinearGradientBrush
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID2D1LinearGradientBrush).
...
public:
	static operator CarenD2D1LinearGradientBrush^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1LinearGradientBrush^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1LinearGradientBrush();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1LinearGradientBrush*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD2D1LinearGradientBrush::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenD2D1LinearGradientBrush)
public:
	/// <summary>
	...
	virtual void GetEndPoint([Out] CA_D2D1_POINT_2F^% Param_Out_EndPoint);
	...
	virtual void GetStartPoint([Out] CA_D2D1_POINT_2F^% Param_Out_StartPoint);
	...
	virtual void SetEndPoint(CA_D2D1_POINT_2F^ Param_EndPoint);
	...
	virtual void SetStartPoint(CA_D2D1_POINT_2F^ Param_StartPoint);
