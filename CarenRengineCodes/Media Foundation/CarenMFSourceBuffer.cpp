...
CarenResult CarenMFSourceBuffer::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IMFSourceBuffer*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenMFSourceBuffer::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IMFSourceBuffer*>(Param_PonteiroNativo);
...
/// </summary>
void CarenMFSourceBuffer::LimparDados()
{
