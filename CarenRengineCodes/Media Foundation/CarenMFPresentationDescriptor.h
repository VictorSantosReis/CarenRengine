...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por descrever detalhes de uma apresentação. Uma apresentação é um conjunto de fluxos de mídia relacionados que compartilham 
/// um tempo de apresentação comum.
/// </summary>
public ref class CarenMFPresentationDescriptor : public ICarenMFPresentationDescriptor
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IMFPresentationDescriptor).
	IMFPresentationDescriptor* PonteiroTrabalho = NULL;
...
public:
	static operator CarenMFPresentationDescriptor^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFPresentationDescriptor^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFPresentationDescriptor();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFPresentationDescriptor*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFPresentationDescriptor::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenMFPresentationDescriptor)
public:
	/// <summary>
...
public:
	...
	virtual CarenResult CompareItem(
	...
	virtual CarenResult GetAllocatedBlob(
		String^ Param_GuidChave, 
	...
	virtual CarenResult GetAllocatedString(
		String^ Param_GuidChave, 
	...
	virtual CarenResult GetBlobSize(
		String^ Param_GuidChave, 
	...
	/// <param name="Param_Out_Valor">Recebe o valor referente ao valor da chave solicitada</param>
	virtual CarenResult GetItemByIndex(
		UInt32 Param_IdItem, 
	...
	virtual CarenResult GetItemType(
		String^ Param_GuidChave, 
	...
	virtual CarenResult GetStringLength(
		String^ Param_GuidChave, 
	...
	virtual CarenResult _MFGetAttributeRatio(
		String^ Param_GuidChave, 
	...
	virtual CarenResult GetUnknown(
		String^ Param_GuidChave, 
	...
	virtual CarenResult _MFGetAttributeSize(
		String^ Param_GuidChave, 
		[Out] UInt32% Param_Out_Largura, 
	...
	virtual CarenResult _MFSetAttributeRatio(
		String^ Param_GuidChave, 
	...
	virtual CarenResult _MFSetAttributeSize(
		String^ Param_GuidChave, 
	...
	virtual CarenResult SetUnknown(
		String^ Param_GuidChave, 
