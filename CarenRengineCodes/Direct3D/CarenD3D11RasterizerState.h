...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por representar um Estado do Rasterizado que contém uma descrição para o estado (Rasterizer) que você pode ligar para o (Estágio Rasterizer).
/// </summary>
public ref class CarenD3D11RasterizerState : public ICarenD3D11RasterizerState
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID3D11RasterizerState).
	ID3D11RasterizerState* PonteiroTrabalho = NULL;
...
public:
	static operator CarenD3D11RasterizerState^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD3D11RasterizerState^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD3D11RasterizerState();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID3D11RasterizerState*>(Param_Pointer.ToPointer());
...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD3D11RasterizerState">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD3D11RasterizerState^% Param_Out_CarenD3D11RasterizerState)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenD3D11RasterizerState = gcnew CarenD3D11RasterizerState();
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD3D11RasterizerState::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
...
public:
	...
	virtual CarenResult GetDesc([Out] Estruturas::CA_D3D11_RASTERIZER_DESC^% Param_Out_DescRasterizador);
