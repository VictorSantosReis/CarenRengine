...
public:
	static operator CarenMFMediaBuffer^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFMediaBuffer^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFMediaBuffer();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFMediaBuffer*>(Param_Pointer.ToPointer());
