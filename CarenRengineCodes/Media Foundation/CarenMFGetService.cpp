...
CarenResult CarenMFGetService::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IMFGetService*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenMFGetService::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IMFGetService*>(Param_PonteiroNativo);
...
/// </summary>
void CarenMFGetService::LimparDados()
{
