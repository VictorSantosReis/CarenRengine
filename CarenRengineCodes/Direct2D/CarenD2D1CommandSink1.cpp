...
#include "../pch.h"
#include "CarenD2D1CommandSink1.h"
...
//Construtor.
CarenD2D1CommandSink1::CarenD2D1CommandSink1(Boolean Param_CriarInterface)
{
	//Verifica se deve ou não criar uma interface.
	if (Param_CriarInterface)
	{
		//Cria a implementação da interface
		PonteiroTrabalho = new CLN_ID2D1CommandSink1();
	}
	else
	{
...
CarenResult CarenD2D1CommandSink1::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD2D1CommandSink1::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1CommandSink1*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1CommandSink1::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1CommandSink1*>(Param_PonteiroNativo);
...
CarenResult CarenD2D1CommandSink1::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1CommandSink1::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1CommandSink1::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenD2D1CommandSink1::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD2D1CommandSink1::ObterCodigoErro()
{
...
/// </summary>
void CarenD2D1CommandSink1::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD2D1CommandSink1::LiberarReferencia()
{
...
/// </summary>
void CarenD2D1CommandSink1::LimparDados()
{
...
/// </summary>
void CarenD2D1CommandSink1::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenD2D1CommandSink1();
}



// Métodos da interface proprietaria ICarenD2D1CommandSink1


/// <summary>
/// Método responsável por registrar os eventos da interface.
/// </summary>
void CarenD2D1CommandSink1::RegistrarCallback()
{
	//Variaveis utilizadas no método
	Utilidades Util;

	//Configura os delegates da CarenD2D1CommandSink1
	Callback_OnSetPrimitiveBlend1 = gcnew DelegateNativo_Evento_OnSetPrimitiveBlend1(this, &CarenD2D1CommandSink1::EncaminharEvento_OnSetPrimitiveBlend1);

	//Configura os delegates da CarenD2D1CommandSink
	Callback_OnBeginDraw = gcnew DelegateNativo_Evento_OnBeginDraw(this, &CarenD2D1CommandSink1::EncaminharEvento_OnBeginDraw);
	Callback_OnEndDraw = gcnew DelegateNativo_Evento_OnEndDraw(this, &CarenD2D1CommandSink1::EncaminharEvento_OnEndDraw);
	Callback_OnSetAntialiasMode = gcnew DelegateNativo_Evento_OnSetAntialiasMode(this, &CarenD2D1CommandSink1::EncaminharEvento_OnSetAntialiasMode);
	Callback_OnSetTags = gcnew DelegateNativo_Evento_OnSetTags(this, &CarenD2D1CommandSink1::EncaminharEvento_OnSetTags);
	Callback_OnSetTextAntialiasMode = gcnew DelegateNativo_Evento_OnSetTextAntialiasMode(this, &CarenD2D1CommandSink1::EncaminharEvento_OnSetTextAntialiasMode);
	Callback_OnSetTextRenderingParams = gcnew DelegateNativo_Evento_OnSetTextRenderingParams(this, &CarenD2D1CommandSink1::EncaminharEvento_OnSetTextRenderingParams);
	Callback_OnSetTransform = gcnew DelegateNativo_Evento_OnSetTransform(this, &CarenD2D1CommandSink1::EncaminharEvento_OnSetTransform);
	Callback_OnSetPrimitiveBlend = gcnew DelegateNativo_Evento_OnSetPrimitiveBlend(this, &CarenD2D1CommandSink1::EncaminharEvento_OnSetPrimitiveBlend);
	Callback_OnSetUnitMode = gcnew DelegateNativo_Evento_OnSetUnitMode(this, &CarenD2D1CommandSink1::EncaminharEvento_OnSetUnitMode);
	Callback_OnClear = gcnew DelegateNativo_Evento_OnClear(this, &CarenD2D1CommandSink1::EncaminharEvento_OnClear);
	Callback_OnDrawGlyphRun = gcnew DelegateNativo_Evento_OnDrawGlyphRun(this, &CarenD2D1CommandSink1::EncaminharEvento_OnDrawGlyphRun);
	Callback_OnDrawLine = gcnew DelegateNativo_Evento_OnDrawLine(this, &CarenD2D1CommandSink1::EncaminharEvento_OnDrawLine);
	Callback_OnDrawGeometry = gcnew DelegateNativo_Evento_OnDrawGeometry(this, &CarenD2D1CommandSink1::EncaminharEvento_OnDrawGeometry);
	Callback_OnDrawRectangle = gcnew DelegateNativo_Evento_OnDrawRectangle(this, &CarenD2D1CommandSink1::EncaminharEvento_OnDrawRectangle);
	Callback_OnDrawBitmap = gcnew DelegateNativo_Evento_OnDrawBitmap(this, &CarenD2D1CommandSink1::EncaminharEvento_OnDrawBitmap);
	Callback_OnDrawImage = gcnew DelegateNativo_Evento_OnDrawImage(this, &CarenD2D1CommandSink1::EncaminharEvento_OnDrawImage);
	Callback_OnDrawGdiMetafile = gcnew DelegateNativo_Evento_OnDrawGdiMetafile(this, &CarenD2D1CommandSink1::EncaminharEvento_OnDrawGdiMetafile);
	Callback_OnFillMesh = gcnew DelegateNativo_Evento_OnFillMesh(this, &CarenD2D1CommandSink1::EncaminharEvento_OnFillMesh);
	Callback_OnFillOpacityMask = gcnew DelegateNativo_Evento_OnFillOpacityMask(this, &CarenD2D1CommandSink1::EncaminharEvento_OnFillOpacityMask);
	Callback_OnFillGeometry = gcnew DelegateNativo_Evento_OnFillGeometry(this, &CarenD2D1CommandSink1::EncaminharEvento_OnFillGeometry);
	Callback_OnFillRectangle = gcnew DelegateNativo_Evento_OnFillRectangle(this, &CarenD2D1CommandSink1::EncaminharEvento_OnFillRectangle);
	Callback_OnPushAxisAlignedClip = gcnew DelegateNativo_Evento_OnPushAxisAlignedClip(this, &CarenD2D1CommandSink1::EncaminharEvento_OnPushAxisAlignedClip);
	Callback_OnPushLayer = gcnew DelegateNativo_Evento_OnPushLayer(this, &CarenD2D1CommandSink1::EncaminharEvento_OnPushLayer);
	Callback_OnPopAxisAlignedClip = gcnew DelegateNativo_Evento_OnPopAxisAlignedClip(this, &CarenD2D1CommandSink1::EncaminharEvento_OnPopAxisAlignedClip);
	Callback_OnPopLayer = gcnew DelegateNativo_Evento_OnPopLayer(this, &CarenD2D1CommandSink1::EncaminharEvento_OnPopLayer);
	...
	((CLN_ID2D1CommandSink1*)PonteiroTrabalho)->Evento_SetPrimitiveBlend1 = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink1_EventoNativo_SetPrimitiveBlend1>(Pointer_OnSetPrimitiveBlend1);

	//Registra os delegates criados para os delegates nativo na classe CLN_ID2D1CommandSink que envia os eventos.
	((CLN_ID2D1CommandSink1*)PonteiroTrabalho)->Evento_BeginDraw = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink1_EventoNativo_BeginDraw>(Pointer_OnBeginDraw);
	((CLN_ID2D1CommandSink1*)PonteiroTrabalho)->Evento_EndDraw = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink1_EventoNativo_EndDraw>(Pointer_OnEndDraw);
	((CLN_ID2D1CommandSink1*)PonteiroTrabalho)->Evento_SetAntialiasMode = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink1_EventoNativo_SetAntialiasMode>(Pointer_OnSetAntialiasMode);
	((CLN_ID2D1CommandSink1*)PonteiroTrabalho)->Evento_SetTags = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink1_EventoNativo_SetTags>(Pointer_OnSetTags);
	((CLN_ID2D1CommandSink1*)PonteiroTrabalho)->Evento_SetTextAntialiasMode = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink1_EventoNativo_SetTextAntialiasMode>(Pointer_OnSetTextAntialiasMode);
	((CLN_ID2D1CommandSink1*)PonteiroTrabalho)->Evento_SetTextRenderingParams = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink1_EventoNativo_SetTextRenderingParams>(Pointer_OnSetTextRenderingParams);
	((CLN_ID2D1CommandSink1*)PonteiroTrabalho)->Evento_SetTransform = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink1_EventoNativo_SetTransform>(Pointer_OnSetTransform);
	((CLN_ID2D1CommandSink1*)PonteiroTrabalho)->Evento_SetPrimitiveBlend = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink1_EventoNativo_SetPrimitiveBlend>(Pointer_OnSetPrimitiveBlend);
	((CLN_ID2D1CommandSink1*)PonteiroTrabalho)->Evento_SetUnitMode = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink1_EventoNativo_SetUnitMode>(Pointer_OnSetUnitMode);
	((CLN_ID2D1CommandSink1*)PonteiroTrabalho)->Evento_Clear = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink1_EventoNativo_Clear>(Pointer_OnClear);
	((CLN_ID2D1CommandSink1*)PonteiroTrabalho)->Evento_DrawGlyphRun = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink1_EventoNativo_DrawGlyphRun>(Pointer_OnDrawGlyphRun);
	((CLN_ID2D1CommandSink1*)PonteiroTrabalho)->Evento_DrawLine = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink1_EventoNativo_DrawLine>(Pointer_OnDrawLine);
	((CLN_ID2D1CommandSink1*)PonteiroTrabalho)->Evento_DrawGeometry = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink1_EventoNativo_DrawGeometry>(Pointer_OnDrawGeometry);
	((CLN_ID2D1CommandSink1*)PonteiroTrabalho)->Evento_DrawRectangle = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink1_EventoNativo_DrawRectangle>(Pointer_OnDrawRectangle);
	((CLN_ID2D1CommandSink1*)PonteiroTrabalho)->Evento_DrawBitmap = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink1_EventoNativo_DrawBitmap>(Pointer_OnDrawBitmap);
	((CLN_ID2D1CommandSink1*)PonteiroTrabalho)->Evento_DrawImage = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink1_EventoNativo_DrawImage>(Pointer_OnDrawImage);
	((CLN_ID2D1CommandSink1*)PonteiroTrabalho)->Evento_DrawGdiMetafile = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink1_EventoNativo_DrawGdiMetafile>(Pointer_OnDrawGdiMetafile);
	((CLN_ID2D1CommandSink1*)PonteiroTrabalho)->Evento_FillMesh = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink1_EventoNativo_FillMesh>(Pointer_OnFillMesh);
	((CLN_ID2D1CommandSink1*)PonteiroTrabalho)->Evento_FillOpacityMask = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink1_EventoNativo_FillOpacityMask>(Pointer_OnFillOpacityMask);
	((CLN_ID2D1CommandSink1*)PonteiroTrabalho)->Evento_FillGeometry = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink1_EventoNativo_FillGeometry>(Pointer_OnFillGeometry);
	((CLN_ID2D1CommandSink1*)PonteiroTrabalho)->Evento_FillRectangle = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink1_EventoNativo_FillRectangle>(Pointer_OnFillRectangle);
	((CLN_ID2D1CommandSink1*)PonteiroTrabalho)->Evento_PushAxisAlignedClip = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink1_EventoNativo_PushAxisAlignedClip>(Pointer_OnPushAxisAlignedClip);
	((CLN_ID2D1CommandSink1*)PonteiroTrabalho)->Evento_PushLayer = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink1_EventoNativo_PushLayer>(Pointer_OnPushLayer);
	((CLN_ID2D1CommandSink1*)PonteiroTrabalho)->Evento_PopAxisAlignedClip = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink1_EventoNativo_PopAxisAlignedClip>(Pointer_OnPopAxisAlignedClip);
	((CLN_ID2D1CommandSink1*)PonteiroTrabalho)->Evento_PopLayer = Util.ConverterPointerDelegateToNativeDelegate<CLN_ID2D1CommandSink1_EventoNativo_PopLayer>(Pointer_OnPopLayer);
}
...
/// </summary>
void CarenD2D1CommandSink1::UnRegisterCallback()
{
	...
	CLN_ID2D1CommandSink1* pVarPointer = (CLN_ID2D1CommandSink1*)PonteiroTrabalho;
...
/// </summary>
void CarenD2D1CommandSink1::EncaminharEvento_OnSetPrimitiveBlend1(D2D1_PRIMITIVE_BLEND primitiveBlend)
{
	//Chama o evento.
...
/// </summary>
void CarenD2D1CommandSink1::EncaminharEvento_OnBeginDraw()
{
...
/// </summary>
void CarenD2D1CommandSink1::EncaminharEvento_OnClear(_In_opt_ CONST D2D1_COLOR_F* color)
{
...
/// </summary>
void CarenD2D1CommandSink1::EncaminharEvento_OnDrawBitmap(
...
/// </summary>
void CarenD2D1CommandSink1::EncaminharEvento_OnDrawGdiMetafile(
...
/// </summary>
void CarenD2D1CommandSink1::EncaminharEvento_OnDrawGeometry(
...
/// </summary>
void CarenD2D1CommandSink1::EncaminharEvento_OnDrawGlyphRun(
...
/// </summary>
void CarenD2D1CommandSink1::EncaminharEvento_OnDrawImage(
...
/// </summary>
void CarenD2D1CommandSink1::EncaminharEvento_OnDrawLine(
...
/// </summary>
void CarenD2D1CommandSink1::EncaminharEvento_OnDrawRectangle(
...
/// </summary>
void CarenD2D1CommandSink1::EncaminharEvento_OnEndDraw()
{
	//Chama o evento.
	OnEndDraw();
}
...
/// </summary>
void CarenD2D1CommandSink1::EncaminharEvento_OnFillGeometry(
	_In_ ID2D1Geometry* geometry,
	_In_ ID2D1Brush* brush,
...
/// </summary>
void CarenD2D1CommandSink1::EncaminharEvento_OnFillMesh(
	_In_ ID2D1Mesh* mesh,
	_In_ ID2D1Brush* brush)
{
	//Variaveis
...
/// </summary>
void CarenD2D1CommandSink1::EncaminharEvento_OnFillOpacityMask(
...
/// </summary>
void CarenD2D1CommandSink1::EncaminharEvento_OnFillRectangle(
	_In_ CONST D2D1_RECT_F* rect,
	_In_ ID2D1Brush* brush)
{
	//Variaveis
...
/// </summary>
void CarenD2D1CommandSink1::EncaminharEvento_OnPopAxisAlignedClip()
{
	//Chama o evento.
...
/// </summary>
void CarenD2D1CommandSink1::EncaminharEvento_OnPopLayer()
{
	//Chama o evento.
	OnPopLayer();
}
...
/// </summary>
void CarenD2D1CommandSink1::EncaminharEvento_OnPushAxisAlignedClip(
...
/// </summary>
void CarenD2D1CommandSink1::EncaminharEvento_OnPushLayer(
...
/// </summary>
void CarenD2D1CommandSink1::EncaminharEvento_OnSetAntialiasMode(D2D1_ANTIALIAS_MODE antialiasMode)
{
	//Chama o evento.
...
/// </summary>
void CarenD2D1CommandSink1::EncaminharEvento_OnSetPrimitiveBlend(D2D1_PRIMITIVE_BLEND primitiveBlend)
{
	//Chama o evento.
...
/// </summary>
void CarenD2D1CommandSink1::EncaminharEvento_OnSetTags(
	D2D1_TAG tag1,
	D2D1_TAG tag2)
{
	//Chama o evento.
...
/// </summary>
void CarenD2D1CommandSink1::EncaminharEvento_OnSetTextAntialiasMode(D2D1_TEXT_ANTIALIAS_MODE textAntialiasMode)
{
	//Chama o evento.
...
/// </summary>
void CarenD2D1CommandSink1::EncaminharEvento_OnSetTextRenderingParams(_In_opt_ IDWriteRenderingParams* textRenderingParams)
{
	//Variaveis
...
/// </summary>
void CarenD2D1CommandSink1::EncaminharEvento_OnSetTransform(_In_ CONST D2D1_MATRIX_3X2_F* transform)
{
	//Variaveis
	Utilidades Util;
...
/// </summary>
void CarenD2D1CommandSink1::EncaminharEvento_OnSetUnitMode(D2D1_UNIT_MODE unitMode)
{
	//Chama o evento.
