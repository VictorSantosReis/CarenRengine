...
public:
	static operator CarenMFSourceBuffer^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFSourceBuffer^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFSourceBuffer();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFSourceBuffer*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFSourceBuffer::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
