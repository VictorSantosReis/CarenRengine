...
//Destruidor.
CarenD2D1ComputeInfo::~CarenD2D1ComputeInfo()
{
...
CarenResult CarenD2D1ComputeInfo::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD2D1ComputeInfo::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1ComputeInfo*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1ComputeInfo::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1ComputeInfo*>(Param_PonteiroNativo);
...
CarenResult CarenD2D1ComputeInfo::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1ComputeInfo::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1ComputeInfo::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenD2D1ComputeInfo::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD2D1ComputeInfo::ObterCodigoErro()
{
...
/// </summary>
void CarenD2D1ComputeInfo::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD2D1ComputeInfo::LiberarReferencia()
{
...
/// </summary>
void CarenD2D1ComputeInfo::LimparDados()
{
...
/// </summary>
void CarenD2D1ComputeInfo::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenD2D1ComputeInfo();
}



// Métodos da interface proprietária(ICarenD2D1ComputeInfo)
...
CarenResult CarenD2D1ComputeInfo::SetComputeShader(String^ Param_ShaderId)
{
	...
	//Variaveis a serem utilizadas.
	Utilidades Util;
	GUID ShaderId = GUID_NULL;

	//Converte a string parao 
	ShaderId = Util.CreateGuidFromString(Param_ShaderId);

	//Chama o método para realizar a operação.
	Hr = PonteiroTrabalho->SetComputeShader(ShaderId);
...
CarenResult CarenD2D1ComputeInfo::SetComputeShaderConstantBuffer(
...
UInt32 Param_DataCount)
{
	...
	//Chama o método para realizar a operação.
	Hr = PonteiroTrabalho->SetComputeShaderConstantBuffer(Util.ConverterIntPtrTo<PBYTE>(PonteiroToBuffer), Param_DataCount);
...
CarenResult CarenD2D1ComputeInfo::SetResourceTexture(
...
void CarenD2D1ComputeInfo::SetCached(Boolean Param_IsCached)
{
	//Chama o método para realizar a operação.
...
CarenResult CarenD2D1ComputeInfo::SetInputDescription(
...
void CarenD2D1ComputeInfo::SetInstructionCountHint(UInt32 Param_InstructionCount)
{
	//Chama o método para realizar a operação.
...
CarenResult CarenD2D1ComputeInfo::SetOutputBuffer(
