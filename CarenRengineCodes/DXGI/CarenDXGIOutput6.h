...
public:
	static operator CarenDXGIOutput6^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenDXGIOutput6^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenDXGIOutput6();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IDXGIOutput6*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenDXGIOutput6::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
...
public:
	...
	virtual CarenResult CheckHardwareCompositionSupport(
	...
	virtual CarenResult GetDesc1([Out] CA_DXGI_OUTPUT_DESC1^% Param_Out_Desc);
...
public:
	...
	virtual CarenResult DuplicateOutput1(
...
public:
	...
	virtual CarenResult CheckOverlayColorSpaceSupport(
...
public:
	...
	virtual CarenResult CheckOverlaySupport(
		CA_DXGI_FORMAT Param_Formato,
		ICaren^ Param_DispositivoD3D,
