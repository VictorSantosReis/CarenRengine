...
public:
	static operator CarenMFCaptureEngine^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFCaptureEngine^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFCaptureEngine();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFCaptureEngine*>(Param_Pointer.ToPointer());
