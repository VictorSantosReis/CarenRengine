...
//Destruidor.
CarenD3D11Asynchronous::~CarenD3D11Asynchronous()
{
...
CarenResult CarenD3D11Asynchronous::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD3D11Asynchronous::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID3D11Asynchronous*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD3D11Asynchronous::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID3D11Asynchronous*>(Param_PonteiroNativo);
...
CarenResult CarenD3D11Asynchronous::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Asynchronous::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Asynchronous::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenD3D11Asynchronous::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD3D11Asynchronous::ObterCodigoErro()
{
...
/// </summary>
void CarenD3D11Asynchronous::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD3D11Asynchronous::LiberarReferencia()
{
...
/// </summary>
void CarenD3D11Asynchronous::LimparDados()
{
...
/// </summary>
void CarenD3D11Asynchronous::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
...
CarenResult CarenD3D11Asynchronous::ObterDispositivo(ICaren^ Param_Out_DispositivoD3D11)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Asynchronous::ObterDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11Asynchronous::DefinirDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11Asynchronous::DefinirInterfaceDadosPrivados(
