...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por encapsular uma classe HLSL.
/// </summary>
public ref class CarenD3D11ClassInstance :public ICarenD3D11ClassInstance
{
	/////////////////////////////////////////
	...
	ID3D11ClassInstance* PonteiroTrabalho = NULL;
...
public:
	static operator CarenD3D11ClassInstance^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD3D11ClassInstance^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD3D11ClassInstance();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID3D11ClassInstance*>(Param_Pointer.ToPointer());
...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD3D11ClassInstance">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD3D11ClassInstance^% Param_Out_CarenD3D11ClassInstance)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenD3D11ClassInstance = gcnew CarenD3D11ClassInstance();
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD3D11ClassInstance::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
...
public:
	...
	virtual CarenResult GetDesc([Out] Estruturas::CA_D3D11_CLASS_INSTANCE_DESC^% Param_Out_DescClasseHLSL);
