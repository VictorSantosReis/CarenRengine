...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por fornecer métodos para permitir que uma operação de mistura seja inserida em um gráfico de transformação.
/// </summary>
public ref class CarenD2D1BlendTransform : public ICarenD2D1BlendTransform
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID2D1BlendTransform).
...
public:
	static operator CarenD2D1BlendTransform^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1BlendTransform^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1BlendTransform();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1BlendTransform*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD2D1BlendTransform::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenD2D1BlendTransform)
public:
	/// <summary>
	...
	virtual void GetDescription([Out] CA_D2D1_BLEND_DESCRIPTION^% Param_Out_Descricao);
	...
	virtual void SetDescription(CA_D2D1_BLEND_DESCRIPTION^ Param_Descricao);
