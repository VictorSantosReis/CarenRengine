...
CarenResult CarenD3D11DeviceChild::GetDevice(ICaren^ Param_Out_DispositivoD3D11)
{
...
CarenResult CarenD3D11DeviceChild::GetPrivateData(
	String^ Param_Guid,
...
CarenResult CarenD3D11DeviceChild::SetPrivateData(
	String^ Param_Guid,
...
CarenResult CarenD3D11DeviceChild::SetPrivateDataInterface(
