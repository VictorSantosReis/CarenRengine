...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenDXGISwapChain4">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenDXGISwapChain4^% Param_Out_CarenDXGISwapChain4)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenDXGISwapChain4 = gcnew CarenDXGISwapChain4();
