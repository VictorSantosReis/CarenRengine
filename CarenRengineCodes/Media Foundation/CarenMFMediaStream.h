...
public ref class CarenMFMediaStream :public ICarenMFMediaStream
{
	...
	//Ponteiro para a interface (IMFMediaStream).
...
public:
	static operator CarenMFMediaStream^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFMediaStream^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFMediaStream();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFMediaStream*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFMediaStream::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenMFMediaStream)
public:
