...
/// <summary>
/// (Concluido - Fase de testes) - Classe responsável por estender a CarenDXGISurface adicionando suporte para usar a Interface de Dispositivo 
/// Gráfico Windows (GDI) para renderizar a uma superfície de Infraestrutura Gráfica Microsoft DirectX (DXGI). 
/// </summary>
public ref class CarenDXGISurface1 : public ICarenDXGISurface1
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IDXGISurface1).
	IDXGISurface1* PonteiroTrabalho = NULL;
...
public:
	static operator CarenDXGISurface1^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenDXGISurface1^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenDXGISurface1();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IDXGISurface1*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenDXGISurface1::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
