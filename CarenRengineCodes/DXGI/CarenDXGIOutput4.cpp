...
CarenResult CarenDXGIOutput4::GetParent(
...
CarenResult CarenDXGIOutput4::SetPrivateData(
...
CarenResult CarenDXGIOutput4::GetPrivateData(
	String^ Param_GuidIdentificao, 
...
CarenResult CarenDXGIOutput4::SetPrivateDataInterface(
