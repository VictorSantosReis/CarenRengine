...
CarenResult CarenMFMediaEngineClassFactory2::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IMFMediaEngineClassFactory2*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenMFMediaEngineClassFactory2::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IMFMediaEngineClassFactory2*>(Param_PonteiroNativo);
...
/// </summary>
void CarenMFMediaEngineClassFactory2::LimparDados()
{
