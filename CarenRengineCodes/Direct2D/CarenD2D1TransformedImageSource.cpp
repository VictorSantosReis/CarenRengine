...
CarenResult CarenD2D1TransformedImageSource::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1TransformedImageSource*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1TransformedImageSource::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1TransformedImageSource*>(Param_PonteiroNativo);
...
/// </summary>
Int32 CarenD2D1TransformedImageSource::ObterCodigoErro()
{
...
/// </summary>
void CarenD2D1TransformedImageSource::LimparDados()
{
