...
CarenResult CarenD3D11DeviceContext3::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
	...
	Hr = (reinterpret_cast<ID3D11DeviceContext3*>(PonteiroTrabalho))->QueryInterface(GuidInterface, (LPVOID*)&pInterfaceSolcitada);
...
CarenResult CarenD3D11DeviceContext3::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<ID3D11DeviceContext3*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD3D11DeviceContext3::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID3D11DeviceContext3*>(Param_PonteiroNativo);
...
{
	//Adiciona uma referência ao ponteiro
	(reinterpret_cast<ID3D11DeviceContext3*>(PonteiroTrabalho))->AddRef();
}
...
void CarenD3D11DeviceContext3::LiberarReferencia()
{
	...
	ULONG RefCount = (reinterpret_cast<ID3D11DeviceContext3*>(PonteiroTrabalho))->Release();
...
/// </summary>
void CarenD3D11DeviceContext3::LimparDados()
{
...
//Métodos da interface proprietária(ICarenD3D11DeviceContext3)
...
CarenResult CarenD3D11DeviceContext3::ObterStatusProtecaoHardware([Out] bool% Param_Out_ProtecaoHardwareHabilitada)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11DeviceContext3::DefinirStatusProtecaoHardware(bool Param_EstadoProtecao)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11DeviceContext3::CopiarSubRecursoRegiao1(
...
CarenResult CarenD3D11DeviceContext3::CSObterConstantBuffers1(
...
CarenResult CarenD3D11DeviceContext3::CSDefinirConstantBuffers1(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroBuffers,
...
CarenResult CarenD3D11DeviceContext3::DescartarRecurso(ICarenD3D11Resource^ Param_Recurso)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11DeviceContext3::DiscardView1(ICarenD3D11View^ Param_Visão, cli::array<CA_RECT^>^ Param_MatrizRetangulos, UInt32 Param_NumeroRetangulos)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// que é especificada na matriz (Param_Out_MatrizInicioConstante). O tempo de execução define (Param_Out_MatrizNumeroConstantes) para NULO se não especificar o número de 
/// constantes em cada buffer.</param>
CarenResult CarenD3D11DeviceContext3::DSObterConstantBuffers1(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroBuffers,
	[Out] cli::array<ICarenD3D11Buffer^>^% Param_Out_MatrizBuffers,
	[Out] cli::array<UInt32>^% Param_Out_MatrizInicioConstante,
...
/// de constantes que estão contidas no buffer constante que o sombreador usa. Cada número de constantes parte de sua respectiva compensação que é especificada na matriz 
/// (Param_MatrizInicioConstante). Cada número de constantes deve ser um múltiplo de 16 constantes, na faixa [0..4096].</param>
CarenResult CarenD3D11DeviceContext3::DSDefinirConstantBuffers1(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroBuffers,
	cli::array<ICarenD3D11Buffer^>^ Param_MatrizBuffers,
	cli::array<UInt32>^ Param_MatrizInicioConstante,
...
/// que é especificada na matriz (Param_Out_MatrizInicioConstante). O tempo de execução define (Param_Out_MatrizNumeroConstantes) para NULO se não especificar o número de 
/// constantes em cada buffer.</param>
CarenResult CarenD3D11DeviceContext3::GSObterConstantBuffers1(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroBuffers,
	[Out] cli::array<ICarenD3D11Buffer^>^% Param_Out_MatrizBuffers,
	[Out] cli::array<UInt32>^% Param_Out_MatrizInicioConstante,
...
/// de constantes que estão contidas no buffer constante que o sombreador usa. Cada número de constantes parte de sua respectiva compensação que é especificada na matriz 
/// (Param_MatrizInicioConstante). Cada número de constantes deve ser um múltiplo de 16 constantes, na faixa [0..4096].</param>
CarenResult CarenD3D11DeviceContext3::GSDefinirConstantBuffers1(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroBuffers,
	cli::array<ICarenD3D11Buffer^>^ Param_MatrizBuffers,
	cli::array<UInt32>^ Param_MatrizInicioConstante,
...
/// que é especificada na matriz (Param_Out_MatrizInicioConstante). O tempo de execução define (Param_Out_MatrizNumeroConstantes) para NULO se não especificar o número de 
/// constantes em cada buffer.</param>
CarenResult CarenD3D11DeviceContext3::HSObterConstantBuffers1(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroBuffers,
	[Out] cli::array<ICarenD3D11Buffer^>^% Param_Out_MatrizBuffers,
	[Out] cli::array<UInt32>^% Param_Out_MatrizInicioConstante,
...
/// de constantes que estão contidas no buffer constante que o sombreador usa. Cada número de constantes parte de sua respectiva compensação que é especificada na matriz 
/// (Param_MatrizInicioConstante). Cada número de constantes deve ser um múltiplo de 16 constantes, na faixa [0..4096].</param>
CarenResult CarenD3D11DeviceContext3::HSDefinirConstantBuffers1(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroBuffers,
	cli::array<ICarenD3D11Buffer^>^ Param_MatrizBuffers,
	cli::array<UInt32>^ Param_MatrizInicioConstante,
...
/// que é especificada na matriz (Param_Out_MatrizInicioConstante). O tempo de execução define (Param_Out_MatrizNumeroConstantes) para NULO se não especificar o número de 
/// constantes em cada buffer.</param>
CarenResult CarenD3D11DeviceContext3::PSObterConstantBuffers1(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroBuffers,
	[Out] cli::array<ICarenD3D11Buffer^>^% Param_Out_MatrizBuffers,
	[Out] cli::array<UInt32>^% Param_Out_MatrizInicioConstante,
...
/// de constantes que estão contidas no buffer constante que o sombreador usa. Cada número de constantes parte de sua respectiva compensação que é especificada na matriz 
/// (Param_MatrizInicioConstante). Cada número de constantes deve ser um múltiplo de 16 constantes, na faixa [0..4096].</param>
CarenResult CarenD3D11DeviceContext3::PSDefinirConstantBuffers1(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroBuffers,
	cli::array<ICarenD3D11Buffer^>^ Param_MatrizBuffers,
	cli::array<UInt32>^ Param_MatrizInicioConstante,
...
CarenResult CarenD3D11DeviceContext3::AtualizarSubresource1(
...
/// que é especificada na matriz (Param_Out_MatrizInicioConstante). O tempo de execução define (Param_Out_MatrizNumeroConstantes) para NULO se não especificar o número de 
/// constantes em cada buffer.</param>
CarenResult CarenD3D11DeviceContext3::VSObterConstantBuffers1(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroBuffers,
	[Out] cli::array<ICarenD3D11Buffer^>^% Param_Out_MatrizBuffers,
	[Out] cli::array<UInt32>^% Param_Out_MatrizInicioConstante,
...
/// de constantes que estão contidas no buffer constante que o sombreador usa. Cada número de constantes parte de sua respectiva compensação que é especificada na matriz 
/// (Param_MatrizInicioConstante). Cada número de constantes deve ser um múltiplo de 16 constantes, na faixa [0..4096].</param>
CarenResult CarenD3D11DeviceContext3::VSDefinirConstantBuffers1(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroBuffers,
	cli::array<ICarenD3D11Buffer^>^ Param_MatrizBuffers,
	cli::array<UInt32>^ Param_MatrizInicioConstante,
...
CarenResult CarenD3D11DeviceContext3::LimparDepthStencilView(
...
/// </summary>
CarenResult CarenD3D11DeviceContext3::RestaurarConfiguracoesDefault()
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11DeviceContext3::LimparRecursoNaoOrdenadoFloat(
...
/// <param name="Param_UnorderedAccess">O ID3D11UnorderedAccessView para limpar.</param>
/// <param name="Param_Valores">Valores para copiar para canais correspondentes.</param>
CarenResult CarenD3D11DeviceContext3::LimparRecursoNaoOrdenadoUint(
	ICarenD3D11UnorderedAccessView^ Param_UnorderedAccess,
...
CarenResult CarenD3D11DeviceContext3::CopiarRecurso(
	ICarenD3D11Resource^ Param_DestinoRecurso,
...
CarenResult CarenD3D11DeviceContext3::CopiarStructureCount(
...
/// <param name="Param_OrigemBox">Uma estrutura(CAIXA 3D) que define o sub-recurso de fonte que pode ser copiado. Se nulo, o sub-recurso fonte inteiro é copiado. A caixa deve caber dentro da fonte 
/// de recurso.</param>
CarenResult CarenD3D11DeviceContext3::CopiarSubRecursoRegiao(
	ICarenD3D11Resource^ Param_DestinoRecurso,
	UInt32 Param_IndiceSubrecrusoDestino,
	UInt32 Param_DestX,
	UInt32 Param_DestY,
...
CarenResult CarenD3D11DeviceContext3::CSObterConstantBuffers(
	UInt32 Param_StartSlot,
...
CarenResult CarenD3D11DeviceContext3::CSObterSamplers(
	UInt32 Param_StartSlot,
...
CarenResult CarenD3D11DeviceContext3::CSObterShader(
...
CarenResult CarenD3D11DeviceContext3::CSObterShaderResources(
	UInt32 Param_StartSlot,
...
CarenResult CarenD3D11DeviceContext3::CSObterUnorderedAccessViews(
	UInt32 Param_StartSlot,
...
/// <param name="Param_NumeroBuffers">Número de buffers para definir (varia de 0 a D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - Param_StartSlot).</param>
/// <param name="Param_MatrizBuffers">Matriz de buffers constantes a ser dada ao dispositivo.</param>
CarenResult CarenD3D11DeviceContext3::CSDefinirConstantBuffers(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroBuffers,
	cli::array<ICarenD3D11Buffer^>^ Param_MatrizBuffers)
{
...
CarenResult CarenD3D11DeviceContext3::CSDefinirSamplers(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroSamplers,
...
CarenResult CarenD3D11DeviceContext3::CSDefinirShader(
...
CarenResult CarenD3D11DeviceContext3::CSDefinirShaderResources(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroRecursos,
...
CarenResult CarenD3D11DeviceContext3::CSDefinirUnorderedAccessViews(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroUAVs,
...
CarenResult CarenD3D11DeviceContext3::Despacho(
...
CarenResult CarenD3D11DeviceContext3::DespachoIndireto(
...
CarenResult CarenD3D11DeviceContext3::Desenhar(
...
/// </summary>
CarenResult CarenD3D11DeviceContext3::DesenharAuto()
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11DeviceContext3::DesenharIndexado(
...
CarenResult CarenD3D11DeviceContext3::DesenharIndexadoInstaciado(
...
CarenResult CarenD3D11DeviceContext3::DesenharIndexadoInstaciadoIndireto(
	ICarenD3D11Buffer^ Param_BufferForArgs,
	UInt32 Param_AlinhamentoBytesOffsetForArgs)
{
	//Variavel a ser retornada.
...
/// <param name="Param_StartInstanciaLocalizacao">Um valor acrescentado para cada índice antes de ler dados por instância de um buffer de vértice.</param>			
CarenResult CarenD3D11DeviceContext3::DesenharInstanciado(
...
CarenResult CarenD3D11DeviceContext3::DesenharInstanciadoIndiretamente(
...
/// <param name="Param_NumeroBuffers">Número de buffers para recuperar (varia de 0 a D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - Param_StartSlot).</param>
/// <param name="Param_Out_MatrizBuffers">Retorna uma matriz que contém as interfaces para o Buffers constantes.</param>
CarenResult CarenD3D11DeviceContext3::DSObterConstantBuffers(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroBuffers,
	[Out] cli::array<ICarenD3D11Buffer^>^% Param_Out_MatrizBuffers)
{
...
CarenResult CarenD3D11DeviceContext3::DSObterSamplers(
	UInt32 Param_StartSlot,
...
CarenResult CarenD3D11DeviceContext3::DSObterShader(
...
CarenResult CarenD3D11DeviceContext3::DSObterShaderResources(
	UInt32 Param_StartSlot,
...
/// <param name="Param_NumeroBuffers">Número de buffers para definir (varia de 0 a D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - Param_StartSlot).</param>
/// <param name="Param_MatrizBuffers">Matriz de buffers constantes a ser dada ao dispositivo.</param>
CarenResult CarenD3D11DeviceContext3::DSDefinirConstantBuffers(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroBuffers,
	cli::array<ICarenD3D11Buffer^>^ Param_MatrizBuffers)
{
...
CarenResult CarenD3D11DeviceContext3::DSDefinirSamplers(
	UInt32 Param_StartSlot,
	UInt32 Param_Amostradores,
...
CarenResult CarenD3D11DeviceContext3::DSDefinirShader(
...
CarenResult CarenD3D11DeviceContext3::DSDefinirShaderResources(
	UInt32 Param_StartSlot,
	UInt32 Param_QuantidadeRecursos,
...
CarenResult CarenD3D11DeviceContext3::ExecutarComandosLista(
...
CarenResult CarenD3D11DeviceContext3::TerminarComandosLista(
...
CarenResult CarenD3D11DeviceContext3::GerarMipmaps(ICarenD3D11ShaderResourceView^ Param_RecursoSombreador)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// uso futuro.</param>
CarenResult CarenD3D11DeviceContext3::ObterContextFlags([Out] UInt32% Param_Out_ContextFlags)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11DeviceContext3::ObterDados(
...
CarenResult CarenD3D11DeviceContext3::ObterPredicado(
...
CarenResult CarenD3D11DeviceContext3::ObterResourceMinLOD(ICarenD3D11Resource^ Param_Recurso, [Out] float% Param_Out_LODMinimo)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11DeviceContext3::ObterTipo([Out] Enumeracoes::CA_D3D11_DEVICE_CONTEXT_TYPE% Param_Out_ContextoDispositivo)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11DeviceContext3::GSObterConstantBuffers(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroBuffers,
	[Out] cli::array<ICarenD3D11Buffer^>^% Param_Out_MatrizBuffers)
{
...
CarenResult CarenD3D11DeviceContext3::GSObterSamplers(
	UInt32 Param_StartSlot,
...
CarenResult CarenD3D11DeviceContext3::GSObterShader(
...
CarenResult CarenD3D11DeviceContext3::GSObterShaderResources(
	UInt32 Param_StartSlot,
...
CarenResult CarenD3D11DeviceContext3::GSDefinirConstantBuffers(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroBuffers,
	cli::array<ICarenD3D11Buffer^>^ Param_MatrizBuffers)
{
...
CarenResult CarenD3D11DeviceContext3::GSDefinirSamplers(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroAmostradores,
	cli::array<ICarenD3D11SamplerState^>^ Param_MatrizAmostradoresEstado)
{
...
CarenResult CarenD3D11DeviceContext3::GSDefinirShader(
...
CarenResult CarenD3D11DeviceContext3::GSDefinirShaderResources(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroViews,
...
/// <param name="Param_NumeroBuffers">Número de buffers a serem recuperados (varia de 0 a D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - Param_StartSlot).</param>
/// <param name="Param_Out_MatrizBuffers">Retorna uma matriz de ponteiros de interface de buffer constante.</param>
CarenResult CarenD3D11DeviceContext3::HSObterConstantBuffers(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroBuffers,
	[Out] cli::array<ICarenD3D11Buffer^>^% Param_Out_MatrizBuffers)
{
...
/// <param name="Param_NumeroAmostradores">Número de (Samplers) para obter de um contexto de dispositivo. Cada estágio de pipeline tem um total de 16 slots disponíveis (varia de 0 a D3D11_COMMONSHADER_SAMPLER_SLOT_COUNT - Param_StartSlot).</param>
/// <param name="Param_Out_MatrizEstadoAmostrado">Retorna uma matriz com interfaces do amostrador de estado.</param>
CarenResult CarenD3D11DeviceContext3::HSObterSamplers(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroAmostradores,
	[Out] cli::array<ICarenD3D11SamplerState^>^% Param_Out_MatrizEstadoAmostrado)
{
...
/// <param name="Param_Out_MatrizInstanciasClasse">Retorna uma matriz com interfaces de Instancias de classe.</param>
/// <param name="Param_Out_QuantidadeInstancias">Retorna a quantidade de de instancias de classe na matriz do parametro (Param_Out_MatrizInstanciasClasse).</param>
CarenResult CarenD3D11DeviceContext3::HSObterShader(
...
/// <param name="Param_NumeroViews">O número de recursos para obter do dispositivo. Até um máximo de 128 slots estão disponíveis para recursos de sombreador (varia de 0 a D3D11_COMMONSHADER_INPUT_RESOURCE_SLOT_COUNT - Param_StartSlot).</param>
/// <param name="Param_Out_MatrizVisualizadoresSombreador">Matriz de interfaces de visualização de recursos do sombreador a serem retornadas pelo dispositivo.</param>
CarenResult CarenD3D11DeviceContext3::HSObterShaderResources(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroViews,
	[Out] cli::array<ICarenD3D11ShaderResourceView^>^% Param_Out_MatrizVisualizadoresSombreador)
{
...
/// <param name="Param_NumeroBuffers">Número de buffers a definir (varia de 0 a D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - Param_StartSlot).</param> 
/// <param name="Param_MatrizBuffers">Matriz de buffers constantes sendo fornecidos ao dispositivo.</param> 
CarenResult CarenD3D11DeviceContext3::HSDefinirConstantBuffers(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroBuffers,
	cli::array<ICarenD3D11Buffer^>^ Param_MatrizBuffers)
{
...
/// <param name="Param_NumeroAmostradores">Número de amostradores na matriz. Cada estágio de pipeline tem um total de 16 slots disponíveis (varia de 0 a D3D11_COMMONSHADER_SAMPLER_SLOT_COUNT - Param_StartSlot).</param>
/// <param name="Param_MatrizAmostradoresEstado">Uma matriz de interfaces de estado do amostrador.</param>
CarenResult CarenD3D11DeviceContext3::HSDefinirSamplers(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroAmostradores,
	cli::array<ICarenD3D11SamplerState^>^ Param_MatrizAmostradoresEstado)
{
...
/// <param name="Param_MatrizInstanciaClasse">Uma matriz de interfaces de instância de classe. Cada interface usada por um sombreador deve ter uma instância de classe correspondente ou o shader será desativado. Defina como NULO se o sombreador não usar nenhuma interface.</param>
/// <param name="Param_NumeroInstanciasClasse">O numero de (ICarenD3D11ClassInstance) dentro da matriz (Param_MatrizInstanciaClasse).</param>
CarenResult CarenD3D11DeviceContext3::HSDefinirShader(
...
/// <param name="Param_NumeroViews">Número de recursos do shader a serem definidos. Até um máximo de 128 slots estão disponíveis para recursos de sombreador (o intervalo é de 0 a D3D11_COMMONSHADER_INPUT_RESOURCE_SLOT_COUNT - Param_StartSlot).</param>
/// <param name="Param_MatrizVisualizadoresSombreador">Uma matriz que contém os Visualizadores de recurso do sombreador para serem definidos no Disposiivo.</param>
CarenResult CarenD3D11DeviceContext3::HSDefinirShaderResources(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroViews,
	cli::array<ICarenD3D11ShaderResourceView^>^ Param_MatrizVisualizadoresSombreador)
{
...
CarenResult CarenD3D11DeviceContext3::IAObterInputLayout([Out] ICarenD3D11InputLayout^% Param_Out_InputLayout)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11DeviceContext3::IAObterPrimitiveTopology([Out] Enumeracoes::CA_D3D11_PRIMITIVE_TOPOLOGY% Param_Out_TipoPrimitivo)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11DeviceContext3::IAObterVertexBuffers(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroBuffers,
...
CarenResult CarenD3D11DeviceContext3::IADefinirInputLayout(ICarenD3D11InputLayout^ Param_InputLayout)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11DeviceContext3::IADefinirPrimitiveTopology(Enumeracoes::CA_D3D11_PRIMITIVE_TOPOLOGY Param_TipoPrimitivo)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11DeviceContext3::IADefinirVertexBuffers(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroBuffers,
...
CarenResult CarenD3D11DeviceContext3::OMObterBlendState(
...
CarenResult CarenD3D11DeviceContext3::OMObterDepthStencilState(
...
CarenResult CarenD3D11DeviceContext3::OMObterRenderTargets(
	UInt32 Param_NumeroViews,
...
CarenResult CarenD3D11DeviceContext3::OMObterRenderTargetsAndUnorderedAccessViews(
...
CarenResult CarenD3D11DeviceContext3::OMDefinirBlendState(
...
CarenResult CarenD3D11DeviceContext3::OMDefinirDepthStencilState(
...
CarenResult CarenD3D11DeviceContext3::OMDefinirRenderTargets(
	UInt32 Param_NumeroViews,
...
CarenResult CarenD3D11DeviceContext3::OMDefinirRenderTargetsAndUnorderedAccessViews(
	UInt32 Param_NumeroRTVs,
...
/// <param name="Param_NumeroBuffers">Número de buffers a serem recuperados (varia de 0 a D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - Param_StartSlot).</param>
/// <param name="Param_Out_MatrizBuffers">Retorna uma matriz de ponteiros de interface de buffer constante.</param>
CarenResult CarenD3D11DeviceContext3::PSObterConstantBuffers(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroBuffers,
	[Out] cli::array<ICarenD3D11Buffer^>^% Param_Out_MatrizBuffers)
{
...
/// <param name="Param_NumeroAmostradores">Número de (Samplers) para obter de um contexto de dispositivo. Cada estágio de pipeline tem um total de 16 slots disponíveis (varia de 0 a D3D11_COMMONSHADER_SAMPLER_SLOT_COUNT - Param_StartSlot).</param>
/// <param name="Param_Out_MatrizEstadoAmostrado">Retorna uma matriz com interfaces do amostrador de estado.</param>
CarenResult CarenD3D11DeviceContext3::PSObterSamplers(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroAmostradores,
	[Out] cli::array<ICarenD3D11SamplerState^>^% Param_Out_MatrizEstadoAmostrado)
{
...
/// <param name="Param_Out_MatrizInstanciasClasse">Retorna uma matriz com interfaces de Instancias de classe.</param>
/// <param name="Param_Out_QuantidadeInstancias">Retorna a quantidade de de instancias de classe na matriz do parametro (Param_Out_MatrizInstanciasClasse).</param>
CarenResult CarenD3D11DeviceContext3::PSObterShader(
...
/// <param name="Param_NumeroViews">O número de recursos para obter do dispositivo. Até um máximo de 128 slots estão disponíveis para recursos de sombreador (varia de 0 a D3D11_COMMONSHADER_INPUT_RESOURCE_SLOT_COUNT - Param_StartSlot).</param>
/// <param name="Param_Out_MatrizVisualizadoresSombreador">Matriz de interfaces de visualização de recursos do sombreador a serem retornadas pelo dispositivo.</param>
CarenResult CarenD3D11DeviceContext3::PSObterShaderResources(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroViews,
	[Out] cli::array<ICarenD3D11ShaderResourceView^>^% Param_Out_MatrizVisualizadoresSombreador)
{
...
/// <param name="Param_NumeroBuffers">Número de buffers a definir (varia de 0 a D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - Param_StartSlot).</param> 
/// <param name="Param_MatrizBuffers">Matriz de buffers constantes sendo fornecidos ao dispositivo.</param>
CarenResult CarenD3D11DeviceContext3::PSDefinirConstantBuffers(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroBuffers,
	cli::array<ICarenD3D11Buffer^>^ Param_MatrizBuffers)
{
...
/// <param name="Param_NumeroAmostradores">Número de amostradores na matriz. Cada estágio de pipeline tem um total de 16 slots disponíveis (varia de 0 a D3D11_COMMONSHADER_SAMPLER_SLOT_COUNT - Param_StartSlot).</param>
/// <param name="Param_MatrizAmostradoresEstado">Uma matriz de interfaces de estado do amostrador.</param>
CarenResult CarenD3D11DeviceContext3::PSDefinirSamplers(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroAmostradores,
	cli::array<ICarenD3D11SamplerState^>^ Param_MatrizAmostradoresEstado)
{
...
/// <param name="Param_MatrizInstanciaClasse">Uma matriz de interfaces de instância de classe. Cada interface usada por um sombreador deve ter uma instância de classe correspondente ou o shader será desativado. Defina como NULO se o sombreador não usar nenhuma interface.</param>
/// <param name="Param_NumeroInstanciasClasse">O numero de (ICarenD3D11ClassInstance) dentro da matriz (Param_MatrizInstanciaClasse).</param>
CarenResult CarenD3D11DeviceContext3::PSDefinirShader(
...
/// <param name="Param_NumeroViews">Número de recursos do shader a serem definidos. Até um máximo de 128 slots estão disponíveis para recursos de sombreador (o intervalo é de 0 a D3D11_COMMONSHADER_INPUT_RESOURCE_SLOT_COUNT - Param_StartSlot).</param>
/// <param name="Param_MatrizVisualizadoresSombreador">Uma matriz que contém os Visualizadores de recurso do sombreador para serem definidos no Disposiivo.</param>
CarenResult CarenD3D11DeviceContext3::PSDefinirShaderResources(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroViews,
	cli::array<ICarenD3D11ShaderResourceView^>^ Param_MatrizVisualizadoresSombreador)
{
...
CarenResult CarenD3D11DeviceContext3::RSObterScissorRects(
...
CarenResult CarenD3D11DeviceContext3::RSObterState([Out] ICarenD3D11RasterizerState^% Param_Out_EstadoRasterizador)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11DeviceContext3::RSObterViewports(
...
CarenResult CarenD3D11DeviceContext3::RSDefinirScissorRects(
...
CarenResult CarenD3D11DeviceContext3::RSDefinirState(ICarenD3D11RasterizerState^ Param_EstadoRasterizador)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11DeviceContext3::RSDefinirViewports(
...
CarenResult CarenD3D11DeviceContext3::DefinirPredication(
...
CarenResult CarenD3D11DeviceContext3::DefinirResourceMinLOD(
	ICarenD3D11Resource^ Param_Recurso,
	float Param_MinLOD)
{
	//Variavel a ser retornada.
...
CarenResult CarenD3D11DeviceContext3::SOObterTargets(
	UInt32 Param_NumeroBuffers,
	[Out] cli::array<ICarenD3D11Buffer^>^% Param_Out_MatrizBuffers)
{
	//Variavel a ser retornada.
...
/// em bytes.</param>
CarenResult CarenD3D11DeviceContext3::SODefinirTargets(
	UInt32 Param_NumeroBuffers,
	cli::array<ICarenD3D11Buffer^>^ Param_MatrizBuffers,
...
/// <param name="Param_TamanhoLinhaOrigem">(SrcRowPitch) - O tamanho de uma linha dos dados de origem.</param>
/// <param name="Param_TamhoFatiaProdundidade">(SrcDepthPitch) - O tamanho de uma fatia de profundidade dos dados de origem.</param>
CarenResult CarenD3D11DeviceContext3::AtualizarSubresource(
	ICarenD3D11Resource^ Param_RecursoDestino,
	UInt32 Param_SubrecursoDestino,
	Estruturas::CA_D3D11_BOX^ Param_Caixa,
	ICarenBuffer^ Param_DadosOrigemMemoria,
...
/// <param name="Param_NumeroBuffers">Número de buffers a serem recuperados (varia de 0 a D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - Param_StartSlot).</param>
/// <param name="Param_Out_MatrizBuffers">Retorna uma matriz de ponteiros de interface de buffer constante.</param>
CarenResult CarenD3D11DeviceContext3::VSObterConstantBuffers(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroBuffers,
	[Out] cli::array<ICarenD3D11Buffer^>^% Param_Out_MatrizBuffers)
{
...
/// <param name="Param_NumeroAmostradores">Número de (Samplers) para obter de um contexto de dispositivo. Cada estágio de pipeline tem um total de 16 slots disponíveis (varia de 0 a D3D11_COMMONSHADER_SAMPLER_SLOT_COUNT - Param_StartSlot).</param>
/// <param name="Param_Out_MatrizEstadoAmostrado">Retorna uma matriz com interfaces do amostrador de estado.</param>
CarenResult CarenD3D11DeviceContext3::VSObterSamplers(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroAmostradores,
	[Out] cli::array<ICarenD3D11SamplerState^>^% Param_Out_MatrizEstadoAmostrado)
{
...
/// <param name="Param_Out_MatrizInstanciasClasse">Retorna uma matriz com interfaces de Instancias de classe.</param>
/// <param name="Param_Out_QuantidadeInstancias">Retorna a quantidade de de instancias de classe na matriz do parametro (Param_Out_MatrizInstanciasClasse).</param>
CarenResult CarenD3D11DeviceContext3::VSObterShader(
...
/// <param name="Param_NumeroViews">O número de recursos para obter do dispositivo. Até um máximo de 128 slots estão disponíveis para recursos de sombreador (varia de 0 a D3D11_COMMONSHADER_INPUT_RESOURCE_SLOT_COUNT - Param_StartSlot).</param>
/// <param name="Param_Out_MatrizVisualizadoresSombreador">Matriz de interfaces de visualização de recursos do sombreador a serem retornadas pelo dispositivo.</param>
CarenResult CarenD3D11DeviceContext3::VSObterShaderResources(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroViews,
	[Out] cli::array<ICarenD3D11ShaderResourceView^>^% Param_Out_MatrizVisualizadoresSombreador)
{
...
/// <param name="Param_NumeroBuffers">Número de buffers a definir (varia de 0 a D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT - Param_StartSlot).</param> 
/// <param name="Param_MatrizBuffers">Matriz de buffers constantes sendo fornecidos ao dispositivo.</param> 
CarenResult CarenD3D11DeviceContext3::VSDefinirConstantBuffers(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroBuffers,
	cli::array<ICarenD3D11Buffer^>^ Param_MatrizBuffers)
{
...
/// <param name="Param_NumeroAmostradores">Número de amostradores na matriz. Cada estágio de pipeline tem um total de 16 slots disponíveis (varia de 0 a D3D11_COMMONSHADER_SAMPLER_SLOT_COUNT - Param_StartSlot).</param>
/// <param name="Param_MatrizAmostradoresEstado">Uma matriz de interfaces de estado do amostrador.</param>
CarenResult CarenD3D11DeviceContext3::VSDefinirSamplers(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroAmostradores,
	cli::array<ICarenD3D11SamplerState^>^ Param_MatrizAmostradoresEstado)
{
...
/// <param name="Param_MatrizInstanciaClasse">Uma matriz de interfaces de instância de classe. Cada interface usada por um sombreador deve ter uma instância de classe correspondente ou o shader será desativado. Defina como NULO se o sombreador não usar nenhuma interface.</param>
/// <param name="Param_NumeroInstanciasClasse">O numero de (ICarenD3D11ClassInstance) dentro da matriz (Param_MatrizInstanciaClasse).</param>
CarenResult CarenD3D11DeviceContext3::VSDefnirShader(
...
/// <param name="Param_NumeroViews">Número de recursos do shader a serem definidos. Até um máximo de 128 slots estão disponíveis para recursos de sombreador (o intervalo é de 0 a D3D11_COMMONSHADER_INPUT_RESOURCE_SLOT_COUNT - Param_StartSlot).</param>
/// <param name="Param_MatrizVisualizadoresSombreador">Uma matriz que contém os Visualizadores de recurso do sombreador para serem definidos no Disposiivo.</param>
CarenResult CarenD3D11DeviceContext3::VSDefinirShaderResources(
	UInt32 Param_StartSlot,
	UInt32 Param_NumeroViews,
	cli::array<ICarenD3D11ShaderResourceView^>^ Param_MatrizVisualizadoresSombreador)
{
...
CarenResult CarenD3D11DeviceContext3::ObterDispositivo(ICaren^ Param_Out_DispositivoD3D11)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11DeviceContext3::ObterDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11DeviceContext3::DefinirDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11DeviceContext3::DefinirInterfaceDadosPrivados(
