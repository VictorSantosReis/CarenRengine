...
//Destruidor.
CarenD3D11BlendState::~CarenD3D11BlendState()
{
...
CarenResult CarenD3D11BlendState::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD3D11BlendState::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID3D11BlendState*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD3D11BlendState::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID3D11BlendState*>(Param_PonteiroNativo);
...
CarenResult CarenD3D11BlendState::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11BlendState::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11BlendState::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenD3D11BlendState::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD3D11BlendState::ObterCodigoErro()
{
...
/// </summary>
void CarenD3D11BlendState::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD3D11BlendState::LiberarReferencia()
{
...
/// </summary>
void CarenD3D11BlendState::LimparDados()
{
...
/// </summary>
void CarenD3D11BlendState::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
