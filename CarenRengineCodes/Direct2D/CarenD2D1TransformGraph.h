...
public:
	static operator CarenD2D1TransformGraph^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1TransformGraph^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1TransformGraph();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1TransformGraph*>(Param_Pointer.ToPointer());
