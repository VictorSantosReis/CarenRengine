...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD2D1RectangleGeometry">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD2D1RectangleGeometry^% Param_Out_CarenD2D1RectangleGeometry)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);

		//Cria a interface
		Param_Out_CarenD2D1RectangleGeometry = gcnew CarenD2D1RectangleGeometry();
