...
//Destruidor.
CarenD3D11DomainShader::~CarenD3D11DomainShader()
{
...
CarenResult CarenD3D11DomainShader::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD3D11DomainShader::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID3D11DomainShader*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD3D11DomainShader::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID3D11DomainShader*>(Param_PonteiroNativo);
...
CarenResult CarenD3D11DomainShader::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11DomainShader::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11DomainShader::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenD3D11DomainShader::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD3D11DomainShader::ObterCodigoErro()
{
...
/// </summary>
void CarenD3D11DomainShader::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD3D11DomainShader::LiberarReferencia()
{
...
/// </summary>
void CarenD3D11DomainShader::LimparDados()
{
...
/// </summary>
void CarenD3D11DomainShader::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
...
CarenResult CarenD3D11DomainShader::ObterDispositivo(ICaren^ Param_Out_DispositivoD3D11)
{
...
CarenResult CarenD3D11DomainShader::ObterDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11DomainShader::DefinirDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11DomainShader::DefinirInterfaceDadosPrivados(
