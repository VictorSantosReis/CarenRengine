...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenDXGIFactory3">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenDXGIFactory3^% Param_Out_CarenDXGIFactory3)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenDXGIFactory3 = gcnew CarenDXGIFactory3();
