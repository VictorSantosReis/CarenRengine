...
CarenResult CarenMFMediaEngineProtectedContent::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IMFMediaEngineProtectedContent*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenMFMediaEngineProtectedContent::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IMFMediaEngineProtectedContent*>(Param_PonteiroNativo);
...
/// </summary>
void CarenMFMediaEngineProtectedContent::LimparDados()
{
