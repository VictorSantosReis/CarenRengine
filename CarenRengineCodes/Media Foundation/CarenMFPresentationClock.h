...
public:
	static operator CarenMFPresentationClock^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFPresentationClock^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFPresentationClock(false);

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFPresentationClock*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFPresentationClock::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
