...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenDXGIDevice">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenDXGIDevice^% Param_Out_CarenDXGIDevice)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenDXGIDevice = gcnew CarenDXGIDevice();
