...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por habilitar um mixer de vídeo personalizado ou um apresentador de vídeo para obter ponteiros de interface do Enhanced Video Renderer (EVR).
/// </summary>
public ref class CarenMFTopologyServiceLookup : public ICarenMFTopologyServiceLookup
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IMFTopologyServiceLookup).
	IMFTopologyServiceLookup* PonteiroTrabalho = NULL;
...
public:
	static operator CarenMFTopologyServiceLookup^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFTopologyServiceLookup^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFTopologyServiceLookup();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFTopologyServiceLookup*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFTopologyServiceLookup::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
...
public:
	...
	virtual CarenResult LookupService(
