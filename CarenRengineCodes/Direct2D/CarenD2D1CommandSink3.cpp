...
//Construtor.
CarenD2D1CommandSink3::CarenD2D1CommandSink3(Boolean Param_CriarInterface)
{
...
{
	//Fixa o ponteiro.
	cli::pin_ptr<ID2D1CommandSink3*> p = &PonteiroTrabalho;

	//Chama o método de ADICIONAR PONTEIRO na classe base(Caren).
	return Caren::Shared_AdicionarPonteiro(Param_PonteiroNativo, reinterpret_cast<IUnknown**>(static_cast<ID2D1CommandSink3**>(p)));
}
