...
/// a CarenDXGIOutput3 para verificar se há suporte ao espaço de cores de sobreposição.
/// </summary>
public ref class CarenDXGIOutput4 : public ICarenDXGIOutput4
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IDXGIOutput4).
	IDXGIOutput4* PonteiroTrabalho = NULL;
...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenDXGIOutput4">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenDXGIOutput4^% Param_Out_CarenDXGIOutput4)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenDXGIOutput4 = gcnew CarenDXGIOutput4();
