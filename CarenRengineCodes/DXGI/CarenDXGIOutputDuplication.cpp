...
{
	//Fixa o ponteiro.
	cli::pin_ptr<IDXGIOutputDuplication*> p = &PonteiroTrabalho;

	//Chama o método de ADICIONAR PONTEIRO na classe base(Caren).
	return Caren::Shared_AdicionarPonteiro(Param_PonteiroNativo, reinterpret_cast<IUnknown**>(static_cast<IDXGIOutputDuplication**>(p)));
}
...
CarenResult CarenDXGIOutputDuplication::GetParent(
...
CarenResult CarenDXGIOutputDuplication::SetPrivateData(
...
CarenResult CarenDXGIOutputDuplication::GetPrivateData(
	String^ Param_GuidIdentificao, 
...
CarenResult CarenDXGIOutputDuplication::SetPrivateDataInterface(
