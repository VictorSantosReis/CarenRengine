...
CarenResult CarenD3D11BlendState1::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
	...
	Hr = (reinterpret_cast<ID3D11BlendState1*>(PonteiroTrabalho))->QueryInterface(GuidInterface, (LPVOID*)&pInterfaceSolcitada);
...
CarenResult CarenD3D11BlendState1::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID3D11BlendState1*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD3D11BlendState1::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID3D11BlendState1*>(Param_PonteiroNativo);
...
CarenResult CarenD3D11BlendState1::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11BlendState1::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11BlendState1::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenD3D11BlendState1::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD3D11BlendState1::ObterCodigoErro()
{
...
/// </summary>
void CarenD3D11BlendState1::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
	(reinterpret_cast<ID3D11BlendState1*>(PonteiroTrabalho))->AddRef();
}

/// <summary>
/// (Release) - 'Decrementa' a contagem de referência do objeto COM atual.
/// </summary>
void CarenD3D11BlendState1::LiberarReferencia()
{
	//Libera a referência e obtém a quantidade atual.
	ULONG RefCount = (reinterpret_cast<ID3D11BlendState1*>(PonteiroTrabalho))->Release();
...
/// </summary>
void CarenD3D11BlendState1::LimparDados()
{
...
/// </summary>
void CarenD3D11BlendState1::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenD3D11BlendState1();
}


//
// Métodos da interface proprietária(ICarenD3D11BlendState1)
//
...
CarenResult CarenD3D11BlendState1::ObterDescriçaoEstado1([Out] Estruturas::CA_D3D11_BLEND_DESC1^% Param_Out_DescEstado)
{
	...
	PonteiroTrabalho->GetDesc1(&BlendDesc);

	//Converte a estrutura nativa para a gerenciada.
	Param_Out_DescEstado = Util.ConverterD3D11_BLEND_DESC1UnManaged_ToManaged(&BlendDesc);
...
//
//Métodos da interface ICarenD3D11BlendState1
//
...
/// </summary>
/// <param name="Param_Out_DescEstado">Retorna uma estrutura com a descrição de um misturador de estado(Blend State).</param>
CarenResult CarenD3D11BlendState1::ObterDescriçaoEstado([Out] Estruturas::CA_D3D11_BLEND_DESC^% Param_Out_DescEstado)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	//Chama o método para realizar a operação
	PonteiroTrabalho->GetDesc(&BlendDesc);

	//Converte a estrutura nativa para a gerenciada.
	Param_Out_DescEstado = Util.ConverterD3D11_BLEND_DESCUnManaged_ToManaged(&BlendDesc);
...
CarenResult CarenD3D11BlendState1::ObterDispositivo(ICaren^ Param_Out_DispositivoD3D11)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11BlendState1::ObterDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11BlendState1::DefinirDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11BlendState1::DefinirInterfaceDadosPrivados(
