...
//Destruidor.
CarenD3D11RenderTargetView1::~CarenD3D11RenderTargetView1()
{
...
CarenResult CarenD3D11RenderTargetView1::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
	...
	Hr = (reinterpret_cast<ID3D11RenderTargetView1*>(PonteiroTrabalho))->QueryInterface(GuidInterface, (LPVOID*)&pInterfaceSolcitada);
...
CarenResult CarenD3D11RenderTargetView1::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID3D11RenderTargetView1*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD3D11RenderTargetView1::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID3D11RenderTargetView1*>(Param_PonteiroNativo);
...
CarenResult CarenD3D11RenderTargetView1::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11RenderTargetView1::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11RenderTargetView1::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenD3D11RenderTargetView1::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD3D11RenderTargetView1::ObterCodigoErro()
{
...
/// </summary>
void CarenD3D11RenderTargetView1::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
	(reinterpret_cast<ID3D11RenderTargetView1*>(PonteiroTrabalho))->AddRef();
}

/// <summary>
/// (Release) - 'Decrementa' a contagem de referência do objeto COM atual.
/// </summary>
void CarenD3D11RenderTargetView1::LiberarReferencia()
{
	//Libera a referência e obtém a quantidade atual.
	ULONG RefCount = (reinterpret_cast<ID3D11RenderTargetView1*>(PonteiroTrabalho))->Release();
...
/// </summary>
void CarenD3D11RenderTargetView1::LimparDados()
{
...
/// </summary>
void CarenD3D11RenderTargetView1::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenD3D11RenderTargetView1();
}


//
// Métodos da interface proprietária(ICarenD3D11RenderTargetView1)
//
...
CarenResult CarenD3D11RenderTargetView1::GetDesc1([Out] Estruturas::CA_D3D11_RENDER_TARGET_VIEW_DESC1^% Param_Out_DescRenderDestino)
{
	...
	//Variaveis a serem utilizadas.
	Utilidades Util;
	D3D11_RENDER_TARGET_VIEW_DESC1 DescRenderTarget;

	//Chama o método para realizar a operação.
	PonteiroTrabalho->GetDesc1(&DescRenderTarget);

	//Converte a estrutura e define no parametro de saida.
	Param_Out_DescRenderDestino = Util.ConverterD3D11_RENDER_TARGET_VIEW_DESC1UnManaged_ToManaged(&DescRenderTarget);
...
//Métodos da interface ICarenD3D11RenderTargetView.

CarenResult CarenD3D11RenderTargetView1::GetDesc(Estruturas::CA_D3D11_RENDER_TARGET_VIEW_DESC^% Param_Out_DescRenderDestino)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	//Chama o método para realizar a operação.
	PonteiroTrabalho->GetDesc(&DescRenderTarget);

	//Converte a estrutura e define no parametro de saida.
	Param_Out_DescRenderDestino = Util.ConverterD3D11_RENDER_TARGET_VIEW_DESCUnManaged_ToManaged(&DescRenderTarget);
...
CarenResult CarenD3D11RenderTargetView1::ObterRecurso([Out] ICarenD3D11Resource^% Param_Out_Recurso)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11RenderTargetView1::ObterDispositivo(ICaren^ Param_Out_DispositivoD3D11)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11RenderTargetView1::ObterDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11RenderTargetView1::DefinirDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11RenderTargetView1::DefinirInterfaceDadosPrivados(
