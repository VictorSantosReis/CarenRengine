...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por uma exibição especifica das partes de um recurso que o pipeline pode acessar durante a renderização.
/// </summary>
public ref class CarenD3D11View : public ICarenD3D11View
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID3D11View).
	ID3D11View* PonteiroTrabalho = NULL;
...
public:
	static operator CarenD3D11View^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD3D11View^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD3D11View();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID3D11View*>(Param_Pointer.ToPointer());
...
public:
	/// <summary>
	/// Cria uma instância vazia da classe atual. O ponteiro de trabalho deve ser definido chamando o método ICaren::AdicionarPonteiro.
	/// Qualquer chamada para algum método dessa classe, sem definir um ponteiro, gera uma exceção.
	/// </summary>
	/// <param name="Param_Out_Interface">Retorna uma instância da classe atual para sua interface correspondente.</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD3D11View^% Param_Out_Interface)
	{
		//Variavel que vai retornar o resultado.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Variavel a ser retornada
		CarenD3D11View^ ClasseVazia = gcnew CarenD3D11View();

		//Define a classe criada no parametro de saida
		Param_Out_Interface = ClasseVazia;
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD3D11View::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
