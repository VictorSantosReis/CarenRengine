...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenDXGIAdapter3">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenDXGIAdapter3^% Param_Out_CarenDXGIAdapter3)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenDXGIAdapter3 = gcnew CarenDXGIAdapter3();
