...
//Destruidor.
CarenD2D1DeviceContext4::~CarenD2D1DeviceContext4()
{
...
CarenResult CarenD2D1DeviceContext4::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD2D1DeviceContext4::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1DeviceContext4*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1DeviceContext4::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1DeviceContext4*>(Param_PonteiroNativo);
...
CarenResult CarenD2D1DeviceContext4::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1DeviceContext4::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1DeviceContext4::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenD2D1DeviceContext4::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD2D1DeviceContext4::ObterCodigoErro()
{
...
/// </summary>
void CarenD2D1DeviceContext4::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD2D1DeviceContext4::LiberarReferencia()
{
...
/// </summary>
void CarenD2D1DeviceContext4::LimparDados()
{
...
/// </summary>
void CarenD2D1DeviceContext4::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenD2D1DeviceContext4();
}



// Métodos da interface proprietária(ICarenD2D1DeviceContext4)
...
CarenResult CarenD2D1DeviceContext4::CreateSvgGlyphStyle(
...
void CarenD2D1DeviceContext4::DrawColorBitmapGlyphRun(
...
void CarenD2D1DeviceContext4::DrawSvgGlyphRun(
CA_D2D1_POINT_2F^ Param_BaselineOrigin,
CA_DWRITE_GLYPH_RUN^ Param_GlyphRun,
...
void CarenD2D1DeviceContext4::DrawText(
String^ Param_Texto,
...
/// <param name="Param_ColorPaletteIndex">O índice usado para selecionar uma paleta de cores dentro de uma fonte de cor.</param>
/// <param name="Param_Opcoes">Um valor que indica se o texto deve ser encaixado nos limites do pixel e se o texto deve ser cortado no retângulo de layout. O valor padrão é D2D1_DRAW_TEXT_OPTIONS_NONE, o que indica que o texto deve ser encaixado nos limites do pixel e não deve ser cortado para o retângulo de layout.</param>
void CarenD2D1DeviceContext4::DrawTextLayout(
...
CarenResult CarenD2D1DeviceContext4::GetColorBitmapGlyphImage(
CA_DWRITE_GLYPH_IMAGE_FORMATS Param_GlyphImageFormat,
...
CarenResult CarenD2D1DeviceContext4::GetSvgGlyphImage(
CA_D2D1_POINT_2F^ Param_GlyphOrigin,
ICaren^ Param_FontFace,
float Param_FontSize,
UInt16 Param_GlyphIndex,
...
CarenResult CarenD2D1DeviceContext4::CreateSpriteBatch(
...
void CarenD2D1DeviceContext4::DrawSpriteBatch(
...
CarenResult CarenD2D1DeviceContext4::CreateGradientMesh(
...
CarenResult CarenD2D1DeviceContext4::CreateImageSourceFromDxgi(
...
CarenResult CarenD2D1DeviceContext4::CreateImageSourceFromWic(
...
CarenResult CarenD2D1DeviceContext4::CreateInk(
...
CarenResult CarenD2D1DeviceContext4::CreateInkStyle(
...
CarenResult CarenD2D1DeviceContext4::CreateLookupTable3D(
...
CarenResult CarenD2D1DeviceContext4::CreateTransformedImageSource(
...
void CarenD2D1DeviceContext4::DrawGdiMetafile(
...
void CarenD2D1DeviceContext4::DrawGradientMesh(
...
void CarenD2D1DeviceContext4::DrawInk(
...
CarenResult CarenD2D1DeviceContext4::GetGradientMeshWorldBounds(
	ICarenD2D1GradientMesh^ Param_GradientMesh,
...
CarenResult CarenD2D1DeviceContext4::CreateFilledGeometryRealization(
...
/// <param name="Param_Out_GeometryRealization">Retorna uma interface(ICarenD2D1GeometryRealization) que contém um ponteiro para o novo objeto de realização.</param>
CarenResult CarenD2D1DeviceContext4::CreateStrokedGeometryRealization(
	ICarenD2D1Geometry^ Param_Geometria,
	float Param_FlatterningTolerance,
...
void CarenD2D1DeviceContext4::DrawGeometryRealization(
...
CarenResult CarenD2D1DeviceContext4::CreateBitmap(
...
CarenResult CarenD2D1DeviceContext4::CreateBitmapBrush(
	ICarenD2D1Bitmap^ Param_Bitmap,
...
CarenResult CarenD2D1DeviceContext4::CreateBitmapFromDxgiSurface(
...
/// <param name="Param_Out_Bitmap">Retorna uma interface(ICarenD2D1Bitmap1) que contém um ponteiro para um novo objeto bitmap.</param>
CarenResult CarenD2D1DeviceContext4::CreateBitmapFromWicBitmap(
	ICaren^ Param_WicBitmapSource,
	CA_D2D1_BITMAP_PROPERTIES1^ Param_PropsBitmap,
	[Out] ICarenD2D1Bitmap1^% Param_Out_Bitmap)
{
...
CarenResult CarenD2D1DeviceContext4::CreateColorContext(
...
/// <param name="Param_Out_ColorContext">Retorna uma interface(ICarenD2D1ColorContext) que contém um ponteiro para o novo objeto de contexto de cores.</param>
CarenResult CarenD2D1DeviceContext4::CreateColorContextFromFilename(
...
/// <param name="Param_Out_ColorContext">Retorna uma interface(ICarenD2D1ColorContext) que contém um ponteiro para o novo objeto de contexto de cores.</param>
CarenResult CarenD2D1DeviceContext4::CreateColorContextFromWicColorContext(
...
CarenResult CarenD2D1DeviceContext4::CreateCommandList(
...
CarenResult CarenD2D1DeviceContext4::CreateEffect(
...
CarenResult CarenD2D1DeviceContext4::CreateGradientStopCollection(
...
CarenResult CarenD2D1DeviceContext4::CreateImageBrush(
...
CarenResult CarenD2D1DeviceContext4::DrawBitmap(
	ICarenD2D1Bitmap^ Param_Bitmap,
	CA_D2D1_RECT_F^ Param_RetanguloDestino,
...
void CarenD2D1DeviceContext4::DrawGlyphRun(
	CA_D2D1_POINT_2F^ Param_BaseLineOrigin,
	CA_DWRITE_GLYPH_RUN^ Param_GlyphRun,
...
void CarenD2D1DeviceContext4::DrawImage(
	ICarenD2D1Image^ Param_Image,
	CA_D2D1_POINT_2F^ Param_TargetOffset,
...
void CarenD2D1DeviceContext4::FillOpacityMask(
...
void CarenD2D1DeviceContext4::GetDevice(ICaren^ Param_Out_Dispositivo)
{
	//Variaveis a serem utilizadas.
...
CarenResult CarenD2D1DeviceContext4::GetEffectInvalidRectangleCount(
	ICarenD2D1Effect^ Param_Efeito,
...
CarenResult CarenD2D1DeviceContext4::GetEffectInvalidRectangles(
	ICarenD2D1Effect^ Param_Efeito,
...
CarenResult CarenD2D1DeviceContext4::GetEffectRequiredInputRectangles(
	ICarenD2D1Effect^ Param_Efeito,
...
CarenResult CarenD2D1DeviceContext4::GetGlyphRunWorldBounds(
	CA_D2D1_POINT_2F^ Param_BaseLineOrigin,
...
CarenResult CarenD2D1DeviceContext4::GetImageLocalBounds(
	ICarenD2D1Image^ Param_Image,
...
CarenResult CarenD2D1DeviceContext4::GetImageWorldBounds(
	ICarenD2D1Image^ Param_Image,
...
void CarenD2D1DeviceContext4::GetPrimitiveBlend(
...
void CarenD2D1DeviceContext4::GetRenderingControls(
...
CarenResult CarenD2D1DeviceContext4::GetTarget(
...
void CarenD2D1DeviceContext4::GetUnitMode([Out] CA_D2D1_UNIT_MODE Param_Out_Unit)
{
	//Chama o método para realizar a operação.
...
CarenResult CarenD2D1DeviceContext4::InvalidateEffectInputRectangle(
	ICarenD2D1Effect^ Param_Efeito,
...
void CarenD2D1DeviceContext4::IsBufferPrecisionSupported(
	CA_D2D1_BUFFER_PRECISION  Param_BufferPrecision,
...
void CarenD2D1DeviceContext4::IsDxgiFormatSupported(
...
void CarenD2D1DeviceContext4::PushLayer(
...
void CarenD2D1DeviceContext4::SetPrimitiveBlend(CA_D2D1_PRIMITIVE_BLEND Param_PrimitiveBlend)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1DeviceContext4::SetRenderingControls(CA_D2D1_RENDERING_CONTROLS^ Param_ControlesRenderizacao)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void CarenD2D1DeviceContext4::SetTarget(ICarenD2D1Image^ Param_Imagem)
{
	//Variaveis a serem utilizadas.
	ID2D1Image* pMyImage = NULL;
...
void CarenD2D1DeviceContext4::SetUnitMode(CA_D2D1_UNIT_MODE Param_UnitMode)
{
	//Chama o método para realizar a operação.
...
/// </summary>
void CarenD2D1DeviceContext4::BeginDraw()
{
	//Chama o método para realizar a operação.
...
void CarenD2D1DeviceContext4::Clear(CA_D2D1_COLOR_F^ Param_ClearColor)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
CarenResult CarenD2D1DeviceContext4::CreateCompatibleRenderTarget(
...
/// </summary>
/// <param name="Param_Out_BitmapRenderTarget">Retorna a interface (ICarenD2D1BitmapRenderTarget) que contém um ponteiro para um novo alvo de renderização bitmap. O usuário deve inicializar a interface antes de chamar este método.</param>
CarenResult CarenD2D1DeviceContext4::CreateCompatibleRenderTarget(ICaren^ Param_Out_BitmapRenderTarget)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1DeviceContext4::CreateLayer(
...
/// </summary>
/// <param name="Param_Out_Layer">Retorna a interface ICarenD2D1Layer que contém um ponteiro para a nova camada(Layer).</param>
CarenResult CarenD2D1DeviceContext4::CreateLayer([Out] ICarenD2D1Layer^% Param_Out_Layer)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1DeviceContext4::CreateLinearGradientBrush(
...
CarenResult CarenD2D1DeviceContext4::CreateMesh([Out] ICarenD2D1Mesh^% Param_Out_Mesh)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1DeviceContext4::CreateRadialGradientBrush(
...
CarenResult CarenD2D1DeviceContext4::CreateSharedBitmap(
	String^ Param_Riid,
...
CarenResult CarenD2D1DeviceContext4::CreateSolidColorBrush(
...
CarenResult CarenD2D1DeviceContext4::DrawEllipse(
...
CarenResult CarenD2D1DeviceContext4::DrawGeometry(
	ICarenD2D1Geometry^ Param_Geometria,
	ICarenD2D1Brush^ Param_Brush,
	float Param_StrokeWidth,
	ICarenD2D1StrokeStyle^ Param_StrokeStyle)
...
CarenResult CarenD2D1DeviceContext4::DrawGlyphRun(
	CA_D2D1_POINT_2F^ Param_BaseLineOrigin,
	CA_DWRITE_GLYPH_RUN^ Param_GlyphRun,
	ICarenD2D1Brush^ Param_ForegroundBrush,
	CA_DWRITE_MEASURING_MODE Param_MeasuringMode)
...
CarenResult CarenD2D1DeviceContext4::DrawLine(
...
CarenResult CarenD2D1DeviceContext4::DrawRectangle(
...
CarenResult CarenD2D1DeviceContext4::DrawRoundedRectangle(
...
/// <param name="Param_MeasuringMode">Um valor que indica como as métricas do glifo(Glyph) são usadas para medir o texto quando ele é formatado. O valor padrão é DWRITE_MEASURING_MODE_NATURAL.</param>
CarenResult CarenD2D1DeviceContext4::DrawText(
	String^ Param_Texto,
...
/// <param name="Param_Opcoes">Um valor que indica se o texto deve ser encaixado nos limites do pixel e se o texto deve ser cortado no retângulo de layout. O valor padrão é D2D1_DRAW_TEXT_OPTIONS_NONE, 
/// o que indica que o texto deve ser encaixado nos limites do pixel e não deve ser cortado para o retângulo de layout.</param>
CarenResult CarenD2D1DeviceContext4::DrawTextLayout(
...
CarenResult CarenD2D1DeviceContext4::EndDraw(
...
CarenResult CarenD2D1DeviceContext4::FillEllipse(
	CA_D2D1_ELLIPSE^ Param_Ellipse,
	ICarenD2D1Brush^ Param_Brush)
{
	//Variavel a ser retornada.
...
CarenResult CarenD2D1DeviceContext4::FillGeometry(
	ICarenD2D1Geometry^ Param_Geometria,
	ICarenD2D1Brush^ Param_Brush,
...
CarenResult CarenD2D1DeviceContext4::FillMesh(
...
CarenResult CarenD2D1DeviceContext4::FillOpacityMask(
...
CarenResult CarenD2D1DeviceContext4::FillRectangle(
	CA_D2D1_RECT_F^ Param_Rect,
	ICarenD2D1Brush^ Param_Brush)
{
	//Variavel a ser retornada.
...
CarenResult CarenD2D1DeviceContext4::FillRoundedRectangle(
...
/// <param name="Param_Out_Tag1">Quando este método retorna, contém a tag para operações de desenho que causaram erros ou 0 se não houver erros.</param>
/// <param name="Param_Out_Tag2">Quando este método retorna, contém a tag para operações de desenho que causaram erros ou 0 se não houver erros.</param>
CarenResult CarenD2D1DeviceContext4::Flush(
	[Out] UInt64% Param_Out_Tag1,
	[Out] UInt64% Param_Out_Tag2)
{
	//Variavel a ser retornada.
...
void CarenD2D1DeviceContext4::GetAntialiasMode([Out] CA_D2D1_ANTIALIAS_MODE% Param_Out_AntialiasMode)
{
	//Variaveis a serem utilizadas.
...
void CarenD2D1DeviceContext4::GetDpi(
...
void CarenD2D1DeviceContext4::GetMaximumBitmapSize([Out] UInt32% Param_Out_MaximumSize)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1DeviceContext4::GetPixelFormat([Out] CA_D2D1_PIXEL_FORMAT^% Param_Out_PixelFormat)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void CarenD2D1DeviceContext4::GetPixelSize([Out] CA_D2D1_SIZE_U^% Param_Out_PixelSize)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void CarenD2D1DeviceContext4::GetSize([Out] CA_D2D1_SIZE_F^% Param_Out_Size)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void CarenD2D1DeviceContext4::GetTags(
	[Out] UInt64% Param_Out_Tag1,
	[Out] UInt64% Param_Out_Tag2)
{
	//Variaveis a serem utilizadas.
...
void CarenD2D1DeviceContext4::GetTextAntialiasMode([Out] CA_D2D1_TEXT_ANTIALIAS_MODE% Param_Out_TextAntialiasMode)
{
	//Variaveis a serem utilizadas.
...
void CarenD2D1DeviceContext4::GetTextRenderingParams(ICaren^ Param_Out_TextRenderingParams)
{
	//Variaveis a serem utilizadas.
...
void CarenD2D1DeviceContext4::GetTransform([Out] CA_D2D1_MATRIX_3X2_F^% Param_Out_Transform)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void CarenD2D1DeviceContext4::IsSupported(
...
/// ou ICarenD2D1RenderTarget::Flush.
/// </summary>
void CarenD2D1DeviceContext4::PopAxisAlignedClip()
{
	//Chama o método para realizar a operação.
...
/// ou ICarenD2D1RenderTarget::Flush.
/// </summary>
void CarenD2D1DeviceContext4::PopLayer()
{
	//Chama o método para realizar a operação.
...
void CarenD2D1DeviceContext4::PushAxisAlignedClip(
...
CarenResult CarenD2D1DeviceContext4::RestoreDrawingState(ICarenD2D1DrawingStateBlock^ Param_DrawingStateBlock)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1DeviceContext4::SaveDrawingState(ICarenD2D1DrawingStateBlock^ Param_DrawingStateBlock)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
void CarenD2D1DeviceContext4::SetAntialiasMode(CA_D2D1_ANTIALIAS_MODE Param_AntialiasMode)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1DeviceContext4::SetDpi(
	float Param_DpiX,
	float Param_DpiY)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1DeviceContext4::SetTags(
	UInt64 Param_Tag1,
	UInt64 Param_Tag2)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1DeviceContext4::SetTextAntialiasMode(CA_D2D1_TEXT_ANTIALIAS_MODE Param_TextAntialiasMode)
{
	//Chama o método para realizar a operação.
...
CarenResult CarenD2D1DeviceContext4::SetTextRenderingParams(ICaren^ Param_TextRenderingParams)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
void CarenD2D1DeviceContext4::SetTransform(CA_D2D1_MATRIX_3X2_F^ Param_Transform)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void  CarenD2D1DeviceContext4::GetFactory(ICaren^ Param_Out_Factory)
{
	//Variaveis a serem utilizadas.
