...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenDXGIFactory4">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenDXGIFactory4^% Param_Out_CarenDXGIFactory4)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenDXGIFactory4 = gcnew CarenDXGIFactory4();
