...
/// <summary>
/// (Concluida - Fase de Teses) - Classe responsável por representar um subsistema de exibição, que inclui uma ou mais GPUs, DACs e memória de vídeo.
/// </summary>
public ref class CarenDXGIAdapter2 : public ICarenDXGIAdapter2
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IDXGIAdapter2).
	IDXGIAdapter2* PonteiroTrabalho = NULL;
...
public:
	static operator CarenDXGIAdapter2^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenDXGIAdapter2^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenDXGIAdapter2();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IDXGIAdapter2*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenDXGIAdapter2::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
