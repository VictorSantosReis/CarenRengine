...
public:
	...
	virtual CarenResult AdicionarNode(ICarenMFTopologyNode^ Param_NoTopologia);

	/// <summary>
	/// (Clear) - Remove todos os nós da topologia.
	/// </summary>
	virtual CarenResult Limpar();
	...
	virtual CarenResult ClonarDe(ICarenMFTopology^ Param_TopologiaClone);
	...
	virtual CarenResult ObterNode(UInt16 Param_Index, [Out] ICarenMFTopologyNode^% Param_Out_NodeTopologia);
	...
	virtual CarenResult ObterNodePorID(UInt64 Param_IdentificadorNode, [Out] ICarenMFTopologyNode^% Param_Out_NodeTopologia);
	...
	virtual CarenResult ObterQuantidadeNode([Out] UInt16 Param_Out_Quantidade);
	...
	virtual CarenResult ObterColecaoNodeSaida([Out] ICarenMFCollection^% Param_Out_ColecaoNoSaida);
	...
	/// A coleção pode conter 0 ou mais ponteiros. Todos os objetos dentro da coleção podem ser consultados para a interface ICarenMFTopologyNode.</param>
	virtual CarenResult ObterColecaoNodeOrigem([Out] ICarenMFCollection^% Param_Out_ColecaoNoOrigem);
	...
	virtual CarenResult ObterIDTopologia([Out] UInt64% Param_Out_IdentificadorTopologia);
	...
	virtual CarenResult RemoverNode(ICarenMFTopologyNode^ Param_NodeRemove);
