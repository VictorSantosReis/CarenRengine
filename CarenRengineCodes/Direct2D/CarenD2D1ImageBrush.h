...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD2D1ImageBrush">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD2D1ImageBrush^% Param_Out_CarenD2D1ImageBrush)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);

		//Cria a interface
		Param_Out_CarenD2D1ImageBrush = gcnew CarenD2D1ImageBrush();
