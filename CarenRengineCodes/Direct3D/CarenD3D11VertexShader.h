...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por representar um Sombreador de vertices que controla um programa executável que controla o estágio de sombreamento de vértice.
/// </summary>
public ref class CarenD3D11VertexShader :public ICarenD3D11VertexShader
{
	/////////////////////////////////////////
...
public:
	static operator CarenD3D11VertexShader^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD3D11VertexShader^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD3D11VertexShader();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID3D11VertexShader*>(Param_Pointer.ToPointer());
...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD3D11VertexShader">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD3D11VertexShader^% Param_Out_CarenD3D11VertexShader)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenD3D11VertexShader = gcnew CarenD3D11VertexShader();
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD3D11VertexShader::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
