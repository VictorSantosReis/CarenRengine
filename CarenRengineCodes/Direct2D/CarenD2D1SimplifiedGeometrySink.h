...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD2D1SimplifiedGeometrySink">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD2D1SimplifiedGeometrySink^% Param_Out_CarenD2D1SimplifiedGeometrySink)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);

		//Cria a interface
		Param_Out_CarenD2D1SimplifiedGeometrySink = gcnew CarenD2D1SimplifiedGeometrySink();
