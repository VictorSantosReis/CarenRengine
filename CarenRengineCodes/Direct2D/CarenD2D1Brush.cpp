...
CarenResult CarenD2D1Brush::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD2D1Brush::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1Brush*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1Brush::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1Brush*>(Param_PonteiroNativo);
...
CarenResult CarenD2D1Brush::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1Brush::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1Brush::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenD2D1Brush::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD2D1Brush::ObterCodigoErro()
{
...
/// </summary>
void CarenD2D1Brush::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD2D1Brush::LiberarReferencia()
{
...
/// </summary>
void CarenD2D1Brush::LimparDados()
{
...
void CarenD2D1Brush::GetOpacity([Out] float% Param_Out_Opacidade)
{
...
void CarenD2D1Brush::GetTransform([Out] CA_D2D1_MATRIX_3X2_F^% Param_Out_Matrix)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
/// Os valores de opacidade são fixados na faixa 0-1 antes de serem múltiplos juntos.</param>
void CarenD2D1Brush::SetOpacity(float Param_Opacidade)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1Brush::SetTransform(CA_D2D1_MATRIX_3X2_F^ Param_Transform)
{
	//Variaveis a serem utilizadas.
	Utilidades Util;
...
void CarenD2D1Brush::GetFactory(ICaren^ Param_Out_Factory)
{
	//Variaveis a serem utilizadas.
