...
public ref class CarenMFMediaSinkPreroll : public ICarenMFMediaSinkPreroll
{
	...
	//Ponteiro para a interface (IMFMediaSinkPreroll).
...
public:
	static operator CarenMFMediaSinkPreroll^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFMediaSinkPreroll^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFMediaSinkPreroll();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFMediaSinkPreroll*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFMediaSinkPreroll::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
