...
CarenResult CarenDXGIOutput2::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
	...
	Hr = (reinterpret_cast<IDXGIOutput2*>(PonteiroTrabalho))->QueryInterface(GuidInterface, (LPVOID*)&pInterfaceSolcitada);
...
CarenResult CarenDXGIOutput2::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IDXGIOutput2*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenDXGIOutput2::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IDXGIOutput2*>(Param_PonteiroNativo);
...
{
	//Adiciona uma referência ao ponteiro
	(reinterpret_cast<IDXGIOutput2*>(PonteiroTrabalho))->AddRef();
}
...
void CarenDXGIOutput2::LiberarReferencia()
{
	...
	ULONG RefCount = (reinterpret_cast<IDXGIOutput2*>(PonteiroTrabalho))->Release();
...
/// </summary>
void CarenDXGIOutput2::LimparDados()
{
...
CarenResult CarenDXGIOutput2::SuporteOverlay([Out] Boolean Param_Out_Suporte)
{
...
CarenResult CarenDXGIOutput2::DuplicarSaida(ICaren^ Param_Dispositivo3D, [Out] ICarenDXGIOutputDuplication^% Param_Out_SaidaDuplicada)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenDXGIOutput2::EncontrarModoExibicaoAdequado1(
...
CarenResult CarenDXGIOutput2::ObterListaModosExibicao1(
...
CarenResult CarenDXGIOutput2::ObterDadosSuperficeExibicaoAtual1(ICarenDXGIResource^ Param_SuperficeDestino)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenDXGIOutput2::EncontrarModoExibicaoAdequado(CA_DXGI_MODE_DESC^ Param_ModoDesc, [Out] CA_DXGI_MODE_DESC^% Param_Out_ModoMaisAproximado, ICaren^ Param_Dispositivo3D)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenDXGIOutput2::ObterDescricao([Out] CA_DXGI_OUTPUT_DESC^% Param_Out_DescSaida)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenDXGIOutput2::ObterListaModosExibicao(
	CA_DXGI_FORMAT Param_Formato,
	CA_DXGI_ENUM_MODES Param_Flags,
	Boolean Param_RecuperaQuantidadeModos,
	UInt32% Param_Ref_QuantidadeModos,
...
CarenResult CarenDXGIOutput2::ObterDadosSuperficeExibicaoAtual(ICarenDXGISurface^% Param_SuperficeDestino)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenDXGIOutput2::ObterEstatisticasFrame([Out] CA_DXGI_FRAME_STATISTICS^% Param_Out_EstatisticasFrame)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenDXGIOutput2::ObterControleGamma([Out] CA_DXGI_GAMMA_CONTROL^% Param_Out_ControleGamma)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenDXGIOutput2::ObterDescricaoCapacidadesControleGamma([Out] CA_DXGI_GAMMA_CONTROL_CAPABILITIES^% Param_Out_GammaCaps)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenDXGIOutput2::LiberarPropriedadeSaida()
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenDXGIOutput2::DefinirSuperficeDisplay(ICarenDXGISurface^% Param_Superfice)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenDXGIOutput2::DefinirControlesGamma(CA_DXGI_GAMMA_CONTROL^ Param_ControleGama)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenDXGIOutput2::ObterPosseSaida(ICaren^ Param_DispositivoD3D, Boolean Param_Exclusivo)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenDXGIOutput2::AguardarForVBlank()
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenDXGIOutput2::ObterPaiObjeto(String^ Param_RIIDInterface, ICaren^ Param_Out_ObjetoPai)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenDXGIOutput2::DefinirDadosPrivados(String^ Param_GuidIdentificao, UInt32 Param_TamanhoDados, ICaren^ Param_Dados)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenDXGIOutput2::ObterDadosPrivados(String^ Param_GuidIdentificao, UInt32% Param_Ref_TamanhoDados, ICaren^ Param_Out_Dados)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenDXGIOutput2::DefinirDadosPrivadosInterface(String^ Param_GuidInterface, ICaren^ Param_Interface)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
