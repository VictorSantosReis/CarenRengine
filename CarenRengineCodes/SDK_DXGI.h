...
namespace CarenRengine
{
	...
	ICaren^ Param_Out_InterfaceBuffer);
			...
			CarenResult GetFullscreenState(
	...
	Enumeracoes::CA_DXGI_SWAP_CHAIN_FLAG Param_SwapChainFlags);
			...
			CarenResult SetFullscreenState(
	...
	[Out] UInt32% Param_Out_Altura);
		...
		public interface class ICarenDXGISwapChain3 : ICarenDXGISwapChain2
		{
			...
			CarenResult CheckColorSpaceSupport(
	CA_DXGI_COLOR_SPACE_TYPE Param_ColorSpace, 
