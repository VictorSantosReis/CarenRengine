...
//Destruidor.
CarenD3D11UnorderedAccessView::~CarenD3D11UnorderedAccessView()
{
...
CarenResult CarenD3D11UnorderedAccessView::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD3D11UnorderedAccessView::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID3D11UnorderedAccessView*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD3D11UnorderedAccessView::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID3D11UnorderedAccessView*>(Param_PonteiroNativo);
...
CarenResult CarenD3D11UnorderedAccessView::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11UnorderedAccessView::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11UnorderedAccessView::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenD3D11UnorderedAccessView::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD3D11UnorderedAccessView::ObterCodigoErro()
{
...
/// </summary>
void CarenD3D11UnorderedAccessView::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD3D11UnorderedAccessView::LiberarReferencia()
{
...
/// </summary>
void CarenD3D11UnorderedAccessView::LimparDados()
{
...
/// </summary>
void CarenD3D11UnorderedAccessView::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
...
CarenResult CarenD3D11UnorderedAccessView::GetDesc([Out] Estruturas::CA_D3D11_UNORDERED_ACCESS_VIEW_DESC^% Param_Out_DescRecurso)
{
...
CarenResult CarenD3D11UnorderedAccessView::ObterRecurso([Out] ICarenD3D11Resource^% Param_Out_Recurso)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	//Cria a interface a ser retornada no parametro de saida.
...
CarenResult CarenD3D11UnorderedAccessView::ObterDispositivo(ICaren^ Param_Out_DispositivoD3D11)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11UnorderedAccessView::ObterDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11UnorderedAccessView::DefinirDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11UnorderedAccessView::DefinirInterfaceDadosPrivados(
