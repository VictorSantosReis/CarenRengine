...
//Destruidor.
CarenD3D11Texture2D::~CarenD3D11Texture2D()
{
...
CarenResult CarenD3D11Texture2D::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD3D11Texture2D::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID3D11Texture2D*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD3D11Texture2D::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID3D11Texture2D*>(Param_PonteiroNativo);
...
CarenResult CarenD3D11Texture2D::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Texture2D::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Texture2D::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenD3D11Texture2D::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD3D11Texture2D::ObterCodigoErro()
{
...
/// </summary>
void CarenD3D11Texture2D::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD3D11Texture2D::LiberarReferencia()
{
...
/// </summary>
void CarenD3D11Texture2D::LimparDados()
{
...
/// </summary>
void CarenD3D11Texture2D::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
...
CarenResult CarenD3D11Texture2D::GetDesc([Out] Estruturas::CA_D3D11_TEXTURE2D_DESC^% Param_Out_PropsTextura2D)
{
