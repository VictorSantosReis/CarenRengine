...
#include "../pch.h"
#include "CarenD2D1Factory1.h"

//Destruidor.
CarenD2D1Factory1::~CarenD2D1Factory1()
{
...
CarenResult CarenD2D1Factory1::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD2D1Factory1::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1Factory1*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1Factory1::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1Factory1*>(Param_PonteiroNativo);
...
CarenResult CarenD2D1Factory1::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1Factory1::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1Factory1::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenD2D1Factory1::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD2D1Factory1::ObterCodigoErro()
{
...
/// </summary>
void CarenD2D1Factory1::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD2D1Factory1::LiberarReferencia()
{
...
/// </summary>
void CarenD2D1Factory1::LimparDados()
{
...
/// </summary>
void CarenD2D1Factory1::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenD2D1Factory1();
}



// Métodos da interface proprietária(ICarenD2D1Factory1)
...
CarenResult CarenD2D1Factory1::CreateDevice(
...
CarenResult CarenD2D1Factory1::CreateDrawingStateBlock(
...
CarenResult CarenD2D1Factory1::CreateGdiMetafile(
...
CarenResult CarenD2D1Factory1::CreatePathGeometry(
...
CarenResult CarenD2D1Factory1::CreateStrokeStyle(
...
CarenResult CarenD2D1Factory1::GetEffectProperties(
...
CarenResult CarenD2D1Factory1::GetRegisteredEffects(
...
CarenResult CarenD2D1Factory1::RegisterEffectFromStream(
...
/// <param name="Param_QuantidadeBindings">O número de Bindings na matriz(Param_Bindings).</param>
/// <param name="Param_CallbackEffectFactory">Um ponteiro para um Factory estatico para criar oefeito correspondente.</param>
CarenResult CarenD2D1Factory1::RegisterEffectFromString(
String^ Param_ClassId,
...
CarenResult CarenD2D1Factory1::UnregisterEffect(
String^ Param_ClassId
)
{
	//Variavel a ser retornada.
...
CarenResult CarenD2D1Factory1::CreateDCRenderTarget(
...
/// </summary>
/// <param name="Param_Out_StateBlock">Retorna uma interface(ICarenD2D1DrawingStateBlock) que contém um ponteiro para o novo bloco de estado de desenhado criado.</param>
CarenResult CarenD2D1Factory1::CreateDrawingStateBlock([Out] ICarenD2D1DrawingStateBlock^% Param_Out_StateBlock)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1Factory1::CreateDxgiSurfaceRenderTarget(
...
CarenResult CarenD2D1Factory1::CreateEllipseGeometry(
...
CarenResult CarenD2D1Factory1::CreateGeometryGroup(
...
CarenResult CarenD2D1Factory1::CreateHwndRenderTarget(
	CA_D2D1_RENDER_TARGET_PROPERTIES^ Param_PropsRenderTarget,
...
CarenResult CarenD2D1Factory1::CreateRectangleGeometry(
...
CarenResult CarenD2D1Factory1::CreateRoundedRectangleGeometry(
...
CarenResult CarenD2D1Factory1::CreateTransformedGeometry(
...
/// <param name="Param_PropsRenderTarget">O modo de renderização, o formato de pixel, as opções de remoção, as informações de DPI e o suporte mínimo directx necessário para renderização de hardware.</param>
/// <param name="Param_Out_RenderTarget">Retorna uma interface(ICarenD2D1RenderTarget) que contém um ponteiro para o objeto criado.</param>
CarenResult CarenD2D1Factory1::CreateWicBitmapRenderTarget(
...
void CarenD2D1Factory1::GetDesktopDpi(
...
/// </summary>
CarenResult CarenD2D1Factory1::ReloadSystemMetrics()
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
