...
//Destruidor.
CarenD3D11Query::~CarenD3D11Query()
{
...
CarenResult CarenD3D11Query::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD3D11Query::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID3D11Query*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD3D11Query::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID3D11Query*>(Param_PonteiroNativo);
...
CarenResult CarenD3D11Query::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Query::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Query::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenD3D11Query::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD3D11Query::ObterCodigoErro()
{
...
/// </summary>
void CarenD3D11Query::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD3D11Query::LiberarReferencia()
{
...
/// </summary>
void CarenD3D11Query::LimparDados()
{
...
/// </summary>
void CarenD3D11Query::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
...
CarenResult CarenD3D11Query::GetDesc([Out] Estruturas::CA_D3D11_QUERY_DESC^% Param_Out_DescConsulta)
{
...
CarenResult CarenD3D11Query::ObterTamanhoDados([Out] UInt32% Param_TamanhoDados)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Query::ObterDispositivo(ICaren^ Param_Out_DispositivoD3D11)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Query::ObterDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11Query::DefinirDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11Query::DefinirInterfaceDadosPrivados(
