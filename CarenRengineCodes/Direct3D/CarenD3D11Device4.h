...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD3D11Device4">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD3D11Device4^% Param_Out_CarenD3D11Device4)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenD3D11Device4 = gcnew CarenD3D11Device4();
