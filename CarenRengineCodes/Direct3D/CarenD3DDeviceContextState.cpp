...
CarenResult CarenD3DDeviceContextState::GetDevice(ICaren^ Param_Out_DispositivoD3D11)
{
...
CarenResult CarenD3DDeviceContextState::GetPrivateData(
	String^ Param_Guid,
...
CarenResult CarenD3DDeviceContextState::SetPrivateData(
	String^ Param_Guid,
...
CarenResult CarenD3DDeviceContextState::SetPrivateDataInterface(
