...
CarenResult CarenDXGIAdapter2::GetParent(
...
CarenResult CarenDXGIAdapter2::SetPrivateData(
...
CarenResult CarenDXGIAdapter2::GetPrivateData(
	String^ Param_GuidIdentificao, 
...
CarenResult CarenDXGIAdapter2::SetPrivateDataInterface(
