...
CarenResult CarenD3D11HullShader::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<ID3D11HullShader*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD3D11HullShader::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID3D11HullShader*>(Param_PonteiroNativo);
...
/// </summary>
void CarenD3D11HullShader::LimparDados()
{
...
CarenResult CarenD3D11HullShader::ObterDispositivo(ICaren^ Param_Out_DispositivoD3D11)
{
...
CarenResult CarenD3D11HullShader::ObterDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11HullShader::DefinirDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11HullShader::DefinirInterfaceDadosPrivados(
