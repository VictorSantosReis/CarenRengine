...
/// <summary>
/// Classe responsável por expor métodos para obter informações e controlar a decodificação progressiva.
/// </summary>
public ref class CarenWICProgressiveLevelControl : public ICarenWICProgressiveLevelControl
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IWICProgressiveLevelControl).
	IWICProgressiveLevelControl* PonteiroTrabalho = NULL;
...
public:
	...
	/// </summary>
	CarenWICProgressiveLevelControl();
...
public:
	static operator CarenWICProgressiveLevelControl^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenWICProgressiveLevelControl^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenWICProgressiveLevelControl();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IWICProgressiveLevelControl*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenWICProgressiveLevelControl::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenWICProgressiveLevelControl)
public:
	/// <summary>
	...
	virtual CarenResult GetCurrentLevel([Out] UInt32% Param_Out_LevelAtual);
	...
	virtual CarenResult GetLevelCount([Out] UInt32% Param_Out_QuantLeveis);
	...
	virtual CarenResult SetCurrentLevel(UInt32 Param_Level);
};