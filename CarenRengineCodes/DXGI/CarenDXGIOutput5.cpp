...
CarenResult CarenDXGIOutput5::GetParent(
...
CarenResult CarenDXGIOutput5::SetPrivateData(
...
CarenResult CarenDXGIOutput5::GetPrivateData(
	String^ Param_GuidIdentificao, 
...
CarenResult CarenDXGIOutput5::SetPrivateDataInterface(
