...
CarenResult CarenMFActivate::Compare(
...
CarenResult CarenMFActivate::CompareItem(
...
CarenResult CarenMFActivate::GetAllocatedBlob(
		String^ Param_GuidChave, 
...
CarenResult CarenMFActivate::GetAllocatedString(
		String^ Param_GuidChave, 
...
CarenResult CarenMFActivate::GetBlob(
		String^ Param_GuidChave, 
...
CarenResult CarenMFActivate::GetBlobSize(
	String^ Param_GuidChave, 
...
CarenResult CarenMFActivate::GetDouble(
		String^ Param_GuidChave, 
...
/// <param name="Param_Out_Valor">Recebe o valor referente ao valor da chave solicitada</param>
CarenResult CarenMFActivate::GetGUID(
		String^ Param_GuidChave, 
...
/// <param name="Param_Out_Valor">Recebe o valor referente ao valor da chave solicitada</param>
CarenResult CarenMFActivate::GetItem(
		String^ Param_GuidChave, 
...
/// <param name="Param_Out_Valor">Recebe o valor referente ao valor da chave solicitada</param>
CarenResult CarenMFActivate::GetItemByIndex(
		UInt32 Param_IdItem, 
...
CarenResult CarenMFActivate::GetItemType(
		String^ Param_GuidChave, 
...
/// <param name="Param_Out_Valor">Recebe o valor referente ao valor da chave solicitada.</param>
CarenResult CarenMFActivate::GetString(
		String^ Param_GuidChave, 
...
CarenResult CarenMFActivate::GetStringLength(
		String^ Param_GuidChave, 
...
/// <param name="Param_Out_Valor">Recebe o valor referente ao valor da chave solicitada</param>
CarenResult CarenMFActivate::GetUINT32(
		String^ Param_GuidChave, 
...
/// <param name="Param_Out_Valor">Recebe o valor referente ao valor da chave solicitada</param>
CarenResult CarenMFActivate::GetUINT64(
		String^ Param_GuidChave, 
...
CarenResult CarenMFActivate::_MFGetAttributeRatio(
		String^ Param_GuidChave, 
...
CarenResult CarenMFActivate::_MFGetAttributeSize(
		String^ Param_GuidChave, 
		[Out] UInt32% Param_Out_Largura, 
...
CarenResult CarenMFActivate::GetUnknown(
		String^ Param_GuidChave, 
...
CarenResult CarenMFActivate::SetBlob(
		String^ Param_GuidChave, 
...
CarenResult CarenMFActivate::SetDouble(
		String^ Param_GuidChave, 
		Double Param_Valor)
{
	//Chama o método na classe de funções compartilhadas da Media Foundation.
...
/// <param name="Param_GuidChave">O GUID para a chave que vai receber o valor.</param>
/// <param name="Param_Valor">O valor a ser definido na chave especificada.</param>
CarenResult CarenMFActivate::SetGUID(
		String^ Param_GuidChave, 
		String^ Param_Valor)
{
	//Chama o método na classe de funções compartilhadas da Media Foundation.
...
CarenResult CarenMFActivate::SetItem(
		String^ Param_GuidChave, 
...
/// <param name="Param_GuidChave">O GUID para a chave que vai receber o valor.</param>
/// <param name="Param_Valor">O valor a ser definido na chave especificada.</param>
CarenResult CarenMFActivate::SetString(
		String^ Param_GuidChave, 
		String^ Param_Valor)
{
	//Chama o método na classe de funções compartilhadas da Media Foundation.
...
/// <param name="Param_GuidChave">O GUID para a chave que vai receber o valor.</param>
/// <param name="Param_Valor">O valor a ser definido na chave especificada.</param>
CarenResult CarenMFActivate::SetUINT32(
		String^ Param_GuidChave, 
		UInt32 Param_Valor)
{
	//Chama o método na classe de funções compartilhadas da Media Foundation.
...
/// <param name="Param_GuidChave">O GUID para a chave que vai receber o valor.</param>
/// <param name="Param_Valor">O valor a ser definido na chave especificada.</param>
CarenResult CarenMFActivate::SetUINT64(
		String^ Param_GuidChave, 
		UInt64 Param_Valor)
{
	//Chama o método na classe de funções compartilhadas da Media Foundation.
...
CarenResult CarenMFActivate::_MFSetAttributeRatio(
		String^ Param_GuidChave, 
...
CarenResult CarenMFActivate::_MFSetAttributeSize(
		String^ Param_GuidChave, 
...
CarenResult CarenMFActivate::SetUnknown(
		String^ Param_GuidChave, 
