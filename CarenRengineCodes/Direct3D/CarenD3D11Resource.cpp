...
//Destruidor.
CarenD3D11Resource::~CarenD3D11Resource()
{
...
CarenResult CarenD3D11Resource::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD3D11Resource::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID3D11Resource*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD3D11Resource::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID3D11Resource*>(Param_PonteiroNativo);
...
CarenResult CarenD3D11Resource::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Resource::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Resource::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
/// </summary>
CarenResult CarenD3D11Resource::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD3D11Resource::ObterCodigoErro()
{
...
/// </summary>
void CarenD3D11Resource::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD3D11Resource::LiberarReferencia()
{
...
/// </summary>
void CarenD3D11Resource::LimparDados()
{
...
/// </summary>
void CarenD3D11Resource::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
...
CarenResult CarenD3D11Resource::ObterPrioridadeDespejo([Out] Enumeracoes::CA_DXGI_PRIORIDADE_RECURSO% Param_Out_Prioridade)
{
...
CarenResult CarenD3D11Resource::ObterTipo([Out] Enumeracoes::CA_D3D11_TIPO_RECURSO% Param_Out_TipoRecurso)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Resource::DefinirPrioridadeDespejo(Enumeracoes::CA_DXGI_PRIORIDADE_RECURSO Param_PrioridadeRecurso)
{
...
CarenResult CarenD3D11Resource::ObterDispositivo(ICaren^ Param_Out_DispositivoD3D11)
{
	//Variavel a ser retornada.
	CarenResult Resultado = CarenResult(E_FAIL, false);
...
CarenResult CarenD3D11Resource::ObterDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11Resource::DefinirDadosPrivados(
	String^ Param_Guid,
...
CarenResult CarenD3D11Resource::DefinirInterfaceDadosPrivados(
