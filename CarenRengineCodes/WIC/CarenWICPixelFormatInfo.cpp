...
CarenResult CarenWICPixelFormatInfo::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IWICPixelFormatInfo*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenWICPixelFormatInfo::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IWICPixelFormatInfo*>(Param_PonteiroNativo);
...
/// </summary>
void CarenWICPixelFormatInfo::LimparDados()
{
