...
CarenResult CarenMFByteStreamCacheControl2::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IMFByteStreamCacheControl2*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenMFByteStreamCacheControl2::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IMFByteStreamCacheControl2*>(Param_PonteiroNativo);
...
/// </summary>
Int32 CarenMFByteStreamCacheControl2::ObterCodigoErro()
{
...
/// </summary>
void CarenMFByteStreamCacheControl2::LimparDados()
{
