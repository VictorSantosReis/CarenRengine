...
public ref class CarenMFQualityAdviseLimits : public ICarenMFQualityAdviseLimits
{
	...
	//Ponteiro para a interface (IMFQualityAdviseLimits).
	IMFQualityAdviseLimits* PonteiroTrabalho = NULL;
...
public:
	static operator CarenMFQualityAdviseLimits^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFQualityAdviseLimits^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFQualityAdviseLimits();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFQualityAdviseLimits*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFQualityAdviseLimits::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenMFQualityAdviseLimits)
public:
	/// <summary>
