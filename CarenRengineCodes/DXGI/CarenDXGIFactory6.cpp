...
CarenResult CarenDXGIFactory6::CheckFeatureSupport(
	...
	ICarenBuffer^% Param_Ref_BufferDescFeature)
{
	...
	return Shared_DXGIFactory::CheckFeatureSupport(PonteiroTrabalho,
		Param_Recurso,
		Param_SizeBuffer,
		Param_Ref_BufferDescFeature
	);
}
...
CarenResult CarenDXGIFactory6::EnumAdapterByLuid(
	CA_LUID^ Param_LUID, 
	String^ Param_RIID, 
...
/// <param name="Param_RIID">O identificador globalmente único (GUID) do objeto ICarenDXGIAdapter referenciado pelo parâmetro (Param_InterfaceAdapter).</param>
/// <param name="Param_Out_InterfaceAdapter">Recebe um ponteiro de interface ICarenDXGIAdapter para o adaptador. </param>
CarenResult CarenDXGIFactory6::EnumWarpAdapter(
	String^ Param_RIID, 
	[Out] ICaren^ Param_Out_InterfaceAdapter)
{
	//Chama o método na classe de funções compartilhadas do DXGI.
...
CarenResult CarenDXGIFactory6::GetCreationFlags(
...
/// reiniciado.</param>
CarenResult CarenDXGIFactory6::GetSharedResourceAdapterLuid(
...
CarenResult CarenDXGIFactory6::IsWindowedStereoEnabled(
...
CarenResult CarenDXGIFactory6::RegisterOcclusionStatusEvent(
...
CarenResult CarenDXGIFactory6::RegisterOcclusionStatusWindow(
...
/// registro do evento de notificação que (Param_Evento) especifica.</param>
CarenResult CarenDXGIFactory6::RegisterStereoStatusEvent(
	ICarenEvent^ Param_Evento, 
	[Out] UInt32% Param_Out_Cookie)
{
	//Chama o método na classe de funções compartilhadas do DXGI.
...
/// de notificação que (Param_WinMensagemCode) especifica.</param>
CarenResult CarenDXGIFactory6::RegisterStereoStatusWindow(
	IntPtr Param_HandleJanela, 
	UInt32 Param_WinMensagemCode, 
	[Out] UInt32% Param_Out_Cookie)
{
...
CarenResult CarenDXGIFactory6::UnregisterOcclusionStatus(
	UInt32 Param_Cookie)
{
	//Chama o método na classe de funções compartilhadas do DXGI.
...
/// </summary>
/// <param name="Param_Cookie">Um valor-chave para a janela ou evento para cancelar o registro. Esse valor é retornado nos métodos de registro de evento e janela desta interface.</param>
CarenResult CarenDXGIFactory6::UnregisterStereoStatus(
	UInt32 Param_Cookie)
{
	//Chama o método na classe de funções compartilhadas do DXGI.
...
CarenResult CarenDXGIFactory6::EnumAdapters1(
...
CarenResult CarenDXGIFactory6::IsCurrent(
...
CarenResult CarenDXGIFactory6::CreateSoftwareAdapter(
...
CarenResult CarenDXGIFactory6::CreateSwapChain(
...
/// <param name="Param_IdAdaptador">O Indice para o adaptador a ser enumerado.</param>
/// <param name="Param_Out_Adaptador">Recebe um ponteiro para a interface do adaptador no indice especificado. O chamador é responsável por liberar a interface.</param>
CarenResult CarenDXGIFactory6::EnumAdapters(
	UInt32 Param_IdAdaptador, 
	[Out] ICarenDXGIAdapter^% Param_Out_Adaptador)
{
	//Chama o método na classe de funções compartilhadas do DXGI.
...
CarenResult CarenDXGIFactory6::GetWindowAssociation(
...
CarenResult CarenDXGIFactory6::MakeWindowAssociation(
	IntPtr Param_HandleJanela, 
