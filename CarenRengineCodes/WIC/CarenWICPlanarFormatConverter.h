...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por permitir que um conversor de formato seja inicializado com uma fonte planar. 
/// </summary>
public ref class CarenWICPlanarFormatConverter : public ICarenWICPlanarFormatConverter
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IWICPlanarFormatConverter).
	IWICPlanarFormatConverter* PonteiroTrabalho = NULL;
...
public:
	static operator CarenWICPlanarFormatConverter^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenWICPlanarFormatConverter^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenWICPlanarFormatConverter();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IWICPlanarFormatConverter*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenWICPlanarFormatConverter::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenWICPlanarFormatConverter)
public:
	/// <summary>
