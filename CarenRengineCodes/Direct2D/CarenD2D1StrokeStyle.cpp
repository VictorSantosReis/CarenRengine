...
//Destruidor.
CarenD2D1StrokeStyle::~CarenD2D1StrokeStyle()
{
...
CarenResult CarenD2D1StrokeStyle::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD2D1StrokeStyle::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1StrokeStyle*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1StrokeStyle::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1StrokeStyle*>(Param_PonteiroNativo);
...
CarenResult CarenD2D1StrokeStyle::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1StrokeStyle::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1StrokeStyle::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenD2D1StrokeStyle::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD2D1StrokeStyle::ObterCodigoErro()
{
...
/// </summary>
void CarenD2D1StrokeStyle::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD2D1StrokeStyle::LiberarReferencia()
{
...
/// </summary>
void CarenD2D1StrokeStyle::LimparDados()
{
...
/// </summary>
void CarenD2D1StrokeStyle::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
...
void CarenD2D1StrokeStyle::GetDashCap([Out] CA_D2D1_CAP_STYLE% Param_Out_EndDashStyle)
{
	//Variaveis a serem utilizadas.
...
void CarenD2D1StrokeStyle::GetDashes(
...
void CarenD2D1StrokeStyle::GetDashesCount([Out] UInt32% Param_Out_Quantidade)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1StrokeStyle::GetDashOffset([Out] float% Param_Out_Offset)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1StrokeStyle::GetDashStyle([Out] CA_D2D1_DASH_STYLE% Param_Out_DashStyleUsado)
{
	//Variaveis a serem utilizadas.
...
void CarenD2D1StrokeStyle::GetEndCap([Out] CA_D2D1_CAP_STYLE% Param_Out_TipoEndShape)
{
	//Variaveis a serem utilizadas.
	D2D1_CAP_STYLE CapStyle;
...
void CarenD2D1StrokeStyle::GetLineJoin([Out] CA_D2D1_LINE_JOIN% Param_Out_TipoJoint)
{
	//Variaveis a serem utilizadas.
...
void CarenD2D1StrokeStyle::GetMiterLimit([Out] float% Param_Out_Limite)
{
	//Chama o método para realizar a operação.
...
void CarenD2D1StrokeStyle::GetStartCap([Out] CA_D2D1_CAP_STYLE% Param_Out_TipoStartShape)
{
	//Variaveis a serem utilizadas.
	D2D1_CAP_STYLE CapStyle;
...
void CarenD2D1StrokeStyle::GetFactory(ICaren^ Param_Out_Factory)
{
	//Variaveis a serem utilizadas.
