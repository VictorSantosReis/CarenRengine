...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por renderizar para uma textura intermediária criada pelo método CreateCompatibleRenderTarget.
/// </summary>
public ref class CarenD2D1BitmapRenderTarget : public ICarenD2D1BitmapRenderTarget
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (ID2D1BitmapRenderTarget).
...
public:
	static operator CarenD2D1BitmapRenderTarget^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenD2D1BitmapRenderTarget^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenD2D1BitmapRenderTarget();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<ID2D1BitmapRenderTarget*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenD2D1BitmapRenderTarget::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
	...
	//Métodos da interface(ICarenD2D1BitmapRenderTarget)
public:
	/// <summary>
