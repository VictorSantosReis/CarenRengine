...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenD2D1SolidColorBrush">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenD2D1SolidColorBrush^% Param_Out_CarenD2D1SolidColorBrush)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);

		//Cria a interface
		Param_Out_CarenD2D1SolidColorBrush = gcnew CarenD2D1SolidColorBrush();
