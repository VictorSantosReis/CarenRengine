...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por representar uma interface base para todos os objetos DXGI; O ICarenDXGIObject suporta associar dados privados definidos pelo chamador (dados privados) a um objeto e recuperação 
/// de uma interface com o objeto pai.
/// </summary>
public ref class CarenDXGIObject : public ICarenDXGIObject
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IDXGIObject).
	IDXGIObject* PonteiroTrabalho = NULL;
...
public:
	static operator CarenDXGIObject^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenDXGIObject^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenDXGIObject();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IDXGIObject*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenDXGIObject::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
