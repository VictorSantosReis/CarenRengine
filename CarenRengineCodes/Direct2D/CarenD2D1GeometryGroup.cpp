...
//Destruidor.
CarenD2D1GeometryGroup::~CarenD2D1GeometryGroup()
{
...
CarenResult CarenD2D1GeometryGroup::ConsultarInterface(String^ Param_Guid, ICaren^ Param_InterfaceSolicitada)
{
...
CarenResult CarenD2D1GeometryGroup::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	PonteiroTrabalho = reinterpret_cast<ID2D1GeometryGroup*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenD2D1GeometryGroup::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<ID2D1GeometryGroup*>(Param_PonteiroNativo);
...
CarenResult CarenD2D1GeometryGroup::RecuperarPonteiro([Out] IntPtr% Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1GeometryGroup::RecuperarPonteiro(LPVOID* Param_Out_PonteiroNativo)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
CarenResult CarenD2D1GeometryGroup::RecuperarReferencias([Out] UInt64% Param_Out_Referencias)
{
	//Variavel que vai retornar o resultado.
	CarenResult Resultado = CarenResult(ResultCode::ER_FAIL, false);
...
/// </summary>
CarenResult CarenD2D1GeometryGroup::StatusPonteiro()
{
...
/// </summary>
Int32 CarenD2D1GeometryGroup::ObterCodigoErro()
{
...
/// </summary>
void CarenD2D1GeometryGroup::AdicionarReferencia()
{
	//Adiciona uma referência ao ponteiro
...
/// </summary>
void CarenD2D1GeometryGroup::LiberarReferencia()
{
...
/// </summary>
void CarenD2D1GeometryGroup::LimparDados()
{
...
/// </summary>
void CarenD2D1GeometryGroup::Finalizar()
{
	//////////////////////
	//Código de descarte//
	//////////////////////
	...
	this->~CarenD2D1GeometryGroup();
}



// Métodos da interface proprietária(ICarenD2D1GeometryGroup)
...
void CarenD2D1GeometryGroup::GetFillMode([Out] CA_D2D1_FILL_MODE% Param_Out_FillMode)
{
	//Variaveis a serem utilizadas.
	D2D1_FILL_MODE OutFillMode;

	//Chama o método para realizar a operação.
	OutFillMode = PonteiroTrabalho->GetFillMode();

	//Converte a enumeração e define no parametro de saida.
	Param_Out_FillMode = static_cast<CA_D2D1_FILL_MODE>(OutFillMode);
}
...
void CarenD2D1GeometryGroup::GetSourceGeometries(
cli::array<ICarenD2D1Geometry^>^ Param_Ref_Geometrias,
UInt32 Param_Quantidade)
{
	//Variaveis a serem utilizadas.
	ID2D1Geometry** pMatrizInterfacesGeometriasOut = NULL;

	//Verifica se a matriz é valida
	if (!ObjetoGerenciadoValido(Param_Ref_Geometrias))
	{
		//O objeto da matriz é invalido
	...
	pMatrizInterfacesGeometriasOut = CriarMatrizPonteiros<ID2D1Geometry>(Param_Quantidade);

	//Chama o método para realizar a operação.
	PonteiroTrabalho->GetSourceGeometries(pMatrizInterfacesGeometriasOut, Param_Quantidade);

	//Faz um for para adicionar todos os ponteiros nas interfaces de destino.
	for (UINT32 i = 0; i < Param_Quantidade; i++)
	{
		//Adiciona o ponteiro a matriz de geometrias.
		Param_Ref_Geometrias[i]->AdicionarPonteiro(pMatrizInterfacesGeometriasOut[i]);
	}

Done:;
	//Deleta a matriz de interfaces
	DeletarMatrizPonteirosSafe(&pMatrizInterfacesGeometriasOut);
}
...
void CarenD2D1GeometryGroup::GetSourceGeometryCount([Out] UInt32% Param_Out_Quantidade)
{
	//Chama o método para realizar a operação.
	Param_Out_Quantidade = PonteiroTrabalho->GetSourceGeometryCount();
}
...
CarenResult CarenD2D1GeometryGroup::CombineWithGeometry(
...
CarenResult CarenD2D1GeometryGroup::CompareWithGeometry(
	ICarenD2D1Geometry^ Param_GeometriaEntrada,
	CA_D2D1_MATRIX_3X2_F^ Param_InputGeometryTransform,
	float Param_FlatteningTolerance,
...
CarenResult CarenD2D1GeometryGroup::ComputeArea(
...
CarenResult CarenD2D1GeometryGroup::ComputeLength(
	CA_D2D1_MATRIX_3X2_F^ Param_WorldTransform,
	float Param_FlatteningTolerance,
...
CarenResult CarenD2D1GeometryGroup::ComputePointAtLength(
	float Param_Length,
	CA_D2D1_MATRIX_3X2_F^ Param_WorldTransform,
	float Param_FlatteningTolerance,
...
CarenResult CarenD2D1GeometryGroup::FillContainsPoint(
...
CarenResult CarenD2D1GeometryGroup::GetBounds(
	CA_D2D1_MATRIX_3X2_F^ Param_WorldTransform,
...
CarenResult CarenD2D1GeometryGroup::GetWidenedBounds(
...
CarenResult CarenD2D1GeometryGroup::Outline(
	CA_D2D1_MATRIX_3X2_F^ Param_WorldTransform,
	float Param_FlatteningTolerance,
...
CarenResult CarenD2D1GeometryGroup::Simplify(
...
CarenResult CarenD2D1GeometryGroup::StrokeContainsPoint(
	CA_D2D1_POINT_2F^ Param_Point,
	float Param_StrokeWidth,
	ICarenD2D1StrokeStyle^ Param_StrokeStyle,
	CA_D2D1_MATRIX_3X2_F^ Param_WorldTransform,
...
CarenResult CarenD2D1GeometryGroup::Tessellate(
	CA_D2D1_MATRIX_3X2_F^ Param_WorldTransform,
	float Param_FlatteningTolerance,
...
CarenResult CarenD2D1GeometryGroup::Widen(
	float Param_StrokeWidth,
	ICarenD2D1StrokeStyle^ Param_StrokeStyle,
	CA_D2D1_MATRIX_3X2_F^ Param_WorldTransform,
	float Param_FlatteningTolerance,
...
void CarenD2D1GeometryGroup::GetFactory(ICaren^ Param_Out_Factory)
{
	//Variaveis a serem utilizadas.
