...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenDXGIFactory1">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenDXGIFactory1^% Param_Out_CarenDXGIFactory1)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenDXGIFactory1 = gcnew CarenDXGIFactory1();
	...
	/// <summary>
	/// Método responsável por criar uma instância da classe de fabrica de objetos DXGI 1.1.
	/// </summary>
	/// <param name="Param_Out_CarenDXGIFactory1">Recebe um ponteiro para a interface.</param>
	static CarenResult CriarInstancia([Out] ICarenDXGIFactory1^% Param_Out_CarenDXGIFactory1)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);
		...
		//Variaveis
		IDXGIFactory1* pFabrica = NULL;

		//Chama o método para criar a Fabrica.
		Hr = CreateDXGIFactory1(__uuidof(IDXGIFactory1), (void**)&pFabrica);
		...
		Param_Out_CarenDXGIFactory1->AdicionarPonteiro(pFabrica);
