...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenDXGIOutputDuplication">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenDXGIOutputDuplication^% Param_Out_CarenDXGIOutputDuplication)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenDXGIOutputDuplication = gcnew CarenDXGIOutputDuplication();
