...
CarenResult CarenMFCaptureRecordSink::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IMFCaptureRecordSink*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenMFCaptureRecordSink::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IMFCaptureRecordSink*>(Param_PonteiroNativo);
...
/// </summary>
void CarenMFCaptureRecordSink::LimparDados()
{
