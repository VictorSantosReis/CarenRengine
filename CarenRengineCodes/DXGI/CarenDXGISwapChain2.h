...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenDXGISwapChain2">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenDXGISwapChain2^% Param_Out_CarenDXGISwapChain2)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenDXGISwapChain2 = gcnew CarenDXGISwapChain2();
