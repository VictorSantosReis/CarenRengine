...
public:
	static operator CarenMFTranscodeProfile^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFTranscodeProfile^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFTranscodeProfile(false);

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFTranscodeProfile*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFTranscodeProfile::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
