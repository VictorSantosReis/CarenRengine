...
public:
	static operator CarenMFAsyncResult^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenMFAsyncResult^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenMFAsyncResult();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IMFAsyncResult*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenMFAsyncResult::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
