...
public:
	...
	virtual CarenResult ObterQuantidadePropriedades([Out] UInt32% Param_Out_Quantidade);
	...
	virtual CarenResult ObterInfoPropriedades(
	UInt32 Param_ID,
	...
	virtual CarenResult CarregarObjeto(
