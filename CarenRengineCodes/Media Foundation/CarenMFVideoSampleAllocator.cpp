...
CarenResult CarenMFVideoSampleAllocator::AdicionarPonteiro(IntPtr Param_PonteiroNativo)
{
	...
	PonteiroTrabalho = reinterpret_cast<IMFVideoSampleAllocatorEx*>(Param_PonteiroNativo.ToPointer());
...
CarenResult CarenMFVideoSampleAllocator::AdicionarPonteiro(LPVOID Param_PonteiroNativo)
{
	...
	//Converte o ponteiro para o tipo especifico da classe.
	PonteiroTrabalho = reinterpret_cast<IMFVideoSampleAllocatorEx*>(Param_PonteiroNativo);
...
/// </summary>
Int32 CarenMFVideoSampleAllocator::ObterCodigoErro()
{
...
/// </summary>
void CarenMFVideoSampleAllocator::LimparDados()
{
