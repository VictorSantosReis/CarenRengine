...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenDXGIAdapter2">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenDXGIAdapter2^% Param_Out_CarenDXGIAdapter2)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenDXGIAdapter2 = gcnew CarenDXGIAdapter2();
