...
/// </summary>
public ref class CarenDXGIDevice : public ICarenDXGIDevice
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IDXGIDevice).
	IDXGIDevice* PonteiroTrabalho = NULL;
...
public:
	static operator CarenDXGIDevice^ (IntPtr Param_Pointer)
	{
		//Variavel a ser retornada.
		CarenDXGIDevice^ ClassResultado = nullptr;
		...
		ClassResultado = gcnew CarenDXGIDevice();

		//Define o ponteiro na classe.
		ClassResultado->PonteiroTrabalho = reinterpret_cast<IDXGIDevice*>(Param_Pointer.ToPointer());
...
public:
	...
	virtual TypeInterface As(cli::array<Object^>^ Param_Args)
	{
		...
		catch (const std::exception&)
		{
			...
			System::Console::WriteLine(String::Concat(ICarenDXGIDevice::typeid->Name, " - O método (As<>) falhou ao tentar criar uma instância para o tipo de destino solicitado => ", TypeInterface::typeid->Name));
