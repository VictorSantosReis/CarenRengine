...
/// <summary>
/// (Concluido - Fase de Testes) - Classe responsável por representar uma saída de adaptador (como um monitor). A classe estende a CarenDXGIOutput5 para 
/// fornecer recursos específicos de monitor.
/// </summary>
public ref class CarenDXGIOutput6 : public ICarenDXGIOutput6
{
	/////////////////////////////////////////
	//Objeto gerenciado por essa interface.//
	/////////////////////////////////////////

	//Ponteiro para a interface (IDXGIOutput6).
	IDXGIOutput6* PonteiroTrabalho = NULL;
...
public:
	...
	/// </summary>
	/// <param name="Param_Out_CarenDXGIOutput6">Recebe um ponteiro para a interface (Vazia).</param>
	static CarenResult CriarInstanciaVazia([Out] ICarenDXGIOutput6^% Param_Out_CarenDXGIOutput6)
	{
		//Variavel a ser retornada.
		CarenResult Resultado = CarenResult(E_FAIL, false);

		//Cria a interface
		Param_Out_CarenDXGIOutput6 = gcnew CarenDXGIOutput6();
...
public:
	...
	virtual CarenResult VerificarSuporteHardwareComposition(
	...
	virtual CarenResult ObterDescricao1([Out] CA_DXGI_OUTPUT_DESC1^% Param_Out_Desc);
...
public:
	...
	virtual CarenResult DuplicarSaida1(
...
public:
	...
	virtual CarenResult VerificarSuporteOverlayColorSpace(
...
public:
	...
	virtual CarenResult ChecarSuporteOverlay(
		CA_DXGI_FORMATO Param_Formato,
		ICaren^ Param_DispositivoD3D,
...
public:
	...
	virtual CarenResult SuporteOverlay([Out] Boolean Param_Out_Suporte);
...
public:
	...
	/// <param name="Param_Out_SaidaDuplicada">Recebe um ponteiro da interface para a nova saida duplicada.</param>
	virtual CarenResult DuplicarSaida(ICaren^ Param_Dispositivo3D, [Out] ICarenDXGIOutputDuplication^% Param_Out_SaidaDuplicada);
	...
	virtual CarenResult EncontrarModoExibicaoAdequado1(
	...
	virtual CarenResult ObterListaModosExibicao1(
		CA_DXGI_FORMATO Param_Formato,
	...
	virtual CarenResult ObterDadosSuperficeExibicaoAtual1(ICarenDXGIResource^ Param_SuperficeDestino);
